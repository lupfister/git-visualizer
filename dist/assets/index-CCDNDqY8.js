 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var my;function Gv(){if(my)return rn;my=1;var e=Symbol.for("react.transitional.element"),n=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),c=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),d=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),x=Symbol.for("react.activity"),b=Symbol.iterator;function C($){return $===null||typeof $!="object"?null:($=b&&$[b]||$["@@iterator"],typeof $=="function"?$:null)}var j={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},T=Object.assign,E={};function N($,re,ee){this.props=$,this.context=re,this.refs=E,this.updater=ee||j}N.prototype.isReactComponent={},N.prototype.setState=function($,re){if(typeof $!="object"&&typeof $!="function"&&$!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,$,re,"setState")},N.prototype.forceUpdate=function($){this.updater.enqueueForceUpdate(this,$,"forceUpdate")};function H(){}H.prototype=N.prototype;function L($,re,ee){this.props=$,this.context=re,this.refs=E,this.updater=ee||j}var A=L.prototype=new H;A.constructor=L,T(A,N.prototype),A.isPureReactComponent=!0;var X=Array.isArray;function W(){}var Y={H:null,A:null,T:null,S:null},q=Object.prototype.hasOwnProperty;function ue($,re,ee){var ve=ee.ref;return{$$typeof:e,type:$,key:re,ref:ve!==void 0?ve:null,props:ee}}function fe($,re){return ue($.type,re,$.props)}function _e($){return typeof $=="object"&&$!==null&&$.$$typeof===e}function De($){var re={"=":"=0",":":"=2"};return"$"+$.replace(/[=:]/g,function(ee){return re[ee]})}var Ge=/\/+/g;function se($,re){return typeof $=="object"&&$!==null&&$.key!=null?De(""+$.key):re.toString(36)}function he($){switch($.status){case"fulfilled":return $.value;case"rejected":throw $.reason;default:switch(typeof $.status=="string"?$.then(W,W):($.status="pending",$.then(function(re){$.status==="pending"&&($.status="fulfilled",$.value=re)},function(re){$.status==="pending"&&($.status="rejected",$.reason=re)})),$.status){case"fulfilled":return $.value;case"rejected":throw $.reason}}throw $}function O($,re,ee,ve,Te){var pe=typeof $;(pe==="undefined"||pe==="boolean")&&($=null);var Oe=!1;if($===null)Oe=!0;else switch(pe){case"bigint":case"string":case"number":Oe=!0;break;case"object":switch($.$$typeof){case e:case n:Oe=!0;break;case g:return Oe=$._init,O(Oe($._payload),re,ee,ve,Te)}}if(Oe)return Te=Te($),Oe=ve===""?"."+se($,0):ve,X(Te)?(ee="",Oe!=null&&(ee=Oe.replace(Ge,"$&/")+"/"),O(Te,re,ee,"",function(mt){return mt})):Te!=null&&(_e(Te)&&(Te=fe(Te,ee+(Te.key==null||$&&$.key===Te.key?"":(""+Te.key).replace(Ge,"$&/")+"/")+Oe)),re.push(Te)),1;Oe=0;var et=ve===""?".":ve+":";if(X($))for(var We=0;We<$.length;We++)ve=$[We],pe=et+se(ve,We),Oe+=O(ve,re,ee,pe,Te);else if(We=C($),typeof We=="function")for($=We.call($),We=0;!(ve=$.next()).done;)ve=ve.value,pe=et+se(ve,We++),Oe+=O(ve,re,ee,pe,Te);else if(pe==="object"){if(typeof $.then=="function")return O(he($),re,ee,ve,Te);throw re=String($),Error("Objects are not valid as a React child (found: "+(re==="[object Object]"?"object with keys {"+Object.keys($).join(", ")+"}":re)+"). If you meant to render a collection of children, use an array instead.")}return Oe}function oe($,re,ee){if($==null)return $;var ve=[],Te=0;return O($,ve,"","",function(pe){return re.call(ee,pe,Te++)}),ve}function P($){if($._status===-1){var re=$._result;re=re(),re.then(function(ee){($._status===0||$._status===-1)&&($._status=1,$._result=ee)},function(ee){($._status===0||$._status===-1)&&($._status=2,$._result=ee)}),$._status===-1&&($._status=0,$._result=re)}if($._status===1)return $._result.default;throw $._result}var me=typeof reportError=="function"?reportError:function($){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var re=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof $=="object"&&$!==null&&typeof $.message=="string"?String($.message):String($),error:$});if(!window.dispatchEvent(re))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",$);return}console.error($)},be={map:oe,forEach:function($,re,ee){oe($,function(){re.apply(this,arguments)},ee)},count:function($){var re=0;return oe($,function(){re++}),re},toArray:function($){return oe($,function(re){return re})||[]},only:function($){if(!_e($))throw Error("React.Children.only expected to receive a single React element child.");return $}};return rn.Activity=x,rn.Children=be,rn.Component=N,rn.Fragment=i,rn.Profiler=c,rn.PureComponent=L,rn.StrictMode=a,rn.Suspense=p,rn.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=Y,rn.__COMPILER_RUNTIME={__proto__:null,c:function($){return Y.H.useMemoCache($)}},rn.cache=function($){return function(){return $.apply(null,arguments)}},rn.cacheSignal=function(){return null},rn.cloneElement=function($,re,ee){if($==null)throw Error("The argument must be a React element, but you passed "+$+".");var ve=T({},$.props),Te=$.key;if(re!=null)for(pe in re.key!==void 0&&(Te=""+re.key),re)!q.call(re,pe)||pe==="key"||pe==="__self"||pe==="__source"||pe==="ref"&&re.ref===void 0||(ve[pe]=re[pe]);var pe=arguments.length-2;if(pe===1)ve.children=ee;else if(1<pe){for(var Oe=Array(pe),et=0;et<pe;et++)Oe[et]=arguments[et+2];ve.children=Oe}return ue($.type,Te,ve)},rn.createContext=function($){return $={$$typeof:d,_currentValue:$,_currentValue2:$,_threadCount:0,Provider:null,Consumer:null},$.Provider=$,$.Consumer={$$typeof:u,_context:$},$},rn.createElement=function($,re,ee){var ve,Te={},pe=null;if(re!=null)for(ve in re.key!==void 0&&(pe=""+re.key),re)q.call(re,ve)&&ve!=="key"&&ve!=="__self"&&ve!=="__source"&&(Te[ve]=re[ve]);var Oe=arguments.length-2;if(Oe===1)Te.children=ee;else if(1<Oe){for(var et=Array(Oe),We=0;We<Oe;We++)et[We]=arguments[We+2];Te.children=et}if($&&$.defaultProps)for(ve in Oe=$.defaultProps,Oe)Te[ve]===void 0&&(Te[ve]=Oe[ve]);return ue($,pe,Te)},rn.createRef=function(){return{current:null}},rn.forwardRef=function($){return{$$typeof:h,render:$}},rn.isValidElement=_e,rn.lazy=function($){return{$$typeof:g,_payload:{_status:-1,_result:$},_init:P}},rn.memo=function($,re){return{$$typeof:y,type:$,compare:re===void 0?null:re}},rn.startTransition=function($){var re=Y.T,ee={};Y.T=ee;try{var ve=$(),Te=Y.S;Te!==null&&Te(ee,ve),typeof ve=="object"&&ve!==null&&typeof ve.then=="function"&&ve.then(W,me)}catch(pe){me(pe)}finally{re!==null&&ee.types!==null&&(re.types=ee.types),Y.T=re}},rn.unstable_useCacheRefresh=function(){return Y.H.useCacheRefresh()},rn.use=function($){return Y.H.use($)},rn.useActionState=function($,re,ee){return Y.H.useActionState($,re,ee)},rn.useCallback=function($,re){return Y.H.useCallback($,re)},rn.useContext=function($){return Y.H.useContext($)},rn.useDebugValue=function(){},rn.useDeferredValue=function($,re){return Y.H.useDeferredValue($,re)},rn.useEffect=function($,re){return Y.H.useEffect($,re)},rn.useEffectEvent=function($){return Y.H.useEffectEvent($)},rn.useId=function(){return Y.H.useId()},rn.useImperativeHandle=function($,re,ee){return Y.H.useImperativeHandle($,re,ee)},rn.useInsertionEffect=function($,re){return Y.H.useInsertionEffect($,re)},rn.useLayoutEffect=function($,re){return Y.H.useLayoutEffect($,re)},rn.useMemo=function($,re){return Y.H.useMemo($,re)},rn.useOptimistic=function($,re){return Y.H.useOptimistic($,re)},rn.useReducer=function($,re,ee){return Y.H.useReducer($,re,ee)},rn.useRef=function($){return Y.H.useRef($)},rn.useState=function($){return Y.H.useState($)},rn.useSyncExternalStore=function($,re,ee){return Y.H.useSyncExternalStore($,re,ee)},rn.useTransition=function(){return Y.H.useTransition()},rn.version="19.2.4",rn}var py;function wp(){return py||(py=1,Gh.exports=Gv()),Gh.exports}var qh={exports:{}},qo={};/**
 * @license React
...
`;const q=yp(Y),fe=p2(q,{includeLeftRight:a==="detailed"||a==="forensic"});for(const Ge of fe)u+=`   - ${Ge}
...
[data-agentation-theme=light] .styles-module__markerTooltip___-VUm- .styles-module__markerNote___Rh4eI {
  color: rgba(0, 0, 0, 0.85);
}`,YM={marker:"styles-module__marker___9CKF7",enter:"styles-module__enter___8kI3q",exit:"styles-module__exit___KBdR3",clearing:"styles-module__clearing___8rM7K",pending:"styles-module__pending___BiY-U",fixed:"styles-module__fixed___aKrQO",multiSelect:"styles-module__multiSelect___CPfTC",hovered:"styles-module__hovered___-mg2N",renumber:"styles-module__renumber___16lvD",markerTooltip:"styles-module__markerTooltip___-VUm-",markerQuote:"styles-module__markerQuote___tQake",markerNote:"styles-module__markerNote___Rh4eI"};if(typeof document<"u"){let e=document.getElementById("feedback-tool-styles-annotation-marker-styles");e||(e=document.createElement("style"),e.id="feedback-tool-styles-annotation-marker-styles",document.head.appendChild(e)),e.textContent=VM}var eo=YM;function Px({annotation:e,globalIndex:n,layerIndex:i,layerSize:a,isExiting:c,isClearing:u,isAnimated:d,isHovered:h,isDeleting:p,isEditingAny:y,renumberFrom:g,markerClickBehavior:x,tooltipStyle:b,onHoverEnter:C,onHoverLeave:j,onClick:T,onContextMenu:E}){const N=(h||p)&&!y,H=N&&x==="delete",L=e.isMultiSelect,A=L?"var(--agentation-color-green)":"var(--agentation-color-accent)",X=c?eo.exit:u?eo.clearing:d?"":eo.enter,W=c?`${(a-1-i)*20}ms`:`${i*20}ms`;return l.jsxs("div",{className:`${eo.marker} ${L?eo.multiSelect:""} ${X} ${H?eo.hovered:""}`,"data-annotation-marker":!0,style:{left:`${e.x}%`,top:e.y,backgroundColor:H?void 0:A,animationDelay:W},onMouseEnter:()=>C(e),onMouseLeave:j,onClick:Y=>{Y.stopPropagation(),c||T(e)},onContextMenu:E?Y=>{x==="delete"&&(Y.preventDefault(),Y.stopPropagation(),c||E(e))}:void 0,children:[N?H?l.jsx(r2,{size:L?18:16}):l.jsx(sj,{size:16}):l.jsx("span",{className:g!==null&&n>=g?eo.renumber:void 0,children:n+1}),h&&!y&&l.jsxs("div",{className:`${eo.markerTooltip} ${eo.enter}`,style:b,children:[l.jsxs("span",{className:eo.markerQuote,children:[e.element,e.selectedText&&` "${e.selectedText.slice(0,30)}${e.selectedText.length>30?"...":""}"`]}),l.jsx("span",{className:eo.markerNote,children:e.comment})]})]})}function WM({x:e,y:n,isMultiSelect:i,isExiting:a}){return l.jsx("div",{className:`${eo.marker} ${eo.pending} ${i?eo.multiSelect:""} ${a?eo.exit:eo.enter}`,style:{left:`${e}%`,top:n,backgroundColor:i?"var(--agentation-color-green)":"var(--agentation-color-accent)"},children:l.jsx(W3,{size:12})})}function Hx({annotation:e,fixed:n}){const i=e.isMultiSelect;return l.jsx("div",{className:`${eo.marker} ${n?eo.fixed:""} ${eo.hovered} ${i?eo.multiSelect:""} ${eo.exit}`,"data-annotation-marker":!0,style:{left:`${e.x}%`,top:e.y},children:l.jsx(r2,{size:i?12:10})})}var FM=`.styles-module__switchContainer___Ka-AB {
  display: flex;
  align-items: center;
  position: relative;
  padding: 2px;
...
`)}
    ...
    }`].join(""),document.head.appendChild(e)};n7();function Lr(e,n){let i=document.elementFromPoint(e,n);if(!i)return null;for(;i!=null&&i.shadowRoot;){const a=i.shadowRoot.elementFromPoint(e,n);if(!a||a===i)break;i=a}return i}function Om(e){let n=e;for(;n&&n!==document.body;){const a=window.getComputedStyle(n).position;if(a==="fixed"||a==="sticky")return!0;n=n.parentElement}return!1}function Or(e){return e.status!=="resolved"&&e.status!=="dismissed"}function jd(e){const n=bp(e),i=n.found?n:PM(e);if(i.found&&i.source)return IM(i.source,"path")}function s7({demoAnnotations:e,demoDelay:n=1e3,enableDemoMode:i=!1,onAnnotationAdd:a,onAnnotationDelete:c,onAnnotationUpdate:u,onAnnotationsClear:d,onCopy:h,onSubmit:p,copyToClipboard:y=!0,endpoint:g,sessionId:x,onSessionCreated:b,webhookUrl:C,className:j}={}){var go,ko,jo,Ro,Mo,Go,la;const[T,E]=_.useState(!1),[N,H]=_.useState([]),[L,A]=_.useState(!0),[X,W]=_.useState(()=>pM()),[Y,q]=_.useState(!1),ue=_.useRef(null);_.useEffect(()=>{const B=w=>{const S=ue.current;S&&S.contains(w.target)&&w.stopPropagation()},U=["mousedown","click","pointerdown"];return U.forEach(w=>document.body.addEventListener(w,B)),()=>{U.forEach(w=>document.body.removeEventListener(w,B))}},[]);const[fe,_e]=_.useState(!1),[De,Ge]=_.useState(!1),[se,he]=_.useState(null),[O,oe]=_.useState({x:0,y:0}),[P,me]=_.useState(null),[be,$]=_.useState(!1),[re,ee]=_.useState("idle"),[ve,Te]=_.useState(!1),[pe,Oe]=_.useState(!1),[et,We]=_.useState(null),[mt,Nt]=_.useState(null),[Mt,ut]=_.useState([]),[$t,_t]=_.useState(null),[Gt,Jt]=_.useState(null),[Z,Re]=_.useState(null),[dt,rt]=_.useState(null),[gt,Ue]=_.useState([]),[vt,yt]=_.useState(0),[Et,qe]=_.useState(!1),[it,V]=_.useState(!1),[te,Se]=_.useState(!1),[Me,nt]=_.useState(!1),[Ye,Ne]=_.useState(!1),[xe,ot]=_.useState("main"),[Xe,st]=_.useState(!1),[Be,tt]=_.useState(!1),[wt,Ct]=_.useState(!1),[Ze,Bt]=_.useState([]),[kt,pt]=_.useState(null),cn=_.useRef(!1),[ft,Pt]=_.useState(!1),[hn,Ot]=_.useState(!1),[jt,mn]=_.useState(1),[rs,en]=_.useState("new-page"),[gn,nn]=_.useState(""),[zt,on]=_.useState(!1),[Qe,zn]=_.useState(null),$n=_.useRef(!1),Rs=_.useRef({rearrange:null,placements:[]}),Un=_.useRef({rearrange:null,placements:[]}),[bo,Ws]=_.useState(0),[co,Fs]=_.useState(0),[tn,kn]=_.useState(0),[bn,Xs]=_.useState(0),Bn=_.useRef(new Set),hs=_.useRef(new Set),sn=_.useRef(null),ts=_.useRef(),vo=Be&&T&&!wt&&ft;_.useEffect(()=>{if(vo){Ot(!1);const B=Al(()=>{Ot(!0)});return()=>cancelAnimationFrame(B)}else Ot(!1)},[vo]);const ws=_.useRef(new Map),_s=_.useRef(new Map),Bs=_.useRef(),[qn,gs]=_.useState(!1),[jn,Uo]=_.useState([]),ui=_.useRef(jn);ui.current=jn;const[wo,ra]=_.useState(null),Ls=_.useRef(null);_.useRef(!1),_.useRef([]),_.useRef(0),_.useRef(null),_.useRef(null),_.useRef(1);const[Gs,Ms]=_.useState(!1),Kn=_.useRef(null),[Sn,qs]=_.useState([]),vn=_.useRef({cmd:!1,shift:!1}),ms=()=>{st(!0)},Si=()=>{st(!1)},Vo=()=>{Gs||(Kn.current=Wt(()=>Ms(!0),850))},Ci=()=>{Kn.current&&(clearTimeout(Kn.current),Kn.current=null),Ms(!1),Si()};_.useEffect(()=>()=>{Kn.current&&clearTimeout(Kn.current)},[]);const[qt,Os]=_.useState(()=>{var B;try{const U=JSON.parse((B=localStorage.getItem("feedback-toolbar-settings"))!=null?B:"");return{...Lm,...U,annotationColorId:Wc.find(w=>w.id===U.annotationColorId)?U.annotationColorId:Lm.annotationColorId}}catch{return Lm}}),[Vn,ki]=_.useState(!0),[ji,zs]=_.useState(!1),uo=()=>{var B;(B=ue.current)==null||B.classList.add(Je.disableTransitions),ki(U=>!U),Al(()=>{var U;(U=ue.current)==null||U.classList.remove(Je.disableTransitions)})},to=!1,ls="off",[Dn,Es]=_.useState(x!=null?x:null),ys=_.useRef(!1),[Ts,$s]=_.useState(g?"connecting":"disconnected"),[yn,Ks]=_.useState(null),[Is,Qo]=_.useState(!1),[xs,Zo]=_.useState(null),Jo=_.useRef(!1),[ei,fo]=_.useState(new Set),[Ao,di]=_.useState(new Set),[cs,ho]=_.useState(!1),[Yo,As]=_.useState(!1),[mo,Wo]=_.useState(!1),Ns=_.useRef(null),wn=_.useRef(null),po=_.useRef(null),us=_.useRef(null),Tn=_.useRef(!1),Fo=_.useRef(0),Ss=_.useRef(null),No=_.useRef(null),fi=8,Mi=50,ti=_.useRef(null),ni=_.useRef(null),Xo=_.useRef(null),At=typeof window<"u"?window.location.pathname:"/";_.useEffect(()=>{if(Me)Ne(!0);else{st(!1),ot("main");const B=Wt(()=>Ne(!1),0);return()=>clearTimeout(B)}},[Me]);const no=T&&L&&!Be;_.useEffect(()=>{if(no){Ge(!1),_e(!0),fo(new Set);const B=Wt(()=>{fo(U=>{const w=new Set(U);return N.forEach(S=>w.add(S.id)),w})},350);return()=>clearTimeout(B)}else if(fe){Ge(!0);const B=Wt(()=>{_e(!1),Ge(!1)},250);return()=>clearTimeout(B)}},[no]),_.useEffect(()=>{V(!0),yt(window.scrollY);const B=Em(At);H(B.filter(Or)),Yx||(zs(!0),Yx=!0,Wt(()=>zs(!1),750));try{const U=localStorage.getItem("feedback-toolbar-theme");U!==null&&ki(U==="dark")}catch{}try{const U=localStorage.getItem("feedback-toolbar-position");if(U){const w=JSON.parse(U);typeof w.x=="number"&&typeof w.y=="number"&&Ks(w)}}catch{}},[At]),_.useEffect(()=>{it&&localStorage.setItem("feedback-toolbar-settings",JSON.stringify(qt))},[qt,it]),_.useEffect(()=>{it&&localStorage.setItem("feedback-toolbar-theme",Vn?"dark":"light")},[Vn,it]);const Qi=_.useRef(!1);_.useEffect(()=>{const B=Qi.current;Qi.current=Is,B&&!Is&&yn&&it&&localStorage.setItem("feedback-toolbar-position",JSON.stringify(yn))},[Is,yn,it]),_.useEffect(()=>{if(!g||!it||ys.current)return;ys.current=!0,$s("connecting"),(async()=>{try{const U=hM(At),w=x||U;let S=!1;if(w)try{const k=await Lx(g,w);Es(k.id),$s("connected"),Tm(At,k.id),S=!0;const R=Em(At),z=new Set(k.annotations.map(le=>le.id)),J=R.filter(le=>!z.has(le.id));if(J.length>0){const Ee=`${typeof window<"u"?window.location.origin:""}${At}`,G=(await Promise.allSettled(J.map(ae=>Cl(g,k.id,{...ae,sessionId:k.id,url:Ee})))).map((ae,K)=>ae.status==="fulfilled"?ae.value:(console.warn("[Agentation] Failed to sync annotation:",ae.reason),J[K])),ie=[...k.annotations,...G];H(ie.filter(Or)),Tc(At,ie.filter(Or),k.id)}else H(k.annotations.filter(Or)),Tc(At,k.annotations.filter(Or),k.id)}catch(k){console.warn("[Agentation] Could not join session, creating new:",k),mM(At)}if(!S){const k=typeof window<"u"?window.location.href:"/",R=await Am(g,k);Es(R.id),$s("connected"),Tm(At,R.id),b==null||b(R.id);const z=iM(),J=typeof window<"u"?window.location.origin:"",le=[];for(const[Ee,Ke]of z){const G=Ke.filter(K=>!K._syncedTo);if(G.length===0)continue;const ie=`${J}${Ee}`,ae=Ee===At;le.push((async()=>{try{const K=ae?R:await Am(g,ie),at=(await Promise.allSettled(G.map(ct=>Cl(g,K.id,{...ct,sessionId:K.id,url:ie})))).map((ct,St)=>ct.status==="fulfilled"?ct.value:(console.warn("[Agentation] Failed to sync annotation:",ct.reason),G[St])).filter(Or);if(Tc(Ee,at,K.id),ae){const ct=new Set(G.map(St=>St.id));H(St=>{const ht=St.filter(bt=>!ct.has(bt.id));return[...at,...ht]})}}catch(K){console.warn(`[Agentation] Failed to sync annotations for ${Ee}:`,K)}})())}await Promise.allSettled(le)}}catch(U){$s("disconnected"),console.warn("[Agentation] Failed to initialize session, using local storage:",U)}})()},[g,x,it,b,At]),_.useEffect(()=>{if(!g||!it)return;const B=async()=>{try{(await fetch(`${g}/health`)).ok?$s("connected"):$s("disconnected")}catch{$s("disconnected")}};B();const U=lj(B,1e4);return()=>clearInterval(U)},[g,it]),_.useEffect(()=>{if(!g||!it||!Dn)return;const B=new EventSource(`${g}/sessions/${Dn}/events`),U=["resolved","dismissed"],w=S=>{var k;try{const R=JSON.parse(S.data);if(U.includes((k=R.payload)==null?void 0:k.status)){const z=R.payload.id,J=R.payload.kind;if(J==="placement"){for(const[le,Ee]of ws.current)if(Ee===z){ws.current.delete(le),Bt(Ke=>Ke.filter(G=>G.id!==le));break}}else if(J==="rearrange"){for(const[le,Ee]of _s.current)if(Ee===z){_s.current.delete(le),zn(Ke=>{if(!Ke)return null;const G=Ke.sections.filter(ie=>ie.id!==le);return G.length===0?null:{...Ke,sections:G}});break}}else di(le=>new Set(le).add(z)),Wt(()=>{H(le=>le.filter(Ee=>Ee.id!==z)),di(le=>{const Ee=new Set(le);return Ee.delete(z),Ee})},150)}}catch{}};return B.addEventListener("annotation.updated",w),()=>{B.removeEventListener("annotation.updated",w),B.close()}},[g,it,Dn]),_.useEffect(()=>{if(!g||!it)return;const B=No.current==="disconnected",U=Ts==="connected";No.current=Ts,B&&U&&(async()=>{try{const S=Em(At);if(S.length===0)return;const R=`${typeof window<"u"?window.location.origin:""}${At}`;let z=Dn,J=[];if(z)try{J=(await Lx(g,z)).annotations}catch{z=null}z||(z=(await Am(g,R)).id,Es(z),Tm(At,z));const le=new Set(J.map(Ke=>Ke.id)),Ee=S.filter(Ke=>!le.has(Ke.id));if(Ee.length>0){const G=(await Promise.allSettled(Ee.map(K=>Cl(g,z,{...K,sessionId:z,url:R})))).map((K,ke)=>K.status==="fulfilled"?K.value:(console.warn("[Agentation] Failed to sync annotation on reconnect:",K.reason),Ee[ke])),ae=[...J,...G].filter(Or);H(ae),Tc(At,ae,z)}}catch(S){console.warn("[Agentation] Failed to sync on reconnect:",S)}})()},[Ts,g,it,Dn,At]);const zi=_.useCallback(()=>{Y||(q(!0),nt(!1),E(!1),Wt(()=>{_M(!0),W(!0),q(!1)},400))},[Y]);_.useEffect(()=>{if(!i||!it||!e||e.length===0||N.length>0)return;const B=[];return B.push(Wt(()=>{E(!0)},n-200)),e.forEach((U,w)=>{const S=n+w*300;B.push(Wt(()=>{const k=document.querySelector(U.selector);if(!k)return;const R=k.getBoundingClientRect(),{name:z,path:J}=Nl(k),le={id:`demo-${Date.now()}-${w}`,x:(R.left+R.width/2)/window.innerWidth*100,y:R.top+R.height/2+window.scrollY,comment:U.comment,element:z,elementPath:J,timestamp:Date.now(),selectedText:U.selectedText,boundingBox:{x:R.left,y:R.top+window.scrollY,width:R.width,height:R.height},nearbyText:Mc(k),cssClasses:Ec(k)};H(Ee=>[...Ee,le])},S))}),()=>{B.forEach(clearTimeout)}},[i,it,e,n]),_.useEffect(()=>{const B=()=>{yt(window.scrollY),qe(!0),Xo.current&&clearTimeout(Xo.current),Xo.current=Wt(()=>{qe(!1)},150)};return window.addEventListener("scroll",B,{passive:!0}),()=>{window.removeEventListener("scroll",B),Xo.current&&clearTimeout(Xo.current)}},[]),_.useEffect(()=>{it&&N.length>0?Dn?Tc(At,N,Dn):b2(At,N):it&&N.length===0&&localStorage.removeItem(Qd(At))},[N,At,it,Dn]),_.useEffect(()=>{if(it&&!cn.current){cn.current=!0;const B=aM(At);B.length>0&&Bt(B)}},[it,At]),_.useEffect(()=>{it&&cn.current&&!ft&&(Ze.length>0?rM(At,Ze):lM(At))},[Ze,At,it,ft]),_.useEffect(()=>{if(it&&!$n.current){$n.current=!0;const B=cM(At);if(B){const U={...B,sections:B.sections.map(w=>{var S;return{...w,currentRect:(S=w.currentRect)!=null?S:{...w.originalRect}}})};zn(U)}}},[it,At]),_.useEffect(()=>{it&&$n.current&&!ft&&(Qe?uM(At,Qe):dM(At))},[Qe,At,it,ft]);const $i=_.useRef(!1);_.useEffect(()=>{if(it&&!$i.current){$i.current=!0;const B=fM(At);B&&(Un.current={rearrange:B.rearrange,placements:B.placements||[]},B.purpose&&nn(B.purpose))}},[it,At]),_.useEffect(()=>{var U,w,S,k,R;if(!it||!$i.current)return;const B=Un.current;ft?((w=(U=Qe==null?void 0:Qe.sections)==null?void 0:U.length)!=null?w:0)>0||Ze.length>0||gn?Bx(At,{rearrange:Qe,placements:Ze,purpose:gn}):Sd(At):((R=(k=(S=B.rearrange)==null?void 0:S.sections)==null?void 0:k.length)!=null?R:0)>0||B.placements.length>0||gn?Bx(At,{rearrange:B.rearrange,placements:B.placements,purpose:gn}):Sd(At)},[Qe,Ze,gn,ft,At,it]),_.useEffect(()=>{Be&&!Qe&&zn({sections:[],originalOrder:[],detectedAt:Date.now()})},[Be,Qe]),_.useEffect(()=>{if(!g||!Dn)return;const B=ws.current,U=new Set(Ze.map(w=>w.id));for(const w of Ze){if(B.has(w.id))continue;B.set(w.id,"");const S=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:At;Cl(g,Dn,{id:w.id,x:w.x/window.innerWidth*100,y:w.y,comment:`Place ${w.type} at (${Math.round(w.x)}, ${Math.round(w.y)}), ${w.width}×${w.height}px${w.text?` — "${w.text}"`:""}`,element:`[design:${w.type}]`,elementPath:"[placement]",timestamp:w.timestamp,url:S,intent:"change",severity:"important",kind:"placement",placement:{componentType:w.type,width:w.width,height:w.height,scrollY:w.scrollY,text:w.text}}).then(k=>{B.has(w.id)&&B.set(w.id,k.id)}).catch(k=>{console.warn("[Agentation] Failed to sync placement annotation:",k),B.delete(w.id)})}for(const[w,S]of B)U.has(w)||(B.delete(w),S&&cr(g,S).catch(()=>{}))},[Ze,g,Dn,At]),_.useEffect(()=>{if(!(!g||!Dn))return Bs.current&&clearTimeout(Bs.current),Bs.current=Wt(()=>{const B=_s.current;if(!Qe||Qe.sections.length===0){for(const[,S]of B)S&&cr(g,S).catch(()=>{});B.clear();return}const U=new Set(Qe.sections.map(S=>S.id)),w=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:At;for(const S of Qe.sections){const k=S.originalRect,R=S.currentRect;if(!(Math.abs(k.x-R.x)>1||Math.abs(k.y-R.y)>1||Math.abs(k.width-R.width)>1||Math.abs(k.height-R.height)>1)){const le=B.get(S.id);le&&(B.delete(S.id),cr(g,le).catch(()=>{}));continue}const J=B.get(S.id);J?Ox(g,J,{comment:`Move ${S.label} section (${S.tagName}) — from (${Math.round(k.x)},${Math.round(k.y)}) ${Math.round(k.width)}×${Math.round(k.height)} to (${Math.round(R.x)},${Math.round(R.y)}) ${Math.round(R.width)}×${Math.round(R.height)}`}).catch(le=>{console.warn("[Agentation] Failed to update rearrange annotation:",le)}):(B.set(S.id,""),Cl(g,Dn,{id:S.id,x:R.x/window.innerWidth*100,y:R.y,comment:`Move ${S.label} section (${S.tagName}) — from (${Math.round(k.x)},${Math.round(k.y)}) ${Math.round(k.width)}×${Math.round(k.height)} to (${Math.round(R.x)},${Math.round(R.y)}) ${Math.round(R.width)}×${Math.round(R.height)}`,element:S.selector,elementPath:"[rearrange]",timestamp:Date.now(),url:w,intent:"change",severity:"important",kind:"rearrange",rearrange:{selector:S.selector,label:S.label,tagName:S.tagName,originalRect:k,currentRect:R}}).then(le=>{B.has(S.id)&&B.set(S.id,le.id)}).catch(le=>{console.warn("[Agentation] Failed to sync rearrange annotation:",le),B.delete(S.id)}))}for(const[S,k]of B)U.has(S)||(B.delete(S),k&&cr(g,k).catch(()=>{}))},300),()=>{Bs.current&&clearTimeout(Bs.current)}},[Qe,g,Dn,At]);const So=_.useRef(new Map);_.useLayoutEffect(()=>{var w;const B=(w=Qe==null?void 0:Qe.sections)!=null?w:[],U=new Set;if((Be||wt)&&T)for(const S of B){U.add(S.id);try{const k=document.querySelector(S.selector);if(!k)continue;if(!So.current.has(S.id)){const R={transform:k.style.transform,transformOrigin:k.style.transformOrigin,opacity:k.style.opacity,position:k.style.position,zIndex:k.style.zIndex,display:k.style.display},z=[];let J=k.parentElement;for(;J&&J!==document.body;){const Ee=getComputedStyle(J);(Ee.overflow!=="visible"||Ee.overflowX!=="visible"||Ee.overflowY!=="visible")&&(z.push({el:J,overflow:J.style.overflow}),J.style.overflow="visible"),J=J.parentElement}getComputedStyle(k).display==="inline"&&(k.style.display="inline-block"),So.current.set(S.id,{el:k,origStyles:R,ancestors:z}),k.style.transformOrigin="top left",k.style.zIndex="9999"}}catch{}}for(const[S,k]of So.current)if(!U.has(S)){const{el:R,origStyles:z,ancestors:J}=k;R.style.transition="transform 0.4s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.4s cubic-bezier(0.22, 1, 0.36, 1)",R.style.transform=z.transform,R.style.transformOrigin=z.transformOrigin,R.style.opacity=z.opacity,R.style.position=z.position,R.style.zIndex=z.zIndex,So.current.delete(S),Wt(()=>{R.style.transition="",R.style.display=z.display;for(const le of J)le.el.style.overflow=le.overflow},450)}},[Qe,Be,wt,T]),_.useEffect(()=>()=>{for(const[,B]of So.current){const{el:U,origStyles:w,ancestors:S}=B;U.style.transition="transform 0.4s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.4s cubic-bezier(0.22, 1, 0.36, 1)",U.style.transform=w.transform,U.style.transformOrigin=w.transformOrigin,U.style.opacity=w.opacity,U.style.position=w.position,U.style.zIndex=w.zIndex,Wt(()=>{U.style.transition="",U.style.display=w.display;for(const k of S)k.el.style.overflow=k.overflow},450)}So.current.clear()},[]);const Do=_.useCallback(()=>{Ct(!0),tt(!1),pt(null),clearTimeout(ts.current),ts.current=Wt(()=>{Ct(!1)},300)},[]),Co=_.useCallback(()=>{Be&&(Ct(!0),tt(!1),pt(null),clearTimeout(ts.current),ts.current=Wt(()=>{Ct(!1)},300)),E(!1)},[Be]),hi=_.useCallback(()=>{te||(uj(),Se(!0))},[te]),M=_.useCallback(()=>{te&&(bx(),Se(!1))},[te]),F=_.useCallback(()=>{te?M():hi()},[te,hi,M]),de=_.useCallback(()=>{if(Sn.length===0)return;const B=Sn[0],U=B.element,w=Sn.length>1,S=Sn.map(k=>k.element.getBoundingClientRect());if(w){const k={left:Math.min(...S.map(K=>K.left)),top:Math.min(...S.map(K=>K.top)),right:Math.max(...S.map(K=>K.right)),bottom:Math.max(...S.map(K=>K.bottom))},R=Sn.slice(0,5).map(K=>K.name).join(", "),z=Sn.length>5?` +${Sn.length-5} more`:"",J=S.map(K=>({x:K.left,y:K.top+window.scrollY,width:K.width,height:K.height})),Ee=Sn[Sn.length-1].element,Ke=S[S.length-1],G=Ke.left+Ke.width/2,ie=Ke.top+Ke.height/2,ae=Om(Ee);me({x:G/window.innerWidth*100,y:ae?ie:ie+window.scrollY,clientY:ie,element:`${Sn.length} elements: ${R}${z}`,elementPath:"multi-select",boundingBox:{x:k.left,y:k.top+window.scrollY,width:k.right-k.left,height:k.bottom-k.top},isMultiSelect:!0,isFixed:ae,elementBoundingBoxes:J,multiSelectElements:Sn.map(K=>K.element),targetElement:Ee,fullPath:bd(U),accessibility:xd(U),computedStyles:yd(U),computedStylesObj:gd(U),nearbyElements:_d(U),cssClasses:Ec(U),nearbyText:Mc(U),sourceFile:jd(U)})}else{const k=S[0],R=Om(U);me({x:k.left/window.innerWidth*100,y:R?k.top:k.top+window.scrollY,clientY:k.top,element:B.name,elementPath:B.path,boundingBox:{x:k.left,y:R?k.top:k.top+window.scrollY,width:k.width,height:k.height},isFixed:R,fullPath:bd(U),accessibility:xd(U),computedStyles:yd(U),computedStylesObj:gd(U),nearbyElements:_d(U),cssClasses:Ec(U),nearbyText:Mc(U),reactComponents:B.reactComponents,sourceFile:jd(U)})}qs([]),he(null)},[Sn]);_.useEffect(()=>{T||(me(null),Re(null),rt(null),Ue([]),he(null),nt(!1),qs([]),vn.current={cmd:!1,shift:!1},te&&M())},[T,te,M]),_.useEffect(()=>()=>{bx()},[]),_.useEffect(()=>{if(!T)return;const B=["p","span","h1","h2","h3","h4","h5","h6","li","td","th","label","blockquote","figcaption","caption","legend","dt","dd","pre","code","em","strong","b","i","u","s","a","time","address","cite","q","abbr","dfn","mark","small","sub","sup","[contenteditable]"].join(", "),U=":not([data-agentation-root]):not([data-agentation-root] *)",w=document.createElement("style");return w.id="feedback-cursor-styles",w.textContent=`
      body ${U} {
        cursor: crosshair !important;
      }
    ...
    `,document.head.appendChild(w),()=>{const S=document.getElementById("feedback-cursor-styles");S&&S.remove()}},[T]),_.useEffect(()=>{if(wo!==null&&T)return document.documentElement.setAttribute("data-drawing-hover",""),()=>document.documentElement.removeAttribute("data-drawing-hover")},[wo,T]),_.useEffect(()=>{if(!T||P||qn||Be)return;const B=U=>{const w=U.composedPath()[0]||U.target;if(ii(w,"[data-feedback-toolbar]")){he(null);return}const S=Lr(U.clientX,U.clientY);if(!S||ii(S,"[data-feedback-toolbar]")){he(null);return}const{name:k,elementName:R,path:z,reactComponents:J}=Bm(S,ls),le=S.getBoundingClientRect();he({element:k,elementName:R,elementPath:z,rect:le,reactComponents:J}),oe({x:U.clientX,y:U.clientY})};return document.addEventListener("mousemove",B),()=>document.removeEventListener("mousemove",B)},[T,P,qn,Be,ls,jn]);const Ae=_.useCallback(B=>{var U;if(Re(B),We(null),Nt(null),ut([]),(U=B.elementBoundingBoxes)!=null&&U.length){const w=[];for(const S of B.elementBoundingBoxes){const k=S.x+S.width/2,R=S.y+S.height/2-window.scrollY,z=Lr(k,R);z&&w.push(z)}Ue(w),rt(null)}else if(B.boundingBox){const w=B.boundingBox,S=w.x+w.width/2,k=B.isFixed?w.y+w.height/2:w.y+w.height/2-window.scrollY,R=Lr(S,k);if(R){const z=R.getBoundingClientRect(),J=z.width/w.width,le=z.height/w.height;J<.5||le<.5?rt(null):rt(R)}else rt(null);Ue([])}else rt(null),Ue([])},[]);_.useEffect(()=>{if(!T||qn||Be)return;const B=U=>{var Ie,at;if(Tn.current){Tn.current=!1;return}const w=U.composedPath()[0]||U.target;if(ii(w,"[data-feedback-toolbar]")||ii(w,"[data-annotation-popup]")||ii(w,"[data-annotation-marker]"))return;if(U.metaKey&&U.shiftKey&&!P&&!Z){U.preventDefault(),U.stopPropagation();const ct=Lr(U.clientX,U.clientY);if(!ct)return;const St=ct.getBoundingClientRect(),{name:ht,path:bt,reactComponents:dn}=Bm(ct,ls),Ft=Sn.findIndex(fn=>fn.element===ct);Ft>=0?qs(fn=>fn.filter((Ln,On)=>On!==Ft)):qs(fn=>[...fn,{element:ct,rect:St,name:ht,path:bt,reactComponents:dn!=null?dn:void 0}]);return}const S=ii(w,"button, a, input, select, textarea, [role='button'], [onclick]");if(qt.blockInteractions&&S&&(U.preventDefault(),U.stopPropagation()),P){if(S&&!qt.blockInteractions)return;U.preventDefault(),(Ie=ti.current)==null||Ie.shake();return}if(Z){if(S&&!qt.blockInteractions)return;U.preventDefault(),(at=ni.current)==null||at.shake();return}U.preventDefault();const k=Lr(U.clientX,U.clientY);if(!k)return;const{name:R,path:z,reactComponents:J}=Bm(k,ls),le=k.getBoundingClientRect(),Ee=U.clientX/window.innerWidth*100,Ke=Om(k),G=Ke?U.clientY:U.clientY+window.scrollY,ie=window.getSelection();let ae;ie&&ie.toString().trim().length>0&&(ae=ie.toString().trim().slice(0,500));const K=gd(k),ke=yd(k);me({x:Ee,y:G,clientY:U.clientY,element:R,elementPath:z,selectedText:ae,boundingBox:{x:le.left,y:Ke?le.top:le.top+window.scrollY,width:le.width,height:le.height},nearbyText:Mc(k),cssClasses:Ec(k),isFixed:Ke,fullPath:bd(k),accessibility:xd(k),computedStyles:ke,computedStylesObj:K,nearbyElements:_d(k),reactComponents:J!=null?J:void 0,sourceFile:jd(k),targetElement:k}),he(null)};return document.addEventListener("click",B,!0),()=>document.removeEventListener("click",B,!0)},[T,qn,Be,P,Z,qt.blockInteractions,ls,Sn]),_.useEffect(()=>{if(!T)return;const B=S=>{S.key==="Meta"&&(vn.current.cmd=!0),S.key==="Shift"&&(vn.current.shift=!0)},U=S=>{const k=vn.current.cmd&&vn.current.shift;S.key==="Meta"&&(vn.current.cmd=!1),S.key==="Shift"&&(vn.current.shift=!1);const R=vn.current.cmd&&vn.current.shift;k&&!R&&Sn.length>0&&de()},w=()=>{vn.current={cmd:!1,shift:!1},qs([])};return document.addEventListener("keydown",B),document.addEventListener("keyup",U),window.addEventListener("blur",w),()=>{document.removeEventListener("keydown",B),document.removeEventListener("keyup",U),window.removeEventListener("blur",w)}},[T,Sn,de]),_.useEffect(()=>{if(!T||P||qn||Be)return;const B=U=>{const w=U.composedPath()[0]||U.target;ii(w,"[data-feedback-toolbar]")||ii(w,"[data-annotation-marker]")||ii(w,"[data-annotation-popup]")||new Set(["P","SPAN","H1","H2","H3","H4","H5","H6","LI","TD","TH","LABEL","BLOCKQUOTE","FIGCAPTION","CAPTION","LEGEND","DT","DD","PRE","CODE","EM","STRONG","B","I","U","S","A","TIME","ADDRESS","CITE","Q","ABBR","DFN","MARK","SMALL","SUB","SUP"]).has(w.tagName)||w.isContentEditable||(U.preventDefault(),Ns.current={x:U.clientX,y:U.clientY})};return document.addEventListener("mousedown",B),()=>document.removeEventListener("mousedown",B)},[T,P,qn,Be]),_.useEffect(()=>{if(!T||P)return;const B=U=>{if(!Ns.current)return;const w=U.clientX-Ns.current.x,S=U.clientY-Ns.current.y,k=w*w+S*S,R=fi*fi;if(!mo&&k>=R&&(wn.current=Ns.current,Wo(!0),U.preventDefault()),(mo||k>=R)&&wn.current){if(po.current){const ht=Math.min(wn.current.x,U.clientX),bt=Math.min(wn.current.y,U.clientY),dn=Math.abs(U.clientX-wn.current.x),Ft=Math.abs(U.clientY-wn.current.y);po.current.style.transform=`translate(${ht}px, ${bt}px)`,po.current.style.width=`${dn}px`,po.current.style.height=`${Ft}px`}const z=Date.now();if(z-Fo.current<Mi)return;Fo.current=z;const J=wn.current.x,le=wn.current.y,Ee=Math.min(J,U.clientX),Ke=Math.min(le,U.clientY),G=Math.max(J,U.clientX),ie=Math.max(le,U.clientY),ae=(Ee+G)/2,K=(Ke+ie)/2,ke=new Set,Ie=[[Ee,Ke],[G,Ke],[Ee,ie],[G,ie],[ae,K],[ae,Ke],[ae,ie],[Ee,K],[G,K]];for(const[ht,bt]of Ie){const dn=document.elementsFromPoint(ht,bt);for(const Ft of dn)Ft instanceof HTMLElement&&ke.add(Ft)}const at=document.querySelectorAll("button, a, input, img, p, h1, h2, h3, h4, h5, h6, li, label, td, th, div, span, section, article, aside, nav");for(const ht of at)if(ht instanceof HTMLElement){const bt=ht.getBoundingClientRect(),dn=bt.left+bt.width/2,Ft=bt.top+bt.height/2,fn=dn>=Ee&&dn<=G&&Ft>=Ke&&Ft<=ie,Ln=Math.min(bt.right,G)-Math.max(bt.left,Ee),On=Math.min(bt.bottom,ie)-Math.max(bt.top,Ke),Eo=Ln>0&&On>0?Ln*On:0,Bo=bt.width*bt.height,mi=Bo>0?Eo/Bo:0;(fn||mi>.5)&&ke.add(ht)}const ct=[],St=new Set(["BUTTON","A","INPUT","IMG","P","H1","H2","H3","H4","H5","H6","LI","LABEL","TD","TH","SECTION","ARTICLE","ASIDE","NAV"]);for(const ht of ke){if(ii(ht,"[data-feedback-toolbar]")||ii(ht,"[data-annotation-marker]"))continue;const bt=ht.getBoundingClientRect();if(!(bt.width>window.innerWidth*.8&&bt.height>window.innerHeight*.5)&&!(bt.width<10||bt.height<10)&&bt.left<G&&bt.right>Ee&&bt.top<ie&&bt.bottom>Ke){const dn=ht.tagName;let Ft=St.has(dn);if(!Ft&&(dn==="DIV"||dn==="SPAN")){const fn=ht.textContent&&ht.textContent.trim().length>0,Ln=ht.onclick!==null||ht.getAttribute("role")==="button"||ht.getAttribute("role")==="link"||ht.classList.contains("clickable")||ht.hasAttribute("data-clickable");(fn||Ln)&&!ht.querySelector("p, h1, h2, h3, h4, h5, h6, button, a")&&(Ft=!0)}if(Ft){let fn=!1;for(const Ln of ct)if(Ln.left<=bt.left&&Ln.right>=bt.right&&Ln.top<=bt.top&&Ln.bottom>=bt.bottom){fn=!0;break}fn||ct.push(bt)}}}if(us.current){const ht=us.current;for(;ht.children.length>ct.length;)ht.removeChild(ht.lastChild);ct.forEach((bt,dn)=>{let Ft=ht.children[dn];Ft||(Ft=document.createElement("div"),Ft.className=Je.selectedElementHighlight,ht.appendChild(Ft)),Ft.style.transform=`translate(${bt.left}px, ${bt.top}px)`,Ft.style.width=`${bt.width}px`,Ft.style.height=`${bt.height}px`})}}};return document.addEventListener("mousemove",B,{passive:!0}),()=>document.removeEventListener("mousemove",B)},[T,P,mo,fi]),_.useEffect(()=>{if(!T)return;const B=U=>{const w=mo,S=wn.current;if(mo&&S){Tn.current=!0;const k=Math.min(S.x,U.clientX),R=Math.min(S.y,U.clientY),z=Math.max(S.x,U.clientX),J=Math.max(S.y,U.clientY),le=[];document.querySelectorAll("button, a, input, img, p, h1, h2, h3, h4, h5, h6, li, label, td, th").forEach(ae=>{if(!(ae instanceof HTMLElement)||ii(ae,"[data-feedback-toolbar]")||ii(ae,"[data-annotation-marker]"))return;const K=ae.getBoundingClientRect();K.width>window.innerWidth*.8&&K.height>window.innerHeight*.5||K.width<10||K.height<10||K.left<z&&K.right>k&&K.top<J&&K.bottom>R&&le.push({element:ae,rect:K})});const Ke=le.filter(({element:ae})=>!le.some(({element:K})=>K!==ae&&ae.contains(K))),G=U.clientX/window.innerWidth*100,ie=U.clientY+window.scrollY;if(Ke.length>0){const ae=Ke.reduce((St,{rect:ht})=>({left:Math.min(St.left,ht.left),top:Math.min(St.top,ht.top),right:Math.max(St.right,ht.right),bottom:Math.max(St.bottom,ht.bottom)}),{left:1/0,top:1/0,right:-1/0,bottom:-1/0}),K=Ke.slice(0,5).map(({element:St})=>Nl(St).name).join(", "),ke=Ke.length>5?` +${Ke.length-5} more`:"",Ie=Ke[0].element,at=gd(Ie),ct=yd(Ie);me({x:G,y:ie,clientY:U.clientY,element:`${Ke.length} elements: ${K}${ke}`,elementPath:"multi-select",boundingBox:{x:ae.left,y:ae.top+window.scrollY,width:ae.right-ae.left,height:ae.bottom-ae.top},isMultiSelect:!0,fullPath:bd(Ie),accessibility:xd(Ie),computedStyles:ct,computedStylesObj:at,nearbyElements:_d(Ie),cssClasses:Ec(Ie),nearbyText:Mc(Ie),sourceFile:jd(Ie)})}else{const ae=Math.abs(z-k),K=Math.abs(J-R);ae>20&&K>20&&me({x:G,y:ie,clientY:U.clientY,element:"Area selection",elementPath:`region at (${Math.round(k)}, ${Math.round(R)})`,boundingBox:{x:k,y:R+window.scrollY,width:ae,height:K},isMultiSelect:!0})}he(null)}else w&&(Tn.current=!0);Ns.current=null,wn.current=null,Wo(!1),us.current&&(us.current.innerHTML="")};return document.addEventListener("mouseup",B),()=>document.removeEventListener("mouseup",B)},[T,mo]);const Pe=_.useCallback(async(B,U,w)=>{const S=qt.webhookUrl||C;if(!S||!qt.webhooksEnabled&&!w)return!1;try{return(await fetch(S,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:B,timestamp:Date.now(),url:typeof window<"u"?window.location.href:void 0,...U})})).ok}catch(k){return console.warn("[Agentation] Webhook failed:",k),!1}},[C,qt.webhookUrl,qt.webhooksEnabled]),lt=_.useCallback(B=>{var w;if(!P)return;const U={id:Date.now().toString(),x:P.x,y:P.y,comment:B,element:P.element,elementPath:P.elementPath,timestamp:Date.now(),selectedText:P.selectedText,boundingBox:P.boundingBox,nearbyText:P.nearbyText,cssClasses:P.cssClasses,isMultiSelect:P.isMultiSelect,isFixed:P.isFixed,fullPath:P.fullPath,accessibility:P.accessibility,computedStyles:P.computedStyles,nearbyElements:P.nearbyElements,reactComponents:P.reactComponents,sourceFile:P.sourceFile,elementBoundingBoxes:P.elementBoundingBoxes,...g&&Dn?{sessionId:Dn,url:typeof window<"u"?window.location.href:void 0,status:"pending"}:{}};H(S=>[...S,U]),Ss.current=U.id,Wt(()=>{Ss.current=null},300),Wt(()=>{fo(S=>new Set(S).add(U.id))},250),a==null||a(U),Pe("annotation.add",{annotation:U}),ho(!0),Wt(()=>{me(null),ho(!1)},150),(w=window.getSelection())==null||w.removeAllRanges(),g&&Dn&&Cl(g,Dn,U).then(S=>{S.id!==U.id&&(H(k=>k.map(R=>R.id===U.id?{...R,id:S.id}:R)),fo(k=>{const R=new Set(k);return R.delete(U.id),R.add(S.id),R}))}).catch(S=>{console.warn("[Agentation] Failed to sync annotation:",S)})},[P,a,Pe,g,Dn]),Yt=_.useCallback(()=>{ho(!0),Wt(()=>{me(null),ho(!1)},150)},[]),Ht=_.useCallback(B=>{const U=N.findIndex(S=>S.id===B),w=N[U];(Z==null?void 0:Z.id)===B&&(As(!0),Wt(()=>{Re(null),rt(null),Ue([]),As(!1)},150)),_t(B),di(S=>new Set(S).add(B)),w&&(c==null||c(w),Pe("annotation.delete",{annotation:w})),g&&cr(g,B).catch(S=>{console.warn("[Agentation] Failed to delete annotation from server:",S)}),Wt(()=>{H(S=>S.filter(k=>k.id!==B)),di(S=>{const k=new Set(S);return k.delete(B),k}),_t(null),U<N.length-1&&(Jt(U),Wt(()=>Jt(null),200))},150)},[N,Z,c,Pe,g]),Zt=_.useCallback(B=>{var U;if(!B){We(null),Nt(null),ut([]);return}if(We(B.id),(U=B.elementBoundingBoxes)!=null&&U.length){const w=[];for(const S of B.elementBoundingBoxes){const k=S.x+S.width/2,R=S.y+S.height/2-window.scrollY,J=document.elementsFromPoint(k,R).find(le=>!le.closest("[data-annotation-marker]")&&!le.closest("[data-agentation-root]"));J&&w.push(J)}ut(w),Nt(null)}else if(B.boundingBox){const w=B.boundingBox,S=w.x+w.width/2,k=B.isFixed?w.y+w.height/2:w.y+w.height/2-window.scrollY,R=Lr(S,k);if(R){const z=R.getBoundingClientRect(),J=z.width/w.width,le=z.height/w.height;J<.5||le<.5?Nt(null):Nt(R)}else Nt(null);ut([])}else Nt(null),ut([])},[]),xt=_.useCallback(B=>{if(!Z)return;const U={...Z,comment:B};H(w=>w.map(S=>S.id===Z.id?U:S)),u==null||u(U),Pe("annotation.update",{annotation:U}),g&&Ox(g,Z.id,{comment:B}).catch(w=>{console.warn("[Agentation] Failed to update annotation on server:",w)}),As(!0),Wt(()=>{Re(null),rt(null),Ue([]),As(!1)},150)},[Z,u,Pe,g]),un=_.useCallback(()=>{As(!0),Wt(()=>{Re(null),rt(null),Ue([]),As(!1)},150)},[]),an=_.useCallback(()=>{const B=N.length,U=Ze.length>0||!!Qe;if(B===0&&jn.length===0&&!U)return;if(d==null||d(N),Pe("annotations.clear",{annotations:N}),g){Promise.all(N.map(k=>cr(g,k.id).catch(R=>{console.warn("[Agentation] Failed to delete annotation from server:",R)})));for(const[,k]of ws.current)k&&cr(g,k).catch(()=>{});ws.current.clear();for(const[,k]of _s.current)k&&cr(g,k).catch(()=>{});_s.current.clear()}Oe(!0),Te(!0),Uo([]);const w=Ls.current;if(w){const k=w.getContext("2d");k&&k.clearRect(0,0,w.width,w.height)}(Ze.length>0||Qe)&&(kn(k=>k+1),Xs(k=>k+1),Wt(()=>{Bt([]),zn(null)},200)),ft&&Pt(!1),gn&&nn(""),Un.current={rearrange:null,placements:[]},Sd(At);const S=B*30+200;Wt(()=>{H([]),fo(new Set),localStorage.removeItem(Qd(At)),Oe(!1)},S),Wt(()=>Te(!1),1500)},[At,N,jn,Ze,Qe,ft,gn,d,Pe,g]),Gn=_.useCallback(async()=>{const B=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:At,U=Be&&ft;let w;if(U){if(Ze.length===0&&!Qe&&!gn)return;w=""}else{if(w=Ix(N,B,qt.outputDetail),!w&&jn.length===0&&Ze.length===0&&!Qe)return;w||(w=`## Page Feedback: ${B}
`)}if(!U&&jn.length>0){const S=new Set;for(const J of N)J.drawingIndex!=null&&S.add(J.drawingIndex);const k=Ls.current;k&&(k.style.visibility="hidden");const R=[],z=window.scrollY;for(let J=0;J<jn.length;J++){if(S.has(J))continue;const le=jn[J];if(le.points.length<2)continue;const Ee=le.fixed?le.points:le.points.map(Wn=>({x:Wn.x,y:Wn.y-z}));let Ke=1/0,G=1/0,ie=-1/0,ae=-1/0;for(const Wn of Ee)Ke=Math.min(Ke,Wn.x),G=Math.min(G,Wn.y),ie=Math.max(ie,Wn.x),ae=Math.max(ae,Wn.y);const K=ie-Ke,ke=ae-G,Ie=Math.hypot(K,ke),at=Ee[0],ct=Ee[Ee.length-1],St=Math.hypot(ct.x-at.x,ct.y-at.y);let ht;const bt=St<Ie*.35,dn=K/Math.max(ke,1);if(bt&&Ie>20){const Wn=Math.max(K,ke)*.15;let pi=0;for(const Ti of Ee){const gr=Ti.x-Ke<Wn,Wr=ie-Ti.x<Wn,Fr=Ti.y-G<Wn,Xr=ae-Ti.y<Wn;(gr||Wr)&&(Fr||Xr)&&pi++}ht=pi>Ee.length*.15?"box":"circle"}else dn>3&&ke<40?ht="underline":St>Ie*.5?ht="arrow":ht="drawing";const Ft=Math.min(10,Ee.length),fn=Math.max(1,Math.floor(Ee.length/Ft)),Ln=new Set,On=[],Eo=[at];for(let Wn=fn;Wn<Ee.length-1;Wn+=fn)Eo.push(Ee[Wn]);Eo.push(ct);for(const Wn of Eo){const pi=Lr(Wn.x,Wn.y);if(!pi||Ln.has(pi)||ii(pi,"[data-feedback-toolbar]"))continue;Ln.add(pi);const{name:Ti}=Nl(pi);On.includes(Ti)||On.push(Ti)}const Bo=`${Math.round(Ke)},${Math.round(G)} → ${Math.round(ie)},${Math.round(ae)}`;let mi;(ht==="circle"||ht==="box")&&On.length>0?mi=`${ht==="box"?"Boxed":"Circled"} **${On[0]}**${On.length>1?` (and ${On.slice(1).join(", ")})`:""} (region: ${Bo})`:ht==="underline"&&On.length>0?mi=`Underlined **${On[0]}** (${Bo})`:ht==="arrow"&&On.length>=2?mi=`Arrow from **${On[0]}** to **${On[On.length-1]}** (${Math.round(at.x)},${Math.round(at.y)} → ${Math.round(ct.x)},${Math.round(ct.y)})`:On.length>0?mi=`${ht==="arrow"?"Arrow":"Drawing"} near **${On.join("**, **")}** (region: ${Bo})`:mi=`Drawing at ${Bo}`,R.push(mi)}k&&(k.style.visibility=""),R.length>0&&(w+=`
**Drawings:**
`,R.forEach((J,le)=>{w+=`${le+1}. ${J}
