 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var iy;function Ov(){if(iy)return sn;iy=1;var t=Symbol.for("react.transitional.element"),n=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),c=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),d=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),b=Symbol.for("react.activity"),v=Symbol.iterator;function C(P){return P===null||typeof P!="object"?null:(P=v&&P[v]||P["@@iterator"],typeof P=="function"?P:null)}var k={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},j=Object.assign,M={};function A(P,le,ee){this.props=P,this.context=le,this.refs=M,this.updater=ee||k}A.prototype.isReactComponent={},A.prototype.setState=function(P,le){if(typeof P!="object"&&typeof P!="function"&&P!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,P,le,"setState")},A.prototype.forceUpdate=function(P){this.updater.enqueueForceUpdate(this,P,"forceUpdate")};function O(){}O.prototype=A.prototype;function B(P,le,ee){this.props=P,this.context=le,this.refs=M,this.updater=ee||k}var T=B.prototype=new O;T.constructor=B,j(T,A.prototype),T.isPureReactComponent=!0;var F=Array.isArray;function H(){}var W={H:null,A:null,T:null,S:null},Q=Object.prototype.hasOwnProperty;function me(P,le,ee){var ve=ee.ref;return{$$typeof:t,type:P,key:le,ref:ve!==void 0?ve:null,props:ee}}function se(P,le){return me(P.type,le,P.props)}function ae(P){return typeof P=="object"&&P!==null&&P.$$typeof===t}function we(P){var le={"=":"=0",":":"=2"};return"$"+P.replace(/[=:]/g,function(ee){return le[ee]})}var Le=/\/+/g;function Z(P,le){return typeof P=="object"&&P!==null&&P.key!=null?we(""+P.key):le.toString(36)}function fe(P){switch(P.status){case"fulfilled":return P.value;case"rejected":throw P.reason;default:switch(typeof P.status=="string"?P.then(H,H):(P.status="pending",P.then(function(le){P.status==="pending"&&(P.status="fulfilled",P.value=le)},function(le){P.status==="pending"&&(P.status="rejected",P.reason=le)})),P.status){case"fulfilled":return P.value;case"rejected":throw P.reason}}throw P}function $(P,le,ee,ve,ue){var je=typeof P;(je==="undefined"||je==="boolean")&&(P=null);var He=!1;if(P===null)He=!0;else switch(je){case"bigint":case"string":case"number":He=!0;break;case"object":switch(P.$$typeof){case t:case n:He=!0;break;case g:return He=P._init,$(He(P._payload),le,ee,ve,ue)}}if(He)return ue=ue(P),He=ve===""?"."+Z(P,0):ve,F(ue)?(ee="",He!=null&&(ee=He.replace(Le,"$&/")+"/"),$(ue,le,ee,"",function(Dt){return Dt})):ue!=null&&(ae(ue)&&(ue=se(ue,ee+(ue.key==null||P&&P.key===ue.key?"":(""+ue.key).replace(Le,"$&/")+"/")+He)),le.push(ue)),1;He=0;var Ge=ve===""?".":ve+":";if(F(P))for(var $e=0;$e<P.length;$e++)ve=P[$e],je=Ge+Z(ve,$e),He+=$(ve,le,ee,je,ue);else if($e=C(P),typeof $e=="function")for(P=$e.call(P),$e=0;!(ve=P.next()).done;)ve=ve.value,je=Ge+Z(ve,$e++),He+=$(ve,le,ee,je,ue);else if(je==="object"){if(typeof P.then=="function")return $(fe(P),le,ee,ve,ue);throw le=String(P),Error("Objects are not valid as a React child (found: "+(le==="[object Object]"?"object with keys {"+Object.keys(P).join(", ")+"}":le)+"). If you meant to render a collection of children, use an array instead.")}return He}function ce(P,le,ee){if(P==null)return P;var ve=[],ue=0;return $(P,ve,"","",function(je){return le.call(ee,je,ue++)}),ve}function X(P){if(P._status===-1){var le=P._result;le=le(),le.then(function(ee){(P._status===0||P._status===-1)&&(P._status=1,P._result=ee)},function(ee){(P._status===0||P._status===-1)&&(P._status=2,P._result=ee)}),P._status===-1&&(P._status=0,P._result=le)}if(P._status===1)return P._result.default;throw P._result}var ge=typeof reportError=="function"?reportError:function(P){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var le=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof P=="object"&&P!==null&&typeof P.message=="string"?String(P.message):String(P),error:P});if(!window.dispatchEvent(le))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",P);return}console.error(P)},Ae={map:ce,forEach:function(P,le,ee){ce(P,function(){le.apply(this,arguments)},ee)},count:function(P){var le=0;return ce(P,function(){le++}),le},toArray:function(P){return ce(P,function(le){return le})||[]},only:function(P){if(!ae(P))throw Error("React.Children.only expected to receive a single React element child.");return P}};return sn.Activity=b,sn.Children=Ae,sn.Component=A,sn.Fragment=i,sn.Profiler=c,sn.PureComponent=B,sn.StrictMode=a,sn.Suspense=p,sn.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=W,sn.__COMPILER_RUNTIME={__proto__:null,c:function(P){return W.H.useMemoCache(P)}},sn.cache=function(P){return function(){return P.apply(null,arguments)}},sn.cacheSignal=function(){return null},sn.cloneElement=function(P,le,ee){if(P==null)throw Error("The argument must be a React element, but you passed "+P+".");var ve=j({},P.props),ue=P.key;if(le!=null)for(je in le.key!==void 0&&(ue=""+le.key),le)!Q.call(le,je)||je==="key"||je==="__self"||je==="__source"||je==="ref"&&le.ref===void 0||(ve[je]=le[je]);var je=arguments.length-2;if(je===1)ve.children=ee;else if(1<je){for(var He=Array(je),Ge=0;Ge<je;Ge++)He[Ge]=arguments[Ge+2];ve.children=He}return me(P.type,ue,ve)},sn.createContext=function(P){return P={$$typeof:d,_currentValue:P,_currentValue2:P,_threadCount:0,Provider:null,Consumer:null},P.Provider=P,P.Consumer={$$typeof:u,_context:P},P},sn.createElement=function(P,le,ee){var ve,ue={},je=null;if(le!=null)for(ve in le.key!==void 0&&(je=""+le.key),le)Q.call(le,ve)&&ve!=="key"&&ve!=="__self"&&ve!=="__source"&&(ue[ve]=le[ve]);var He=arguments.length-2;if(He===1)ue.children=ee;else if(1<He){for(var Ge=Array(He),$e=0;$e<He;$e++)Ge[$e]=arguments[$e+2];ue.children=Ge}if(P&&P.defaultProps)for(ve in He=P.defaultProps,He)ue[ve]===void 0&&(ue[ve]=He[ve]);return me(P,je,ue)},sn.createRef=function(){return{current:null}},sn.forwardRef=function(P){return{$$typeof:h,render:P}},sn.isValidElement=ae,sn.lazy=function(P){return{$$typeof:g,_payload:{_status:-1,_result:P},_init:X}},sn.memo=function(P,le){return{$$typeof:y,type:P,compare:le===void 0?null:le}},sn.startTransition=function(P){var le=W.T,ee={};W.T=ee;try{var ve=P(),ue=W.S;ue!==null&&ue(ee,ve),typeof ve=="object"&&ve!==null&&typeof ve.then=="function"&&ve.then(H,ge)}catch(je){ge(je)}finally{le!==null&&ee.types!==null&&(le.types=ee.types),W.T=le}},sn.unstable_useCacheRefresh=function(){return W.H.useCacheRefresh()},sn.use=function(P){return W.H.use(P)},sn.useActionState=function(P,le,ee){return W.H.useActionState(P,le,ee)},sn.useCallback=function(P,le){return W.H.useCallback(P,le)},sn.useContext=function(P){return W.H.useContext(P)},sn.useDebugValue=function(){},sn.useDeferredValue=function(P,le){return W.H.useDeferredValue(P,le)},sn.useEffect=function(P,le){return W.H.useEffect(P,le)},sn.useEffectEvent=function(P){return W.H.useEffectEvent(P)},sn.useId=function(){return W.H.useId()},sn.useImperativeHandle=function(P,le,ee){return W.H.useImperativeHandle(P,le,ee)},sn.useInsertionEffect=function(P,le){return W.H.useInsertionEffect(P,le)},sn.useLayoutEffect=function(P,le){return W.H.useLayoutEffect(P,le)},sn.useMemo=function(P,le){return W.H.useMemo(P,le)},sn.useOptimistic=function(P,le){return W.H.useOptimistic(P,le)},sn.useReducer=function(P,le,ee){return W.H.useReducer(P,le,ee)},sn.useRef=function(P){return W.H.useRef(P)},sn.useState=function(P){return W.H.useState(P)},sn.useSyncExternalStore=function(P,le,ee){return W.H.useSyncExternalStore(P,le,ee)},sn.useTransition=function(){return W.H.useTransition()},sn.version="19.2.4",sn}var ay;function up(){return ay||(ay=1,Vh.exports=Ov()),Vh.exports}var Yh={exports:{}},Lo={};/**
 * @license React
...
`)})})]}):null})}function Jw({commitDialogOpen:t,commitMessageDraft:n,onCommitMessageDraftChange:i,onCommitDialogClose:a,onCommitConfirm:c,commitInProgress:u,deleteConfirmOpen:d,deleteSelectionItems:h,onDeleteConfirmClose:p,onDeleteConfirm:y,deleteInProgress:g,deletableSelectionCount:b,newBranchDialogOpen:v,newBranchName:C,newBranchCreateMode:k,onNewBranchNameChange:j,onNewBranchCreateModeChange:M,onNewBranchDialogClose:A,onNewBranchConfirm:O,selectedCommitCanCreateBranch:B,currentCheckedOutCommitCanCreateBranch:T,createBranchFromNodeInProgress:F}){return l.jsxs(l.Fragment,{children:[t?l.jsx("div",{className:"absolute inset-0 z-[80] flex items-center justify-center bg-background/70 p-4 backdrop-blur-sm",onClick:a,children:l.jsxs("div",{className:"w-full max-w-md rounded-2xl border border-border bg-card p-4",onClick:H=>H.stopPropagation(),children:[l.jsx("p",{className:"text-sm font-medium text-foreground",children:"Create commit"}),l.jsx("p",{className:"mt-1 text-xs text-muted-foreground",children:"Stage all changes, then commit on current HEAD."}),l.jsx("textarea",{value:n,onChange:H=>i(H.target.value),onKeyDown:H=>{(H.metaKey||H.ctrlKey)&&H.key==="Enter"&&(H.preventDefault(),c())},rows:4,placeholder:"Describe your changes",className:"mt-3 w-full rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none"}),l.jsxs("div",{className:"mt-4 flex items-center justify-end gap-2",children:[l.jsx("button",{type:"button",onClick:a,className:"rounded-lg border border-border bg-card px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent",children:"Cancel"}),l.jsxs("button",{type:"button",onClick:c,disabled:!n.trim()||u,className:"inline-flex items-center rounded-lg border border-border bg-card px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent disabled:cursor-not-allowed disabled:opacity-50",children:[l.jsx(mw,{className:"mr-1.5 h-3.5 w-3.5 shrink-0"}),u?"Committing...":"Commit"]})]})]})}):null,d?l.jsx("div",{className:"absolute inset-0 z-[80] flex items-center justify-center bg-background/70 p-4 backdrop-blur-sm",onClick:p,children:l.jsxs("div",{className:"w-full max-w-md rounded-2xl border border-border bg-card p-4",onClick:H=>H.stopPropagation(),children:[l.jsx("p",{className:"text-sm font-medium text-foreground",children:"Delete selected items?"}),l.jsx("div",{className:"mt-3 space-y-1.5",children:h.map(H=>l.jsx("div",{className:"rounded-lg border border-border/50 bg-muted/30 px-2.5 py-1.5 text-xs text-muted-foreground",children:H},H))}),l.jsxs("div",{className:"mt-4 flex items-center justify-end gap-2",children:[l.jsx("button",{type:"button",onClick:p,className:"rounded-lg border border-border bg-card px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent",children:"Cancel"}),l.jsx("button",{type:"button",onClick:y,disabled:b===0||g,className:"rounded-lg bg-red-50 px-3 py-1.5 text-xs font-medium text-red-600 transition-colors hover:bg-red-50/80 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/30",children:g?"Deleting...":"Delete"})]})]})}):null,v?l.jsx("div",{className:"absolute inset-0 z-[80] flex items-center justify-center bg-background/70 p-4 backdrop-blur-sm",onClick:A,children:l.jsxs("div",{className:"w-full max-w-sm rounded-2xl border border-border bg-card p-4",onClick:H=>H.stopPropagation(),children:[l.jsx("p",{className:"text-sm font-medium text-foreground",children:"Create branch"}),l.jsxs("div",{className:"mt-3 inline-flex items-center rounded-lg border border-border bg-muted/30 p-1",children:[l.jsx("button",{type:"button",onClick:()=>M("from-selected-node"),className:cn("rounded-md px-2.5 py-1 text-xs font-medium transition-colors",k==="from-selected-node"?"bg-card text-foreground":"text-muted-foreground hover:bg-accent hover:text-foreground"),children:"From selection"}),l.jsx("button",{type:"button",onClick:()=>M("new-root"),className:cn("rounded-md px-2.5 py-1 text-xs font-medium transition-colors",k==="new-root"?"bg-card text-foreground":"text-muted-foreground hover:bg-accent hover:text-foreground"),children:"New root"})]}),k==="from-selected-node"?l.jsx("p",{className:"mt-2 text-xs text-muted-foreground",children:"Creates from selected uncommitted changes or stash node."}):l.jsx("p",{className:"mt-2 text-xs text-muted-foreground",children:"Creates an orphan branch with unrelated history."}),l.jsx("input",{value:C,onChange:H=>j(H.target.value),placeholder:"feature/my-changes",className:"mt-3 w-full rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none"}),l.jsxs("div",{className:"mt-4 flex items-center justify-end gap-2",children:[l.jsx("button",{type:"button",onClick:A,className:"rounded-lg border border-border bg-card px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent",children:"Cancel"}),l.jsxs("button",{type:"button",onClick:O,disabled:!C.trim()||F||k==="from-selected-node"&&!B&&!T,className:cn("inline-flex items-center rounded-lg border border-border bg-card px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-accent","disabled:cursor-not-allowed disabled:opacity-50"),children:[l.jsx(Yx,{className:"mr-1.5 h-3.5 w-3.5 shrink-0"}),F?"Creating...":"Create"]})]})]})}):null]})}const jy="/icon-GitOrientation.svg";function eS({compactLabels:t=!1,orientation:n,onOrientationChange:i}){const a=n==="horizontal"?"vertical":"horizontal";return l.jsxs("button",{type:"button",onClick:()=>i(a),className:cn("window-no-drag inline-flex h-7 items-center rounded-md border border-border bg-background text-foreground hover:bg-accent hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",t?"w-7 justify-center px-0":"gap-1.5 pl-1.5 pr-2 py-1"),"aria-label":`Rotate view to ${a}`,title:"Rotate View",children:[l.jsx("span",{className:"relative size-4 shrink-0",children:l.jsx("span",{"aria-hidden":"true",className:cn("absolute inset-0 bg-current transition-transform duration-300 ease-in-out",n==="vertical"&&"rotate-[-90deg]"),style:{WebkitMaskImage:`url(${jy})`,WebkitMaskPosition:"center",WebkitMaskRepeat:"no-repeat",WebkitMaskSize:"contain",maskImage:`url(${jy})`,maskPosition:"center",maskRepeat:"no-repeat",maskSize:"contain"}})}),t?null:l.jsx("span",{className:"whitespace-nowrap text-[12px] font-normal leading-none text-foreground transition-colors",children:"Rotate View"})]})}function tS({query:t,onQueryChange:n,resultCount:i,resultIndex:a,onJump:c}){const u=_.useRef(null);return l.jsxs("div",{className:"window-no-drag flex h-7 w-[12rem] shrink-0 items-center gap-2 rounded-full border border-border bg-background pl-1.5 pr-2.5",children:[l.jsx(ww,{className:"h-3.5 w-3.5 shrink-0 text-foreground"}),l.jsx("input",{ref:u,value:t,onChange:d=>n(d.target.value),onBlur:d=>{const h=d.relatedTarget;h!=null&&h.closest('button, a, input, textarea, select, [contenteditable="true"]')||window.setTimeout(()=>{var p;(p=u.current)==null||p.focus()},0)},onKeyDown:d=>{d.key==="Enter"&&(d.preventDefault(),c(1))},placeholder:"Search",className:"min-w-0 flex-1 bg-transparent text-[11px] text-foreground outline-none placeholder:text-muted-foreground/70"}),i!=null&&i>0?l.jsxs("div",{className:"flex items-center gap-2",children:[l.jsxs("span",{className:"text-[11px] font-medium tabular-nums text-foreground",children:[(a!=null?a:0)+1,"/",i]}),l.jsx("button",{type:"button",onClick:()=>c(-1),className:"inline-flex h-6 w-6 items-center justify-center rounded-md text-foreground transition-colors hover:text-foreground","aria-label":"Previous search result",title:"Previous result",children:l.jsx(rw,{className:"h-4 w-4 shrink-0"})}),l.jsx("button",{type:"button",onClick:()=>c(1),className:"inline-flex h-6 w-6 items-center justify-center rounded-md text-foreground transition-colors hover:text-foreground","aria-label":"Next search result",title:"Next result",children:l.jsx(Vx,{className:"h-4 w-4 shrink-0"})})]}):null]})}function nS({mapPadHostRef:t,transformLayerRef:n}){const i=_.useRef({x:0,y:0}),a=_.useRef(rc),c=_.useRef(null),u=_.useRef({panX:0,panY:0,zoom:rc}),d=_.useRef(null),h=_.useRef(rc),p=_.useRef(null),[y,g]=_.useState(!1),[b,v]=_.useState(rc),[C,k]=_.useState(0),j=_.useRef(null),M=_.useRef(0),A=_.useCallback(()=>{const se=t.current;if(!se)return null;const ae=se.getBoundingClientRect(),we=getComputedStyle(se),Le=Number.parseFloat(we.borderLeftWidth)||0,Z=Number.parseFloat(we.borderTopWidth)||0,fe=Number.parseFloat(we.paddingLeft)||Ed,$=Number.parseFloat(we.paddingTop)||Ed;return{x:ae.left+Le+fe,y:ae.top+Z+$}},[t]),O=_.useCallback(()=>{j.current!=null&&(window.clearTimeout(j.current),j.current=null),_.startTransition(()=>{k(se=>se+1)}),M.current=performance.now()},[]),B=_.useCallback((se,ae,we)=>{const Le=u.current;u.current={panX:se,panY:ae,zoom:we};const Z=n.current;if(Z&&(Z.style.transform=`translate3d(${se}px, ${ae}px, 0) scale(${we/Bi})`),Math.abs(h.current-we)>Xu&&(h.current=we,v(we)),Math.abs(we-Le.zoom)>Xu){O();return}const ce=performance.now()-M.current;if(ce>=wy){O();return}j.current!=null&&window.clearTimeout(j.current),j.current=window.setTimeout(()=>{j.current=null,O()},wy-ce)},[O,n]),T=_.useRef(null),F=_.useCallback(()=>{d.current!=null||!T.current||(d.current=window.requestAnimationFrame(T.current))},[]),H=_.useCallback(()=>{g(!0),p.current!=null&&window.clearTimeout(p.current),p.current=window.setTimeout(()=>{p.current=null,g(!1)},90)},[]),W=_.useCallback((se,ae,we)=>{i.current={x:se,y:ae},a.current=we,H(),F()},[H,F]);T.current=()=>{d.current=null;const se=u.current,ae=i.current.x,we=i.current.y,Le=a.current,Z=c.current,fe=Math.abs(Le-se.zoom)<=Xu?Le:se.zoom+(Le-se.zoom)*$w,$=Z!=null?Z.anchorX-Z.worldX*(fe/Bi):ae,ce=Z!=null?Z.anchorY-Z.worldY*(fe/Bi):we;Z!=null&&Math.abs(fe-Le)<=Xu&&(c.current=null),B($,ce,fe),$!==ae||ce!==we||fe!==Le?T.current&&(d.current=window.requestAnimationFrame(T.current)):O()};const Q=_.useCallback((se,ae,we)=>{const Le=Hw(we),Z=i.current.x,fe=i.current.y,$=a.current,ce=A();if(!ce){W(Z,fe,Le);return}const X=se-ce.x,ge=ae-ce.y,Ae=$/Bi,P=Le/Bi,le=(X-Z)/Ae,ee=(ge-fe)/Ae,ve=X-le*P,ue=ge-ee*P;c.current={anchorX:X,anchorY:ge,worldX:le,worldY:ee},W(ve,ue,Le)},[A,W]),me=_.useCallback(se=>{if(se.preventDefault(),se.ctrlKey||se.metaKey){const Z=Math.exp(-se.deltaY*Ow);Q(se.clientX,se.clientY,a.current*Z);return}c.current=null;const ae=u.current;i.current={x:ae.panX,y:ae.panY},a.current=ae.zoom;const we=ae.panX-se.deltaX,Le=ae.panY-se.deltaY;i.current={x:we,y:Le},B(we,Le,ae.zoom)},[B,Q]);return _.useLayoutEffect(()=>(B(0,0,rc),()=>{p.current!=null&&window.clearTimeout(p.current),d.current!=null&&window.cancelAnimationFrame(d.current),j.current!=null&&(window.clearTimeout(j.current),j.current=null)}),[B]),_.useLayoutEffect(()=>{const se=n.current;if(!se)return;const ae=u.current;se.style.transform=`translate3d(${ae.panX}px, ${ae.panY}px, 0) scale(${ae.zoom/Bi})`}),{isCameraMoving:y,renderedZoom:b,cameraRenderTick:C,renderedCameraRef:u,interactionIdleTimeoutRef:p,getTransformLayerOriginScreen:A,flushCameraReactTick:O,syncCamera:W,handleWheel:me}}function sS(t){const n=Math.min(t.startX,t.currentX),i=Math.min(t.startY,t.currentY),a=Math.abs(t.currentX-t.startX),c=Math.abs(t.currentY-t.startY);return{left:n,top:i,width:a,height:c}}function oS({scrollContainerRef:t,renderedCameraRef:n,getTransformLayerOriginScreen:i,renderNodes:a,shouldRenderNode:c,onPointerReleaseNoMarquee:u}){const d=_.useRef(null),h=_.useRef(!1),p=_.useRef([]),[y,g]=_.useState(!1),[b,v]=_.useState(null),[C,k]=_.useState([]),[j,M]=_.useState(null),A=_.useCallback(B=>{const T=t.current,F=i();if(!T||!F)return[];const H=T.getBoundingClientRect(),W=n.current.zoom/Bi;if(W<=0)return[];const Q=[],me=B.left,se=B.left+B.width,ae=B.top,we=B.top+B.height;for(const Le of a){if(!c(Le))continue;const Z=F.x+n.current.panX+Le.x*W-H.left,fe=F.y+n.current.panY+Le.y*W-H.top,$=Z+hs*W,ce=fe+(vl+Rs)*W;!($<me||Z>se||ce<ae||fe>we)&&Q.push(Le.commit.id)}return Q},[i,a,n,t,c]),O=_.useCallback(B=>{if(B.button!==0)return;const T=B.target;if(T!=null&&T.closest("[data-commit-card]")||T!=null&&T.closest("button, a, input, textarea, select"))return;const F=t.current;if(!F)return;B.preventDefault();const H=F.getBoundingClientRect(),W=B.clientX-H.left,Q=B.clientY-H.top;d.current={startX:W,startY:Q,currentX:W,currentY:Q,additive:B.metaKey||B.ctrlKey},h.current=!1,p.current=B.metaKey||B.ctrlKey?C:[],g(!0),v({left:W,top:Q,width:0,height:0})},[t,C]);return _.useEffect(()=>{const B=F=>{var ae;const H=d.current;if(!H)return;const W=t.current;if(!W)return;const Q=W.getBoundingClientRect();H.currentX=F.clientX-Q.left,H.currentY=F.clientY-Q.top,!h.current&&(Math.abs(H.currentX-H.startX)>2||Math.abs(H.currentY-H.startY)>2)&&(h.current=!0);const me=sS(H);v(me);const se=A(me);k(H.additive?Array.from(new Set([...p.current,...se])):Array.from(new Set(se))),H.additive||M((ae=se[se.length-1])!=null?ae:null)},T=()=>{if(d.current){const F=h.current;d.current=null,h.current=!1,g(!1),v(null),F||(k([]),M(null));return}u()};return window.addEventListener("mousemove",B),window.addEventListener("mouseup",T),()=>{window.removeEventListener("mousemove",B),window.removeEventListener("mouseup",T)}},[A,u,t]),{isMarqueeSelecting:y,marqueeRect:b,selectedCommitShas:C,setSelectedCommitShas:k,mergeTargetCommitSha:j,setMergeTargetCommitSha:M,startMarqueeDrag:O}}function iS(){return l.jsx("div",{className:"flex flex-1 min-h-0 items-center justify-center",children:l.jsx("div",{role:"status","aria-label":"Loading commits",className:"h-5 w-5 rounded-full border-2 border-border border-t-muted-foreground animate-spin"})})}function My({branches:t,mergeNodes:n=[],directCommits:i=[],unpushedDirectCommits:a=[],unpushedCommitShasByBranch:c={},openPRs:u=[],defaultBranch:d,onCommitClick:h,onLoadMore:p,view:y,staleBranches:g=[],isLoading:b=!1,scrollRequest:v,focusedErrorBranch:C,mapTopInsetPx:k=0,onMergeRefsIntoBranch:j,mergeInProgress:M=!1,onPushAllBranches:A,onPushCurrentBranch:O,onPushCommitTargets:B,pushInProgress:T=!1,onDeleteSelection:F,deleteInProgress:H=!1,worktrees:W=[],currentRepoPath:Q,onRemoveWorktree:me,removeWorktreeInProgress:se=!1,onSwitchToWorktree:ae,onStashLocalChanges:we,stashInProgress:Le=!1,stashDisabled:Z=!1,onCommitLocalChanges:fe,commitInProgress:$=!1,commitDisabled:ce=!1,onStageAllChanges:X,stageInProgress:ge=!1,onCreateBranchFromNode:Ae,onCreateRootBranch:P,createBranchFromNodeInProgress:le=!1,isDebugOpen:ee=!1,onDebugClose:ve,orientation:ue="horizontal",branchCommitPreviews:je={},branchParentByName:He={},branchUniqueAheadCounts:Ge={},gridSearchQuery:$e="",gridSearchJumpToken:Dt=0,gridSearchJumpDirection:It=1,gridFocusSha:ut=null,checkedOutRef:tt=null,onGridSearchResultCountChange:st,onGridSearchResultIndexChange:Gt,onGridSearchFocusChange:an,onInteractionChange:Pe,manuallyOpenedClumps:ie,manuallyClosedClumps:We,setManuallyOpenedClumps:nt,setManuallyClosedClumps:Se,gridHudProps:qe}){var An,as,Ks,Us,Qs,uo,Dn,gs,As,ei,lr,R,I,K;const rt=_.useRef(null),lt=_.useRef(null),Ct=_.useRef(null),_t=_.useRef(null),Pt=_.useRef(null),ot=_.useRef(void 0),V=_.useRef(void 0),J=_.useRef(void 0),xe=_.useRef(0),Me=_.useRef(null),[et,Ke]=_.useState(!1),[Te,he]=_.useState(!1),[Oe,Ye]=_.useState(""),[Qe,Re]=_.useState(!1),[it,mt]=_.useState(!1),[wt,Ze]=_.useState(""),[Bt,gt]=_.useState("from-selected-node"),[Mt,Yt]=_.useState(()=>new Set),[pt,Nt]=_.useState(()=>new Set),[Lt,Rt]=_.useState({}),xt=_.useRef(!1),Vt=_.useRef(null),Xn=_.useRef(null),Nn=ie!=null?ie:Mt,Kt=We!=null?We:pt,Hn=nt!=null?nt:Yt,qt=Se!=null?Se:Nt,[hn,at]=_.useState(null),[_n,ps]=_.useState(null),[po,Ls]=_.useState(!1),[wo,_o]=_.useState(!1),{isCameraMoving:Ht,renderedZoom:Rn,cameraRenderTick:Zn,renderedCameraRef:Bn,interactionIdleTimeoutRef:En,getTransformLayerOriginScreen:Es,flushCameraReactTick:Ts,syncCamera:bn,handleWheel:zn}=nS({mapPadHostRef:Ct,transformLayerRef:_t}),Fs=_.useMemo(()=>fp(t,d,je,He),[t,d,je,He]),So=_.useMemo(()=>Ec({lanes:Fs,branches:t,mergeNodes:n,directCommits:i,unpushedDirectCommits:a,defaultBranch:d,branchCommitPreviews:je,branchParentByName:He,branchUniqueAheadCounts:Ge,manuallyOpenedClumps:Nn,manuallyClosedClumps:Kt,isDebugOpen:ee,gridSearchQuery:$e,gridFocusSha:ut,checkedOutRef:tt!=null?tt:null,orientation:ue,nodePositionOverrides:Lt}),[Fs,t,n,i,a,d,je,He,Ge,Nn,Kt,ee,$e,ut,(An=tt==null?void 0:tt.headSha)!=null?An:null,(as=tt==null?void 0:tt.branchName)!=null?as:null,ue,Lt]),Ro=_.useMemo(()=>Ec({lanes:Fs,branches:t,mergeNodes:n,directCommits:i,unpushedDirectCommits:a,defaultBranch:d,branchCommitPreviews:je,branchParentByName:He,branchUniqueAheadCounts:Ge,manuallyOpenedClumps:Nn,manuallyClosedClumps:Kt,isDebugOpen:ee,gridSearchQuery:$e,gridFocusSha:ut,checkedOutRef:tt!=null?tt:null,orientation:ue,nodePositionOverrides:Lt}),[Fs,t,n,i,a,d,je,He,Ge,Nn,Kt,ee,$e,ut,(Ks=tt==null?void 0:tt.headSha)!=null?Ks:null,(Us=tt==null?void 0:tt.branchName)!=null?Us:null,ue,Lt]),{allCommits:oo,clusterKeyByCommitId:Cn,leadByClusterKey:us,clusterCounts:mn,matchingNodes:_s,matchingNodeIds:vi,normalizedSearchQuery:Cs,focusedNode:io,defaultCollapsedClumps:yo,renderNodes:is,visibleNodesBySha:ks,contentWidth:ao,contentHeight:$n,connectors:ro,mergeConnectors:ds,connectorDecisions:Gn,nodeWarnings:ri,commitIdsWithRenderedAncestry:zo,connectorParentShas:ea,branchStartShas:Zt,branchOffNodeShas:$i,crossBranchOutgoingShas:Os,branchBaseCommitByName:Ii,pointFormatter:Pi}=So,$o=!!Cs,fs=Rn/Bi,li=_.useMemo(()=>({transform:`scale(${1/fs})`,transformOrigin:"top left",width:`${100*fs}%`,height:`${100*fs}%`}),[fs]),gn=-(20/fs),Tn=_.useMemo(()=>{const E=new Map;for(const L of is)E.set(L.commit.visualId,L);return E},[is]),lo=_.useMemo(()=>Ww(is,gn),[is,gn]),Ko=E=>{var ye;const L=E.commit.id,q=E.commit.visualId;if($o&&vi.has(L)||(io==null?void 0:io.commit.id)===L||hn===null)return!0;if(!hn.has(q))return!1;const oe=Cn.get(q);return oe&&((ye=mn.get(oe))!=null?ye:1)>1&&(Nn.has(oe)||!yo.has(oe)&&!Kt.has(oe)),!0},vs=1.25/fs,Xs=Iw/fs,rn="border-border/70",zs="border-highlight",$s=_.useMemo(()=>new Map(t.map(E=>[E.name,E])),[t]),Io=(Qs=tt==null?void 0:tt.hasUncommittedChanges)!=null?Qs:!1;_.useMemo(()=>new Set(t.filter(E=>E.commitsAhead===0&&!E.name.startsWith("*")).map(E=>E.name)),[t]);const js=_.useMemo(()=>{var L,q;const E=new Map;for(const oe of is){const ye=(L=E.get(oe.commit.id))!=null?L:new Set;ye.add(oe.commit.branchName),E.set(oe.commit.id,ye)}for(const oe of i){const ye=(q=E.get(oe.fullSha))!=null?q:new Set;oe.branch&&ye.add(oe.branch),E.set(oe.fullSha,ye)}return E},[is,i,d]),ci=_.useMemo(()=>new Map(Object.entries(c).map(([E,L])=>[E,new Set(L)])),[c]),Po=_.useCallback(()=>{En.current,Ts()},[Ts,En]),{isMarqueeSelecting:Ho,marqueeRect:Is,selectedCommitShas:Uo,setSelectedCommitShas:Co,mergeTargetCommitSha:Un,setMergeTargetCommitSha:Ms,startMarqueeDrag:ui}=oS({scrollContainerRef:rt,renderedCameraRef:Bn,getTransformLayerOriginScreen:Es,renderNodes:is,shouldRenderNode:Ko,onPointerReleaseNoMarquee:Po}),Gs=_.useMemo(()=>new Set(is.map(E=>E.commit.id)),[is]),tn=_.useMemo(()=>Uo.filter(E=>Gs.has(E)),[Uo,Gs]),Ps=_.useCallback((E,L)=>{var ye;if(!L)return!1;if(((ye=je[E])!=null?ye:[]).some(Ce=>bi(Ce.fullSha,L)||bi(Ce.sha,L)))return!0;const oe=$s.get(E);return!!(oe!=null&&oe.headSha&&bi(oe.headSha,L))},[je,$s]),Vn=(uo=tt==null?void 0:tt.branchName)!=null?uo:null,Yn=(Dn=tt==null?void 0:tt.headSha)!=null?Dn:null,ws=Vn==null,qs=_.useMemo(()=>{if(!ut)return null;const E=is.filter(L=>L.commit.id===ut);return E.length===0?null:E.length===1||!io?E[0]:E.reduce((L,q)=>{const oe=(L.x-io.x)**2+(L.y-io.y)**2;return(q.x-io.x)**2+(q.y-io.y)**2<oe?q:L})},[ut,is,io]),Vo=_.useCallback((E,L,q)=>{for(const oe of W){if(!Qh(oe,Q))continue;if(oe.branchName){if(oe.branchName===E&&bi(oe.headSha,L))return oe;continue}if(!bi(oe.headSha,L)&&!bi(oe.headSha,q))continue;if(oe.parentSha&&Ps(E,oe.parentSha)||Ps(E,oe.headSha))return oe;const ye=$s.get(E);if(ye&&bi(ye.headSha,oe.headSha)||E===d&&i.some(Ce=>bi(Ce.fullSha,oe.headSha)))return oe}return null},[W,Q,Ps,$s,d,i]),xo=_.useCallback(E=>{for(const L of W)if(Qh(L,Q)&&L.branchName===E)return L;return null},[W,Q]),ko=_.useCallback((E,L)=>{for(const q of W)if(Qh(q,Q)&&(bi(q.headSha,E)||bi(q.headSha,L)))return q;return null},[W,Q]),Hs=_.useCallback(E=>{var L;return Array.from((L=js.get(E))!=null?L:[])},[js]),di=_.useMemo(()=>{var ye,Ce,Ve,Je;const E=new Map;for(const vt of tn){const At=Hs(vt);if(At.length===0)continue;const ft=(ye=At.find(nn=>nn!==d))!=null?ye:At[0],ct=tn.filter(nn=>nn!==vt).filter(nn=>!new Set(Hs(nn)).has(ft));E.set(ft,{targetSha:vt,targetBranch:ft,sourceRefs:ct})}const L=Array.from(E.values()),q=Un?L.find(vt=>{var At;return vt.targetSha===Un||vt.targetBranch===((At=Hs(Un)[0])!=null?At:"")}):null,oe=(Ce=q!=null?q:L[L.length-1])!=null?Ce:null;return{options:L,selected:oe,targetBranch:(Ve=oe==null?void 0:oe.targetBranch)!=null?Ve:null,sources:(Je=oe==null?void 0:oe.sourceRefs)!=null?Je:[]}},[tn,Hs,d,Un]),Qo=_.useMemo(()=>{const E=[...Vn===d?[{name:d,headSha:Yn!=null?Yn:"",unpushedCommits:a.length,remoteSyncStatus:"unpushed"}]:[],...t].filter(L=>!L.name.startsWith("*")&&L.unpushedCommits>0&&L.remoteSyncStatus!=="on-github").map(L=>[L.name,L]);return new Map(E)},[t,Vn,Yn,d,a.length]),co=_.useMemo(()=>{const E=oe=>{var Ce;const ye=Hs(oe).filter(Ve=>Qo.has(Ve));return ye.length===0?null:ye.length===1?ye[0]:Vn&&ye.includes(Vn)?Vn:(Ce=ye.find(Ve=>Ve!==d))!=null?Ce:ye[0]},L=oe=>{var ye;return oe===d?a.map(Ce=>{var Ve,Je;return{fullSha:Ce.fullSha,sha:Ce.sha,parentSha:(Ve=Ce.parentSha)!=null?Ve:null,message:Ce.message,author:Ce.author,date:Ce.date,kind:(Je=Ce.kind)!=null?Je:"commit"}}):(ye=je[oe])!=null?ye:[]},q=new Map;for(const oe of tn){const ye=E(oe);if(!ye)continue;const Ce=Qo.get(ye);if(!Ce)continue;const Ve=L(ye).slice(0,Ce.unpushedCommits),Je=Ve.findIndex(At=>At.fullSha===oe);if(Je===-1)continue;const vt=q.get(ye);(!vt||Je<vt.targetIndex)&&q.set(ye,{branchName:ye,targetSha:oe,targetIndex:Je,commitCount:Ve.length-Je})}return Array.from(q.values())},[tn,Hs,Qo,Vn,d,a,je]),Zo=_.useMemo(()=>Array.from(new Set(tn.map(E=>/^STASH:(\d+)$/.exec(E)).filter(E=>!!E).map(E=>parseInt(E[1],10)))).sort((E,L)=>E-L),[tn]),jo=tn.includes("WORKING_TREE"),zt=(jo?1:0)+Zo.length,wi=[...jo?["Uncommitted changes"]:[],...Zo.map(E=>`Stash ${E+1}`)],Si=Qo.size,Hi=!ws&&!!Vn&&Qo.has(Vn),fi=Vn?`Push ${Vn}`:"Push current branch",bo=co.length===1?co[0].commitCount>1?`Push ${co[0].commitCount} commits on ${co[0].branchName}`:`Push ${co[0].targetSha.slice(0,7)} on ${co[0].branchName}`:`Push ${co.length} selected ranges`,Jo=_.useCallback(E=>{const L=E.target;L!=null&&L.closest('.window-no-drag, input, textarea, select, button, [contenteditable="true"]')||dp().startDragging()},[]);_.useEffect(()=>{const E=Ht||Ho;Pt.current!==E&&(Pt.current=E,Pe==null||Pe(E))},[Ht,Ho,Pe]),_.useEffect(()=>{const E=Cs?_s.length:null;ot.current!==E&&(ot.current=E,st==null||st(E))},[_s.length,Cs,st]),_.useEffect(()=>{const E=Cs&&ut?(()=>{const L=_s.findIndex(q=>q.commit.id===ut);return L>=0?L:null})():null;V.current!==E&&(V.current=E,Gt==null||Gt(E))},[ut,_s,Cs,Gt]);const U=_.useMemo(()=>{var vt,At,ft,ct,nn,dn;if(!Cs)return null;const E=Cs,L=t.map(yn=>yn.name),q=L.find(yn=>yn.toLowerCase()===E),oe=q!=null?q:L.find(yn=>yn.toLowerCase().startsWith(E)),Ce=oe!=null?oe:L.find(yn=>yn.toLowerCase().includes(E));if(!Ce)return null;const Ve=(vt=t.find(yn=>yn.name===Ce))!=null?vt:null;if(Ve!=null&&Ve.headSha)return Ve.headSha;const Je=(At=je[Ce])!=null?At:[];return Je.length>0?(ct=(ft=Je[0])==null?void 0:ft.fullSha)!=null?ct:null:Ce===d&&(dn=(nn=i[0])==null?void 0:nn.fullSha)!=null?dn:null},[Cs,t,je,d,i]);_.useEffect(()=>{var oe,ye,Ce;if(!Cs){if(xe.current=Dt,J.current===null)return;J.current=null,an==null||an(null);return}if(Dt<=0||xe.current===Dt)return;xe.current=Dt;let E;const L=ut?_s.findIndex(Ve=>Ve.commit.id===ut):-1,q=_s.length>0?L<0?0:(L+It+_s.length)%_s.length:-1;E=(Ce=(ye=(oe=_s[q])==null?void 0:oe.commit.id)!=null?ye:U)!=null?Ce:null,J.current!==E&&(J.current=E,an==null||an(E))},[_s,Cs,an,U,Dt,It]),_.useLayoutEffect(()=>{if(!ut)return;const E=`${ut}:${Dt}`;if(Me.current===E)return;const L=rt.current,q=qs;if(!L||!q)return;const oe=Es();if(!oe)return;const ye=L.getBoundingClientRect(),Ce=Bn.current.zoom,Ve=Ce/Bi,Je=q.x+hs/2,vt=q.y+vl+Rs/2,At=ye.left+ye.width/2,ft=ye.top+ye.height/2;bn(At-oe.x-Je*Ve,ft-oe.y-vt*Ve,Ce),Me.current=E},[ut,Dt,qs,Es,bn,Bn]);const x=(ei=(As=_n==null?void 0:_n.width)!=null?As:(gs=rt.current)==null?void 0:gs.clientWidth)!=null?ei:0,S=(I=(R=_n==null?void 0:_n.height)!=null?R:(lr=rt.current)==null?void 0:lr.clientHeight)!=null?I:0,N=x>0&&S>0?Sy(x,S,Bn.current,{innerPaddingPx:Ed}):null,Y=N!=null?Cy(N,Bn.current.zoom):null,ne=E=>{if(!Y)return!0;const{fromX:L,fromY:q,toX:oe,toY:ye}=E;return Yw(L,q,oe,ye,Y,E.fromFace,E.toFace)};_.useLayoutEffect(()=>{var Ve;const E=rt.current;if(!E||E.clientWidth<=0||E.clientHeight<=0)return;const L=E.clientWidth,q=E.clientHeight;ps(Je=>(Je==null?void 0:Je.width)===L&&(Je==null?void 0:Je.height)===q?Je:{width:L,height:q});const oe=Sy(L,q,Bn.current,{innerPaddingPx:Ed});if(!oe){at(Je=>Je===null?Je:null);return}const ye=Cy(oe,Bn.current.zoom),Ce=Fw(lo,ye,Tn,gn);for(const Je of is){const vt=Cn.get(Je.commit.visualId);if(!vt||((Ve=mn.get(vt))!=null?Ve:1)<=1)continue;(Nn.has(vt)||!yo.has(vt)&&!Kt.has(vt))&&Ce.add(Je.commit.visualId)}at(Je=>Uw(Je,Ce)?Je:Ce)},[Rn,Dt,ut,Ht,Zn,Nn,Kt,yo,Cn,mn,is,_n,lo,Tn,gn]),_.useLayoutEffect(()=>{const E=rt.current;if(!E)return;const L=()=>{const oe=E.clientWidth,ye=E.clientHeight;oe<=0||ye<=0||ps(Ce=>(Ce==null?void 0:Ce.width)===oe&&(Ce==null?void 0:Ce.height)===ye?Ce:{width:oe,height:ye})};L();const q=new ResizeObserver(L);return q.observe(E),()=>q.disconnect()},[oo.length]);const de=is.filter(E=>Ko(E)).length,Xe=ds.filter(E=>ne(E)).length,dt=ro.filter(E=>ne(E)).length,Tt=_.useCallback((E,L)=>{if(xt.current){E.preventDefault(),E.stopPropagation();return}E.stopPropagation();const q=L.commit.id;if(E.shiftKey?(Co(Ve=>Ve.includes(q)?Ve.filter(Je=>Je!==q):[...Ve,q]),Ms(q)):(Co(Ve=>Ve.includes(q)?[]:[q]),Ms(Ve=>Ve===q?null:q)),!(E.metaKey||E.ctrlKey||E.detail>=2)||q==="WORKING_TREE")return;const ye=q.length>=40?q.slice(0,7):q;let Ce=null;if(L.commit.branchName?(Ce=Vo(L.commit.branchName,q,ye),Ce||(Ce=xo(L.commit.branchName))):Ce=ko(q,ye),Ce&&ae){ae(Ce.path);return}h==null||h({commitSha:q})},[ko,Vo,xo,h,ae]),bt=_.useCallback((E,L)=>{var Je,vt,At,ft,ct;if(E.button!==0)return;const q=E.target;if(q!=null&&q.closest('[data-selectable-text="true"]')||q!=null&&q.closest("button, a, input, textarea, select"))return;E.stopPropagation(),E.preventDefault(),xt.current=!1,E.currentTarget.setPointerCapture(E.pointerId);const oe=(Je=Lt[L.commit.visualId])!=null?Je:Lt[L.commit.id];Vt.current={nodeId:L.commit.visualId,startX:E.clientX,startY:E.clientY,baseX:(vt=oe==null?void 0:oe.x)!=null?vt:L.x,baseY:(At=oe==null?void 0:oe.y)!=null?At:L.y,moved:!1,pendingX:(ft=oe==null?void 0:oe.x)!=null?ft:L.x,pendingY:(ct=oe==null?void 0:oe.y)!=null?ct:L.y};const ye=()=>{Xn.current=null;const nn=Vt.current;nn&&Rt(dn=>({...dn,[nn.nodeId]:{x:nn.pendingX,y:nn.pendingY}}))},Ce=nn=>{const dn=Vt.current;if(!dn)return;const yn=Bn.current.zoom/Bi,vn=yn>0?1/yn:1,Ln=(nn.clientX-dn.startX)*vn,Wt=(nn.clientY-dn.startY)*vn;(Math.abs(Ln)>2||Math.abs(Wt)>2)&&(dn.moved=!0),dn.moved&&(xt.current=!0),dn.pendingX=dn.baseX+Ln,dn.pendingY=dn.baseY+Wt,Xn.current==null&&(Xn.current=window.requestAnimationFrame(ye))},Ve=()=>{window.removeEventListener("pointermove",Ce),window.removeEventListener("pointerup",Ve),window.removeEventListener("pointercancel",Ve),Xn.current!=null&&(window.cancelAnimationFrame(Xn.current),Xn.current=null,ye());try{E.currentTarget.releasePointerCapture(E.pointerId)}catch{}const nn=Vt.current;Vt.current=null,nn&&window.setTimeout(()=>{xt.current=!1},0)};window.addEventListener("pointermove",Ce),window.addEventListener("pointerup",Ve),window.addEventListener("pointercancel",Ve)},[Lt]),en=_.useCallback(async()=>{if(!fe)return;await fe(Oe)&&(he(!1),Ye(""))},[fe,Oe]),ht=_.useCallback(async()=>{F&&(await F({branchNames:[],discardUncommittedChanges:jo,stashIndices:Zo}),Re(!1),Co([]),Ms(null))},[F,jo,Zo]),$t=_.useCallback(async()=>{var L;const E=wt.trim();if(E){if(Bt==="new-root"){if(!P)return;await P(E)}else{if(!Ae)return;const q=tn.length===1?tn[0]:(L=tt==null?void 0:tt.headSha)!=null?L:null;if(!q||!(q==="WORKING_TREE"||q.startsWith("STASH:")||q===(tt==null?void 0:tt.headSha)))return;await Ae(q,E)}mt(!1),Ze(""),gt("from-selected-node"),Co([]),Ms(null)}},[tt==null?void 0:tt.headSha,Bt,wt,Ae,P,tn]),Jt=!!(tt!=null&&tt.headSha),yt=tn.length===0&&Jt,un=tn.length===1&&(tn[0]==="WORKING_TREE"||tn[0].startsWith("STASH:"))||yt,pn=!!P;return _.useEffect(()=>{if(it){if(!un&&!yt&&pn){gt("new-root");return}(un||yt)&&gt("from-selected-node")}},[pn,yt,it,un]),_.useEffect(()=>{const E=lt.current;if(!E)return;const L=640,q=440,oe=()=>{const Ce=E.getBoundingClientRect().width;Ls(Ce<L),_o(Ce<q)};oe();const ye=new ResizeObserver(()=>oe());return ye.observe(E),()=>ye.disconnect()},[]),_.useEffect(()=>{const E=L=>{if(!F||Qe||tn.length===0)return;const q=L.target;q!=null&&q.closest('input, textarea, select, button, [contenteditable="true"]')||L.key!=="Delete"&&L.key!=="Backspace"||(L.preventDefault(),Re(!0))};return window.addEventListener("keydown",E),()=>window.removeEventListener("keydown",E)},[Qe,F,tn.length]),l.jsxs("div",{className:"relative flex h-full min-h-0 flex-col overflow-hidden border-l border-border bg-card",children:[l.jsx(Zw,{isOpen:ee,onClose:()=>ve==null?void 0:ve(),visibleBounds:Y,renderedNodeCount:de,totalNodeCount:is.length,renderedMergeConnectorCount:Xe,totalMergeConnectorCount:ds.length,renderedConnectorCount:dt,totalConnectorCount:ro.length,mapGridCullViewportInsetScreenPx:zw,debugRows:Ro.debugRows,branchDebugRows:Ro.branchDebugRows,connectorDecisions:Gn}),qe?l.jsxs("header",{"data-tauri-drag-region":!0,onPointerDown:Jo,className:"window-drag-region pointer-events-none absolute inset-x-0 top-0 z-[70] flex w-full select-none",children:[l.jsxs("div",{ref:lt,className:"pointer-events-auto ml-auto flex w-full max-w-[calc(100vw-116px)] min-w-0 items-start justify-between gap-3 p-2.25 select-none",children:[l.jsx("div",{className:"flex min-w-0 flex-nowrap items-center justify-start gap-3 overflow-visible",children:l.jsx(qw,{compactLabels:po,selectedVisibleCommitShas:tn,commitInProgress:$,commitDisabled:ce,stageInProgress:ge,stashInProgress:Le,stashDisabled:Z,pushInProgress:T,hasUncommittedChanges:Io,createBranchFromNodeInProgress:le,onCommitLocalChanges:fe,onStageAllChanges:X?()=>void X():void 0,onStashLocalChanges:we,onPushCurrentBranch:O,onPushAllBranches:A,onPushCommitTargets:B,onMergeRefsIntoBranch:j,selectedPushTargets:co,selectedPushLabel:bo,canPushCurrentBranch:Hi,pushCurrentBranchLabel:fi,pushableRemoteBranchCount:Si,selectedCommitTargetOption:di,mergeInProgress:M,mergeTargetCommitSha:Un,setMergeTargetCommitSha:Ms,worktrees:W,currentRepoPath:Q,worktreeMenuOpen:et,setWorktreeMenuOpen:Ke,onSwitchToWorktree:ae,onRemoveWorktree:me,removeWorktreeInProgress:se,setCommitDialogOpen:he,setNewBranchDialogOpen:mt})}),l.jsx("div",{className:"flex min-w-0 shrink-0 items-center justify-end gap-2",children:l.jsxs("div",{className:"window-no-drag pointer-events-auto flex items-center gap-2",children:[wo?null:l.jsx(tS,{query:qe.gridSearchQuery,onQueryChange:qe.setGridSearchQuery,resultCount:qe.gridSearchResultCount,resultIndex:qe.gridSearchResultIndex,onJump:E=>{qe.setGridSearchJumpDirection(E),qe.setGridSearchJumpToken(L=>L+1)}}),l.jsx(eS,{compactLabels:po,orientation:qe.mapGridOrientation,onOrientationChange:qe.setMapGridOrientation})]})})]}),l.jsxs("div",{className:"pointer-events-none fixed bottom-4 right-4 z-[80] flex max-w-[min(22rem,calc(100vw-2rem))] flex-col items-end gap-1.5",children:[(K=qe.githubAuthStatus)!=null&&K.ghAvailable&&!qe.githubAuthStatus.authenticated?l.jsx("button",{onClick:qe.onGitHubAuthSetup,disabled:qe.githubAuthLoading,className:"window-no-drag pointer-events-auto inline-flex h-7 items-center gap-2 rounded-md border border-border/60 bg-card/95 px-2 text-[11px] font-medium text-foreground backdrop-blur-sm transition-colors hover:bg-accent hover:text-foreground disabled:cursor-not-allowed disabled:opacity-50",children:qe.githubAuthLoading?"Connecting GitHub...":"Connect GitHub"}):null,qe.githubAuthStatus&&!qe.githubAuthStatus.ghAvailable?l.jsxs("div",{className:"window-no-drag pointer-events-auto inline-flex h-7 items-center gap-2 rounded-md border border-border/60 bg-card/95 px-2 text-[11px] font-medium text-foreground backdrop-blur-sm",children:[l.jsx("p",{className:"shrink-0 text-[10px] font-medium text-foreground",children:"GitHub"}),l.jsx("p",{className:"max-w-36 truncate text-[11px] text-foreground/90",children:"Install `gh` for private PR data"})]}):null,qe.githubAuthMessage?l.jsxs("div",{className:"window-no-drag pointer-events-auto inline-flex h-7 items-center gap-2 rounded-md border border-border/60 bg-card/95 px-2 text-[11px] text-foreground backdrop-blur-sm",children:[l.jsx("p",{className:"shrink-0 text-[10px] font-medium text-foreground",children:"GitHub"}),l.jsx("p",{className:"max-w-36 truncate text-[11px] text-foreground/90",title:qe.githubAuthMessage,children:qe.githubAuthMessage})]}):null,qe.commitSwitchFeedback?l.jsxs("div",{className:`window-no-drag pointer-events-auto inline-flex h-7 items-center gap-2 rounded-md border px-2 text-[11px] backdrop-blur-sm transition-opacity duration-200 ${qe.isCommitSwitchFeedbackVisible?"opacity-100":"opacity-0"} ${qe.commitSwitchFeedback.kind==="error"?"border-red-500/25 bg-red-50/95 text-red-600 dark:border-red-900/30 dark:bg-red-900/20 dark:text-red-400":"border-blue-500/25 bg-blue-50/95 text-blue-600 dark:border-blue-900/30 dark:bg-blue-900/20 dark:text-blue-400"}`,title:qe.commitSwitchFeedback.message,children:[l.jsx("p",{className:"shrink-0 text-[10px] font-medium opacity-70",children:qe.commitSwitchFeedback.kind==="error"?"Alert":"Update"}),l.jsx("p",{className:"truncate text-[11px]",children:qe.commitSwitchFeedback.message})]}):null]})]}):null,b||oo.length===0?l.jsx(iS,{}):l.jsx(Qw,{scrollContainerRef:rt,mapPadHostRef:Ct,transformLayerRef:_t,isMarqueeSelecting:Ho,contentWidth:ao,contentHeight:$n,isCameraMoving:Ht,onWheel:zn,onMouseDown:ui,onNodePointerDown:bt,labelTopPx:gn,inverseZoomStyle:li,displayZoom:fs,selectedVisibleCommitShas:tn,normalizedSearchQuery:Cs,matchingNodeIds:vi,focusedNode:qs,renderNodes:is,shouldRenderNode:Ko,manuallyOpenedClumps:Nn,manuallyClosedClumps:Kt,defaultCollapsedClumps:yo,leadByClusterKey:us,clusterKeyByCommitId:Cn,clusterCounts:mn,commitIdsWithRenderedAncestry:zo,nodeWarnings:ri,connectorParentShas:ea,branchStartShas:Zt,branchOffNodeShas:$i,crossBranchOutgoingShas:Os,branchBaseCommitByName:Ii,branchStartAccentClass:zs,connectorParentAccentClass:rn,commitCornerRadiusPx:Xs,lineStrokeWidth:vs,pointFormatter:Pi,connectors:ro,mergeConnectors:ds,cullConnectorPath:ne,flushCameraReactTick:Ts,setManuallyOpenedClumps:Hn,setManuallyClosedClumps:qt,onCommitCardClick:Tt,unpushedCommitShasSetByBranch:ci,checkedOutHeadSha:Yn,orientation:ue}),Is&&Ho?l.jsx("div",{className:"pointer-events-none absolute z-[60] border",style:{left:Is.left,top:Is.top,width:Is.width,height:Is.height,borderColor:"var(--highlight-border)",borderWidth:"1.5px",backgroundColor:"transparent",borderRadius:0}}):null,l.jsx(Jw,{commitDialogOpen:Te,commitMessageDraft:Oe,onCommitMessageDraftChange:Ye,onCommitDialogClose:()=>he(!1),onCommitConfirm:()=>void en(),commitInProgress:$,deleteConfirmOpen:Qe,deleteSelectionItems:wi,onDeleteConfirmClose:()=>Re(!1),onDeleteConfirm:()=>void ht(),deleteInProgress:H,deletableSelectionCount:zt,newBranchDialogOpen:it,newBranchName:wt,newBranchCreateMode:Bt,onNewBranchNameChange:Ze,onNewBranchCreateModeChange:gt,onNewBranchDialogClose:()=>mt(!1),onNewBranchConfirm:()=>void $t(),selectedCommitCanCreateBranch:un,currentCheckedOutCommitCanCreateBranch:yt,createBranchFromNodeInProgress:le})]})}function aS({branches:t,mergeNodes:n=[],directCommits:i=[],unpushedDirectCommits:a=[],unpushedCommitShasByBranch:c={},openPRs:u=[],defaultBranch:d,onCommitClick:h,onLoadMore:p,branchPromptMeta:y={},branchCommitPreviews:g={},branchParentByName:b={},branchUniqueAheadCounts:v={},gridSearchQuery:C="",gridSearchJumpToken:k=0,gridSearchJumpDirection:j=1,gridFocusSha:M=null,onGridSearchResultCountChange:A,onGridSearchResultIndexChange:O,onGridSearchFocusChange:B,view:T="time",isLoading:F=!1,scrollRequest:H,focusedErrorBranch:W,checkedOutRef:Q=null,mapTopInsetPx:me=0,onMergeRefsIntoBranch:se,mergeInProgress:ae=!1,onPushAllBranches:we,onPushCurrentBranch:Le,onPushCommitTargets:Z,pushInProgress:fe=!1,onDeleteSelection:$,worktrees:ce=[],currentRepoPath:X,onRemoveWorktree:ge,removeWorktreeInProgress:Ae=!1,onSwitchToWorktree:P,onStashLocalChanges:le,stashInProgress:ee=!1,stashDisabled:ve=!1,onCommitLocalChanges:ue,commitInProgress:je=!1,commitDisabled:He=!1,onStageAllChanges:Ge,stageInProgress:$e=!1,onCreateBranchFromNode:Dt,onCreateRootBranch:It,createBranchFromNodeInProgress:ut=!1,onMoveNodeBackToBranch:tt,isDebugOpen:st=!1,onDebugClose:Gt,orientation:an="horizontal",onInteractionChange:Pe,manuallyOpenedClumps:ie,manuallyClosedClumps:We,setManuallyOpenedClumps:nt,setManuallyClosedClumps:Se,layoutModel:qe,gridHudProps:rt}){const lt=new Set(u.map(V=>V.branchName)),Ct=14*864e5,_t=Date.now();function Pt(V){return lt.has(V.name)||_t-new Date(V.lastCommitDate).getTime()<=Ct}const ot=t.filter(V=>V.status==="stale"&&Pt(V)).sort((V,J)=>new Date(J.lastCommitDate).getTime()-new Date(V.lastCommitDate).getTime());return l.jsx("div",{className:"h-full flex flex-col",children:T==="time"?l.jsx("div",{className:"flex-1 min-h-0",children:l.jsx(My,{branches:t,mergeNodes:n,directCommits:i,unpushedDirectCommits:a,unpushedCommitShasByBranch:c,openPRs:u,defaultBranch:d,onCommitClick:h,onLoadMore:p,branchPromptMeta:y,branchCommitPreviews:g,branchParentByName:b,branchUniqueAheadCounts:v,gridSearchQuery:C,gridSearchJumpToken:k,gridSearchJumpDirection:j,gridFocusSha:M,onGridSearchResultCountChange:A,onGridSearchResultIndexChange:O,onGridSearchFocusChange:B,staleBranches:ot,isLoading:F,scrollRequest:H,focusedErrorBranch:W,checkedOutRef:Q,mapTopInsetPx:me,onMergeRefsIntoBranch:se,mergeInProgress:ae,onPushAllBranches:we,onPushCurrentBranch:Le,onPushCommitTargets:Z,pushInProgress:fe,onDeleteSelection:$,worktrees:ce,currentRepoPath:X,onRemoveWorktree:ge,removeWorktreeInProgress:Ae,onSwitchToWorktree:P,onStashLocalChanges:le,stashInProgress:ee,stashDisabled:ve,onCommitLocalChanges:ue,commitInProgress:je,commitDisabled:He,onStageAllChanges:Ge,stageInProgress:$e,onCreateBranchFromNode:Dt,onCreateRootBranch:It,createBranchFromNodeInProgress:ut,onMoveNodeBackToBranch:tt,isDebugOpen:st,onDebugClose:Gt,orientation:an,onInteractionChange:Pe,manuallyOpenedClumps:ie,manuallyClosedClumps:We,setManuallyOpenedClumps:nt,setManuallyClosedClumps:Se,layoutModel:qe,gridHudProps:rt})}):T==="grid"?l.jsx("div",{className:"flex-1 min-h-0 overflow-hidden",children:l.jsx(My,{branches:t,mergeNodes:n,directCommits:i,unpushedDirectCommits:a,defaultBranch:d,branchCommitPreviews:g,branchParentByName:b,branchUniqueAheadCounts:v,gridSearchQuery:C,gridSearchJumpToken:k,gridSearchJumpDirection:j,gridFocusSha:M,checkedOutRef:Q,onGridSearchResultCountChange:A,onGridSearchResultIndexChange:O,onGridSearchFocusChange:B,onInteractionChange:Pe,manuallyOpenedClumps:ie,manuallyClosedClumps:We,setManuallyOpenedClumps:nt,setManuallyClosedClumps:Se,layoutModel:qe,isDebugOpen:st,onDebugClose:Gt,orientation:an,gridHudProps:rt})}):null})}var wl=zx();const mp=_.createContext({});function Lc(t){const n=_.useRef(null);return n.current===null&&(n.current=t()),n.current}const rS=typeof window<"u",pp=rS?_.useLayoutEffect:_.useEffect,Pd=_.createContext(null);function _p(t,n){t.indexOf(n)===-1&&t.push(n)}function gl(t,n){const i=t.indexOf(n);i>-1&&t.splice(i,1)}const da=(t,n,i)=>i>n?n:i<t?t:i;let gp=()=>{};const ir={},Qx=t=>/^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t);function Zx(t){return typeof t=="object"&&t!==null}const Jx=t=>/^0[^.\s]+$/u.test(t);function eb(t){let n;return()=>(n===void 0&&(n=t()),n)}const Oi=t=>t,lS=(t,n)=>i=>n(t(i)),Oc=(...t)=>t.reduce(lS),yl=(t,n,i)=>{const a=n-t;return a===0?1:(i-t)/a};class yp{constructor(){this.subscriptions=[]}add(n){return _p(this.subscriptions,n),()=>gl(this.subscriptions,n)}notify(n,i,a){const c=this.subscriptions.length;if(c)if(c===1)this.subscriptions[0](n,i,a);else for(let u=0;u<c;u++){const d=this.subscriptions[u];d&&d(n,i,a)}}getSize(){return this.subscriptions.length}clear(){this.subscriptions.length=0}}const ai=t=>t*1e3,Li=t=>t/1e3;function tb(t,n){return n?t*(1e3/n):0}const cS=(t,n,i)=>{const a=n-t;return((i-t)%a+a)%a+t},nb=(t,n,i)=>(((1-3*i+3*n)*t+(3*i-6*n))*t+3*n)*t,uS=1e-7,dS=12;function fS(t,n,i,a,c){let u,d,h=0;do d=n+(i-n)/2,u=nb(d,a,c)-t,u>0?i=d:n=d;while(Math.abs(u)>uS&&++h<dS);return d}function zc(t,n,i,a){if(t===n&&i===a)return Oi;const c=u=>fS(u,0,1,t,i);return u=>u===0||u===1?u:nb(c(u),n,a)}const sb=t=>n=>n<=.5?t(2*n)/2:(2-t(2*(1-n)))/2,ob=t=>n=>1-t(1-n),ib=zc(.33,1.53,.69,.99),xp=ob(ib),ab=sb(xp),rb=t=>t>=1?1:(t*=2)<1?.5*xp(t):.5*(2-Math.pow(2,-10*(t-1))),bp=t=>1-Math.sin(Math.acos(t)),lb=ob(bp),cb=sb(bp),hS=zc(.42,0,1,1),mS=zc(0,0,.58,1),ub=zc(.42,0,.58,1),db=t=>Array.isArray(t)&&typeof t[0]!="number";function fb(t,n){return db(t)?t[cS(0,t.length,n)]:t}const hb=t=>Array.isArray(t)&&typeof t[0]=="number",pS={linear:Oi,easeIn:hS,easeInOut:ub,easeOut:mS,circIn:bp,circInOut:cb,circOut:lb,backIn:xp,backInOut:ab,backOut:ib,anticipate:rb},_S=t=>typeof t=="string",Ey=t=>{if(hb(t)){gp(t.length===4);const[n,i,a,c]=t;return zc(n,i,a,c)}else if(_S(t))return pS[t];return t},Gu=["setup","read","resolveKeyframes","preUpdate","update","preRender","render","postRender"];function gS(t,n){let i=new Set,a=new Set,c=!1,u=!1;const d=new WeakSet;let h={delta:0,timestamp:0,isProcessing:!1};function p(g){d.has(g)&&(y.schedule(g),t()),g(h)}const y={schedule:(g,b=!1,v=!1)=>{const k=v&&c?i:a;return b&&d.add(g),k.add(g),g},cancel:g=>{a.delete(g),d.delete(g)},process:g=>{if(h=g,c){u=!0;return}c=!0;const b=i;i=a,a=b,i.forEach(p),i.clear(),c=!1,u&&(u=!1,y.process(g))}};return y}const yS=40;function mb(t,n){let i=!1,a=!0;const c={delta:0,timestamp:0,isProcessing:!1},u=()=>i=!0,d=Gu.reduce((B,T)=>(B[T]=gS(u),B),{}),{setup:h,read:p,resolveKeyframes:y,preUpdate:g,update:b,preRender:v,render:C,postRender:k}=d,j=()=>{const B=ir.useManualTiming,T=B?c.timestamp:performance.now();i=!1,B||(c.delta=a?1e3/60:Math.max(Math.min(T-c.timestamp,yS),1)),c.timestamp=T,c.isProcessing=!0,h.process(c),p.process(c),y.process(c),g.process(c),b.process(c),v.process(c),C.process(c),k.process(c),c.isProcessing=!1,i&&n&&(a=!1,t(j))},M=()=>{i=!0,a=!0,c.isProcessing||t(j)};return{schedule:Gu.reduce((B,T)=>{const F=d[T];return B[T]=(H,W=!1,Q=!1)=>(i||M(),F.schedule(H,W,Q)),B},{}),cancel:B=>{for(let T=0;T<Gu.length;T++)d[Gu[T]].cancel(B)},state:c,steps:d}}const{schedule:os,cancel:Da,state:No,steps:Zh}=mb(typeof requestAnimationFrame<"u"?requestAnimationFrame:Oi,!0);let gd;function xS(){gd=void 0}const Fo={now:()=>(gd===void 0&&Fo.set(No.isProcessing||ir.useManualTiming?No.timestamp:performance.now()),gd),set:t=>{gd=t,queueMicrotask(xS)}},pb=t=>n=>typeof n=="string"&&n.startsWith(t),_b=pb("--"),bS=pb("var(--"),vp=t=>bS(t)?vS.test(t.split("/*")[0].trim()):!1,vS=/var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;function Ty(t){return typeof t!="string"?!1:t.split("/*")[0].includes("var(--")}const Sl={test:t=>typeof t=="number",parse:parseFloat,transform:t=>t},Tc={...Sl,transform:t=>da(0,1,t)},qu={...Sl,default:1},wc=t=>Math.round(t*1e5)/1e5,wp=/-?(?:\d+(?:\.\d+)?|\.\d+)/gu;function wS(t){return t==null}const SS=/^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu,Sp=(t,n)=>i=>!!(typeof i=="string"&&SS.test(i)&&i.startsWith(t)||n&&!wS(i)&&Object.prototype.hasOwnProperty.call(i,n)),gb=(t,n,i)=>a=>{if(typeof a!="string")return a;const[c,u,d,h]=a.match(wp);return{[t]:parseFloat(c),[n]:parseFloat(u),[i]:parseFloat(d),alpha:h!==void 0?parseFloat(h):1}},CS=t=>da(0,255,t),Jh={...Sl,transform:t=>Math.round(CS(t))},Tr={test:Sp("rgb","red"),parse:gb("red","green","blue"),transform:({red:t,green:n,blue:i,alpha:a=1})=>"rgba("+Jh.transform(t)+", "+Jh.transform(n)+", "+Jh.transform(i)+", "+wc(Tc.transform(a))+")"};function kS(t){let n="",i="",a="",c="";return t.length>5?(n=t.substring(1,3),i=t.substring(3,5),a=t.substring(5,7),c=t.substring(7,9)):(n=t.substring(1,2),i=t.substring(2,3),a=t.substring(3,4),c=t.substring(4,5),n+=n,i+=i,a+=a,c+=c),{red:parseInt(n,16),green:parseInt(i,16),blue:parseInt(a,16),alpha:c?parseInt(c,16)/255:1}}const Dm={test:Sp("#"),parse:kS,transform:Tr.transform},$c=t=>({test:n=>typeof n=="string"&&n.endsWith(t)&&n.split(" ").length===1,parse:parseFloat,transform:n=>`${n}${t}`}),tr=$c("deg"),ua=$c("%"),Et=$c("px"),jS=$c("vh"),MS=$c("vw"),Ay={...ua,parse:t=>ua.parse(t)/100,transform:t=>ua.transform(t*100)},fl={test:Sp("hsl","hue"),parse:gb("hue","saturation","lightness"),transform:({hue:t,saturation:n,lightness:i,alpha:a=1})=>"hsla("+Math.round(t)+", "+ua.transform(wc(n))+", "+ua.transform(wc(i))+", "+wc(Tc.transform(a))+")"},so={test:t=>Tr.test(t)||Dm.test(t)||fl.test(t),parse:t=>Tr.test(t)?Tr.parse(t):fl.test(t)?fl.parse(t):Dm.parse(t),transform:t=>typeof t=="string"?t:t.hasOwnProperty("red")?Tr.transform(t):fl.transform(t),getAnimatableNone:t=>{const n=so.parse(t);return n.alpha=0,so.transform(n)}},ES=/(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu;function TS(t){var n,i;return isNaN(t)&&typeof t=="string"&&(((n=t.match(wp))==null?void 0:n.length)||0)+(((i=t.match(ES))==null?void 0:i.length)||0)>0}const yb="number",xb="color",AS="var",DS="var(",Dy="${}",NS=/var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;function xl(t){const n=t.toString(),i=[],a={color:[],number:[],var:[]},c=[];let u=0;const h=n.replace(NS,p=>(so.test(p)?(a.color.push(u),c.push(xb),i.push(so.parse(p))):p.startsWith(DS)?(a.var.push(u),c.push(AS),i.push(p)):(a.number.push(u),c.push(yb),i.push(parseFloat(p))),++u,Dy)).split(Dy);return{values:i,split:h,indexes:a,types:c}}function RS(t){return xl(t).values}function bb({split:t,types:n}){const i=t.length;return a=>{let c="";for(let u=0;u<i;u++)if(c+=t[u],a[u]!==void 0){const d=n[u];d===yb?c+=wc(a[u]):d===xb?c+=so.transform(a[u]):c+=a[u]}return c}}function BS(t){return bb(xl(t))}const LS=t=>typeof t=="number"?0:so.test(t)?so.getAnimatableNone(t):t,OS=(t,n)=>typeof t=="number"?n!=null&&n.trim().endsWith("/")?t:0:LS(t);function zS(t){const n=xl(t);return bb(n)(n.values.map((a,c)=>OS(a,n.split[c])))}const Zi={test:TS,parse:RS,createTransformer:BS,getAnimatableNone:zS};function em(t,n,i){return i<0&&(i+=1),i>1&&(i-=1),i<1/6?t+(n-t)*6*i:i<1/2?n:i<2/3?t+(n-t)*(2/3-i)*6:t}function $S({hue:t,saturation:n,lightness:i,alpha:a}){t/=360,n/=100,i/=100;let c=0,u=0,d=0;if(!n)c=u=d=i;else{const h=i<.5?i*(1+n):i+n-i*n,p=2*i-h;c=em(p,h,t+1/3),u=em(p,h,t),d=em(p,h,t-1/3)}return{red:Math.round(c*255),green:Math.round(u*255),blue:Math.round(d*255),alpha:a}}function Td(t,n){return i=>i>0?n:t}const ms=(t,n,i)=>t+(n-t)*i,tm=(t,n,i)=>{const a=t*t,c=i*(n*n-a)+a;return c<0?0:Math.sqrt(c)},IS=[Dm,Tr,fl],PS=t=>IS.find(n=>n.test(t));function Ny(t){const n=PS(t);if(!n)return!1;let i=n.parse(t);return n===fl&&(i=$S(i)),i}const Ry=(t,n)=>{const i=Ny(t),a=Ny(n);if(!i||!a)return Td(t,n);const c={...i};return u=>(c.red=tm(i.red,a.red,u),c.green=tm(i.green,a.green,u),c.blue=tm(i.blue,a.blue,u),c.alpha=ms(i.alpha,a.alpha,u),Tr.transform(c))},Nm=new Set(["none","hidden"]);function HS(t,n){return Nm.has(t)?i=>i<=0?t:n:i=>i>=1?n:t}function US(t,n){return i=>ms(t,n,i)}function Cp(t){return typeof t=="number"?US:typeof t=="string"?vp(t)?Td:so.test(t)?Ry:WS:Array.isArray(t)?vb:typeof t=="object"?so.test(t)?Ry:VS:Td}function vb(t,n){const i=[...t],a=i.length,c=t.map((u,d)=>Cp(u)(u,n[d]));return u=>{for(let d=0;d<a;d++)i[d]=c[d](u);return i}}function VS(t,n){const i={...t,...n},a={};for(const c in i)t[c]!==void 0&&n[c]!==void 0&&(a[c]=Cp(t[c])(t[c],n[c]));return c=>{for(const u in a)i[u]=a[u](c);return i}}function YS(t,n){var c;const i=[],a={color:0,var:0,number:0};for(let u=0;u<n.values.length;u++){const d=n.types[u],h=t.indexes[d][a[d]],p=(c=t.values[h])!=null?c:0;i[u]=p,a[d]++}return i}const WS=(t,n)=>{const i=Zi.createTransformer(n),a=xl(t),c=xl(n);return a.indexes.var.length===c.indexes.var.length&&a.indexes.color.length===c.indexes.color.length&&a.indexes.number.length>=c.indexes.number.length?Nm.has(t)&&!c.values.length||Nm.has(n)&&!a.values.length?HS(t,n):Oc(vb(YS(a,c),c.values),i):Td(t,n)};function wb(t,n,i){return typeof t=="number"&&typeof n=="number"&&typeof i=="number"?ms(t,n,i):Cp(t)(t,n)}const FS=t=>{const n=({timestamp:i})=>t(i);return{start:(i=!0)=>os.update(n,i),stop:()=>Da(n),now:()=>No.isProcessing?No.timestamp:Fo.now()}},Sb=(t,n,i=10)=>{let a="";const c=Math.max(Math.round(n/i),2);for(let u=0;u<c;u++)a+=Math.round(t(u/(c-1))*1e4)/1e4+", ";return`linear(${a.substring(0,a.length-2)})`},Ad=2e4;function kp(t){let n=0;const i=50;let a=t.next(n);for(;!a.done&&n<Ad;)n+=i,a=t.next(n);return n>=Ad?1/0:n}function Cb(t,n=100,i){const a=i({...t,keyframes:[0,n]}),c=Math.min(kp(a),Ad);return{type:"keyframes",ease:u=>a.next(c*u).value/n,duration:Li(c)}}const Bs={stiffness:100,damping:10,mass:1,velocity:0,duration:800,bounce:.3,visualDuration:.3,restSpeed:{granular:.01,default:2},restDelta:{granular:.005,default:.5},minDuration:.01,maxDuration:10,minDamping:.05,maxDamping:1};function Rm(t,n){return t*Math.sqrt(1-n*n)}const XS=12;function GS(t,n,i){let a=i;for(let c=1;c<XS;c++)a=a-t(a)/n(a);return a}const nm=.001;function qS({duration:t=Bs.duration,bounce:n=Bs.bounce,velocity:i=Bs.velocity,mass:a=Bs.mass}){let c,u,d=1-n;d=da(Bs.minDamping,Bs.maxDamping,d),t=da(Bs.minDuration,Bs.maxDuration,Li(t)),d<1?(c=y=>{const g=y*d,b=g*t,v=g-i,C=Rm(y,d),k=Math.exp(-b);return nm-v/C*k},u=y=>{const b=y*d*t,v=b*i+i,C=Math.pow(d,2)*Math.pow(y,2)*t,k=Math.exp(-b),j=Rm(Math.pow(y,2),d);return(-c(y)+nm>0?-1:1)*((v-C)*k)/j}):(c=y=>{const g=Math.exp(-y*t),b=(y-i)*t+1;return-nm+g*b},u=y=>{const g=Math.exp(-y*t),b=(i-y)*(t*t);return g*b});const h=5/t,p=GS(c,u,h);if(t=ai(t),isNaN(p))return{stiffness:Bs.stiffness,damping:Bs.damping,duration:t};{const y=Math.pow(p,2)*a;return{stiffness:y,damping:d*2*Math.sqrt(a*y),duration:t}}}const KS=["duration","bounce"],QS=["stiffness","damping","mass"];function By(t,n){return n.some(i=>t[i]!==void 0)}function ZS(t){let n={velocity:Bs.velocity,stiffness:Bs.stiffness,damping:Bs.damping,mass:Bs.mass,isResolvedFromDuration:!1,...t};if(!By(t,QS)&&By(t,KS))if(n.velocity=0,t.visualDuration){const i=t.visualDuration,a=2*Math.PI/(i*1.2),c=a*a,u=2*da(.05,1,1-(t.bounce||0))*Math.sqrt(c);n={...n,mass:Bs.mass,stiffness:c,damping:u}}else{const i=qS({...t,velocity:0});n={...n,...i,mass:Bs.mass},n.isResolvedFromDuration=!0}return n}function Ac(t=Bs.visualDuration,n=Bs.bounce){const i=typeof t!="object"?{visualDuration:t,keyframes:[0,1],bounce:n}:t;let{restSpeed:a,restDelta:c}=i;const u=i.keyframes[0],d=i.keyframes[i.keyframes.length-1],h={done:!1,value:u},{stiffness:p,damping:y,mass:g,duration:b,velocity:v,isResolvedFromDuration:C}=ZS({...i,velocity:-Li(i.velocity||0)}),k=v||0,j=y/(2*Math.sqrt(p*g)),M=d-u,A=Li(Math.sqrt(p/g)),O=Math.abs(M)<5;a||(a=O?Bs.restSpeed.granular:Bs.restSpeed.default),c||(c=O?Bs.restDelta.granular:Bs.restDelta.default);let B,T,F,H,W,Q;if(j<1)F=Rm(A,j),H=(k+j*A*M)/F,B=se=>{const ae=Math.exp(-j*A*se);return d-ae*(H*Math.sin(F*se)+M*Math.cos(F*se))},W=j*A*H+M*F,Q=j*A*M-H*F,T=se=>Math.exp(-j*A*se)*(W*Math.sin(F*se)+Q*Math.cos(F*se));else if(j===1){B=ae=>d-Math.exp(-A*ae)*(M+(k+A*M)*ae);const se=k+A*M;T=ae=>Math.exp(-A*ae)*(A*se*ae-k)}else{const se=A*Math.sqrt(j*j-1);B=Z=>{const fe=Math.exp(-j*A*Z),$=Math.min(se*Z,300);return d-fe*((k+j*A*M)*Math.sinh($)+se*M*Math.cosh($))/se};const ae=(k+j*A*M)/se,we=j*A*ae-M*se,Le=j*A*M-ae*se;T=Z=>{const fe=Math.exp(-j*A*Z),$=Math.min(se*Z,300);return fe*(we*Math.sinh($)+Le*Math.cosh($))}}const me={calculatedDuration:C&&b||null,velocity:se=>ai(T(se)),next:se=>{if(!C&&j<1){const we=Math.exp(-j*A*se),Le=Math.sin(F*se),Z=Math.cos(F*se),fe=d-we*(H*Le+M*Z),$=ai(we*(W*Le+Q*Z));return h.done=Math.abs($)<=a&&Math.abs(d-fe)<=c,h.value=h.done?d:fe,h}const ae=B(se);if(C)h.done=se>=b;else{const we=ai(T(se));h.done=Math.abs(we)<=a&&Math.abs(d-ae)<=c}return h.value=h.done?d:ae,h},toString:()=>{const se=Math.min(kp(me),Ad),ae=Sb(we=>me.next(se*we).value,se,30);return se+"ms "+ae},toTransition:()=>{}};return me}Ac.applyToOptions=t=>{const n=Cb(t,100,Ac);return t.ease=n.ease,t.duration=ai(n.duration),t.type="keyframes",t};const JS=5;function kb(t,n,i){const a=Math.max(n-JS,0);return tb(i-t(a),n-a)}function Bm({keyframes:t,velocity:n=0,power:i=.8,timeConstant:a=325,bounceDamping:c=10,bounceStiffness:u=500,modifyTarget:d,min:h,max:p,restDelta:y=.5,restSpeed:g}){const b=t[0],v={done:!1,value:b},C=Q=>h!==void 0&&Q<h||p!==void 0&&Q>p,k=Q=>h===void 0?p:p===void 0||Math.abs(h-Q)<Math.abs(p-Q)?h:p;let j=i*n;const M=b+j,A=d===void 0?M:d(M);A!==M&&(j=A-b);const O=Q=>-j*Math.exp(-Q/a),B=Q=>A+O(Q),T=Q=>{const me=O(Q),se=B(Q);v.done=Math.abs(me)<=y,v.value=v.done?A:se};let F,H;const W=Q=>{C(v.value)&&(F=Q,H=Ac({keyframes:[v.value,k(v.value)],velocity:kb(B,Q,v.value),damping:c,stiffness:u,restDelta:y,restSpeed:g}))};return W(0),{calculatedDuration:null,next:Q=>{let me=!1;return!H&&F===void 0&&(me=!0,T(Q),W(Q)),F!==void 0&&Q>=F?H.next(Q-F):(!me&&T(Q),v)}}}function e4(t,n,i){const a=[],c=i||ir.mix||wb,u=t.length-1;for(let d=0;d<u;d++){let h=c(t[d],t[d+1]);if(n){const p=Array.isArray(n)?n[d]||Oi:n;h=Oc(p,h)}a.push(h)}return a}function jb(t,n,{clamp:i=!0,ease:a,mixer:c}={}){const u=t.length;if(gp(u===n.length),u===1)return()=>n[0];if(u===2&&n[0]===n[1])return()=>n[1];const d=t[0]===t[1];t[0]>t[u-1]&&(t=[...t].reverse(),n=[...n].reverse());const h=e4(n,a,c),p=h.length,y=g=>{if(d&&g<t[0])return n[0];let b=0;if(p>1)for(;b<t.length-2&&!(g<t[b+1]);b++);const v=yl(t[b],t[b+1],g);return h[b](v)};return i?g=>y(da(t[0],t[u-1],g)):y}function Mb(t,n){const i=t[t.length-1];for(let a=1;a<=n;a++){const c=yl(0,n,a);t.push(ms(i,1,c))}}function Eb(t){const n=[0];return Mb(n,t.length-1),n}function t4(t,n){return t.map(i=>i*n)}function n4(t,n){return t.map(()=>n||ub).splice(0,t.length-1)}function Sc({duration:t=300,keyframes:n,times:i,ease:a="easeInOut"}){const c=db(a)?a.map(Ey):Ey(a),u={done:!1,value:n[0]},d=t4(i&&i.length===n.length?i:Eb(n),t),h=jb(d,n,{ease:Array.isArray(c)?c:n4(n,c)});return{calculatedDuration:t,next:p=>(u.value=h(p),u.done=p>=t,u)}}const s4=t=>t!==null;function Hd(t,{repeat:n,repeatType:i="loop"},a,c=1){const u=t.filter(s4),h=c<0||n&&i!=="loop"&&n%2===1?0:u.length-1;return!h||a===void 0?u[h]:a}const o4={decay:Bm,inertia:Bm,tween:Sc,keyframes:Sc,spring:Ac};function Tb(t){typeof t.type=="string"&&(t.type=o4[t.type])}class jp{constructor(){this.updateFinished()}get finished(){return this._finished}updateFinished(){this._finished=new Promise(n=>{this.resolve=n})}notifyFinished(){this.resolve()}then(n,i){return this.finished.then(n,i)}}const i4=t=>t/100;class Dd extends jp{constructor(n){super(),this.state="idle",this.startTime=null,this.isStopped=!1,this.currentTime=0,this.holdTime=null,this.playbackSpeed=1,this.delayState={done:!1,value:void 0},this.stop=()=>{var a,c;const{motionValue:i}=this.options;i&&i.updatedAt!==Fo.now()&&this.tick(Fo.now()),this.isStopped=!0,this.state!=="idle"&&(this.teardown(),(c=(a=this.options).onStop)==null||c.call(a))},this.options=n,this.initAnimation(),this.play(),n.autoplay===!1&&this.pause()}initAnimation(){const{options:n}=this;Tb(n);const{type:i=Sc,repeat:a=0,repeatDelay:c=0,repeatType:u,velocity:d=0}=n;let{keyframes:h}=n;const p=i||Sc;p!==Sc&&typeof h[0]!="number"&&(this.mixKeyframes=Oc(i4,wb(h[0],h[1])),h=[0,100]);const y=p({...n,keyframes:h});u==="mirror"&&(this.mirroredGenerator=p({...n,keyframes:[...h].reverse(),velocity:-d})),y.calculatedDuration===null&&(y.calculatedDuration=kp(y));const{calculatedDuration:g}=y;this.calculatedDuration=g,this.resolvedDuration=g+c,this.totalDuration=this.resolvedDuration*(a+1)-c,this.generator=y}updateTime(n){const i=Math.round(n-this.startTime)*this.playbackSpeed;this.holdTime!==null?this.currentTime=this.holdTime:this.currentTime=i}tick(n,i=!1){const{generator:a,totalDuration:c,mixKeyframes:u,mirroredGenerator:d,resolvedDuration:h,calculatedDuration:p}=this;if(this.startTime===null)return a.next(0);const{delay:y=0,keyframes:g,repeat:b,repeatType:v,repeatDelay:C,type:k,onUpdate:j,finalKeyframe:M}=this.options;this.speed>0?this.startTime=Math.min(this.startTime,n):this.speed<0&&(this.startTime=Math.min(n-c/this.speed,this.startTime)),i?this.currentTime=n:this.updateTime(n);const A=this.currentTime-y*(this.playbackSpeed>=0?1:-1),O=this.playbackSpeed>=0?A<0:A>c;this.currentTime=Math.max(A,0),this.state==="finished"&&this.holdTime===null&&(this.currentTime=c);let B=this.currentTime,T=a;if(b){const Q=Math.min(this.currentTime,c)/h;let me=Math.floor(Q),se=Q%1;!se&&Q>=1&&(se=1),se===1&&me--,me=Math.min(me,b+1),!!(me%2)&&(v==="reverse"?(se=1-se,C&&(se-=C/h)):v==="mirror"&&(T=d)),B=da(0,1,se)*h}let F;O?(this.delayState.value=g[0],F=this.delayState):F=T.next(B),u&&!O&&(F.value=u(F.value));let{done:H}=F;!O&&p!==null&&(H=this.playbackSpeed>=0?this.currentTime>=c:this.currentTime<=0);const W=this.holdTime===null&&(this.state==="finished"||this.state==="running"&&H);return W&&k!==Bm&&(F.value=Hd(g,this.options,M,this.speed)),j&&j(F.value),W&&this.finish(),F}then(n,i){return this.finished.then(n,i)}get duration(){return Li(this.calculatedDuration)}get iterationDuration(){const{delay:n=0}=this.options||{};return this.duration+Li(n)}get time(){return Li(this.currentTime)}set time(n){n=ai(n),this.currentTime=n,this.startTime===null||this.holdTime!==null||this.playbackSpeed===0?this.holdTime=n:this.driver&&(this.startTime=this.driver.now()-n/this.playbackSpeed),this.driver?this.driver.start(!1):(this.startTime=0,this.state="paused",this.holdTime=n,this.tick(n))}getGeneratorVelocity(){const n=this.currentTime;if(n<=0)return this.options.velocity||0;if(this.generator.velocity)return this.generator.velocity(n);const i=this.generator.next(n).value;return kb(a=>this.generator.next(a).value,n,i)}get speed(){return this.playbackSpeed}set speed(n){const i=this.playbackSpeed!==n;i&&this.driver&&this.updateTime(Fo.now()),this.playbackSpeed=n,i&&this.driver&&(this.time=Li(this.currentTime))}play(){var c,u;if(this.isStopped)return;const{driver:n=FS,startTime:i}=this.options;this.driver||(this.driver=n(d=>this.tick(d))),(u=(c=this.options).onPlay)==null||u.call(c);const a=this.driver.now();this.state==="finished"?(this.updateFinished(),this.startTime=a):this.holdTime!==null?this.startTime=a-this.holdTime:this.startTime||(this.startTime=i!=null?i:a),this.state==="finished"&&this.speed<0&&(this.startTime+=this.calculatedDuration),this.holdTime=null,this.state="running",this.driver.start()}pause(){this.state="paused",this.updateTime(Fo.now()),this.holdTime=this.currentTime}complete(){this.state!=="running"&&this.play(),this.state="finished",this.holdTime=null}finish(){var n,i;this.notifyFinished(),this.teardown(),this.state="finished",(i=(n=this.options).onComplete)==null||i.call(n)}cancel(){var n,i;this.holdTime=null,this.startTime=0,this.tick(0),this.teardown(),(i=(n=this.options).onCancel)==null||i.call(n)}teardown(){this.state="idle",this.stopDriver(),this.startTime=this.holdTime=null}stopDriver(){this.driver&&(this.driver.stop(),this.driver=void 0)}sample(n){return this.startTime=0,this.tick(n,!0)}attachTimeline(n){var i;return this.options.allowFlatten&&(this.options.type="keyframes",this.options.ease="linear",this.initAnimation()),(i=this.driver)==null||i.stop(),n.observe(this)}}function a4(t){var n;for(let i=1;i<t.length;i++)(n=t[i])!=null||(t[i]=t[i-1])}const Ar=t=>t*180/Math.PI,Lm=t=>{const n=Ar(Math.atan2(t[1],t[0]));return Om(n)},r4={x:4,y:5,translateX:4,translateY:5,scaleX:0,scaleY:3,scale:t=>(Math.abs(t[0])+Math.abs(t[3]))/2,rotate:Lm,rotateZ:Lm,skewX:t=>Ar(Math.atan(t[1])),skewY:t=>Ar(Math.atan(t[2])),skew:t=>(Math.abs(t[1])+Math.abs(t[2]))/2},Om=t=>(t=t%360,t<0&&(t+=360),t),Ly=Lm,Oy=t=>Math.sqrt(t[0]*t[0]+t[1]*t[1]),zy=t=>Math.sqrt(t[4]*t[4]+t[5]*t[5]),l4={x:12,y:13,z:14,translateX:12,translateY:13,translateZ:14,scaleX:Oy,scaleY:zy,scale:t=>(Oy(t)+zy(t))/2,rotateX:t=>Om(Ar(Math.atan2(t[6],t[5]))),rotateY:t=>Om(Ar(Math.atan2(-t[2],t[0]))),rotateZ:Ly,rotate:Ly,skewX:t=>Ar(Math.atan(t[4])),skewY:t=>Ar(Math.atan(t[1])),skew:t=>(Math.abs(t[1])+Math.abs(t[4]))/2};function zm(t){return t.includes("scale")?1:0}function $m(t,n){if(!t||t==="none")return zm(n);const i=t.match(/^matrix3d\(([-\d.e\s,]+)\)$/u);let a,c;if(i)a=l4,c=i;else{const h=t.match(/^matrix\(([-\d.e\s,]+)\)$/u);a=r4,c=h}if(!c)return zm(n);const u=a[n],d=c[1].split(",").map(u4);return typeof u=="function"?u(d):d[u]}const c4=(t,n)=>{const{transform:i="none"}=getComputedStyle(t);return $m(i,n)};function u4(t){return parseFloat(t.trim())}const Cl=["transformPerspective","x","y","z","translateX","translateY","translateZ","scale","scaleX","scaleY","rotate","rotateX","rotateY","rotateZ","skew","skewX","skewY"],kl=new Set(Cl),$y=t=>t===Sl||t===Et,d4=new Set(["x","y","z"]),f4=Cl.filter(t=>!d4.has(t));function h4(t){const n=[];return f4.forEach(i=>{const a=t.getValue(i);a!==void 0&&(n.push([i,a.get()]),a.set(i.startsWith("scale")?1:0))}),n}const or={width:({x:t},{paddingLeft:n="0",paddingRight:i="0",boxSizing:a})=>{const c=t.max-t.min;return a==="border-box"?c:c-parseFloat(n)-parseFloat(i)},height:({y:t},{paddingTop:n="0",paddingBottom:i="0",boxSizing:a})=>{const c=t.max-t.min;return a==="border-box"?c:c-parseFloat(n)-parseFloat(i)},top:(t,{top:n})=>parseFloat(n),left:(t,{left:n})=>parseFloat(n),bottom:({y:t},{top:n})=>parseFloat(n)+(t.max-t.min),right:({x:t},{left:n})=>parseFloat(n)+(t.max-t.min),x:(t,{transform:n})=>$m(n,"x"),y:(t,{transform:n})=>$m(n,"y")};or.translateX=or.x;or.translateY=or.y;const Dr=new Set;let Im=!1,Pm=!1,Hm=!1;function Ab(){if(Pm){const t=Array.from(Dr).filter(a=>a.needsMeasurement),n=new Set(t.map(a=>a.element)),i=new Map;n.forEach(a=>{const c=h4(a);c.length&&(i.set(a,c),a.render())}),t.forEach(a=>a.measureInitialState()),n.forEach(a=>{a.render();const c=i.get(a);c&&c.forEach(([u,d])=>{var h;(h=a.getValue(u))==null||h.set(d)})}),t.forEach(a=>a.measureEndState()),t.forEach(a=>{a.suspendedScrollY!==void 0&&window.scrollTo(0,a.suspendedScrollY)})}Pm=!1,Im=!1,Dr.forEach(t=>t.complete(Hm)),Dr.clear()}function Db(){Dr.forEach(t=>{t.readKeyframes(),t.needsMeasurement&&(Pm=!0)})}function m4(){Hm=!0,Db(),Ab(),Hm=!1}class Mp{constructor(n,i,a,c,u,d=!1){this.state="pending",this.isAsync=!1,this.needsMeasurement=!1,this.unresolvedKeyframes=[...n],this.onComplete=i,this.name=a,this.motionValue=c,this.element=u,this.isAsync=d}scheduleResolve(){this.state="scheduled",this.isAsync?(Dr.add(this),Im||(Im=!0,os.read(Db),os.resolveKeyframes(Ab))):(this.readKeyframes(),this.complete())}readKeyframes(){const{unresolvedKeyframes:n,name:i,element:a,motionValue:c}=this;if(n[0]===null){const u=c==null?void 0:c.get(),d=n[n.length-1];if(u!==void 0)n[0]=u;else if(a&&i){const h=a.readValue(i,d);h!=null&&(n[0]=h)}n[0]===void 0&&(n[0]=d),c&&u===void 0&&c.set(n[0])}a4(n)}setFinalKeyframe(){}measureInitialState(){}renderEndStyles(){}measureEndState(){}complete(n=!1){this.state="complete",this.onComplete(this.unresolvedKeyframes,this.finalKeyframe,n),Dr.delete(this)}cancel(){this.state==="scheduled"&&(Dr.delete(this),this.state="pending")}resume(){this.state==="pending"&&this.scheduleResolve()}}const p4=t=>t.startsWith("--");function Nb(t,n,i){p4(n)?t.style.setProperty(n,i):t.style[n]=i}const _4={};function Rb(t,n){const i=eb(t);return()=>{var a;return(a=_4[n])!=null?a:i()}}const g4=Rb(()=>window.ScrollTimeline!==void 0,"scrollTimeline"),Bb=Rb(()=>{try{document.createElement("div").animate({opacity:0},{easing:"linear(0, 1)"})}catch{return!1}return!0},"linearEasing"),yc=([t,n,i,a])=>`cubic-bezier(${t}, ${n}, ${i}, ${a})`,Iy={linear:"linear",ease:"ease",easeIn:"ease-in",easeOut:"ease-out",easeInOut:"ease-in-out",circIn:yc([0,.65,.55,1]),circOut:yc([.55,0,1,.45]),backIn:yc([.31,.01,.66,-.59]),backOut:yc([.33,1.53,.69,.99])};function Lb(t,n){if(t)return typeof t=="function"?Bb()?Sb(t,n):"ease-out":hb(t)?yc(t):Array.isArray(t)?t.map(i=>Lb(i,n)||Iy.easeOut):Iy[t]}function y4(t,n,i,{delay:a=0,duration:c=300,repeat:u=0,repeatType:d="loop",ease:h="easeOut",times:p}={},y=void 0){const g={[n]:i};p&&(g.offset=p);const b=Lb(h,c);Array.isArray(b)&&(g.easing=b);const v={delay:a,duration:c,easing:Array.isArray(b)?"linear":b,fill:"both",iterations:u+1,direction:d==="reverse"?"alternate":"normal"};return y&&(v.pseudoElement=y),t.animate(g,v)}function Ep(t){return typeof t=="function"&&"applyToOptions"in t}function x4({type:t,...n}){var i,a;return Ep(t)&&Bb()?t.applyToOptions(n):((i=n.duration)!=null||(n.duration=300),(a=n.ease)!=null||(n.ease="easeOut"),n)}class Ob extends jp{constructor(n){if(super(),this.finishedTime=null,this.isStopped=!1,this.manualStartTime=null,!n)return;const{element:i,name:a,keyframes:c,pseudoElement:u,allowFlatten:d=!1,finalKeyframe:h,onComplete:p}=n;this.isPseudoElement=!!u,this.allowFlatten=d,this.options=n,gp(typeof n.type!="string");const y=x4(n);this.animation=y4(i,a,c,y,u),y.autoplay===!1&&this.animation.pause(),this.animation.onfinish=()=>{if(this.finishedTime=this.time,!u){const g=Hd(c,this.options,h,this.speed);this.updateMotionValue&&this.updateMotionValue(g),Nb(i,a,g),this.animation.cancel()}p==null||p(),this.notifyFinished()}}play(){this.isStopped||(this.manualStartTime=null,this.animation.play(),this.state==="finished"&&this.updateFinished())}pause(){this.animation.pause()}complete(){var n,i;(i=(n=this.animation).finish)==null||i.call(n)}cancel(){try{this.animation.cancel()}catch{}}stop(){if(this.isStopped)return;this.isStopped=!0;const{state:n}=this;n==="idle"||n==="finished"||(this.updateMotionValue?this.updateMotionValue():this.commitStyles(),this.isPseudoElement||this.cancel())}commitStyles(){var i,a,c;const n=(i=this.options)==null?void 0:i.element;!this.isPseudoElement&&(n!=null&&n.isConnected)&&((c=(a=this.animation).commitStyles)==null||c.call(a))}get duration(){var i,a;const n=((a=(i=this.animation.effect)==null?void 0:i.getComputedTiming)==null?void 0:a.call(i).duration)||0;return Li(Number(n))}get iterationDuration(){const{delay:n=0}=this.options||{};return this.duration+Li(n)}get time(){return Li(Number(this.animation.currentTime)||0)}set time(n){const i=this.finishedTime!==null;this.manualStartTime=null,this.finishedTime=null,this.animation.currentTime=ai(n),i&&this.animation.pause()}get speed(){return this.animation.playbackRate}set speed(n){n<0&&(this.finishedTime=null),this.animation.playbackRate=n}get state(){return this.finishedTime!==null?"finished":this.animation.playState}get startTime(){var n;return(n=this.manualStartTime)!=null?n:Number(this.animation.startTime)}set startTime(n){this.manualStartTime=this.animation.startTime=n}attachTimeline({timeline:n,rangeStart:i,rangeEnd:a,observe:c}){var u;return this.allowFlatten&&((u=this.animation.effect)==null||u.updateTiming({easing:"linear"})),this.animation.onfinish=null,n&&g4()?(this.animation.timeline=n,i&&(this.animation.rangeStart=i),a&&(this.animation.rangeEnd=a),Oi):c(this)}}const zb={anticipate:rb,backInOut:ab,circInOut:cb};function b4(t){return t in zb}function v4(t){typeof t.ease=="string"&&b4(t.ease)&&(t.ease=zb[t.ease])}const sm=10;class w4 extends Ob{constructor(n){v4(n),Tb(n),super(n),n.startTime!==void 0&&n.autoplay!==!1&&(this.startTime=n.startTime),this.options=n}updateMotionValue(n){const{motionValue:i,onUpdate:a,onComplete:c,element:u,...d}=this.options;if(!i)return;if(n!==void 0){i.set(n);return}const h=new Dd({...d,autoplay:!1}),p=Math.max(sm,Fo.now()-this.startTime),y=da(0,sm,p-sm),g=h.sample(p).value,{name:b}=this.options;u&&b&&Nb(u,b,g),i.setWithVelocity(h.sample(Math.max(0,p-y)).value,g,y),h.stop()}}const Py=(t,n)=>n==="zIndex"?!1:!!(typeof t=="number"||Array.isArray(t)||typeof t=="string"&&(Zi.test(t)||t==="0")&&!t.startsWith("url("));function S4(t){const n=t[0];if(t.length===1)return!0;for(let i=0;i<t.length;i++)if(t[i]!==n)return!0}function C4(t,n,i,a){const c=t[0];if(c===null)return!1;if(n==="display"||n==="visibility")return!0;const u=t[t.length-1],d=Py(c,n),h=Py(u,n);return!d||!h?!1:S4(t)||(i==="spring"||Ep(i))&&a}function Um(t){t.duration=0,t.type="keyframes"}const $b=new Set(["opacity","clipPath","filter","transform"]),k4=/^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/;function j4(t){for(let n=0;n<t.length;n++)if(typeof t[n]=="string"&&k4.test(t[n]))return!0;return!1}const M4=new Set(["color","backgroundColor","outlineColor","fill","stroke","borderColor","borderTopColor","borderRightColor","borderBottomColor","borderLeftColor"]),E4=eb(()=>Object.hasOwnProperty.call(Element.prototype,"animate"));function T4(t){var b;const{motionValue:n,name:i,repeatDelay:a,repeatType:c,damping:u,type:d,keyframes:h}=t;if(!(((b=n==null?void 0:n.owner)==null?void 0:b.current)instanceof HTMLElement))return!1;const{onUpdate:y,transformTemplate:g}=n.owner.getProps();return E4()&&i&&($b.has(i)||M4.has(i)&&j4(h))&&(i!=="transform"||!g)&&!y&&!a&&c!=="mirror"&&u!==0&&d!=="inertia"}const A4=40;class D4 extends jp{constructor({autoplay:n=!0,delay:i=0,type:a="keyframes",repeat:c=0,repeatDelay:u=0,repeatType:d="loop",keyframes:h,name:p,motionValue:y,element:g,...b}){var k;super(),this.stop=()=>{var j,M;this._animation&&(this._animation.stop(),(j=this.stopTimeline)==null||j.call(this)),(M=this.keyframeResolver)==null||M.cancel()},this.createdAt=Fo.now();const v={autoplay:n,delay:i,type:a,repeat:c,repeatDelay:u,repeatType:d,name:p,motionValue:y,element:g,...b},C=(g==null?void 0:g.KeyframeResolver)||Mp;this.keyframeResolver=new C(h,(j,M,A)=>this.onKeyframesResolved(j,M,v,!A),p,y,g),(k=this.keyframeResolver)==null||k.scheduleResolve()}onKeyframesResolved(n,i,a,c){var A,O;this.keyframeResolver=void 0;const{name:u,type:d,velocity:h,delay:p,isHandoff:y,onUpdate:g}=a;this.resolvedAt=Fo.now();let b=!0;C4(n,u,d,h)||(b=!1,(ir.instantAnimations||!p)&&(g==null||g(Hd(n,a,i))),n[0]=n[n.length-1],Um(a),a.repeat=0);const C={startTime:c?this.resolvedAt?this.resolvedAt-this.createdAt>A4?this.resolvedAt:this.createdAt:this.createdAt:void 0,finalKeyframe:i,...a,keyframes:n},k=b&&!y&&T4(C),j=(O=(A=C.motionValue)==null?void 0:A.owner)==null?void 0:O.current;let M;if(k)try{M=new w4({...C,element:j})}catch{M=new Dd(C)}else M=new Dd(C);M.finished.then(()=>{this.notifyFinished()}).catch(Oi),this.pendingTimeline&&(this.stopTimeline=M.attachTimeline(this.pendingTimeline),this.pendingTimeline=void 0),this._animation=M}get finished(){return this._animation?this.animation.finished:this._finished}then(n,i){return this.finished.finally(n).then(()=>{})}get animation(){var n;return this._animation||((n=this.keyframeResolver)==null||n.resume(),m4()),this._animation}get duration(){return this.animation.duration}get iterationDuration(){return this.animation.iterationDuration}get time(){return this.animation.time}set time(n){this.animation.time=n}get speed(){return this.animation.speed}get state(){return this.animation.state}set speed(n){this.animation.speed=n}get startTime(){return this.animation.startTime}attachTimeline(n){return this._animation?this.stopTimeline=this.animation.attachTimeline(n):this.pendingTimeline=n,()=>this.stop()}play(){this.animation.play()}pause(){this.animation.pause()}complete(){this.animation.complete()}cancel(){var n;this._animation&&this.animation.cancel(),(n=this.keyframeResolver)==null||n.cancel()}}class N4{constructor(n){this.stop=()=>this.runAll("stop"),this.animations=n.filter(Boolean)}get finished(){return Promise.all(this.animations.map(n=>n.finished))}getAll(n){return this.animations[0][n]}setAll(n,i){for(let a=0;a<this.animations.length;a++)this.animations[a][n]=i}attachTimeline(n){const i=this.animations.map(a=>a.attachTimeline(n));return()=>{i.forEach((a,c)=>{a&&a(),this.animations[c].stop()})}}get time(){return this.getAll("time")}set time(n){this.setAll("time",n)}get speed(){return this.getAll("speed")}set speed(n){this.setAll("speed",n)}get state(){return this.getAll("state")}get startTime(){return this.getAll("startTime")}get duration(){return Hy(this.animations,"duration")}get iterationDuration(){return Hy(this.animations,"iterationDuration")}runAll(n){this.animations.forEach(i=>i[n]())}play(){this.runAll("play")}pause(){this.runAll("pause")}cancel(){this.runAll("cancel")}complete(){this.runAll("complete")}}function Hy(t,n){let i=0;for(let a=0;a<t.length;a++){const c=t[a][n];c!==null&&c>i&&(i=c)}return i}class R4 extends N4{then(n,i){return this.finished.finally(n).then(()=>{})}}function Ib(t,n,i,a=0,c=1){const u=Array.from(t).sort((y,g)=>y.sortNodePosition(g)).indexOf(n),d=t.size,h=(d-1)*a;return typeof i=="function"?i(u,d):c===1?u*a:h-u*a}const B4=/^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u;function L4(t){const n=B4.exec(t);if(!n)return[,];const[,i,a,c]=n;return[`--${i!=null?i:a}`,c]}function Pb(t,n,i=1){const[a,c]=L4(t);if(!a)return;const u=window.getComputedStyle(n).getPropertyValue(a);if(u){const d=u.trim();return Qx(d)?parseFloat(d):d}return vp(c)?Pb(c,n,i+1):c}const O4={type:"spring",stiffness:500,damping:25,restSpeed:10},z4=t=>({type:"spring",stiffness:550,damping:t===0?2*Math.sqrt(550):30,restSpeed:10}),$4={type:"keyframes",duration:.8},I4={type:"keyframes",ease:[.25,.1,.35,1],duration:.3},P4=(t,{keyframes:n})=>n.length>2?$4:kl.has(t)?t.startsWith("scale")?z4(n[1]):O4:I4;function Hb(t,n){if(t!=null&&t.inherit&&n){const{inherit:i,...a}=t;return{...n,...a}}return t}function Tp(t,n){var a,c;const i=(c=(a=t==null?void 0:t[n])!=null?a:t==null?void 0:t.default)!=null?c:t;return i!==t?Hb(i,t):i}const H4=new Set(["when","delay","delayChildren","staggerChildren","staggerDirection","repeat","repeatType","repeatDelay","from","elapsed"]);function U4(t){for(const n in t)if(!H4.has(n))return!0;return!1}const Ap=(t,n,i,a={},c,u)=>d=>{const h=Tp(a,t)||{},p=h.delay||a.delay||0;let{elapsed:y=0}=a;y=y-ai(p);const g={keyframes:Array.isArray(i)?i:[null,i],ease:"easeOut",velocity:n.getVelocity(),...h,delay:-y,onUpdate:v=>{n.set(v),h.onUpdate&&h.onUpdate(v)},onComplete:()=>{d(),h.onComplete&&h.onComplete()},name:t,motionValue:n,element:u?void 0:c};U4(h)||Object.assign(g,P4(t,g)),g.duration&&(g.duration=ai(g.duration)),g.repeatDelay&&(g.repeatDelay=ai(g.repeatDelay)),g.from!==void 0&&(g.keyframes[0]=g.from);let b=!1;if((g.type===!1||g.duration===0&&!g.repeatDelay)&&(Um(g),g.delay===0&&(b=!0)),(ir.instantAnimations||ir.skipAnimations||c!=null&&c.shouldSkipAnimations)&&(b=!0,Um(g),g.delay=0),g.allowFlatten=!h.type&&!h.ease,b&&!u&&n.get()!==void 0){const v=Hd(g.keyframes,h);if(v!==void 0){os.update(()=>{g.onUpdate(v),g.onComplete()});return}}return h.isSync?new Dd(g):new D4(g)};function Uy(t){const n=[{},{}];return t==null||t.values.forEach((i,a)=>{n[0][a]=i.get(),n[1][a]=i.getVelocity()}),n}function Dp(t,n,i,a){if(typeof n=="function"){const[c,u]=Uy(a);n=n(i!==void 0?i:t.custom,c,u)}if(typeof n=="string"&&(n=t.variants&&t.variants[n]),typeof n=="function"){const[c,u]=Uy(a);n=n(i!==void 0?i:t.custom,c,u)}return n}function Nr(t,n,i){const a=t.getProps();return Dp(a,n,i!==void 0?i:a.custom,t)}const Ub=new Set(["width","height","top","left","right","bottom",...Cl]),Vy=30,V4=t=>!isNaN(parseFloat(t)),Cc={current:void 0};class Y4{constructor(n,i={}){this.canTrackVelocity=null,this.events={},this.updateAndNotify=a=>{var u;const c=Fo.now();if(this.updatedAt!==c&&this.setPrevFrameValue(),this.prev=this.current,this.setCurrent(a),this.current!==this.prev&&((u=this.events.change)==null||u.notify(this.current),this.dependents))for(const d of this.dependents)d.dirty()},this.hasAnimated=!1,this.setCurrent(n),this.owner=i.owner}setCurrent(n){this.current=n,this.updatedAt=Fo.now(),this.canTrackVelocity===null&&n!==void 0&&(this.canTrackVelocity=V4(this.current))}setPrevFrameValue(n=this.current){this.prevFrameValue=n,this.prevUpdatedAt=this.updatedAt}onChange(n){return this.on("change",n)}on(n,i){this.events[n]||(this.events[n]=new yp);const a=this.events[n].add(i);return n==="change"?()=>{a(),os.read(()=>{this.events.change.getSize()||this.stop()})}:a}clearListeners(){for(const n in this.events)this.events[n].clear()}attach(n,i){this.passiveEffect=n,this.stopPassiveEffect=i}set(n){this.passiveEffect?this.passiveEffect(n,this.updateAndNotify):this.updateAndNotify(n)}setWithVelocity(n,i,a){this.set(i),this.prev=void 0,this.prevFrameValue=n,this.prevUpdatedAt=this.updatedAt-a}jump(n,i=!0){this.updateAndNotify(n),this.prev=n,this.prevUpdatedAt=this.prevFrameValue=void 0,i&&this.stop(),this.stopPassiveEffect&&this.stopPassiveEffect()}dirty(){var n;(n=this.events.change)==null||n.notify(this.current)}addDependent(n){this.dependents||(this.dependents=new Set),this.dependents.add(n)}removeDependent(n){this.dependents&&this.dependents.delete(n)}get(){return Cc.current&&Cc.current.push(this),this.current}getPrevious(){return this.prev}getVelocity(){const n=Fo.now();if(!this.canTrackVelocity||this.prevFrameValue===void 0||n-this.updatedAt>Vy)return 0;const i=Math.min(this.updatedAt-this.prevUpdatedAt,Vy);return tb(parseFloat(this.current)-parseFloat(this.prevFrameValue),i)}start(n){return this.stop(),new Promise(i=>{this.hasAnimated=!0,this.animation=n(i),this.events.animationStart&&this.events.animationStart.notify()}).then(()=>{this.events.animationComplete&&this.events.animationComplete.notify(),this.clearAnimation()})}stop(){this.animation&&(this.animation.stop(),this.events.animationCancel&&this.events.animationCancel.notify()),this.clearAnimation()}isAnimating(){return!!this.animation}clearAnimation(){delete this.animation}destroy(){var n,i;(n=this.dependents)==null||n.clear(),(i=this.events.destroy)==null||i.notify(),this.clearListeners(),this.stop(),this.stopPassiveEffect&&this.stopPassiveEffect()}}function ar(t,n){return new Y4(t,n)}const Vm=t=>Array.isArray(t);function W4(t,n,i){t.hasValue(n)?t.getValue(n).set(i):t.addValue(n,ar(i))}function F4(t){return Vm(t)?t[t.length-1]||0:t}function X4(t,n){const i=Nr(t,n);let{transitionEnd:a={},transition:c={},...u}=i||{};u={...u,...a};for(const d in u){const h=F4(u[d]);W4(t,d,h)}}const mo=t=>!!(t&&t.getVelocity);function G4(t){return!!(mo(t)&&t.add)}function Ym(t,n){const i=t.getValue("willChange");if(G4(i))return i.add(n);if(!i&&ir.WillChange){const a=new ir.WillChange("auto");t.addValue("willChange",a),a.add(n)}}function Np(t){return t.replace(/([A-Z])/g,n=>`-${n.toLowerCase()}`)}const q4="framerAppearId",Vb="data-"+Np(q4);function Yb(t){return t.props[Vb]}function K4({protectedKeys:t,needsAnimating:n},i){const a=t.hasOwnProperty(i)&&n[i]!==!0;return n[i]=!1,a}function Rp(t,n,{delay:i=0,transitionOverride:a,type:c}={}){var v;let{transition:u,transitionEnd:d,...h}=n;const p=t.getDefaultTransition();u=u?Hb(u,p):p;const y=u==null?void 0:u.reduceMotion;a&&(u=a);const g=[],b=c&&t.animationState&&t.animationState.getState()[c];for(const C in h){const k=t.getValue(C,(v=t.latestValues[C])!=null?v:null),j=h[C];if(j===void 0||b&&K4(b,C))continue;const M={delay:i,...Tp(u||{},C)},A=k.get();if(A!==void 0&&!k.isAnimating()&&!Array.isArray(j)&&j===A&&!M.velocity){os.update(()=>k.set(j));continue}let O=!1;if(window.MotionHandoffAnimation){const F=Yb(t);if(F){const H=window.MotionHandoffAnimation(F,C,os);H!==null&&(M.startTime=H,O=!0)}}Ym(t,C);const B=y!=null?y:t.shouldReduceMotion;k.start(Ap(C,k,j,B&&Ub.has(C)?{type:!1}:M,t,O));const T=k.animation;T&&g.push(T)}if(d){const C=()=>os.update(()=>{d&&X4(t,d)});g.length?Promise.all(g).then(C):C()}return g}function Wm(t,n,i={}){var p;const a=Nr(t,n,i.type==="exit"?(p=t.presenceContext)==null?void 0:p.custom:void 0);let{transition:c=t.getDefaultTransition()||{}}=a||{};i.transitionOverride&&(c=i.transitionOverride);const u=a?()=>Promise.all(Rp(t,a,i)):()=>Promise.resolve(),d=t.variantChildren&&t.variantChildren.size?(y=0)=>{const{delayChildren:g=0,staggerChildren:b,staggerDirection:v}=c;return Q4(t,n,y,g,b,v,i)}:()=>Promise.resolve(),{when:h}=c;if(h){const[y,g]=h==="beforeChildren"?[u,d]:[d,u];return y().then(()=>g())}else return Promise.all([u(),d(i.delay)])}function Q4(t,n,i=0,a=0,c=0,u=1,d){const h=[];for(const p of t.variantChildren)p.notify("AnimationStart",n),h.push(Wm(p,n,{...d,delay:i+(typeof a=="function"?0:a)+Ib(t.variantChildren,p,a,c,u)}).then(()=>p.notify("AnimationComplete",n)));return Promise.all(h)}function Z4(t,n,i={}){t.notify("AnimationStart",n);let a;if(Array.isArray(n)){const c=n.map(u=>Wm(t,u,i));a=Promise.all(c)}else if(typeof n=="string")a=Wm(t,n,i);else{const c=typeof n=="function"?Nr(t,n,i.custom):n;a=Promise.all(Rp(t,c,i))}return a.then(()=>{t.notify("AnimationComplete",n)})}const J4={test:t=>t==="auto",parse:t=>t},Wb=t=>n=>n.test(t),Fb=[Sl,Et,ua,tr,MS,jS,J4],Yy=t=>Fb.find(Wb(t));function e6(t){return typeof t=="number"?t===0:t!==null?t==="none"||t==="0"||Jx(t):!0}const t6=new Set(["brightness","contrast","saturate","opacity"]);function n6(t){const[n,i]=t.slice(0,-1).split("(");if(n==="drop-shadow")return t;const[a]=i.match(wp)||[];if(!a)return t;const c=i.replace(a,"");let u=t6.has(n)?1:0;return a!==i&&(u*=100),n+"("+u+c+")"}const s6=/\b([a-z-]*)\(.*?\)/gu,Fm={...Zi,getAnimatableNone:t=>{const n=t.match(s6);return n?n.map(n6).join(" "):t}},Xm={...Zi,getAnimatableNone:t=>{const n=Zi.parse(t);return Zi.createTransformer(t)(n.map(a=>typeof a=="number"?0:typeof a=="object"?{...a,alpha:1}:a))}},Wy={...Sl,transform:Math.round},o6={rotate:tr,rotateX:tr,rotateY:tr,rotateZ:tr,scale:qu,scaleX:qu,scaleY:qu,scaleZ:qu,skew:tr,skewX:tr,skewY:tr,distance:Et,translateX:Et,translateY:Et,translateZ:Et,x:Et,y:Et,z:Et,perspective:Et,transformPerspective:Et,opacity:Tc,originX:Ay,originY:Ay,originZ:Et},Bp={borderWidth:Et,borderTopWidth:Et,borderRightWidth:Et,borderBottomWidth:Et,borderLeftWidth:Et,borderRadius:Et,borderTopLeftRadius:Et,borderTopRightRadius:Et,borderBottomRightRadius:Et,borderBottomLeftRadius:Et,width:Et,maxWidth:Et,height:Et,maxHeight:Et,top:Et,right:Et,bottom:Et,left:Et,inset:Et,insetBlock:Et,insetBlockStart:Et,insetBlockEnd:Et,insetInline:Et,insetInlineStart:Et,insetInlineEnd:Et,padding:Et,paddingTop:Et,paddingRight:Et,paddingBottom:Et,paddingLeft:Et,paddingBlock:Et,paddingBlockStart:Et,paddingBlockEnd:Et,paddingInline:Et,paddingInlineStart:Et,paddingInlineEnd:Et,margin:Et,marginTop:Et,marginRight:Et,marginBottom:Et,marginLeft:Et,marginBlock:Et,marginBlockStart:Et,marginBlockEnd:Et,marginInline:Et,marginInlineStart:Et,marginInlineEnd:Et,fontSize:Et,backgroundPositionX:Et,backgroundPositionY:Et,...o6,zIndex:Wy,fillOpacity:Tc,strokeOpacity:Tc,numOctaves:Wy},i6={...Bp,color:so,backgroundColor:so,outlineColor:so,fill:so,stroke:so,borderColor:so,borderTopColor:so,borderRightColor:so,borderBottomColor:so,borderLeftColor:so,filter:Fm,WebkitFilter:Fm,mask:Xm,WebkitMask:Xm},Xb=t=>i6[t],a6=new Set([Fm,Xm]);function Gb(t,n){let i=Xb(t);return a6.has(i)||(i=Zi),i.getAnimatableNone?i.getAnimatableNone(n):void 0}const r6=new Set(["auto","none","0"]);function l6(t,n,i){let a=0,c;for(;a<t.length&&!c;){const u=t[a];typeof u=="string"&&!r6.has(u)&&xl(u).values.length&&(c=t[a]),a++}if(c&&i)for(const u of n)t[u]=Gb(i,c)}class c6 extends Mp{constructor(n,i,a,c,u){super(n,i,a,c,u,!0)}readKeyframes(){const{unresolvedKeyframes:n,element:i,name:a}=this;if(!i||!i.current)return;super.readKeyframes();for(let g=0;g<n.length;g++){let b=n[g];if(typeof b=="string"&&(b=b.trim(),vp(b))){const v=Pb(b,i.current);v!==void 0&&(n[g]=v),g===n.length-1&&(this.finalKeyframe=b)}}if(this.resolveNoneKeyframes(),!Ub.has(a)||n.length!==2)return;const[c,u]=n,d=Yy(c),h=Yy(u),p=Ty(c),y=Ty(u);if(p!==y&&or[a]){this.needsMeasurement=!0;return}if(d!==h)if($y(d)&&$y(h))for(let g=0;g<n.length;g++){const b=n[g];typeof b=="string"&&(n[g]=parseFloat(b))}else or[a]&&(this.needsMeasurement=!0)}resolveNoneKeyframes(){const{unresolvedKeyframes:n,name:i}=this,a=[];for(let c=0;c<n.length;c++)(n[c]===null||e6(n[c]))&&a.push(c);a.length&&l6(n,a,i)}measureInitialState(){const{element:n,unresolvedKeyframes:i,name:a}=this;if(!n||!n.current)return;a==="height"&&(this.suspendedScrollY=window.pageYOffset),this.measuredOrigin=or[a](n.measureViewportBox(),window.getComputedStyle(n.current)),i[0]=this.measuredOrigin;const c=i[i.length-1];c!==void 0&&n.getValue(a,c).jump(c,!1)}measureEndState(){var h;const{element:n,name:i,unresolvedKeyframes:a}=this;if(!n||!n.current)return;const c=n.getValue(i);c&&c.jump(this.measuredOrigin,!1);const u=a.length-1,d=a[u];a[u]=or[i](n.measureViewportBox(),window.getComputedStyle(n.current)),d!==null&&this.finalKeyframe===void 0&&(this.finalKeyframe=d),(h=this.removedTransforms)!=null&&h.length&&this.removedTransforms.forEach(([p,y])=>{n.getValue(p).set(y)}),this.resolveNoneKeyframes()}}function Lp(t,n,i){var a;if(t==null)return[];if(t instanceof EventTarget)return[t];if(typeof t=="string"){let c=document;n&&(c=n.current);const u=(a=i==null?void 0:i[t])!=null?a:c.querySelectorAll(t);return u?Array.from(u):[]}return Array.from(t).filter(c=>c!=null)}const qb=(t,n)=>n&&typeof t=="number"?n.transform(t):t;function yd(t){return Zx(t)&&"offsetHeight"in t&&!("ownerSVGElement"in t)}const{schedule:Op}=mb(queueMicrotask,!1),Ki={x:!1,y:!1};function Kb(){return Ki.x||Ki.y}function u6(t){return t==="x"||t==="y"?Ki[t]?null:(Ki[t]=!0,()=>{Ki[t]=!1}):Ki.x||Ki.y?null:(Ki.x=Ki.y=!0,()=>{Ki.x=Ki.y=!1})}function Qb(t,n){const i=Lp(t),a=new AbortController,c={passive:!0,...n,signal:a.signal};return[i,c,()=>a.abort()]}function d6(t){return!(t.pointerType==="touch"||Kb())}function f6(t,n,i={}){const[a,c,u]=Qb(t,i);return a.forEach(d=>{let h=!1,p=!1,y;const g=()=>{d.removeEventListener("pointerleave",k)},b=M=>{y&&(y(M),y=void 0),g()},v=M=>{h=!1,window.removeEventListener("pointerup",v),window.removeEventListener("pointercancel",v),p&&(p=!1,b(M))},C=()=>{h=!0,window.addEventListener("pointerup",v,c),window.addEventListener("pointercancel",v,c)},k=M=>{if(M.pointerType!=="touch"){if(h){p=!0;return}b(M)}},j=M=>{if(!d6(M))return;p=!1;const A=n(d,M);typeof A=="function"&&(y=A,d.addEventListener("pointerleave",k,c))};d.addEventListener("pointerenter",j,c),d.addEventListener("pointerdown",C,c)}),u}const Zb=(t,n)=>n?t===n?!0:Zb(t,n.parentElement):!1,zp=t=>t.pointerType==="mouse"?typeof t.button!="number"||t.button<=0:t.isPrimary!==!1,h6=new Set(["BUTTON","INPUT","SELECT","TEXTAREA","A"]);function m6(t){return h6.has(t.tagName)||t.isContentEditable===!0}const p6=new Set(["INPUT","SELECT","TEXTAREA"]);function _6(t){return p6.has(t.tagName)||t.isContentEditable===!0}const xd=new WeakSet;function Fy(t){return n=>{n.key==="Enter"&&t(n)}}function om(t,n){t.dispatchEvent(new PointerEvent("pointer"+n,{isPrimary:!0,bubbles:!0}))}const g6=(t,n)=>{const i=t.currentTarget;if(!i)return;const a=Fy(()=>{if(xd.has(i))return;om(i,"down");const c=Fy(()=>{om(i,"up")}),u=()=>om(i,"cancel");i.addEventListener("keyup",c,n),i.addEventListener("blur",u,n)});i.addEventListener("keydown",a,n),i.addEventListener("blur",()=>i.removeEventListener("keydown",a),n)};function Xy(t){return zp(t)&&!Kb()}const Gy=new WeakSet;function y6(t,n,i={}){const[a,c,u]=Qb(t,i),d=h=>{const p=h.currentTarget;if(!Xy(h)||Gy.has(h))return;xd.add(p),i.stopPropagation&&Gy.add(h);const y=n(p,h),g=(C,k)=>{window.removeEventListener("pointerup",b),window.removeEventListener("pointercancel",v),xd.has(p)&&xd.delete(p),Xy(C)&&typeof y=="function"&&y(C,{success:k})},b=C=>{g(C,p===window||p===document||i.useGlobalTarget||Zb(p,C.target))},v=C=>{g(C,!1)};window.addEventListener("pointerup",b,c),window.addEventListener("pointercancel",v,c)};return a.forEach(h=>{(i.useGlobalTarget?window:h).addEventListener("pointerdown",d,c),yd(h)&&(h.addEventListener("focus",y=>g6(y,c)),!m6(h)&&!h.hasAttribute("tabindex")&&(h.tabIndex=0))}),u}function Ud(t){return Zx(t)&&"ownerSVGElement"in t}const bd=new WeakMap;let nr;const Jb=(t,n,i)=>(a,c)=>c&&c[0]?c[0][t+"Size"]:Ud(a)&&"getBBox"in a?a.getBBox()[n]:a[i],x6=Jb("inline","width","offsetWidth"),b6=Jb("block","height","offsetHeight");function v6({target:t,borderBoxSize:n}){var i;(i=bd.get(t))==null||i.forEach(a=>{a(t,{get width(){return x6(t,n)},get height(){return b6(t,n)}})})}function w6(t){t.forEach(v6)}function S6(){typeof ResizeObserver>"u"||(nr=new ResizeObserver(w6))}function C6(t,n){nr||S6();const i=Lp(t);return i.forEach(a=>{let c=bd.get(a);c||(c=new Set,bd.set(a,c)),c.add(n),nr==null||nr.observe(a)}),()=>{i.forEach(a=>{const c=bd.get(a);c==null||c.delete(n),c!=null&&c.size||nr==null||nr.unobserve(a)})}}const vd=new Set;let hl;function k6(){hl=()=>{const t={get width(){return window.innerWidth},get height(){return window.innerHeight}};vd.forEach(n=>n(t))},window.addEventListener("resize",hl)}function j6(t){return vd.add(t),hl||k6(),()=>{vd.delete(t),!vd.size&&typeof hl=="function"&&(window.removeEventListener("resize",hl),hl=void 0)}}function qy(t,n){return typeof t=="function"?j6(t):C6(t,n)}function e5(t){return Ud(t)&&t.tagName==="svg"}function M6(...t){const n=!Array.isArray(t[0]),i=n?0:-1,a=t[0+i],c=t[1+i],u=t[2+i],d=t[3+i],h=jb(c,u,d);return n?h(a):h}const E6=[...Fb,so,Zi],T6=t=>E6.find(Wb(t)),Ky=()=>({translate:0,scale:1,origin:0,originPoint:0}),ml=()=>({x:Ky(),y:Ky()}),Qy=()=>({min:0,max:0}),no=()=>({x:Qy(),y:Qy()}),Dc=new WeakMap;function Vd(t){return t!==null&&typeof t=="object"&&typeof t.start=="function"}function Nc(t){return typeof t=="string"||Array.isArray(t)}const $p=["animate","whileInView","whileFocus","whileHover","whileTap","whileDrag","exit"],Ip=["initial",...$p];function Yd(t){return Vd(t.animate)||Ip.some(n=>Nc(t[n]))}function t5(t){return!!(Yd(t)||t.variants)}function A6(t,n,i){for(const a in n){const c=n[a],u=i[a];if(mo(c))t.addValue(a,c);else if(mo(u))t.addValue(a,ar(c,{owner:t}));else if(u!==c)if(t.hasValue(a)){const d=t.getValue(a);d.liveStyle===!0?d.jump(c):d.hasAnimated||d.set(c)}else{const d=t.getStaticValue(a);t.addValue(a,ar(d!==void 0?d:c,{owner:t}))}}for(const a in i)n[a]===void 0&&t.removeValue(a);return n}const Gm={current:null},n5={current:!1},D6=typeof window<"u";function N6(){if(n5.current=!0,!!D6)if(window.matchMedia){const t=window.matchMedia("(prefers-reduced-motion)"),n=()=>Gm.current=t.matches;t.addEventListener("change",n),n()}else Gm.current=!1}const Zy=["AnimationStart","AnimationComplete","Update","BeforeLayoutMeasure","LayoutMeasure","LayoutAnimationStart","LayoutAnimationComplete"];let Nd={};function s5(t){Nd=t}function R6(){return Nd}class o5{scrapeMotionValuesFromProps(n,i,a){return{}}constructor({parent:n,props:i,presenceContext:a,reducedMotionConfig:c,skipAnimations:u,blockInitialAnimation:d,visualState:h},p={}){this.current=null,this.children=new Set,this.isVariantNode=!1,this.isControllingVariants=!1,this.shouldReduceMotion=null,this.shouldSkipAnimations=!1,this.values=new Map,this.KeyframeResolver=Mp,this.features={},this.valueSubscriptions=new Map,this.prevMotionValues={},this.hasBeenMounted=!1,this.events={},this.propEventSubscriptions={},this.notifyUpdate=()=>this.notify("Update",this.latestValues),this.render=()=>{this.current&&(this.triggerBuild(),this.renderInstance(this.current,this.renderState,this.props.style,this.projection))},this.renderScheduledAt=0,this.scheduleRender=()=>{const C=Fo.now();this.renderScheduledAt<C&&(this.renderScheduledAt=C,os.render(this.render,!1,!0))};const{latestValues:y,renderState:g}=h;this.latestValues=y,this.baseTarget={...y},this.initialValues=i.initial?{...y}:{},this.renderState=g,this.parent=n,this.props=i,this.presenceContext=a,this.depth=n?n.depth+1:0,this.reducedMotionConfig=c,this.skipAnimationsConfig=u,this.options=p,this.blockInitialAnimation=!!d,this.isControllingVariants=Yd(i),this.isVariantNode=t5(i),this.isVariantNode&&(this.variantChildren=new Set),this.manuallyAnimateOnMount=!!(n&&n.current);const{willChange:b,...v}=this.scrapeMotionValuesFromProps(i,{},this);for(const C in v){const k=v[C];y[C]!==void 0&&mo(k)&&k.set(y[C])}}mount(n){var i,a,c;if(this.hasBeenMounted)for(const u in this.initialValues)(i=this.values.get(u))==null||i.jump(this.initialValues[u]),this.latestValues[u]=this.initialValues[u];this.current=n,Dc.set(n,this),this.projection&&!this.projection.instance&&this.projection.mount(n),this.parent&&this.isVariantNode&&!this.isControllingVariants&&(this.removeFromVariantTree=this.parent.addVariantChild(this)),this.values.forEach((u,d)=>this.bindToMotionValue(d,u)),this.reducedMotionConfig==="never"?this.shouldReduceMotion=!1:this.reducedMotionConfig==="always"?this.shouldReduceMotion=!0:(n5.current||N6(),this.shouldReduceMotion=Gm.current),this.shouldSkipAnimations=(a=this.skipAnimationsConfig)!=null?a:!1,(c=this.parent)==null||c.addChild(this),this.update(this.props,this.presenceContext),this.hasBeenMounted=!0}unmount(){var n;this.projection&&this.projection.unmount(),Da(this.notifyUpdate),Da(this.render),this.valueSubscriptions.forEach(i=>i()),this.valueSubscriptions.clear(),this.removeFromVariantTree&&this.removeFromVariantTree(),(n=this.parent)==null||n.removeChild(this);for(const i in this.events)this.events[i].clear();for(const i in this.features){const a=this.features[i];a&&(a.unmount(),a.isMounted=!1)}this.current=null}addChild(n){var i;this.children.add(n),(i=this.enteringChildren)!=null||(this.enteringChildren=new Set),this.enteringChildren.add(n)}removeChild(n){this.children.delete(n),this.enteringChildren&&this.enteringChildren.delete(n)}bindToMotionValue(n,i){if(this.valueSubscriptions.has(n)&&this.valueSubscriptions.get(n)(),i.accelerate&&$b.has(n)&&this.current instanceof HTMLElement){const{factory:d,keyframes:h,times:p,ease:y,duration:g}=i.accelerate,b=new Ob({element:this.current,name:n,keyframes:h,times:p,ease:y,duration:ai(g)}),v=d(b);this.valueSubscriptions.set(n,()=>{v(),b.cancel()});return}const a=kl.has(n);a&&this.onBindTransform&&this.onBindTransform();const c=i.on("change",d=>{this.latestValues[n]=d,this.props.onUpdate&&os.preRender(this.notifyUpdate),a&&this.projection&&(this.projection.isTransformDirty=!0),this.scheduleRender()});let u;typeof window<"u"&&window.MotionCheckAppearSync&&(u=window.MotionCheckAppearSync(this,n,i)),this.valueSubscriptions.set(n,()=>{c(),u&&u(),i.owner&&i.stop()})}sortNodePosition(n){return!this.current||!this.sortInstanceNodePosition||this.type!==n.type?0:this.sortInstanceNodePosition(this.current,n.current)}updateFeatures(){let n="animation";for(n in Nd){const i=Nd[n];if(!i)continue;const{isEnabled:a,Feature:c}=i;if(!this.features[n]&&c&&a(this.props)&&(this.features[n]=new c(this)),this.features[n]){const u=this.features[n];u.isMounted?u.update():(u.mount(),u.isMounted=!0)}}}triggerBuild(){this.build(this.renderState,this.latestValues,this.props)}measureViewportBox(){return this.current?this.measureInstanceViewportBox(this.current,this.props):no()}getStaticValue(n){return this.latestValues[n]}setStaticValue(n,i){this.latestValues[n]=i}update(n,i){(n.transformTemplate||this.props.transformTemplate)&&this.scheduleRender(),this.prevProps=this.props,this.props=n,this.prevPresenceContext=this.presenceContext,this.presenceContext=i;for(let a=0;a<Zy.length;a++){const c=Zy[a];this.propEventSubscriptions[c]&&(this.propEventSubscriptions[c](),delete this.propEventSubscriptions[c]);const u="on"+c,d=n[u];d&&(this.propEventSubscriptions[c]=this.on(c,d))}this.prevMotionValues=A6(this,this.scrapeMotionValuesFromProps(n,this.prevProps||{},this),this.prevMotionValues),this.handleChildMotionValue&&this.handleChildMotionValue()}getProps(){return this.props}getVariant(n){return this.props.variants?this.props.variants[n]:void 0}getDefaultTransition(){return this.props.transition}getTransformPagePoint(){return this.props.transformPagePoint}getClosestVariantNode(){return this.isVariantNode?this:this.parent?this.parent.getClosestVariantNode():void 0}addVariantChild(n){const i=this.getClosestVariantNode();if(i)return i.variantChildren&&i.variantChildren.add(n),()=>i.variantChildren.delete(n)}addValue(n,i){const a=this.values.get(n);i!==a&&(a&&this.removeValue(n),this.bindToMotionValue(n,i),this.values.set(n,i),this.latestValues[n]=i.get())}removeValue(n){this.values.delete(n);const i=this.valueSubscriptions.get(n);i&&(i(),this.valueSubscriptions.delete(n)),delete this.latestValues[n],this.removeValueFromRenderState(n,this.renderState)}hasValue(n){return this.values.has(n)}getValue(n,i){if(this.props.values&&this.props.values[n])return this.props.values[n];let a=this.values.get(n);return a===void 0&&i!==void 0&&(a=ar(i===null?void 0:i,{owner:this}),this.addValue(n,a)),a}readValue(n,i){var c;let a=this.latestValues[n]!==void 0||!this.current?this.latestValues[n]:(c=this.getBaseTargetFromProps(this.props,n))!=null?c:this.readValueFromInstance(this.current,n,this.options);return a!=null&&(typeof a=="string"&&(Qx(a)||Jx(a))?a=parseFloat(a):!T6(a)&&Zi.test(i)&&(a=Gb(n,i)),this.setBaseTarget(n,mo(a)?a.get():a)),mo(a)?a.get():a}setBaseTarget(n,i){this.baseTarget[n]=i}getBaseTarget(n){var u;const{initial:i}=this.props;let a;if(typeof i=="string"||typeof i=="object"){const d=Dp(this.props,i,(u=this.presenceContext)==null?void 0:u.custom);d&&(a=d[n])}if(i&&a!==void 0)return a;const c=this.getBaseTargetFromProps(this.props,n);return c!==void 0&&!mo(c)?c:this.initialValues[n]!==void 0&&a===void 0?void 0:this.baseTarget[n]}on(n,i){return this.events[n]||(this.events[n]=new yp),this.events[n].add(i)}notify(n,...i){this.events[n]&&this.events[n].notify(...i)}scheduleRenderMicrotask(){Op.render(this.render)}}class i5 extends o5{constructor(){super(...arguments),this.KeyframeResolver=c6}sortInstanceNodePosition(n,i){return n.compareDocumentPosition(i)&2?1:-1}getBaseTargetFromProps(n,i){const a=n.style;return a?a[i]:void 0}removeValueFromRenderState(n,{vars:i,style:a}){delete i[n],delete a[n]}handleChildMotionValue(){this.childSubscription&&(this.childSubscription(),delete this.childSubscription);const{children:n}=this.props;mo(n)&&(this.childSubscription=n.on("change",i=>{this.current&&(this.current.textContent=`${i}`)}))}}class rr{constructor(n){this.isMounted=!1,this.node=n}update(){}}function a5({top:t,left:n,right:i,bottom:a}){return{x:{min:n,max:i},y:{min:t,max:a}}}function B6({x:t,y:n}){return{top:n.min,right:t.max,bottom:n.max,left:t.min}}function L6(t,n){if(!n)return t;const i=n({x:t.left,y:t.top}),a=n({x:t.right,y:t.bottom});return{top:i.y,left:i.x,bottom:a.y,right:a.x}}function im(t){return t===void 0||t===1}function qm({scale:t,scaleX:n,scaleY:i}){return!im(t)||!im(n)||!im(i)}function jr(t){return qm(t)||r5(t)||t.z||t.rotate||t.rotateX||t.rotateY||t.skewX||t.skewY}function r5(t){return Jy(t.x)||Jy(t.y)}function Jy(t){return t&&t!=="0%"}function Rd(t,n,i){const a=t-i,c=n*a;return i+c}function e1(t,n,i,a,c){return c!==void 0&&(t=Rd(t,c,a)),Rd(t,i,a)+n}function Km(t,n=0,i=1,a,c){t.min=e1(t.min,n,i,a,c),t.max=e1(t.max,n,i,a,c)}function l5(t,{x:n,y:i}){Km(t.x,n.translate,n.scale,n.originPoint),Km(t.y,i.translate,i.scale,i.originPoint)}const t1=.999999999999,n1=1.0000000000001;function O6(t,n,i,a=!1){var h;const c=i.length;if(!c)return;n.x=n.y=1;let u,d;for(let p=0;p<c;p++){u=i[p],d=u.projectionDelta;const{visualElement:y}=u.options;y&&y.props.style&&y.props.style.display==="contents"||(a&&u.options.layoutScroll&&u.scroll&&u!==u.root&&(ca(t.x,-u.scroll.offset.x),ca(t.y,-u.scroll.offset.y)),d&&(n.x*=d.x.scale,n.y*=d.y.scale,l5(t,d)),a&&jr(u.latestValues)&&wd(t,u.latestValues,(h=u.layout)==null?void 0:h.layoutBox))}n.x<n1&&n.x>t1&&(n.x=1),n.y<n1&&n.y>t1&&(n.y=1)}function ca(t,n){t.min+=n,t.max+=n}function s1(t,n,i,a,c=.5){const u=ms(t.min,t.max,c);Km(t,n,i,u,a)}function o1(t,n){return typeof t=="string"?parseFloat(t)/100*(n.max-n.min):t}function wd(t,n,i){const a=i!=null?i:t;s1(t.x,o1(n.x,a.x),n.scaleX,n.scale,n.originX),s1(t.y,o1(n.y,a.y),n.scaleY,n.scale,n.originY)}function c5(t,n){return a5(L6(t.getBoundingClientRect(),n))}function z6(t,n,i){const a=c5(t,i),{scroll:c}=n;return c&&(ca(a.x,c.offset.x),ca(a.y,c.offset.y)),a}const $6={x:"translateX",y:"translateY",z:"translateZ",transformPerspective:"perspective"},I6=Cl.length;function P6(t,n,i){let a="",c=!0;for(let u=0;u<I6;u++){const d=Cl[u],h=t[d];if(h===void 0)continue;let p=!0;if(typeof h=="number")p=h===(d.startsWith("scale")?1:0);else{const y=parseFloat(h);p=d.startsWith("scale")?y===1:y===0}if(!p||i){const y=qb(h,Bp[d]);if(!p){c=!1;const g=$6[d]||d;a+=`${g}(${y}) `}i&&(n[d]=y)}}return a=a.trim(),i?a=i(n,c?"":a):c&&(a="none"),a}function Pp(t,n,i){const{style:a,vars:c,transformOrigin:u}=t;let d=!1,h=!1;for(const p in n){const y=n[p];if(kl.has(p)){d=!0;continue}else if(_b(p)){c[p]=y;continue}else{const g=qb(y,Bp[p]);p.startsWith("origin")?(h=!0,u[p]=g):a[p]=g}}if(n.transform||(d||i?a.transform=P6(n,t.transform,i):a.transform&&(a.transform="none")),h){const{originX:p="50%",originY:y="50%",originZ:g=0}=u;a.transformOrigin=`${p} ${y} ${g}`}}function u5(t,{style:n,vars:i},a,c){const u=t.style;let d;for(d in n)u[d]=n[d];c==null||c.applyProjectionStyles(u,a);for(d in i)u.setProperty(d,i[d])}function i1(t,n){return n.max===n.min?0:t/(n.max-n.min)*100}const lc={correct:(t,n)=>{if(!n.target)return t;if(typeof t=="string")if(Et.test(t))t=parseFloat(t);else return t;const i=i1(t,n.target.x),a=i1(t,n.target.y);return`${i}% ${a}%`}},H6={correct:(t,{treeScale:n,projectionDelta:i})=>{const a=t,c=Zi.parse(t);if(c.length>5)return a;const u=Zi.createTransformer(t),d=typeof c[0]!="number"?1:0,h=i.x.scale*n.x,p=i.y.scale*n.y;c[0+d]/=h,c[1+d]/=p;const y=ms(h,p,.5);return typeof c[2+d]=="number"&&(c[2+d]/=y),typeof c[3+d]=="number"&&(c[3+d]/=y),u(c)}},Qm={borderRadius:{...lc,applyTo:["borderTopLeftRadius","borderTopRightRadius","borderBottomLeftRadius","borderBottomRightRadius"]},borderTopLeftRadius:lc,borderTopRightRadius:lc,borderBottomLeftRadius:lc,borderBottomRightRadius:lc,boxShadow:H6};function d5(t,{layout:n,layoutId:i}){return kl.has(t)||t.startsWith("origin")||(n||i!==void 0)&&(!!Qm[t]||t==="opacity")}function Hp(t,n,i){var d;const a=t.style,c=n==null?void 0:n.style,u={};if(!a)return u;for(const h in a)(mo(a[h])||c&&mo(c[h])||d5(h,t)||((d=i==null?void 0:i.getValue(h))==null?void 0:d.liveStyle)!==void 0)&&(u[h]=a[h]);return u}function U6(t){return window.getComputedStyle(t)}class f5 extends i5{constructor(){super(...arguments),this.type="html",this.renderInstance=u5}readValueFromInstance(n,i){var a;if(kl.has(i))return(a=this.projection)!=null&&a.isProjecting?zm(i):c4(n,i);{const c=U6(n),u=(_b(i)?c.getPropertyValue(i):c[i])||0;return typeof u=="string"?u.trim():u}}measureInstanceViewportBox(n,{transformPagePoint:i}){return c5(n,i)}build(n,i,a){Pp(n,i,a.transformTemplate)}scrapeMotionValuesFromProps(n,i,a){return Hp(n,i,a)}}function V6(t,n){return t in n}class Y6 extends o5{constructor(){super(...arguments),this.type="object"}readValueFromInstance(n,i){if(V6(i,n)){const a=n[i];if(typeof a=="string"||typeof a=="number")return a}}getBaseTargetFromProps(){}removeValueFromRenderState(n,i){delete i.output[n]}measureInstanceViewportBox(){return no()}build(n,i){Object.assign(n.output,i)}renderInstance(n,{output:i}){Object.assign(n,i)}sortInstanceNodePosition(){return 0}}const W6={offset:"stroke-dashoffset",array:"stroke-dasharray"},F6={offset:"strokeDashoffset",array:"strokeDasharray"};function X6(t,n,i=1,a=0,c=!0){t.pathLength=1;const u=c?W6:F6;t[u.offset]=`${-a}`,t[u.array]=`${n} ${i}`}const G6=["offsetDistance","offsetPath","offsetRotate","offsetAnchor"];function h5(t,{attrX:n,attrY:i,attrScale:a,pathLength:c,pathSpacing:u=1,pathOffset:d=0,...h},p,y,g){var C,k;if(Pp(t,h,y),p){t.style.viewBox&&(t.attrs.viewBox=t.style.viewBox);return}t.attrs=t.style,t.style={};const{attrs:b,style:v}=t;b.transform&&(v.transform=b.transform,delete b.transform),(v.transform||b.transformOrigin)&&(v.transformOrigin=(C=b.transformOrigin)!=null?C:"50% 50%",delete b.transformOrigin),v.transform&&(v.transformBox=(k=g==null?void 0:g.transformBox)!=null?k:"fill-box",delete b.transformBox);for(const j of G6)b[j]!==void 0&&(v[j]=b[j],delete b[j]);n!==void 0&&(b.x=n),i!==void 0&&(b.y=i),a!==void 0&&(b.scale=a),c!==void 0&&X6(b,c,u,d,!1)}const m5=new Set(["baseFrequency","diffuseConstant","kernelMatrix","kernelUnitLength","keySplines","keyTimes","limitingConeAngle","markerHeight","markerWidth","numOctaves","targetX","targetY","surfaceScale","specularConstant","specularExponent","stdDeviation","tableValues","viewBox","gradientTransform","pathLength","startOffset","textLength","lengthAdjust"]),p5=t=>typeof t=="string"&&t.toLowerCase()==="svg";function q6(t,n,i,a){u5(t,n,void 0,a);for(const c in n.attrs)t.setAttribute(m5.has(c)?c:Np(c),n.attrs[c])}function _5(t,n,i){const a=Hp(t,n,i);for(const c in t)if(mo(t[c])||mo(n[c])){const u=Cl.indexOf(c)!==-1?"attr"+c.charAt(0).toUpperCase()+c.substring(1):c;a[u]=t[c]}return a}class g5 extends i5{constructor(){super(...arguments),this.type="svg",this.isSVGTag=!1,this.measureInstanceViewportBox=no}getBaseTargetFromProps(n,i){return n[i]}readValueFromInstance(n,i){if(kl.has(i)){const a=Xb(i);return a&&a.default||0}return i=m5.has(i)?i:Np(i),n.getAttribute(i)}scrapeMotionValuesFromProps(n,i,a){return _5(n,i,a)}build(n,i,a){h5(n,i,this.isSVGTag,a.transformTemplate,a.style)}renderInstance(n,i,a,c){q6(n,i,a,c)}mount(n){this.isSVGTag=p5(n.tagName),super.mount(n)}}const K6=Ip.length;function y5(t){if(!t)return;if(!t.isControllingVariants){const i=t.parent?y5(t.parent)||{}:{};return t.props.initial!==void 0&&(i.initial=t.props.initial),i}const n={};for(let i=0;i<K6;i++){const a=Ip[i],c=t.props[a];(Nc(c)||c===!1)&&(n[a]=c)}return n}function x5(t,n){if(!Array.isArray(n))return!1;const i=n.length;if(i!==t.length)return!1;for(let a=0;a<i;a++)if(n[a]!==t[a])return!1;return!0}const Q6=[...$p].reverse(),Z6=$p.length;function J6(t){return n=>Promise.all(n.map(({animation:i,options:a})=>Z4(t,i,a)))}function eC(t){let n=J6(t),i=a1(),a=!0,c=!1;const u=y=>(g,b)=>{var C;const v=Nr(t,b,y==="exit"?(C=t.presenceContext)==null?void 0:C.custom:void 0);if(v){const{transition:k,transitionEnd:j,...M}=v;g={...g,...M,...j}}return g};function d(y){n=y(t)}function h(y){const{props:g}=t,b=y5(t.parent)||{},v=[],C=new Set;let k={},j=1/0;for(let A=0;A<Z6;A++){const O=Q6[A],B=i[O],T=g[O]!==void 0?g[O]:b[O],F=Nc(T),H=O===y?B.isActive:null;H===!1&&(j=A);let W=T===b[O]&&T!==g[O]&&F;if(W&&(a||c)&&t.manuallyAnimateOnMount&&(W=!1),B.protectedKeys={...k},!B.isActive&&H===null||!T&&!B.prevProp||Vd(T)||typeof T=="boolean")continue;if(O==="exit"&&B.isActive&&H!==!0){B.prevResolvedValues&&(k={...k,...B.prevResolvedValues});continue}const Q=tC(B.prevProp,T);let me=Q||O===y&&B.isActive&&!W&&F||A>j&&F,se=!1;const ae=Array.isArray(T)?T:[T];let we=ae.reduce(u(O),{});H===!1&&(we={});const{prevResolvedValues:Le={}}=B,Z={...Le,...we},fe=X=>{me=!0,C.has(X)&&(se=!0,C.delete(X)),B.needsAnimating[X]=!0;const ge=t.getValue(X);ge&&(ge.liveStyle=!1)};for(const X in Z){const ge=we[X],Ae=Le[X];if(k.hasOwnProperty(X))continue;let P=!1;Vm(ge)&&Vm(Ae)?P=!x5(ge,Ae):P=ge!==Ae,P?ge!=null?fe(X):C.add(X):ge!==void 0&&C.has(X)?fe(X):B.protectedKeys[X]=!0}B.prevProp=T,B.prevResolvedValues=we,B.isActive&&(k={...k,...we}),(a||c)&&t.blockInitialAnimation&&(me=!1);const $=W&&Q;me&&(!$||se)&&v.push(...ae.map(X=>{const ge={type:O};if(typeof X=="string"&&(a||c)&&!$&&t.manuallyAnimateOnMount&&t.parent){const{parent:Ae}=t,P=Nr(Ae,X);if(Ae.enteringChildren&&P){const{delayChildren:le}=P.transition||{};ge.delay=Ib(Ae.enteringChildren,t,le)}}return{animation:X,options:ge}}))}if(C.size){const A={};if(typeof g.initial!="boolean"){const O=Nr(t,Array.isArray(g.initial)?g.initial[0]:g.initial);O&&O.transition&&(A.transition=O.transition)}C.forEach(O=>{const B=t.getBaseTarget(O),T=t.getValue(O);T&&(T.liveStyle=!0),A[O]=B!=null?B:null}),v.push({animation:A})}let M=!!v.length;return a&&(g.initial===!1||g.initial===g.animate)&&!t.manuallyAnimateOnMount&&(M=!1),a=!1,c=!1,M?n(v):Promise.resolve()}function p(y,g){var v;if(i[y].isActive===g)return Promise.resolve();(v=t.variantChildren)==null||v.forEach(C=>{var k;return(k=C.animationState)==null?void 0:k.setActive(y,g)}),i[y].isActive=g;const b=h(y);for(const C in i)i[C].protectedKeys={};return b}return{animateChanges:h,setActive:p,setAnimateFunction:d,getState:()=>i,reset:()=>{i=a1(),c=!0}}}function tC(t,n){return typeof n=="string"?n!==t:Array.isArray(n)?!x5(n,t):!1}function wr(t=!1){return{isActive:t,protectedKeys:{},needsAnimating:{},prevResolvedValues:{}}}function a1(){return{animate:wr(!0),whileInView:wr(),whileHover:wr(),whileTap:wr(),whileDrag:wr(),whileFocus:wr(),exit:wr()}}function Zm(t,n){t.min=n.min,t.max=n.max}function qi(t,n){Zm(t.x,n.x),Zm(t.y,n.y)}function r1(t,n){t.translate=n.translate,t.scale=n.scale,t.originPoint=n.originPoint,t.origin=n.origin}const b5=1e-4,nC=1-b5,sC=1+b5,v5=.01,oC=0-v5,iC=0+v5;function Xo(t){return t.max-t.min}function aC(t,n,i){return Math.abs(t-n)<=i}function l1(t,n,i,a=.5){t.origin=a,t.originPoint=ms(n.min,n.max,t.origin),t.scale=Xo(i)/Xo(n),t.translate=ms(i.min,i.max,t.origin)-t.originPoint,(t.scale>=nC&&t.scale<=sC||isNaN(t.scale))&&(t.scale=1),(t.translate>=oC&&t.translate<=iC||isNaN(t.translate))&&(t.translate=0)}function kc(t,n,i,a){l1(t.x,n.x,i.x,a?a.originX:void 0),l1(t.y,n.y,i.y,a?a.originY:void 0)}function c1(t,n,i,a=0){const c=a?ms(i.min,i.max,a):i.min;t.min=c+n.min,t.max=t.min+Xo(n)}function rC(t,n,i,a){c1(t.x,n.x,i.x,a==null?void 0:a.x),c1(t.y,n.y,i.y,a==null?void 0:a.y)}function u1(t,n,i,a=0){const c=a?ms(i.min,i.max,a):i.min;t.min=n.min-c,t.max=t.min+Xo(n)}function Bd(t,n,i,a){u1(t.x,n.x,i.x,a==null?void 0:a.x),u1(t.y,n.y,i.y,a==null?void 0:a.y)}function d1(t,n,i,a,c){return t-=n,t=Rd(t,1/i,a),c!==void 0&&(t=Rd(t,1/c,a)),t}function lC(t,n=0,i=1,a=.5,c,u=t,d=t){if(ua.test(n)&&(n=parseFloat(n),n=ms(d.min,d.max,n/100)-d.min),typeof n!="number")return;let h=ms(u.min,u.max,a);t===u&&(h-=n),t.min=d1(t.min,n,i,h,c),t.max=d1(t.max,n,i,h,c)}function f1(t,n,[i,a,c],u,d){lC(t,n[i],n[a],n[c],n.scale,u,d)}const cC=["x","scaleX","originX"],uC=["y","scaleY","originY"];function h1(t,n,i,a){f1(t.x,n,cC,i?i.x:void 0,a?a.x:void 0),f1(t.y,n,uC,i?i.y:void 0,a?a.y:void 0)}function m1(t){return t.translate===0&&t.scale===1}function w5(t){return m1(t.x)&&m1(t.y)}function p1(t,n){return t.min===n.min&&t.max===n.max}function dC(t,n){return p1(t.x,n.x)&&p1(t.y,n.y)}function _1(t,n){return Math.round(t.min)===Math.round(n.min)&&Math.round(t.max)===Math.round(n.max)}function S5(t,n){return _1(t.x,n.x)&&_1(t.y,n.y)}function g1(t){return Xo(t.x)/Xo(t.y)}function y1(t,n){return t.translate===n.translate&&t.scale===n.scale&&t.originPoint===n.originPoint}function la(t){return[t("x"),t("y")]}function fC(t,n,i){let a="";const c=t.x.translate/n.x,u=t.y.translate/n.y,d=(i==null?void 0:i.z)||0;if((c||u||d)&&(a=`translate3d(${c}px, ${u}px, ${d}px) `),(n.x!==1||n.y!==1)&&(a+=`scale(${1/n.x}, ${1/n.y}) `),i){const{transformPerspective:y,rotate:g,rotateX:b,rotateY:v,skewX:C,skewY:k}=i;y&&(a=`perspective(${y}px) ${a}`),g&&(a+=`rotate(${g}deg) `),b&&(a+=`rotateX(${b}deg) `),v&&(a+=`rotateY(${v}deg) `),C&&(a+=`skewX(${C}deg) `),k&&(a+=`skewY(${k}deg) `)}const h=t.x.scale*n.x,p=t.y.scale*n.y;return(h!==1||p!==1)&&(a+=`scale(${h}, ${p})`),a||"none"}const C5=["borderTopLeftRadius","borderTopRightRadius","borderBottomLeftRadius","borderBottomRightRadius"],hC=C5.length,x1=t=>typeof t=="string"?parseFloat(t):t,b1=t=>typeof t=="number"||Et.test(t);function mC(t,n,i,a,c,u){var d,h,p,y;c?(t.opacity=ms(0,(d=i.opacity)!=null?d:1,pC(a)),t.opacityExit=ms((h=n.opacity)!=null?h:1,0,_C(a))):u&&(t.opacity=ms((p=n.opacity)!=null?p:1,(y=i.opacity)!=null?y:1,a));for(let g=0;g<hC;g++){const b=C5[g];let v=v1(n,b),C=v1(i,b);if(v===void 0&&C===void 0)continue;v||(v=0),C||(C=0),v===0||C===0||b1(v)===b1(C)?(t[b]=Math.max(ms(x1(v),x1(C),a),0),(ua.test(C)||ua.test(v))&&(t[b]+="%")):t[b]=C}(n.rotate||i.rotate)&&(t.rotate=ms(n.rotate||0,i.rotate||0,a))}function v1(t,n){return t[n]!==void 0?t[n]:t.borderRadius}const pC=k5(0,.5,lb),_C=k5(.5,.95,Oi);function k5(t,n,i){return a=>a<t?0:a>n?1:i(yl(t,n,a))}function j5(t,n,i){const a=mo(t)?t:ar(t);return a.start(Ap("",a,n,i)),a.animation}function Rc(t,n,i,a={passive:!0}){return t.addEventListener(n,i,a),()=>t.removeEventListener(n,i)}const gC=(t,n)=>t.depth-n.depth;class yC{constructor(){this.children=[],this.isDirty=!1}add(n){_p(this.children,n),this.isDirty=!0}remove(n){gl(this.children,n),this.isDirty=!0}forEach(n){this.isDirty&&this.children.sort(gC),this.isDirty=!1,this.children.forEach(n)}}function xC(t,n){const i=Fo.now(),a=({timestamp:c})=>{const u=c-i;u>=n&&(Da(a),t(u-n))};return os.setup(a,!0),()=>Da(a)}function Sd(t){return mo(t)?t.get():t}class bC{constructor(){this.members=[]}add(n){_p(this.members,n);for(let i=this.members.length-1;i>=0;i--){const a=this.members[i];if(a===n||a===this.lead||a===this.prevLead)continue;const c=a.instance;(!c||c.isConnected===!1)&&!a.snapshot&&(gl(this.members,a),a.unmount())}n.scheduleRender()}remove(n){if(gl(this.members,n),n===this.prevLead&&(this.prevLead=void 0),n===this.lead){const i=this.members[this.members.length-1];i&&this.promote(i)}}relegate(n){var i;for(let a=this.members.indexOf(n)-1;a>=0;a--){const c=this.members[a];if(c.isPresent!==!1&&((i=c.instance)==null?void 0:i.isConnected)!==!1)return this.promote(c),!0}return!1}promote(n,i){var c;const a=this.lead;if(n!==a&&(this.prevLead=a,this.lead=n,n.show(),a)){a.updateSnapshot(),n.scheduleRender();const{layoutDependency:u}=a.options,{layoutDependency:d}=n.options;(u===void 0||u!==d)&&(n.resumeFrom=a,i&&(a.preserveOpacity=!0),a.snapshot&&(n.snapshot=a.snapshot,n.snapshot.latestValues=a.animationValues||a.latestValues),(c=n.root)!=null&&c.isUpdating&&(n.isLayoutDirty=!0)),n.options.crossfade===!1&&a.hide()}}exitAnimationComplete(){this.members.forEach(n=>{var i,a,c,u,d;(a=(i=n.options).onExitComplete)==null||a.call(i),(d=(c=n.resumingFrom)==null?void 0:(u=c.options).onExitComplete)==null||d.call(u)})}scheduleRender(){this.members.forEach(n=>n.instance&&n.scheduleRender(!1))}removeLeadSnapshot(){var n;(n=this.lead)!=null&&n.snapshot&&(this.lead.snapshot=void 0)}}const Cd={hasAnimatedSinceResize:!0,hasEverUpdated:!1},am=["","X","Y","Z"],vC=1e3;let wC=0;function rm(t,n,i,a){const{latestValues:c}=n;c[t]&&(i[t]=c[t],n.setStaticValue(t,0),a&&(a[t]=0))}function M5(t){if(t.hasCheckedOptimisedAppear=!0,t.root===t)return;const{visualElement:n}=t.options;if(!n)return;const i=Yb(n);if(window.MotionHasOptimisedAnimation(i,"transform")){const{layout:c,layoutId:u}=t.options;window.MotionCancelOptimisedAnimation(i,"transform",os,!(c||u))}const{parent:a}=t;a&&!a.hasCheckedOptimisedAppear&&M5(a)}function E5({attachResizeListener:t,defaultParent:n,measureScroll:i,checkIsScrollRoot:a,resetTransform:c}){return class{constructor(d={},h=n==null?void 0:n()){this.id=wC++,this.animationId=0,this.animationCommitId=0,this.children=new Set,this.options={},this.isTreeAnimating=!1,this.isAnimationBlocked=!1,this.isLayoutDirty=!1,this.isProjectionDirty=!1,this.isSharedProjectionDirty=!1,this.isTransformDirty=!1,this.updateManuallyBlocked=!1,this.updateBlockedByResize=!1,this.isUpdating=!1,this.isSVG=!1,this.needsReset=!1,this.shouldResetTransform=!1,this.hasCheckedOptimisedAppear=!1,this.treeScale={x:1,y:1},this.eventHandlers=new Map,this.hasTreeAnimated=!1,this.layoutVersion=0,this.updateScheduled=!1,this.scheduleUpdate=()=>this.update(),this.projectionUpdateScheduled=!1,this.checkUpdateFailed=()=>{this.isUpdating&&(this.isUpdating=!1,this.clearAllSnapshots())},this.updateProjection=()=>{this.projectionUpdateScheduled=!1,this.nodes.forEach(kC),this.nodes.forEach(DC),this.nodes.forEach(NC),this.nodes.forEach(jC)},this.resolvedRelativeTargetAt=0,this.linkedParentVersion=0,this.hasProjected=!1,this.isVisible=!0,this.animationProgress=0,this.sharedNodes=new Map,this.latestValues=d,this.root=h?h.root||h:this,this.path=h?[...h.path,h]:[],this.parent=h,this.depth=h?h.depth+1:0;for(let p=0;p<this.path.length;p++)this.path[p].shouldResetTransform=!0;this.root===this&&(this.nodes=new yC)}addEventListener(d,h){return this.eventHandlers.has(d)||this.eventHandlers.set(d,new yp),this.eventHandlers.get(d).add(h)}notifyListeners(d,...h){const p=this.eventHandlers.get(d);p&&p.notify(...h)}hasListeners(d){return this.eventHandlers.has(d)}mount(d){if(this.instance)return;this.isSVG=Ud(d)&&!e5(d),this.instance=d;const{layoutId:h,layout:p,visualElement:y}=this.options;if(y&&!y.current&&y.mount(d),this.root.nodes.add(this),this.parent&&this.parent.children.add(this),this.root.hasTreeAnimated&&(p||h)&&(this.isLayoutDirty=!0),t){let g,b=0;const v=()=>this.root.updateBlockedByResize=!1;os.read(()=>{b=window.innerWidth}),t(d,()=>{const C=window.innerWidth;C!==b&&(b=C,this.root.updateBlockedByResize=!0,g&&g(),g=xC(v,250),Cd.hasAnimatedSinceResize&&(Cd.hasAnimatedSinceResize=!1,this.nodes.forEach(C1)))})}h&&this.root.registerSharedNode(h,this),this.options.animate!==!1&&y&&(h||p)&&this.addEventListener("didUpdate",({delta:g,hasLayoutChanged:b,hasRelativeLayoutChanged:v,layout:C})=>{if(this.isTreeAnimationBlocked()){this.target=void 0,this.relativeTarget=void 0;return}const k=this.options.transition||y.getDefaultTransition()||zC,{onLayoutAnimationStart:j,onLayoutAnimationComplete:M}=y.getProps(),A=!this.targetLayout||!S5(this.targetLayout,C),O=!b&&v;if(this.options.layoutRoot||this.resumeFrom||O||b&&(A||!this.currentAnimation)){this.resumeFrom&&(this.resumingFrom=this.resumeFrom,this.resumingFrom.resumingFrom=void 0);const B={...Tp(k,"layout"),onPlay:j,onComplete:M};(y.shouldReduceMotion||this.options.layoutRoot)&&(B.delay=0,B.type=!1),this.startAnimation(B),this.setAnimationOrigin(g,O)}else b||C1(this),this.isLead()&&this.options.onExitComplete&&this.options.onExitComplete();this.targetLayout=C})}unmount(){this.options.layoutId&&this.willUpdate(),this.root.nodes.remove(this);const d=this.getStack();d&&d.remove(this),this.parent&&this.parent.children.delete(this),this.instance=void 0,this.eventHandlers.clear(),Da(this.updateProjection)}blockUpdate(){this.updateManuallyBlocked=!0}unblockUpdate(){this.updateManuallyBlocked=!1}isUpdateBlocked(){return this.updateManuallyBlocked||this.updateBlockedByResize}isTreeAnimationBlocked(){return this.isAnimationBlocked||this.parent&&this.parent.isTreeAnimationBlocked()||!1}startUpdate(){this.isUpdateBlocked()||(this.isUpdating=!0,this.nodes&&this.nodes.forEach(RC),this.animationId++)}getTransformTemplate(){const{visualElement:d}=this.options;return d&&d.getProps().transformTemplate}willUpdate(d=!0){if(this.root.hasTreeAnimated=!0,this.root.isUpdateBlocked()){this.options.onExitComplete&&this.options.onExitComplete();return}if(window.MotionCancelOptimisedAnimation&&!this.hasCheckedOptimisedAppear&&M5(this),!this.root.isUpdating&&this.root.startUpdate(),this.isLayoutDirty)return;this.isLayoutDirty=!0;for(let g=0;g<this.path.length;g++){const b=this.path[g];b.shouldResetTransform=!0,(typeof b.latestValues.x=="string"||typeof b.latestValues.y=="string")&&(b.isLayoutDirty=!0),b.updateScroll("snapshot"),b.options.layoutRoot&&b.willUpdate(!1)}const{layoutId:h,layout:p}=this.options;if(h===void 0&&!p)return;const y=this.getTransformTemplate();this.prevTransformTemplateValue=y?y(this.latestValues,""):void 0,this.updateSnapshot(),d&&this.notifyListeners("willUpdate")}update(){if(this.updateScheduled=!1,this.isUpdateBlocked()){const p=this.updateBlockedByResize;this.unblockUpdate(),this.updateBlockedByResize=!1,this.clearAllSnapshots(),p&&this.nodes.forEach(EC),this.nodes.forEach(w1);return}if(this.animationId<=this.animationCommitId){this.nodes.forEach(S1);return}this.animationCommitId=this.animationId,this.isUpdating?(this.isUpdating=!1,this.nodes.forEach(TC),this.nodes.forEach(AC),this.nodes.forEach(SC),this.nodes.forEach(CC)):this.nodes.forEach(S1),this.clearAllSnapshots();const h=Fo.now();No.delta=da(0,1e3/60,h-No.timestamp),No.timestamp=h,No.isProcessing=!0,Zh.update.process(No),Zh.preRender.process(No),Zh.render.process(No),No.isProcessing=!1}didUpdate(){this.updateScheduled||(this.updateScheduled=!0,Op.read(this.scheduleUpdate))}clearAllSnapshots(){this.nodes.forEach(MC),this.sharedNodes.forEach(BC)}scheduleUpdateProjection(){this.projectionUpdateScheduled||(this.projectionUpdateScheduled=!0,os.preRender(this.updateProjection,!1,!0))}scheduleCheckAfterUnmount(){os.postRender(()=>{this.isLayoutDirty?this.root.didUpdate():this.root.checkUpdateFailed()})}updateSnapshot(){this.snapshot||!this.instance||(this.snapshot=this.measure(),this.snapshot&&!Xo(this.snapshot.measuredBox.x)&&!Xo(this.snapshot.measuredBox.y)&&(this.snapshot=void 0))}updateLayout(){if(!this.instance||(this.updateScroll(),!(this.options.alwaysMeasureLayout&&this.isLead())&&!this.isLayoutDirty))return;if(this.resumeFrom&&!this.resumeFrom.instance)for(let p=0;p<this.path.length;p++)this.path[p].updateScroll();const d=this.layout;this.layout=this.measure(!1),this.layoutVersion++,this.layoutCorrected||(this.layoutCorrected=no()),this.isLayoutDirty=!1,this.projectionDelta=void 0,this.notifyListeners("measure",this.layout.layoutBox);const{visualElement:h}=this.options;h&&h.notify("LayoutMeasure",this.layout.layoutBox,d?d.layoutBox:void 0)}updateScroll(d="measure"){let h=!!(this.options.layoutScroll&&this.instance);if(this.scroll&&this.scroll.animationId===this.root.animationId&&this.scroll.phase===d&&(h=!1),h&&this.instance){const p=a(this.instance);this.scroll={animationId:this.root.animationId,phase:d,isRoot:p,offset:i(this.instance),wasRoot:this.scroll?this.scroll.isRoot:p}}}resetTransform(){if(!c)return;const d=this.isLayoutDirty||this.shouldResetTransform||this.options.alwaysMeasureLayout,h=this.projectionDelta&&!w5(this.projectionDelta),p=this.getTransformTemplate(),y=p?p(this.latestValues,""):void 0,g=y!==this.prevTransformTemplateValue;d&&this.instance&&(h||jr(this.latestValues)||g)&&(c(this.instance,y),this.shouldResetTransform=!1,this.scheduleRender())}measure(d=!0){const h=this.measurePageBox();let p=this.removeElementScroll(h);return d&&(p=this.removeTransform(p)),$C(p),{animationId:this.root.animationId,measuredBox:h,layoutBox:p,latestValues:{},source:this.id}}measurePageBox(){var y;const{visualElement:d}=this.options;if(!d)return no();const h=d.measureViewportBox();if(!(((y=this.scroll)==null?void 0:y.wasRoot)||this.path.some(IC))){const{scroll:g}=this.root;g&&(ca(h.x,g.offset.x),ca(h.y,g.offset.y))}return h}removeElementScroll(d){var p;const h=no();if(qi(h,d),(p=this.scroll)!=null&&p.wasRoot)return h;for(let y=0;y<this.path.length;y++){const g=this.path[y],{scroll:b,options:v}=g;g!==this.root&&b&&v.layoutScroll&&(b.wasRoot&&qi(h,d),ca(h.x,b.offset.x),ca(h.y,b.offset.y))}return h}applyTransform(d,h=!1,p){var g,b;const y=p||no();qi(y,d);for(let v=0;v<this.path.length;v++){const C=this.path[v];!h&&C.options.layoutScroll&&C.scroll&&C!==C.root&&(ca(y.x,-C.scroll.offset.x),ca(y.y,-C.scroll.offset.y)),jr(C.latestValues)&&wd(y,C.latestValues,(g=C.layout)==null?void 0:g.layoutBox)}return jr(this.latestValues)&&wd(y,this.latestValues,(b=this.layout)==null?void 0:b.layoutBox),y}removeTransform(d){var p;const h=no();qi(h,d);for(let y=0;y<this.path.length;y++){const g=this.path[y];if(!jr(g.latestValues))continue;let b;g.instance&&(qm(g.latestValues)&&g.updateSnapshot(),b=no(),qi(b,g.measurePageBox())),h1(h,g.latestValues,(p=g.snapshot)==null?void 0:p.layoutBox,b)}return jr(this.latestValues)&&h1(h,this.latestValues),h}setTargetDelta(d){this.targetDelta=d,this.root.scheduleUpdateProjection(),this.isProjectionDirty=!0}setOptions(d){this.options={...this.options,...d,crossfade:d.crossfade!==void 0?d.crossfade:!0}}clearMeasurements(){this.scroll=void 0,this.layout=void 0,this.snapshot=void 0,this.prevTransformTemplateValue=void 0,this.targetDelta=void 0,this.target=void 0,this.isLayoutDirty=!1}forceRelativeParentToResolveTarget(){this.relativeParent&&this.relativeParent.resolvedRelativeTargetAt!==No.timestamp&&this.relativeParent.resolveTargetDelta(!0)}resolveTargetDelta(d=!1){var C;const h=this.getLead();this.isProjectionDirty||(this.isProjectionDirty=h.isProjectionDirty),this.isTransformDirty||(this.isTransformDirty=h.isTransformDirty),this.isSharedProjectionDirty||(this.isSharedProjectionDirty=h.isSharedProjectionDirty);const p=!!this.resumingFrom||this!==h;if(!(d||p&&this.isSharedProjectionDirty||this.isProjectionDirty||(C=this.parent)!=null&&C.isProjectionDirty||this.attemptToResolveRelativeTarget||this.root.updateBlockedByResize))return;const{layout:g,layoutId:b}=this.options;if(!this.layout||!(g||b))return;this.resolvedRelativeTargetAt=No.timestamp;const v=this.getClosestProjectingParent();v&&this.linkedParentVersion!==v.layoutVersion&&!v.options.layoutRoot&&this.removeRelativeTarget(),!this.targetDelta&&!this.relativeTarget&&(this.options.layoutAnchor!==!1&&v&&v.layout?this.createRelativeTarget(v,this.layout.layoutBox,v.layout.layoutBox):this.removeRelativeTarget()),!(!this.relativeTarget&&!this.targetDelta)&&(this.target||(this.target=no(),this.targetWithTransforms=no()),this.relativeTarget&&this.relativeTargetOrigin&&this.relativeParent&&this.relativeParent.target?(this.forceRelativeParentToResolveTarget(),rC(this.target,this.relativeTarget,this.relativeParent.target,this.options.layoutAnchor||void 0)):this.targetDelta?(this.resumingFrom?this.applyTransform(this.layout.layoutBox,!1,this.target):qi(this.target,this.layout.layoutBox),l5(this.target,this.targetDelta)):qi(this.target,this.layout.layoutBox),this.attemptToResolveRelativeTarget&&(this.attemptToResolveRelativeTarget=!1,this.options.layoutAnchor!==!1&&v&&!!v.resumingFrom==!!this.resumingFrom&&!v.options.layoutScroll&&v.target&&this.animationProgress!==1?this.createRelativeTarget(v,this.target,v.target):this.relativeParent=this.relativeTarget=void 0))}getClosestProjectingParent(){if(!(!this.parent||qm(this.parent.latestValues)||r5(this.parent.latestValues)))return this.parent.isProjecting()?this.parent:this.parent.getClosestProjectingParent()}isProjecting(){return!!((this.relativeTarget||this.targetDelta||this.options.layoutRoot)&&this.layout)}createRelativeTarget(d,h,p){this.relativeParent=d,this.linkedParentVersion=d.layoutVersion,this.forceRelativeParentToResolveTarget(),this.relativeTarget=no(),this.relativeTargetOrigin=no(),Bd(this.relativeTargetOrigin,h,p,this.options.layoutAnchor||void 0),qi(this.relativeTarget,this.relativeTargetOrigin)}removeRelativeTarget(){this.relativeParent=this.relativeTarget=void 0}calcProjection(){var k;const d=this.getLead(),h=!!this.resumingFrom||this!==d;let p=!0;if((this.isProjectionDirty||(k=this.parent)!=null&&k.isProjectionDirty)&&(p=!1),h&&(this.isSharedProjectionDirty||this.isTransformDirty)&&(p=!1),this.resolvedRelativeTargetAt===No.timestamp&&(p=!1),p)return;const{layout:y,layoutId:g}=this.options;if(this.isTreeAnimating=!!(this.parent&&this.parent.isTreeAnimating||this.currentAnimation||this.pendingAnimation),this.isTreeAnimating||(this.targetDelta=this.relativeTarget=void 0),!this.layout||!(y||g))return;qi(this.layoutCorrected,this.layout.layoutBox);const b=this.treeScale.x,v=this.treeScale.y;O6(this.layoutCorrected,this.treeScale,this.path,h),d.layout&&!d.target&&(this.treeScale.x!==1||this.treeScale.y!==1)&&(d.target=d.layout.layoutBox,d.targetWithTransforms=no());const{target:C}=d;if(!C){this.prevProjectionDelta&&(this.createProjectionDeltas(),this.scheduleRender());return}!this.projectionDelta||!this.prevProjectionDelta?this.createProjectionDeltas():(r1(this.prevProjectionDelta.x,this.projectionDelta.x),r1(this.prevProjectionDelta.y,this.projectionDelta.y)),kc(this.projectionDelta,this.layoutCorrected,C,this.latestValues),(this.treeScale.x!==b||this.treeScale.y!==v||!y1(this.projectionDelta.x,this.prevProjectionDelta.x)||!y1(this.projectionDelta.y,this.prevProjectionDelta.y))&&(this.hasProjected=!0,this.scheduleRender(),this.notifyListeners("projectionUpdate",C))}hide(){this.isVisible=!1}show(){this.isVisible=!0}scheduleRender(d=!0){var h;if((h=this.options.visualElement)==null||h.scheduleRender(),d){const p=this.getStack();p&&p.scheduleRender()}this.resumingFrom&&!this.resumingFrom.instance&&(this.resumingFrom=void 0)}createProjectionDeltas(){this.prevProjectionDelta=ml(),this.projectionDelta=ml(),this.projectionDeltaWithTransform=ml()}setAnimationOrigin(d,h=!1){const p=this.snapshot,y=p?p.latestValues:{},g={...this.latestValues},b=ml();(!this.relativeParent||!this.relativeParent.options.layoutRoot)&&(this.relativeTarget=this.relativeTargetOrigin=void 0),this.attemptToResolveRelativeTarget=!h;const v=no(),C=p?p.source:void 0,k=this.layout?this.layout.source:void 0,j=C!==k,M=this.getStack(),A=!M||M.members.length<=1,O=!!(j&&!A&&this.options.crossfade===!0&&!this.path.some(OC));this.animationProgress=0;let B;this.mixTargetDelta=T=>{const F=T/1e3;k1(b.x,d.x,F),k1(b.y,d.y,F),this.setTargetDelta(b),this.relativeTarget&&this.relativeTargetOrigin&&this.layout&&this.relativeParent&&this.relativeParent.layout&&(Bd(v,this.layout.layoutBox,this.relativeParent.layout.layoutBox,this.options.layoutAnchor||void 0),LC(this.relativeTarget,this.relativeTargetOrigin,v,F),B&&dC(this.relativeTarget,B)&&(this.isProjectionDirty=!1),B||(B=no()),qi(B,this.relativeTarget)),j&&(this.animationValues=g,mC(g,y,this.latestValues,F,O,A)),this.root.scheduleUpdateProjection(),this.scheduleRender(),this.animationProgress=F},this.mixTargetDelta(this.options.layoutRoot?1e3:0)}startAnimation(d){var h,p,y;this.notifyListeners("animationStart"),(h=this.currentAnimation)==null||h.stop(),(y=(p=this.resumingFrom)==null?void 0:p.currentAnimation)==null||y.stop(),this.pendingAnimation&&(Da(this.pendingAnimation),this.pendingAnimation=void 0),this.pendingAnimation=os.update(()=>{Cd.hasAnimatedSinceResize=!0,this.motionValue||(this.motionValue=ar(0)),this.motionValue.jump(0,!1),this.currentAnimation=j5(this.motionValue,[0,1e3],{...d,velocity:0,isSync:!0,onUpdate:g=>{this.mixTargetDelta(g),d.onUpdate&&d.onUpdate(g)},onStop:()=>{},onComplete:()=>{d.onComplete&&d.onComplete(),this.completeAnimation()}}),this.resumingFrom&&(this.resumingFrom.currentAnimation=this.currentAnimation),this.pendingAnimation=void 0})}completeAnimation(){this.resumingFrom&&(this.resumingFrom.currentAnimation=void 0,this.resumingFrom.preserveOpacity=void 0);const d=this.getStack();d&&d.exitAnimationComplete(),this.resumingFrom=this.currentAnimation=this.animationValues=void 0,this.notifyListeners("animationComplete")}finishAnimation(){this.currentAnimation&&(this.mixTargetDelta&&this.mixTargetDelta(vC),this.currentAnimation.stop()),this.completeAnimation()}applyTransformsToTarget(){const d=this.getLead();let{targetWithTransforms:h,target:p,layout:y,latestValues:g}=d;if(!(!h||!p||!y)){if(this!==d&&this.layout&&y&&T5(this.options.animationType,this.layout.layoutBox,y.layoutBox)){p=this.target||no();const b=Xo(this.layout.layoutBox.x);p.x.min=d.target.x.min,p.x.max=p.x.min+b;const v=Xo(this.layout.layoutBox.y);p.y.min=d.target.y.min,p.y.max=p.y.min+v}qi(h,p),wd(h,g),kc(this.projectionDeltaWithTransform,this.layoutCorrected,h,g)}}registerSharedNode(d,h){this.sharedNodes.has(d)||this.sharedNodes.set(d,new bC),this.sharedNodes.get(d).add(h);const y=h.options.initialPromotionConfig;h.promote({transition:y?y.transition:void 0,preserveFollowOpacity:y&&y.shouldPreserveFollowOpacity?y.shouldPreserveFollowOpacity(h):void 0})}isLead(){const d=this.getStack();return d?d.lead===this:!0}getLead(){var h;const{layoutId:d}=this.options;return d?((h=this.getStack())==null?void 0:h.lead)||this:this}getPrevLead(){var h;const{layoutId:d}=this.options;return d?(h=this.getStack())==null?void 0:h.prevLead:void 0}getStack(){const{layoutId:d}=this.options;if(d)return this.root.sharedNodes.get(d)}promote({needsReset:d,transition:h,preserveFollowOpacity:p}={}){const y=this.getStack();y&&y.promote(this,p),d&&(this.projectionDelta=void 0,this.needsReset=!0),h&&this.setOptions({transition:h})}relegate(){const d=this.getStack();return d?d.relegate(this):!1}resetSkewAndRotation(){const{visualElement:d}=this.options;if(!d)return;let h=!1;const{latestValues:p}=d;if((p.z||p.rotate||p.rotateX||p.rotateY||p.rotateZ||p.skewX||p.skewY)&&(h=!0),!h)return;const y={};p.z&&rm("z",d,y,this.animationValues);for(let g=0;g<am.length;g++)rm(`rotate${am[g]}`,d,y,this.animationValues),rm(`skew${am[g]}`,d,y,this.animationValues);d.render();for(const g in y)d.setStaticValue(g,y[g]),this.animationValues&&(this.animationValues[g]=y[g]);d.scheduleRender()}applyProjectionStyles(d,h){var k,j;if(!this.instance||this.isSVG)return;if(!this.isVisible){d.visibility="hidden";return}const p=this.getTransformTemplate();if(this.needsReset){this.needsReset=!1,d.visibility="",d.opacity="",d.pointerEvents=Sd(h==null?void 0:h.pointerEvents)||"",d.transform=p?p(this.latestValues,""):"none";return}const y=this.getLead();if(!this.projectionDelta||!this.layout||!y.target){this.options.layoutId&&(d.opacity=this.latestValues.opacity!==void 0?this.latestValues.opacity:1,d.pointerEvents=Sd(h==null?void 0:h.pointerEvents)||""),this.hasProjected&&!jr(this.latestValues)&&(d.transform=p?p({},""):"none",this.hasProjected=!1);return}d.visibility="";const g=y.animationValues||y.latestValues;this.applyTransformsToTarget();let b=fC(this.projectionDeltaWithTransform,this.treeScale,g);p&&(b=p(g,b)),d.transform=b;const{x:v,y:C}=this.projectionDelta;d.transformOrigin=`${v.origin*100}% ${C.origin*100}% 0`,y.animationValues?d.opacity=y===this?(j=(k=g.opacity)!=null?k:this.latestValues.opacity)!=null?j:1:this.preserveOpacity?this.latestValues.opacity:g.opacityExit:d.opacity=y===this?g.opacity!==void 0?g.opacity:"":g.opacityExit!==void 0?g.opacityExit:0;for(const M in Qm){if(g[M]===void 0)continue;const{correct:A,applyTo:O,isCSSVariable:B}=Qm[M],T=b==="none"?g[M]:A(g[M],y);if(O){const F=O.length;for(let H=0;H<F;H++)d[O[H]]=T}else B?this.options.visualElement.renderState.vars[M]=T:d[M]=T}this.options.layoutId&&(d.pointerEvents=y===this?Sd(h==null?void 0:h.pointerEvents)||"":"none")}clearSnapshot(){this.resumeFrom=this.snapshot=void 0}resetTree(){this.root.nodes.forEach(d=>{var h;return(h=d.currentAnimation)==null?void 0:h.stop()}),this.root.nodes.forEach(w1),this.root.sharedNodes.clear()}}}function SC(t){t.updateLayout()}function CC(t){var i;const n=((i=t.resumeFrom)==null?void 0:i.snapshot)||t.snapshot;if(t.isLead()&&t.layout&&n&&t.hasListeners("didUpdate")){const{layoutBox:a,measuredBox:c}=t.layout,{animationType:u}=t.options,d=n.source!==t.layout.source;if(u==="size")la(b=>{const v=d?n.measuredBox[b]:n.layoutBox[b],C=Xo(v);v.min=a[b].min,v.max=v.min+C});else if(u==="x"||u==="y"){const b=u==="x"?"y":"x";Zm(d?n.measuredBox[b]:n.layoutBox[b],a[b])}else T5(u,n.layoutBox,a)&&la(b=>{const v=d?n.measuredBox[b]:n.layoutBox[b],C=Xo(a[b]);v.max=v.min+C,t.relativeTarget&&!t.currentAnimation&&(t.isProjectionDirty=!0,t.relativeTarget[b].max=t.relativeTarget[b].min+C)});const h=ml();kc(h,a,n.layoutBox);const p=ml();d?kc(p,t.applyTransform(c,!0),n.measuredBox):kc(p,a,n.layoutBox);const y=!w5(h);let g=!1;if(!t.resumeFrom){const b=t.getClosestProjectingParent();if(b&&!b.resumeFrom){const{snapshot:v,layout:C}=b;if(v&&C){const k=t.options.layoutAnchor||void 0,j=no();Bd(j,n.layoutBox,v.layoutBox,k);const M=no();Bd(M,a,C.layoutBox,k),S5(j,M)||(g=!0),b.options.layoutRoot&&(t.relativeTarget=M,t.relativeTargetOrigin=j,t.relativeParent=b)}}}t.notifyListeners("didUpdate",{layout:a,snapshot:n,delta:p,layoutDelta:h,hasLayoutChanged:y,hasRelativeLayoutChanged:g})}else if(t.isLead()){const{onExitComplete:a}=t.options;a&&a()}t.options.transition=void 0}function kC(t){t.parent&&(t.isProjecting()||(t.isProjectionDirty=t.parent.isProjectionDirty),t.isSharedProjectionDirty||(t.isSharedProjectionDirty=!!(t.isProjectionDirty||t.parent.isProjectionDirty||t.parent.isSharedProjectionDirty)),t.isTransformDirty||(t.isTransformDirty=t.parent.isTransformDirty))}function jC(t){t.isProjectionDirty=t.isSharedProjectionDirty=t.isTransformDirty=!1}function MC(t){t.clearSnapshot()}function w1(t){t.clearMeasurements()}function EC(t){t.isLayoutDirty=!0,t.updateLayout()}function S1(t){t.isLayoutDirty=!1}function TC(t){t.isAnimationBlocked&&t.layout&&!t.isLayoutDirty&&(t.snapshot=t.layout,t.isLayoutDirty=!0)}function AC(t){const{visualElement:n}=t.options;n&&n.getProps().onBeforeLayoutMeasure&&n.notify("BeforeLayoutMeasure"),t.resetTransform()}function C1(t){t.finishAnimation(),t.targetDelta=t.relativeTarget=t.target=void 0,t.isProjectionDirty=!0}function DC(t){t.resolveTargetDelta()}function NC(t){t.calcProjection()}function RC(t){t.resetSkewAndRotation()}function BC(t){t.removeLeadSnapshot()}function k1(t,n,i){t.translate=ms(n.translate,0,i),t.scale=ms(n.scale,1,i),t.origin=n.origin,t.originPoint=n.originPoint}function j1(t,n,i,a){t.min=ms(n.min,i.min,a),t.max=ms(n.max,i.max,a)}function LC(t,n,i,a){j1(t.x,n.x,i.x,a),j1(t.y,n.y,i.y,a)}function OC(t){return t.animationValues&&t.animationValues.opacityExit!==void 0}const zC={duration:.45,ease:[.4,0,.1,1]},M1=t=>typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().includes(t),E1=M1("applewebkit/")&&!M1("chrome/")?Math.round:Oi;function T1(t){t.min=E1(t.min),t.max=E1(t.max)}function $C(t){T1(t.x),T1(t.y)}function T5(t,n,i){return t==="position"||t==="preserve-aspect"&&!aC(g1(n),g1(i),.2)}function IC(t){var n;return t!==t.root&&((n=t.scroll)==null?void 0:n.wasRoot)}const PC=E5({attachResizeListener:(t,n)=>Rc(t,"resize",n),measureScroll:()=>{var t,n;return{x:document.documentElement.scrollLeft||((t=document.body)==null?void 0:t.scrollLeft)||0,y:document.documentElement.scrollTop||((n=document.body)==null?void 0:n.scrollTop)||0}},checkIsScrollRoot:()=>!0}),lm={current:void 0},A5=E5({measureScroll:t=>({x:t.scrollLeft,y:t.scrollTop}),defaultParent:()=>{if(!lm.current){const t=new PC({});t.mount(window),t.setOptions({layoutScroll:!0}),lm.current=t}return lm.current},resetTransform:(t,n)=>{t.style.transform=n!==void 0?n:"none"},checkIsScrollRoot:t=>window.getComputedStyle(t).position==="fixed"}),Wd=_.createContext({transformPagePoint:t=>t,isStatic:!1,reducedMotion:"never"});function A1(t,n){if(typeof t=="function")return t(n);t!=null&&(t.current=n)}function HC(...t){return n=>{let i=!1;const a=t.map(c=>{const u=A1(c,n);return!i&&typeof u=="function"&&(i=!0),u});if(i)return()=>{for(let c=0;c<a.length;c++){const u=a[c];typeof u=="function"?u():A1(t[c],null)}}}}function UC(...t){return _.useCallback(HC(...t),t)}class VC extends _.Component{getSnapshotBeforeUpdate(n){const i=this.props.childRef.current;if(yd(i)&&n.isPresent&&!this.props.isPresent&&this.props.pop!==!1){const a=i.offsetParent,c=yd(a)&&a.offsetWidth||0,u=yd(a)&&a.offsetHeight||0,d=getComputedStyle(i),h=this.props.sizeRef.current;h.height=parseFloat(d.height),h.width=parseFloat(d.width),h.top=i.offsetTop,h.left=i.offsetLeft,h.right=c-h.width-h.left,h.bottom=u-h.height-h.top}return null}componentDidUpdate(){}render(){return this.props.children}}function YC({children:t,isPresent:n,anchorX:i,anchorY:a,root:c,pop:u}){var v,C;const d=_.useId(),h=_.useRef(null),p=_.useRef({width:0,height:0,top:0,left:0,right:0,bottom:0}),{nonce:y}=_.useContext(Wd),g=(C=(v=t.props)==null?void 0:v.ref)!=null?C:t==null?void 0:t.ref,b=UC(h,g);return _.useInsertionEffect(()=>{const{width:k,height:j,top:M,left:A,right:O,bottom:B}=p.current;if(n||u===!1||!h.current||!k||!j)return;const T=i==="left"?`left: ${A}`:`right: ${O}`,F=a==="bottom"?`bottom: ${B}`:`top: ${M}`;h.current.dataset.motionPopId=d;const H=document.createElement("style");y&&(H.nonce=y);const W=c!=null?c:document.head;return W.appendChild(H),H.sheet&&H.sheet.insertRule(`
        ...
        `),()=>{var Q;(Q=h.current)==null||Q.removeAttribute("data-motion-pop-id"),W.contains(H)&&W.removeChild(H)}},[n]),l.jsx(VC,{isPresent:n,childRef:h,sizeRef:p,pop:u,children:u===!1?t:_.cloneElement(t,{ref:b})})}const WC=({children:t,initial:n,isPresent:i,onExitComplete:a,custom:c,presenceAffectsLayout:u,mode:d,anchorX:h,anchorY:p,root:y})=>{const g=Lc(FC),b=_.useId();let v=!0,C=_.useMemo(()=>(v=!1,{id:b,initial:n,isPresent:i,custom:c,onExitComplete:k=>{g.set(k,!0);for(const j of g.values())if(!j)return;a&&a()},register:k=>(g.set(k,!1),()=>g.delete(k))}),[i,g,a]);return u&&v&&(C={...C}),_.useMemo(()=>{g.forEach((k,j)=>g.set(j,!1))},[i]),_.useEffect(()=>{!i&&!g.size&&a&&a()},[i]),t=l.jsx(YC,{pop:d==="popLayout",isPresent:i,anchorX:h,anchorY:p,root:y,children:t}),l.jsx(Pd.Provider,{value:C,children:t})};function FC(){return new Map}function D5(t=!0){const n=_.useContext(Pd);if(n===null)return[!0,null];const{isPresent:i,onExitComplete:a,register:c}=n,u=_.useId();_.useEffect(()=>{if(t)return c(u)},[t]);const d=_.useCallback(()=>t&&a&&a(u),[u,a,t]);return!i&&a?[!1,d]:[!0]}const Ku=t=>t.key||"";function D1(t){const n=[];return _.Children.forEach(t,i=>{_.isValidElement(i)&&n.push(i)}),n}const Fd=({children:t,custom:n,initial:i=!0,onExitComplete:a,presenceAffectsLayout:c=!0,mode:u="sync",propagate:d=!1,anchorX:h="left",anchorY:p="top",root:y})=>{const[g,b]=D5(d),v=_.useMemo(()=>D1(t),[t]),C=d&&!g?[]:v.map(Ku),k=_.useRef(!0),j=_.useRef(v),M=Lc(()=>new Map),A=_.useRef(new Set),[O,B]=_.useState(v),[T,F]=_.useState(v);pp(()=>{k.current=!1,j.current=v;for(let Q=0;Q<T.length;Q++){const me=Ku(T[Q]);C.includes(me)?(M.delete(me),A.current.delete(me)):M.get(me)!==!0&&M.set(me,!1)}},[T,C.length,C.join("-")]);const H=[];if(v!==O){let Q=[...v];for(let me=0;me<T.length;me++){const se=T[me],ae=Ku(se);C.includes(ae)||(Q.splice(me,0,se),H.push(se))}return u==="wait"&&H.length&&(Q=H),F(D1(Q)),B(v),null}const{forceRender:W}=_.useContext(mp);return l.jsx(l.Fragment,{children:T.map(Q=>{const me=Ku(Q),se=d&&!g?!1:v===T||C.includes(me),ae=()=>{if(A.current.has(me))return;if(M.has(me))A.current.add(me),M.set(me,!0);else return;let we=!0;M.forEach(Le=>{Le||(we=!1)}),we&&(W==null||W(),F(j.current),d&&(b==null||b()),a&&a())};return l.jsx(WC,{isPresent:se,initial:!k.current||i?void 0:!1,custom:n,presenceAffectsLayout:c,mode:u,root:y,onExitComplete:se?void 0:ae,anchorX:h,anchorY:p,children:Q},me)})})},N5=_.createContext({strict:!1}),N1={animation:["animate","variants","whileHover","whileTap","exit","whileInView","whileFocus","whileDrag"],exit:["exit"],drag:["drag","dragControls"],focus:["whileFocus"],hover:["whileHover","onHoverStart","onHoverEnd"],tap:["whileTap","onTap","onTapStart","onTapCancel"],pan:["onPan","onPanStart","onPanSessionStart","onPanEnd"],inView:["whileInView","onViewportEnter","onViewportLeave"],layout:["layout","layoutId"]};let R1=!1;function XC(){if(R1)return;const t={};for(const n in N1)t[n]={isEnabled:i=>N1[n].some(a=>!!i[a])};s5(t),R1=!0}function R5(){return XC(),R6()}function GC(t){const n=R5();for(const i in t)n[i]={...n[i],...t[i]};s5(n)}const qC=new Set(["animate","exit","variants","initial","style","values","variants","transition","transformTemplate","custom","inherit","onBeforeLayoutMeasure","onAnimationStart","onAnimationComplete","onUpdate","onDragStart","onDrag","onDragEnd","onMeasureDragConstraints","onDirectionLock","onDragTransitionEnd","_dragX","_dragY","onHoverStart","onHoverEnd","onViewportEnter","onViewportLeave","globalTapTarget","propagate","ignoreStrict","viewport"]);function Ld(t){return t.startsWith("while")||t.startsWith("drag")&&t!=="draggable"||t.startsWith("layout")||t.startsWith("onTap")||t.startsWith("onPan")||t.startsWith("onLayout")||qC.has(t)}let B5=t=>!Ld(t);function KC(t){typeof t=="function"&&(B5=n=>n.startsWith("on")?!Ld(n):t(n))}try{KC(require("@emotion/is-prop-valid").default)}catch{}function QC(t,n,i){const a={};for(const c in t)c==="values"&&typeof t.values=="object"||mo(t[c])||(B5(c)||i===!0&&Ld(c)||!n&&!Ld(c)||t.draggable&&c.startsWith("onDrag"))&&(a[c]=t[c]);return a}const Xd=_.createContext({});function ZC(t,n){if(Yd(t)){const{initial:i,animate:a}=t;return{initial:i===!1||Nc(i)?i:void 0,animate:Nc(a)?a:void 0}}return t.inherit!==!1?n:{}}function JC(t){const{initial:n,animate:i}=ZC(t,_.useContext(Xd));return _.useMemo(()=>({initial:n,animate:i}),[B1(n),B1(i)])}function B1(t){return Array.isArray(t)?t.join(" "):t}const Up=()=>({style:{},transform:{},transformOrigin:{},vars:{}});function L5(t,n,i){for(const a in n)!mo(n[a])&&!d5(a,i)&&(t[a]=n[a])}function e3({transformTemplate:t},n){return _.useMemo(()=>{const i=Up();return Pp(i,n,t),Object.assign({},i.vars,i.style)},[n])}function t3(t,n){const i=t.style||{},a={};return L5(a,i,t),Object.assign(a,e3(t,n)),a}function n3(t,n){const i={},a=t3(t,n);return t.drag&&t.dragListener!==!1&&(i.draggable=!1,a.userSelect=a.WebkitUserSelect=a.WebkitTouchCallout="none",a.touchAction=t.drag===!0?"none":`pan-${t.drag==="x"?"y":"x"}`),t.tabIndex===void 0&&(t.onTap||t.onTapStart||t.whileTap)&&(i.tabIndex=0),i.style=a,i}const O5=()=>({...Up(),attrs:{}});function s3(t,n,i,a){const c=_.useMemo(()=>{const u=O5();return h5(u,n,p5(a),t.transformTemplate,t.style),{...u.attrs,style:{...u.style}}},[n]);if(t.style){const u={};L5(u,t.style,t),c.style={...u,...c.style}}return c}const o3=["animate","circle","defs","desc","ellipse","g","image","line","filter","marker","mask","metadata","path","pattern","polygon","polyline","rect","stop","switch","symbol","svg","text","tspan","use","view"];function Vp(t){return typeof t!="string"||t.includes("-")?!1:!!(o3.indexOf(t)>-1||/[A-Z]/u.test(t))}function i3(t,n,i,{latestValues:a},c,u=!1,d){const p=((d!=null?d:Vp(t))?s3:n3)(n,a,c,t),y=QC(n,typeof t=="string",u),g=t!==_.Fragment?{...y,...p,ref:i}:{},{children:b}=n,v=_.useMemo(()=>mo(b)?b.get():b,[b]);return _.createElement(t,{...g,children:v})}function a3({scrapeMotionValuesFromProps:t,createRenderState:n},i,a,c){return{latestValues:r3(i,a,c,t),renderState:n()}}function r3(t,n,i,a){const c={},u=a(t,{});for(const v in u)c[v]=Sd(u[v]);let{initial:d,animate:h}=t;const p=Yd(t),y=t5(t);n&&y&&!p&&t.inherit!==!1&&(d===void 0&&(d=n.initial),h===void 0&&(h=n.animate));let g=i?i.initial===!1:!1;g=g||d===!1;const b=g?h:d;if(b&&typeof b!="boolean"&&!Vd(b)){const v=Array.isArray(b)?b:[b];for(let C=0;C<v.length;C++){const k=Dp(t,v[C]);if(k){const{transitionEnd:j,transition:M,...A}=k;for(const O in A){let B=A[O];if(Array.isArray(B)){const T=g?B.length-1:0;B=B[T]}B!==null&&(c[O]=B)}for(const O in j)c[O]=j[O]}}}return c}const z5=t=>(n,i)=>{const a=_.useContext(Xd),c=_.useContext(Pd),u=()=>a3(t,n,a,c);return i?u():Lc(u)},l3=z5({scrapeMotionValuesFromProps:Hp,createRenderState:Up}),c3=z5({scrapeMotionValuesFromProps:_5,createRenderState:O5}),u3=Symbol.for("motionComponentSymbol");function d3(t,n,i){const a=_.useRef(i);_.useInsertionEffect(()=>{a.current=i});const c=_.useRef(null);return _.useCallback(u=>{var h;u&&((h=t.onMount)==null||h.call(t,u));const d=a.current;if(typeof d=="function")if(u){const p=d(u);typeof p=="function"&&(c.current=p)}else c.current?(c.current(),c.current=null):d(u);else d&&(d.current=u);n&&(u?n.mount(u):n.unmount())},[n])}const $5=_.createContext({});function dl(t){return t&&typeof t=="object"&&Object.prototype.hasOwnProperty.call(t,"current")}function f3(t,n,i,a,c,u){var B,T;const{visualElement:d}=_.useContext(Xd),h=_.useContext(N5),p=_.useContext(Pd),y=_.useContext(Wd),g=y.reducedMotion,b=y.skipAnimations,v=_.useRef(null),C=_.useRef(!1);a=a||h.renderer,!v.current&&a&&(v.current=a(t,{visualState:n,parent:d,props:i,presenceContext:p,blockInitialAnimation:p?p.initial===!1:!1,reducedMotionConfig:g,skipAnimations:b,isSVG:u}),C.current&&v.current&&(v.current.manuallyAnimateOnMount=!0));const k=v.current,j=_.useContext($5);k&&!k.projection&&c&&(k.type==="html"||k.type==="svg")&&h3(v.current,i,c,j);const M=_.useRef(!1);_.useInsertionEffect(()=>{k&&M.current&&k.update(i,p)});const A=i[Vb],O=_.useRef(!!A&&typeof window<"u"&&!((B=window.MotionHandoffIsComplete)!=null&&B.call(window,A))&&((T=window.MotionHasOptimisedAnimation)==null?void 0:T.call(window,A)));return pp(()=>{C.current=!0,k&&(M.current=!0,window.MotionIsMounted=!0,k.updateFeatures(),k.scheduleRenderMicrotask(),O.current&&k.animationState&&k.animationState.animateChanges())}),_.useEffect(()=>{k&&(!O.current&&k.animationState&&k.animationState.animateChanges(),O.current&&(queueMicrotask(()=>{var F;(F=window.MotionHandoffMarkAsComplete)==null||F.call(window,A)}),O.current=!1),k.enteringChildren=void 0)}),k}function h3(t,n,i,a){const{layoutId:c,layout:u,drag:d,dragConstraints:h,layoutScroll:p,layoutRoot:y,layoutAnchor:g,layoutCrossfade:b}=n;t.projection=new i(t.latestValues,n["data-framer-portal-id"]?void 0:I5(t.parent)),t.projection.setOptions({layoutId:c,layout:u,alwaysMeasureLayout:!!d||h&&dl(h),visualElement:t,animationType:typeof u=="string"?u:"both",initialPromotionConfig:a,crossfade:b,layoutScroll:p,layoutRoot:y,layoutAnchor:g})}function I5(t){if(t)return t.options.allowProjection!==!1?t.projection:I5(t.parent)}function cm(t,{forwardMotionProps:n=!1,type:i}={},a,c){var y,g;a&&GC(a);const u=i?i==="svg":Vp(t),d=u?c3:l3;function h(b,v){let C;const k={..._.useContext(Wd),...b,layoutId:m3(b)},{isStatic:j}=k,M=JC(b),A=d(b,j);if(!j&&typeof window<"u"){p3();const O=_3(k);C=O.MeasureLayout,M.visualElement=f3(t,A,k,c,O.ProjectionNode,u)}return l.jsxs(Xd.Provider,{value:M,children:[C&&M.visualElement?l.jsx(C,{visualElement:M.visualElement,...k}):null,i3(t,b,d3(A,M.visualElement,v),A,j,n,u)]})}h.displayName=`motion.${typeof t=="string"?t:`create(${(g=(y=t.displayName)!=null?y:t.name)!=null?g:""})`}`;const p=_.forwardRef(h);return p[u3]=t,p}function m3({layoutId:t}){const n=_.useContext(mp).id;return n&&t!==void 0?n+"-"+t:t}function p3(t,n){_.useContext(N5).strict}function _3(t){const n=R5(),{drag:i,layout:a}=n;if(!i&&!a)return{};const c={...i,...a};return{MeasureLayout:i!=null&&i.isEnabled(t)||a!=null&&a.isEnabled(t)?c.MeasureLayout:void 0,ProjectionNode:c.ProjectionNode}}function g3(t,n){if(typeof Proxy>"u")return cm;const i=new Map,a=(u,d)=>cm(u,d,t,n),c=(u,d)=>a(u,d);return new Proxy(c,{get:(u,d)=>d==="create"?a:(i.has(d)||i.set(d,cm(d,void 0,t,n)),i.get(d))})}const y3=(t,n)=>{var a;return((a=n.isSVG)!=null?a:Vp(t))?new g5(n):new f5(n,{allowProjection:t!==_.Fragment})};class x3 extends rr{constructor(n){super(n),n.animationState||(n.animationState=eC(n))}updateAnimationControlsSubscription(){const{animate:n}=this.node.getProps();Vd(n)&&(this.unmountControls=n.subscribe(this.node))}mount(){this.updateAnimationControlsSubscription()}update(){const{animate:n}=this.node.getProps(),{animate:i}=this.node.prevProps||{};n!==i&&this.updateAnimationControlsSubscription()}unmount(){var n;this.node.animationState.reset(),(n=this.unmountControls)==null||n.call(this)}}let b3=0;class v3 extends rr{constructor(){super(...arguments),this.id=b3++,this.isExitComplete=!1}update(){var u;if(!this.node.presenceContext)return;const{isPresent:n,onExitComplete:i}=this.node.presenceContext,{isPresent:a}=this.node.prevPresenceContext||{};if(!this.node.animationState||n===a)return;if(n&&a===!1){if(this.isExitComplete){const{initial:d,custom:h}=this.node.getProps();if(typeof d=="string"){const p=Nr(this.node,d,h);if(p){const{transition:y,transitionEnd:g,...b}=p;for(const v in b)(u=this.node.getValue(v))==null||u.jump(b[v])}}this.node.animationState.reset(),this.node.animationState.animateChanges()}else this.node.animationState.setActive("exit",!1);this.isExitComplete=!1;return}const c=this.node.animationState.setActive("exit",!n);i&&!n&&c.then(()=>{this.isExitComplete=!0,i(this.id)})}mount(){const{register:n,onExitComplete:i}=this.node.presenceContext||{};i&&i(this.id),n&&(this.unmount=n(this.id))}unmount(){}}const w3={animation:{Feature:x3},exit:{Feature:v3}};function Ic(t){return{point:{x:t.pageX,y:t.pageY}}}const S3=t=>n=>zp(n)&&t(n,Ic(n));function jc(t,n,i,a){return Rc(t,n,S3(i),a)}const P5=({current:t})=>t?t.ownerDocument.defaultView:null,L1=(t,n)=>Math.abs(t-n);function C3(t,n){const i=L1(t.x,n.x),a=L1(t.y,n.y);return Math.sqrt(i**2+a**2)}const O1=new Set(["auto","scroll"]);class H5{constructor(n,i,{transformPagePoint:a,contextWindow:c=window,dragSnapToOrigin:u=!1,distanceThreshold:d=3,element:h}={}){if(this.startEvent=null,this.lastMoveEvent=null,this.lastMoveEventInfo=null,this.lastRawMoveEventInfo=null,this.handlers={},this.contextWindow=window,this.scrollPositions=new Map,this.removeScrollListeners=null,this.onElementScroll=C=>{this.handleScroll(C.target)},this.onWindowScroll=()=>{this.handleScroll(window)},this.updatePoint=()=>{if(!(this.lastMoveEvent&&this.lastMoveEventInfo))return;this.lastRawMoveEventInfo&&(this.lastMoveEventInfo=Qu(this.lastRawMoveEventInfo,this.transformPagePoint));const C=um(this.lastMoveEventInfo,this.history),k=this.startEvent!==null,j=C3(C.offset,{x:0,y:0})>=this.distanceThreshold;if(!k&&!j)return;const{point:M}=C,{timestamp:A}=No;this.history.push({...M,timestamp:A});const{onStart:O,onMove:B}=this.handlers;k||(O&&O(this.lastMoveEvent,C),this.startEvent=this.lastMoveEvent),B&&B(this.lastMoveEvent,C)},this.handlePointerMove=(C,k)=>{this.lastMoveEvent=C,this.lastRawMoveEventInfo=k,this.lastMoveEventInfo=Qu(k,this.transformPagePoint),os.update(this.updatePoint,!0)},this.handlePointerUp=(C,k)=>{this.end();const{onEnd:j,onSessionEnd:M,resumeAnimation:A}=this.handlers;if((this.dragSnapToOrigin||!this.startEvent)&&A&&A(),!(this.lastMoveEvent&&this.lastMoveEventInfo))return;const O=um(C.type==="pointercancel"?this.lastMoveEventInfo:Qu(k,this.transformPagePoint),this.history);this.startEvent&&j&&j(C,O),M&&M(C,O)},!zp(n))return;this.dragSnapToOrigin=u,this.handlers=i,this.transformPagePoint=a,this.distanceThreshold=d,this.contextWindow=c||window;const p=Ic(n),y=Qu(p,this.transformPagePoint),{point:g}=y,{timestamp:b}=No;this.history=[{...g,timestamp:b}];const{onSessionStart:v}=i;v&&v(n,um(y,this.history)),this.removeListeners=Oc(jc(this.contextWindow,"pointermove",this.handlePointerMove),jc(this.contextWindow,"pointerup",this.handlePointerUp),jc(this.contextWindow,"pointercancel",this.handlePointerUp)),h&&this.startScrollTracking(h)}startScrollTracking(n){let i=n.parentElement;for(;i;){const a=getComputedStyle(i);(O1.has(a.overflowX)||O1.has(a.overflowY))&&this.scrollPositions.set(i,{x:i.scrollLeft,y:i.scrollTop}),i=i.parentElement}this.scrollPositions.set(window,{x:window.scrollX,y:window.scrollY}),window.addEventListener("scroll",this.onElementScroll,{capture:!0}),window.addEventListener("scroll",this.onWindowScroll),this.removeScrollListeners=()=>{window.removeEventListener("scroll",this.onElementScroll,{capture:!0}),window.removeEventListener("scroll",this.onWindowScroll)}}handleScroll(n){const i=this.scrollPositions.get(n);if(!i)return;const a=n===window,c=a?{x:window.scrollX,y:window.scrollY}:{x:n.scrollLeft,y:n.scrollTop},u={x:c.x-i.x,y:c.y-i.y};u.x===0&&u.y===0||(a?this.lastMoveEventInfo&&(this.lastMoveEventInfo.point.x+=u.x,this.lastMoveEventInfo.point.y+=u.y):this.history.length>0&&(this.history[0].x-=u.x,this.history[0].y-=u.y),this.scrollPositions.set(n,c),os.update(this.updatePoint,!0))}updateHandlers(n){this.handlers=n}end(){this.removeListeners&&this.removeListeners(),this.removeScrollListeners&&this.removeScrollListeners(),this.scrollPositions.clear(),Da(this.updatePoint)}}function Qu(t,n){return n?{point:n(t.point)}:t}function z1(t,n){return{x:t.x-n.x,y:t.y-n.y}}function um({point:t},n){return{point:t,delta:z1(t,U5(n)),offset:z1(t,k3(n)),velocity:j3(n,.1)}}function k3(t){return t[0]}function U5(t){return t[t.length-1]}function j3(t,n){if(t.length<2)return{x:0,y:0};let i=t.length-1,a=null;const c=U5(t);for(;i>=0&&(a=t[i],!(c.timestamp-a.timestamp>ai(n)));)i--;if(!a)return{x:0,y:0};a===t[0]&&t.length>2&&c.timestamp-a.timestamp>ai(n)*2&&(a=t[1]);const u=Li(c.timestamp-a.timestamp);if(u===0)return{x:0,y:0};const d={x:(c.x-a.x)/u,y:(c.y-a.y)/u};return d.x===1/0&&(d.x=0),d.y===1/0&&(d.y=0),d}function M3(t,{min:n,max:i},a){return n!==void 0&&t<n?t=a?ms(n,t,a.min):Math.max(t,n):i!==void 0&&t>i&&(t=a?ms(i,t,a.max):Math.min(t,i)),t}function $1(t,n,i){return{min:n!==void 0?t.min+n:void 0,max:i!==void 0?t.max+i-(t.max-t.min):void 0}}function E3(t,{top:n,left:i,bottom:a,right:c}){return{x:$1(t.x,i,c),y:$1(t.y,n,a)}}function I1(t,n){let i=n.min-t.min,a=n.max-t.max;return n.max-n.min<t.max-t.min&&([i,a]=[a,i]),{min:i,max:a}}function T3(t,n){return{x:I1(t.x,n.x),y:I1(t.y,n.y)}}function A3(t,n){let i=.5;const a=Xo(t),c=Xo(n);return c>a?i=yl(n.min,n.max-a,t.min):a>c&&(i=yl(t.min,t.max-c,n.min)),da(0,1,i)}function D3(t,n){const i={};return n.min!==void 0&&(i.min=n.min-t.min),n.max!==void 0&&(i.max=n.max-t.min),i}const Jm=.35;function N3(t=Jm){return t===!1?t=0:t===!0&&(t=Jm),{x:P1(t,"left","right"),y:P1(t,"top","bottom")}}function P1(t,n,i){return{min:H1(t,n),max:H1(t,i)}}function H1(t,n){return typeof t=="number"?t:t[n]||0}const R3=new WeakMap;class B3{constructor(n){this.openDragLock=null,this.isDragging=!1,this.currentDirection=null,this.originPoint={x:0,y:0},this.constraints=!1,this.hasMutatedConstraints=!1,this.elastic=no(),this.latestPointerEvent=null,this.latestPanInfo=null,this.visualElement=n}start(n,{snapToCursor:i=!1,distanceThreshold:a}={}){const{presenceContext:c}=this.visualElement;if(c&&c.isPresent===!1)return;const u=b=>{i&&this.snapToCursor(Ic(b).point),this.stopAnimation()},d=(b,v)=>{const{drag:C,dragPropagation:k,onDragStart:j}=this.getProps();if(C&&!k&&(this.openDragLock&&this.openDragLock(),this.openDragLock=u6(C),!this.openDragLock))return;this.latestPointerEvent=b,this.latestPanInfo=v,this.isDragging=!0,this.currentDirection=null,this.resolveConstraints(),this.visualElement.projection&&(this.visualElement.projection.isAnimationBlocked=!0,this.visualElement.projection.target=void 0),la(A=>{let O=this.getAxisMotionValue(A).get()||0;if(ua.test(O)){const{projection:B}=this.visualElement;if(B&&B.layout){const T=B.layout.layoutBox[A];T&&(O=Xo(T)*(parseFloat(O)/100))}}this.originPoint[A]=O}),j&&os.update(()=>j(b,v),!1,!0),Ym(this.visualElement,"transform");const{animationState:M}=this.visualElement;M&&M.setActive("whileDrag",!0)},h=(b,v)=>{this.latestPointerEvent=b,this.latestPanInfo=v;const{dragPropagation:C,dragDirectionLock:k,onDirectionLock:j,onDrag:M}=this.getProps();if(!C&&!this.openDragLock)return;const{offset:A}=v;if(k&&this.currentDirection===null){this.currentDirection=O3(A),this.currentDirection!==null&&j&&j(this.currentDirection);return}this.updateAxis("x",v.point,A),this.updateAxis("y",v.point,A),this.visualElement.render(),M&&os.update(()=>M(b,v),!1,!0)},p=(b,v)=>{this.latestPointerEvent=b,this.latestPanInfo=v,this.stop(b,v),this.latestPointerEvent=null,this.latestPanInfo=null},y=()=>{const{dragSnapToOrigin:b}=this.getProps();(b||this.constraints)&&this.startAnimation({x:0,y:0})},{dragSnapToOrigin:g}=this.getProps();this.panSession=new H5(n,{onSessionStart:u,onStart:d,onMove:h,onSessionEnd:p,resumeAnimation:y},{transformPagePoint:this.visualElement.getTransformPagePoint(),dragSnapToOrigin:g,distanceThreshold:a,contextWindow:P5(this.visualElement),element:this.visualElement.current})}stop(n,i){const a=n||this.latestPointerEvent,c=i||this.latestPanInfo,u=this.isDragging;if(this.cancel(),!u||!c||!a)return;const{velocity:d}=c;this.startAnimation(d);const{onDragEnd:h}=this.getProps();h&&os.postRender(()=>h(a,c))}cancel(){this.isDragging=!1;const{projection:n,animationState:i}=this.visualElement;n&&(n.isAnimationBlocked=!1),this.endPanSession();const{dragPropagation:a}=this.getProps();!a&&this.openDragLock&&(this.openDragLock(),this.openDragLock=null),i&&i.setActive("whileDrag",!1)}endPanSession(){this.panSession&&this.panSession.end(),this.panSession=void 0}updateAxis(n,i,a){const{drag:c}=this.getProps();if(!a||!Zu(n,c,this.currentDirection))return;const u=this.getAxisMotionValue(n);let d=this.originPoint[n]+a[n];this.constraints&&this.constraints[n]&&(d=M3(d,this.constraints[n],this.elastic[n])),u.set(d)}resolveConstraints(){var u;const{dragConstraints:n,dragElastic:i}=this.getProps(),a=this.visualElement.projection&&!this.visualElement.projection.layout?this.visualElement.projection.measure(!1):(u=this.visualElement.projection)==null?void 0:u.layout,c=this.constraints;n&&dl(n)?this.constraints||(this.constraints=this.resolveRefConstraints()):n&&a?this.constraints=E3(a.layoutBox,n):this.constraints=!1,this.elastic=N3(i),c!==this.constraints&&!dl(n)&&a&&this.constraints&&!this.hasMutatedConstraints&&la(d=>{this.constraints!==!1&&this.getAxisMotionValue(d)&&(this.constraints[d]=D3(a.layoutBox[d],this.constraints[d]))})}resolveRefConstraints(){const{dragConstraints:n,onMeasureDragConstraints:i}=this.getProps();if(!n||!dl(n))return!1;const a=n.current,{projection:c}=this.visualElement;if(!c||!c.layout)return!1;const u=z6(a,c.root,this.visualElement.getTransformPagePoint());let d=T3(c.layout.layoutBox,u);if(i){const h=i(B6(d));this.hasMutatedConstraints=!!h,h&&(d=a5(h))}return d}startAnimation(n){const{drag:i,dragMomentum:a,dragElastic:c,dragTransition:u,dragSnapToOrigin:d,onDragTransitionEnd:h}=this.getProps(),p=this.constraints||{},y=la(g=>{if(!Zu(g,i,this.currentDirection))return;let b=p&&p[g]||{};(d===!0||d===g)&&(b={min:0,max:0});const v=c?200:1e6,C=c?40:1e7,k={type:"inertia",velocity:a?n[g]:0,bounceStiffness:v,bounceDamping:C,timeConstant:750,restDelta:1,restSpeed:10,...u,...b};return this.startAxisValueAnimation(g,k)});return Promise.all(y).then(h)}startAxisValueAnimation(n,i){const a=this.getAxisMotionValue(n);return Ym(this.visualElement,n),a.start(Ap(n,a,0,i,this.visualElement,!1))}stopAnimation(){la(n=>this.getAxisMotionValue(n).stop())}getAxisMotionValue(n){const i=`_drag${n.toUpperCase()}`,a=this.visualElement.getProps(),c=a[i];return c||this.visualElement.getValue(n,(a.initial?a.initial[n]:void 0)||0)}snapToCursor(n){la(i=>{const{drag:a}=this.getProps();if(!Zu(i,a,this.currentDirection))return;const{projection:c}=this.visualElement,u=this.getAxisMotionValue(i);if(c&&c.layout){const{min:d,max:h}=c.layout.layoutBox[i],p=u.get()||0;u.set(n[i]-ms(d,h,.5)+p)}})}scalePositionWithinConstraints(){if(!this.visualElement.current)return;const{drag:n,dragConstraints:i}=this.getProps(),{projection:a}=this.visualElement;if(!dl(i)||!a||!this.constraints)return;this.stopAnimation();const c={x:0,y:0};la(d=>{const h=this.getAxisMotionValue(d);if(h&&this.constraints!==!1){const p=h.get();c[d]=A3({min:p,max:p},this.constraints[d])}});const{transformTemplate:u}=this.visualElement.getProps();this.visualElement.current.style.transform=u?u({},""):"none",a.root&&a.root.updateScroll(),a.updateLayout(),this.constraints=!1,this.resolveConstraints(),la(d=>{if(!Zu(d,n,null))return;const h=this.getAxisMotionValue(d),{min:p,max:y}=this.constraints[d];h.set(ms(p,y,c[d]))}),this.visualElement.render()}addListeners(){if(!this.visualElement.current)return;R3.set(this.visualElement,this);const n=this.visualElement.current,i=jc(n,"pointerdown",y=>{const{drag:g,dragListener:b=!0}=this.getProps(),v=y.target,C=v!==n&&_6(v);g&&b&&!C&&this.start(y)});let a;const c=()=>{const{dragConstraints:y}=this.getProps();dl(y)&&y.current&&(this.constraints=this.resolveRefConstraints(),a||(a=L3(n,y.current,()=>this.scalePositionWithinConstraints())))},{projection:u}=this.visualElement,d=u.addEventListener("measure",c);u&&!u.layout&&(u.root&&u.root.updateScroll(),u.updateLayout()),os.read(c);const h=Rc(window,"resize",()=>this.scalePositionWithinConstraints()),p=u.addEventListener("didUpdate",(({delta:y,hasLayoutChanged:g})=>{this.isDragging&&g&&(la(b=>{const v=this.getAxisMotionValue(b);v&&(this.originPoint[b]+=y[b].translate,v.set(v.get()+y[b].translate))}),this.visualElement.render())}));return()=>{h(),i(),d(),p&&p(),a&&a()}}getProps(){const n=this.visualElement.getProps(),{drag:i=!1,dragDirectionLock:a=!1,dragPropagation:c=!1,dragConstraints:u=!1,dragElastic:d=Jm,dragMomentum:h=!0}=n;return{...n,drag:i,dragDirectionLock:a,dragPropagation:c,dragConstraints:u,dragElastic:d,dragMomentum:h}}}function U1(t){let n=!0;return()=>{if(n){n=!1;return}t()}}function L3(t,n,i){const a=qy(t,U1(i)),c=qy(n,U1(i));return()=>{a(),c()}}function Zu(t,n,i){return(n===!0||n===t)&&(i===null||i===t)}function O3(t,n=10){let i=null;return Math.abs(t.y)>n?i="y":Math.abs(t.x)>n&&(i="x"),i}class z3 extends rr{constructor(n){super(n),this.removeGroupControls=Oi,this.removeListeners=Oi,this.controls=new B3(n)}mount(){const{dragControls:n}=this.node.getProps();n&&(this.removeGroupControls=n.subscribe(this.controls)),this.removeListeners=this.controls.addListeners()||Oi}update(){const{dragControls:n}=this.node.getProps(),{dragControls:i}=this.node.prevProps||{};n!==i&&(this.removeGroupControls(),n&&(this.removeGroupControls=n.subscribe(this.controls)))}unmount(){this.removeGroupControls(),this.removeListeners(),this.controls.isDragging||this.controls.endPanSession()}}const dm=t=>(n,i)=>{t&&os.update(()=>t(n,i),!1,!0)};class $3 extends rr{constructor(){super(...arguments),this.removePointerDownListener=Oi}onPointerDown(n){this.session=new H5(n,this.createPanHandlers(),{transformPagePoint:this.node.getTransformPagePoint(),contextWindow:P5(this.node)})}createPanHandlers(){const{onPanSessionStart:n,onPanStart:i,onPan:a,onPanEnd:c}=this.node.getProps();return{onSessionStart:dm(n),onStart:dm(i),onMove:dm(a),onEnd:(u,d)=>{delete this.session,c&&os.postRender(()=>c(u,d))}}}mount(){this.removePointerDownListener=jc(this.node.current,"pointerdown",n=>this.onPointerDown(n))}update(){this.session&&this.session.updateHandlers(this.createPanHandlers())}unmount(){this.removePointerDownListener(),this.session&&this.session.end()}}let fm=!1;class I3 extends _.Component{componentDidMount(){const{visualElement:n,layoutGroup:i,switchLayoutGroup:a,layoutId:c}=this.props,{projection:u}=n;u&&(i.group&&i.group.add(u),a&&a.register&&c&&a.register(u),fm&&u.root.didUpdate(),u.addEventListener("animationComplete",()=>{this.safeToRemove()}),u.setOptions({...u.options,layoutDependency:this.props.layoutDependency,onExitComplete:()=>this.safeToRemove()})),Cd.hasEverUpdated=!0}getSnapshotBeforeUpdate(n){const{layoutDependency:i,visualElement:a,drag:c,isPresent:u}=this.props,{projection:d}=a;return d&&(d.isPresent=u,n.layoutDependency!==i&&d.setOptions({...d.options,layoutDependency:i}),fm=!0,c||n.layoutDependency!==i||i===void 0||n.isPresent!==u?d.willUpdate():this.safeToRemove(),n.isPresent!==u&&(u?d.promote():d.relegate()||os.postRender(()=>{const h=d.getStack();(!h||!h.members.length)&&this.safeToRemove()}))),null}componentDidUpdate(){const{visualElement:n,layoutAnchor:i}=this.props,{projection:a}=n;a&&(a.options.layoutAnchor=i,a.root.didUpdate(),Op.postRender(()=>{!a.currentAnimation&&a.isLead()&&this.safeToRemove()}))}componentWillUnmount(){const{visualElement:n,layoutGroup:i,switchLayoutGroup:a}=this.props,{projection:c}=n;fm=!0,c&&(c.scheduleCheckAfterUnmount(),i&&i.group&&i.group.remove(c),a&&a.deregister&&a.deregister(c))}safeToRemove(){const{safeToRemove:n}=this.props;n&&n()}render(){return null}}function V5(t){const[n,i]=D5(),a=_.useContext(mp);return l.jsx(I3,{...t,layoutGroup:a,switchLayoutGroup:_.useContext($5),isPresent:n,safeToRemove:i})}const P3={pan:{Feature:$3},drag:{Feature:z3,ProjectionNode:A5,MeasureLayout:V5}};function V1(t,n,i){const{props:a}=t;t.animationState&&a.whileHover&&t.animationState.setActive("whileHover",i==="Start");const c="onHover"+i,u=a[c];u&&os.postRender(()=>u(n,Ic(n)))}class H3 extends rr{mount(){const{current:n}=this.node;n&&(this.unmount=f6(n,(i,a)=>(V1(this.node,a,"Start"),c=>V1(this.node,c,"End"))))}unmount(){}}class U3 extends rr{constructor(){super(...arguments),this.isActive=!1}onFocus(){let n=!1;try{n=this.node.current.matches(":focus-visible")}catch{n=!0}!n||!this.node.animationState||(this.node.animationState.setActive("whileFocus",!0),this.isActive=!0)}onBlur(){!this.isActive||!this.node.animationState||(this.node.animationState.setActive("whileFocus",!1),this.isActive=!1)}mount(){this.unmount=Oc(Rc(this.node.current,"focus",()=>this.onFocus()),Rc(this.node.current,"blur",()=>this.onBlur()))}unmount(){}}function Y1(t,n,i){const{props:a}=t;if(t.current instanceof HTMLButtonElement&&t.current.disabled)return;t.animationState&&a.whileTap&&t.animationState.setActive("whileTap",i==="Start");const c="onTap"+(i==="End"?"":i),u=a[c];u&&os.postRender(()=>u(n,Ic(n)))}class V3 extends rr{mount(){const{current:n}=this.node;if(!n)return;const{globalTapTarget:i,propagate:a}=this.node.props;this.unmount=y6(n,(c,u)=>(Y1(this.node,u,"Start"),(d,{success:h})=>Y1(this.node,d,h?"End":"Cancel")),{useGlobalTarget:i,stopPropagation:(a==null?void 0:a.tap)===!1})}unmount(){}}const ep=new WeakMap,hm=new WeakMap,Y3=t=>{const n=ep.get(t.target);n&&n(t)},W3=t=>{t.forEach(Y3)};function F3({root:t,...n}){const i=t||document;hm.has(i)||hm.set(i,{});const a=hm.get(i),c=JSON.stringify(n);return a[c]||(a[c]=new IntersectionObserver(W3,{root:t,...n})),a[c]}function X3(t,n,i){const a=F3(n);return ep.set(t,i),a.observe(t),()=>{ep.delete(t),a.unobserve(t)}}const G3={some:0,all:1};class q3 extends rr{constructor(){super(...arguments),this.hasEnteredView=!1,this.isInView=!1}startObserver(){var p;(p=this.stopObserver)==null||p.call(this);const{viewport:n={}}=this.node.getProps(),{root:i,margin:a,amount:c="some",once:u}=n,d={root:i?i.current:void 0,rootMargin:a,threshold:typeof c=="number"?c:G3[c]},h=y=>{const{isIntersecting:g}=y;if(this.isInView===g||(this.isInView=g,u&&!g&&this.hasEnteredView))return;g&&(this.hasEnteredView=!0),this.node.animationState&&this.node.animationState.setActive("whileInView",g);const{onViewportEnter:b,onViewportLeave:v}=this.node.getProps(),C=g?b:v;C&&C(y)};this.stopObserver=X3(this.node.current,d,h)}mount(){this.startObserver()}update(){if(typeof IntersectionObserver>"u")return;const{props:n,prevProps:i}=this.node;["amount","margin","root"].some(K3(n,i))&&this.startObserver()}unmount(){var n;(n=this.stopObserver)==null||n.call(this),this.hasEnteredView=!1,this.isInView=!1}}function K3({viewport:t={}},{viewport:n={}}={}){return i=>t[i]!==n[i]}const Q3={inView:{Feature:q3},tap:{Feature:V3},focus:{Feature:U3},hover:{Feature:H3}},Z3={layout:{ProjectionNode:A5,MeasureLayout:V5}},J3={...w3,...Q3,...P3,...Z3},Go=g3(J3,y3);function tp(t){const n=Lc(()=>ar(t)),{isStatic:i}=_.useContext(Wd);if(i){const[,a]=_.useState(t);_.useEffect(()=>n.on("change",a),[])}return n}function Y5(t,n){const i=tp(n()),a=()=>i.set(n());return a(),pp(()=>{const c=()=>os.preRender(a,!1,!0),u=t.map(d=>d.on("change",c));return()=>{u.forEach(d=>d()),Da(a)}}),i}function ek(t){Cc.current=[],t();const n=Y5(Cc.current,t);return Cc.current=void 0,n}function Ju(t,n,i,a){if(typeof t=="function")return ek(t);const u=typeof n=="function"?n:M6(n,i,a),d=Array.isArray(t)?W1(t,u):W1([t],([p])=>u(p)),h=Array.isArray(t)?void 0:t.accelerate;return h&&!h.isTransformed&&typeof n!="function"&&Array.isArray(i)&&(a==null?void 0:a.clamp)!==!1&&(d.accelerate={...h,times:n,keyframes:i,isTransformed:!0}),d}function W1(t,n){const i=Lc(()=>[]);return Y5(t,()=>{i.length=0;const a=t.length;for(let c=0;c<a;c++)i[c]=t[c].get();return n(i)})}function Yp(t){return typeof t=="object"&&!Array.isArray(t)}function W5(t,n,i,a){return t==null?[]:typeof t=="string"&&Yp(n)?Lp(t,i,a):t instanceof NodeList?Array.from(t):Array.isArray(t)?t.filter(c=>c!=null):[t]}function tk(t,n,i){return t*(n+1)}function F1(t,n,i,a){var c;return typeof n=="number"?n:n.startsWith("-")||n.startsWith("+")?Math.max(0,t+parseFloat(n)):n==="<"?i:n.startsWith("<")?Math.max(0,i+parseFloat(n.slice(1))):(c=a.get(n))!=null?c:t}function nk(t,n,i){for(let a=0;a<t.length;a++){const c=t[a];c.at>n&&c.at<i&&(gl(t,c),a--)}}function sk(t,n,i,a,c,u){nk(t,c,u);for(let d=0;d<n.length;d++)t.push({value:n[d],at:ms(c,u,a[d]),easing:fb(i,d)})}function ok(t,n){for(let i=0;i<t.length;i++)t[i]=t[i]/(n+1)}function ik(t,n){return t.at===n.at?t.value===null?1:n.value===null?-1:0:t.at-n.at}const ak="easeInOut";function rk(t,{defaultTransition:n={},...i}={},a,c){const u=n.duration||.3,d=new Map,h=new Map,p={},y=new Map;let g=0,b=0,v=0;for(let C=0;C<t.length;C++){const k=t[C];if(typeof k=="string"){y.set(k,b);continue}else if(!Array.isArray(k)){y.set(k.name,F1(b,k.at,g,y));continue}let[j,M,A={}]=k;A.at!==void 0&&(b=F1(b,A.at,g,y));let O=0;const B=(T,F,H,W=0,Q=0)=>{const me=lk(T),{delay:se=0,times:ae=Eb(me),type:we=n.type||"keyframes",repeat:Le,repeatType:Z,repeatDelay:fe=0,...$}=F;let{ease:ce=n.ease||"easeOut",duration:X}=F;const ge=typeof se=="function"?se(W,Q):se,Ae=me.length,P=Ep(we)?we:c==null?void 0:c[we||"keyframes"];if(Ae<=2&&P){let ue=100;if(Ae===2&&dk(me)){const Ge=me[1]-me[0];ue=Math.abs(Ge)}const je={...n,...$};X!==void 0&&(je.duration=ai(X));const He=Cb(je,ue,P);ce=He.ease,X=He.duration}X!=null||(X=u);const le=b+ge;ae.length===1&&ae[0]===0&&(ae[1]=1);const ee=ae.length-me.length;if(ee>0&&Mb(ae,ee),me.length===1&&me.unshift(null),Le){X=tk(X,Le);const ue=[...me],je=[...ae];ce=Array.isArray(ce)?[...ce]:[ce];const He=[...ce];for(let Ge=0;Ge<Le;Ge++){me.push(...ue);for(let $e=0;$e<ue.length;$e++)ae.push(je[$e]+(Ge+1)),ce.push($e===0?"linear":fb(He,$e-1))}ok(ae,Le)}const ve=le+X;sk(H,me,ce,ae,le,ve),O=Math.max(ge+X,O),v=Math.max(ve,v)};if(mo(j)){const T=X1(j,h);B(M,A,G1("default",T))}else{const T=W5(j,M,a,p),F=T.length;for(let H=0;H<F;H++){M=M,A=A;const W=T[H],Q=X1(W,h);for(const me in M)B(M[me],ck(A,me),G1(me,Q),H,F)}}g=b,b+=O}return h.forEach((C,k)=>{for(const j in C){const M=C[j];M.sort(ik);const A=[],O=[],B=[];for(let W=0;W<M.length;W++){const{at:Q,value:me,easing:se}=M[W];A.push(me),O.push(yl(0,v,Q)),B.push(se||"easeOut")}O[0]!==0&&(O.unshift(0),A.unshift(A[0]),B.unshift(ak)),O[O.length-1]!==1&&(O.push(1),A.push(null)),d.has(k)||d.set(k,{keyframes:{},transition:{}});const T=d.get(k);T.keyframes[j]=A;const{type:F,...H}=n;T.transition[j]={...H,duration:v,ease:B,times:O,...i}}}),d}function X1(t,n){return!n.has(t)&&n.set(t,{}),n.get(t)}function G1(t,n){return n[t]||(n[t]=[]),n[t]}function lk(t){return Array.isArray(t)?t:[t]}function ck(t,n){return t&&t[n]?{...t,...t[n]}:{...t}}const uk=t=>typeof t=="number",dk=t=>t.every(uk);function fk(t){const n={presenceContext:null,props:{},visualState:{renderState:{transform:{},transformOrigin:{},style:{},vars:{},attrs:{}},latestValues:{}}},i=Ud(t)&&!e5(t)?new g5(n):new f5(n);i.mount(t),Dc.set(t,i)}function hk(t){const n={presenceContext:null,props:{},visualState:{renderState:{output:{}},latestValues:{}}},i=new Y6(n);i.mount(t),Dc.set(t,i)}function mk(t,n){return mo(t)||typeof t=="number"||typeof t=="string"&&!Yp(n)}function F5(t,n,i,a){const c=[];if(mk(t,n))c.push(j5(t,Yp(n)&&n.default||n,i&&(i.default||i)));else{if(t==null)return c;const u=W5(t,n,a),d=u.length;for(let h=0;h<d;h++){const p=u[h],y=p instanceof Element?fk:hk;Dc.has(p)||y(p);const g=Dc.get(p),b={...i};"delay"in b&&typeof b.delay=="function"&&(b.delay=b.delay(h,d)),c.push(...Rp(g,{...n,transition:b},{}))}}return c}function pk(t,n,i){const a=[],c=t.map(d=>{if(Array.isArray(d)&&typeof d[0]=="function"){const h=d[0],p=ar(0);return p.on("change",h),d.length===1?[p,[0,1]]:d.length===2?[p,[0,1],d[1]]:[p,d[1],d[2]]}return d});return rk(c,n,i,{spring:Ac}).forEach(({keyframes:d,transition:h},p)=>{a.push(...F5(p,d,h))}),a}function _k(t){return Array.isArray(t)&&t.some(Array.isArray)}function gk(t={}){const{scope:n,reduceMotion:i}=t;function a(c,u,d){let h=[],p;if(_k(c)){const{onComplete:g,...b}=u||{};typeof g=="function"&&(p=g),h=pk(c,i!==void 0?{reduceMotion:i,...b}:b,n)}else{const{onComplete:g,...b}=d||{};typeof g=="function"&&(p=g),h=F5(c,u,i!==void 0?{reduceMotion:i,...b}:b,n)}const y=new R4(h);return p&&y.finished.then(p),n&&(n.animations.push(y),y.finished.then(()=>{gl(n.animations,y)})),y}return a}const q1=gk(),Aa=(t,n)=>!t||!n?!1:t===n||t.startsWith(n)||n.startsWith(t);function K1(t,n){var a;const i=[...(a=t.childShas)!=null?a:[]];return i.includes(n)||i.push(n),{...t,childShas:i}}function yk(t,n,i,a,c,u){if(!i)return{directCommits:t,branchCommitPreviews:n};const d=t.map(p=>Aa(p.fullSha,i)||Aa(p.sha,i)?K1(p,a):p),h=Object.fromEntries(Object.entries(n).map(([p,y])=>[p,y.map(g=>(p===c||p===u)&&(Aa(g.fullSha,i)||Aa(g.sha,i))?K1(g,a):g)]));return{directCommits:d,branchCommitPreviews:h}}function xk(t,n,i,a){if(!t)return null;const c=d=>Aa(d,t);if(n.some(d=>c(d.fullSha)||c(d.sha)))return a;for(const[d,h]of Object.entries(i))if(h.some(y=>c(y.fullSha)||c(y.sha)))return d;return null}function bk(t,n,i,a,c,u,d=!1){const h=t.baseSha,p=`STASH:${t.index}`,y=`Stash ${t.index+1}`,g=xk(h,i,a,u),b=(()=>{var H;if(!h)return null;const F=i.find(W=>Aa(W.fullSha,h)||Aa(W.sha,h));if(F!=null&&F.date)return F.date;if(g&&!d){const W=((H=a[g])!=null?H:[]).find(Q=>Aa(Q.fullSha,h)||Aa(Q.sha,h));if(W!=null&&W.date)return W.date}return null})(),v=b?new Date(b).getTime():Number.NaN,C=Date.now(),k=Number.isFinite(v)?Math.max(C,v+1+t.index):C+t.index,j=new Date(k).toISOString(),M=t.message.trim(),A={fullSha:p,sha:y,parentSha:h,clusterKey:null,childShas:[],message:M||y,author:"You",date:j,kind:"stash"},O=`*Stash:${t.index}`,B={name:O,commitsAhead:1,commitsBehind:0,lastCommitDate:j,lastCommitAuthor:"You",status:"fresh",remoteSyncStatus:"local-only",unpushedCommits:1,headSha:p,divergedFromSha:h!=null?h:void 0,parentBranch:g||u},T=yk(i,a,h,p,O,u);return{branches:[B,...n],directCommits:T.directCommits,branchCommitPreviews:{...T.branchCommitPreviews,[O]:[A]},branchUniqueAheadCounts:{...c,[O]:1}}}function X5(t,n,i,a,c,u,d=!1){const h=[...t].sort((y,g)=>y.index-g.index);let p={branches:n,directCommits:i,branchCommitPreviews:a,branchUniqueAheadCounts:c};for(const y of h)p=bk(y,p.branches,p.directCommits,p.branchCommitPreviews,p.branchUniqueAheadCounts,u,d);return p}function vk({branches:t,mergeNodes:n,directCommits:i,unpushedDirectCommits:a,defaultBranch:c,branchCommitPreviews:u,branchParentByName:d={},branchUniqueAheadCounts:h,checkedOutRef:p,stashes:y,manuallyOpenedClumps:g=new Set,manuallyClosedClumps:b=new Set,gridSearchQuery:v="",gridFocusSha:C=null,orientation:k="horizontal"}){var W,Q;const j=X5(y,t,i,u,h,c,(W=p==null?void 0:p.hasUncommittedChanges)!=null?W:!1);let M=j.branches,A=j.directCommits,O=j.branchCommitPreviews,B=j.branchUniqueAheadCounts;if(p!=null&&p.hasUncommittedChanges){const me=p.headSha||p.parentSha||null,se=(X,ge)=>!X||!ge?!1:X===ge||X.startsWith(ge)||ge.startsWith(X),ae=p.branchName?M.find(X=>X.name===p.branchName):void 0,we=(()=>{var ge;if(!me)return null;const X=A.find(Ae=>se(Ae.fullSha,me)||se(Ae.sha,me));if(X!=null&&X.date)return X.date;if(ae){const Ae=((ge=O[ae.name])!=null?ge:[]).find(P=>se(P.fullSha,me)||se(P.sha,me));if(Ae!=null&&Ae.date)return Ae.date}return null})(),Le=we?new Date(we).getTime():Number.NaN,Z=Date.now(),fe=Number.isFinite(Le)?Math.max(Z,Le+1):Z,$=new Date(fe).toISOString(),ce={fullSha:"WORKING_TREE",sha:"Uncommited Changes",parentSha:me,message:"Local uncommitted changes",author:"You",date:$,kind:"uncommitted"};ae?(M=M.map(X=>X.name===ae.name?{...X,commitsAhead:X.commitsAhead+1,unpushedCommits:X.unpushedCommits+1,lastCommitDate:$,headSha:"WORKING_TREE"}:X),O={...O,[ae.name]:[ce,...O[ae.name]||[]]},B={...B,[ae.name]:Math.max(0,(Q=Object.prototype.hasOwnProperty.call(B,ae.name)?B[ae.name]:ae.commitsAhead)!=null?Q:0)+1}):O={...O,[c]:[ce,...O[c]||[]]}}const T={...d};T[c]=null;const F=fp(M,c,O,T),H=Ec({lanes:F,branches:M,mergeNodes:n,directCommits:A,unpushedDirectCommits:a,defaultBranch:c,branchCommitPreviews:O,branchParentByName:T,branchUniqueAheadCounts:B,manuallyOpenedClumps:g,manuallyClosedClumps:b,isDebugOpen:!1,gridSearchQuery:v,gridFocusSha:C,checkedOutRef:p,orientation:k});return{enrichedBranches:M,enrichedBranchCommitPreviews:O,enrichedBranchUniqueAheadCounts:B,enrichedDirectCommits:A,sharedGridLayoutModel:H}}const Q1="git-visualizer:expanded-projects",Z1="git-visualizer:expanded-branches";function wk(t,n){var u;const i=new Map(t.map(d=>[d.name,d])),a=new Map;for(const d of t){const h=d.parentBranch;if(!h||h===d.name||!(i.has(h)||h===n))continue;const y=(u=a.get(h))!=null?u:[];y.push(d.name),a.set(h,y)}const c=(d,h)=>{var g,b,v,C;const p=new Date((b=(g=i.get(d))==null?void 0:g.lastCommitDate)!=null?b:0).getTime(),y=new Date((C=(v=i.get(h))==null?void 0:v.lastCommitDate)!=null?C:0).getTime();return p-y};for(const[d,h]of a.entries())h.sort(c);return a}function Sk(t,n,i){const a=new Map(t.map(d=>[d.name,d])),c=(d,h)=>{var g,b,v,C;const p=new Date((b=(g=a.get(d))==null?void 0:g.lastCommitDate)!=null?b:0).getTime(),y=new Date((C=(v=a.get(h))==null?void 0:v.lastCommitDate)!=null?C:0).getTime();return p-y},u=new Set;for(const d of i.values())for(const h of d)u.add(h);return t.map(d=>d.name).filter(d=>!u.has(d)).sort((d,h)=>d===n?-1:h===n?1:c(d,h))}function Ck(t,n,i,a){const c=new Set([a]);if(!(i!=null&&i.branchName))return c;const u=(d,h)=>{var p;for(const y of d){const g=[...h,y];if(y===i.branchName){for(const b of g)c.add(b);return!0}if(u((p=n.get(y))!=null?p:[],g))return!0}return!1};return u(t,[]),c}function J1(t,n){if(!t||!n)return!1;const i=u=>{const d=u.replace(/\\/g,"/").replace(/\/+$/,""),h=new Set([d]);return d.startsWith("/private/")&&h.add(d.slice(8)),Array.from(h)},a=i(t),c=i(n);for(const u of a)for(const d of c)if(u===d||u.toLowerCase()===d.toLowerCase())return!0;return!1}function np({branchName:t,depth:n,isLast:i,branchByName:a,branchCommitPreviews:c,childNamesByParent:u,branchAnchorShaByName:d,expandedBranchNames:h,onToggleBranch:p,checkedOutBranchName:y,checkedOutHeadSha:g,ancestors:b,showCommits:v,getMergeTargetLabels:C,sourceBranchName:k,clusterKeyByCommitId:j,isGridClusterOpen:M,onToggleGridCluster:A,onSelectCommit:O,onSelectBranch:B,isActiveProject:T}){var ee,ve;if(b.has(t))return null;const F=a.get(t);if(!F)return null;const H=(ee=u.get(t))!=null?ee:[],W=H.length>0,Q=_.useMemo(()=>{var ue;return[...(ue=c[t])!=null?ue:[]]},[c,t]),me=v&&Q.length>0,se=v,ae=W||me,we=h.has(t),Le=se?Q:[],Z=we&&Le.length>0,fe=y===t||g!=null&&F.headSha===g,$=new Set(b);$.add(t);const ce="top-[-0.45rem] h-5 w-[10px]",X="rounded-bl-[7px]",ge="left-[0.65rem]",Ae=new Map,P=[];for(const ue of H){const je=d.get(ue);if(je){const He=Le.findIndex(Ge=>bi(Ge.fullSha,je)||bi(Ge.sha,je));if(He>=0){const Ge=(ve=Ae.get(He))!=null?ve:[];Ge.push(ue),Ae.set(He,Ge);continue}}P.push(ue)}const le=_.useMemo(()=>{if(!v||Le.length===0)return[];const ue=[];let je=[],He=null;const Ge=()=>{if(je.length===0)return;const $e=je[je.length-1],Dt=`sidebar-single-${t}-${$e.fullSha}`;ue.push({key:He!=null?He:Dt,commits:je,count:je.length,lead:$e}),je=[],He=null};return Le.forEach($e=>{var It;const Dt=(It=j.get(`${t}:${$e.fullSha}`))!=null?It:null;if(je.length===0){je=[$e],He=Dt;return}if(Dt===He){je.push($e);return}Ge(),je=[$e],He=Dt}),Ge(),ue},[t,v,Le,j]);return l.jsxs("li",{className:cn("relative flex flex-col gap-1",n>0?"pl-4":"pl-0",we?"mb-2.5":""),children:[n>0?l.jsx("span",{"aria-hidden":"true",className:cn("absolute w-3 border-b-[1.5px] border-l-[1.5px] border-border",X,ge,ce)}):null,!i&&n>0?l.jsx("span",{"aria-hidden":"true",className:cn("absolute top-0 border-l-[1.5px] border-border","bottom-[-0.25rem]",ge)}):null,l.jsx("div",{className:"flex items-center gap-1",children:l.jsxs("div",{className:cn("branch-row","group flex min-w-0 flex-1 items-center gap-0 rounded-md px-2 h-6 text-left text-sm font-normal transition-colors hover:bg-accent","text-inherit hover:text-inherit"),"data-active-project":T?"true":"false","data-checked-out-branch":fe?"true":"false",style:{color:T?fe?"var(--highlight)":"var(--foreground)":"var(--muted-foreground)"},role:"button",tabIndex:0,onClick:()=>{T?B==null||B(t):ae?p(t):B==null||B(t)},onKeyDown:ue=>{(ue.key==="Enter"||ue.key===" ")&&(ue.preventDefault(),T?B==null||B(t):ae?p(t):B==null||B(t))},children:[ae?l.jsx("button",{type:"button","aria-label":`${we?"Collapse":"Expand"} ${t}`,onPointerDown:ue=>{ue.preventDefault()},onClick:ue=>{ue.preventDefault(),ue.stopPropagation(),p(t)},className:"group/chevron branch-chevron flex h-6 w-6 -ml-2 shrink-0 items-center justify-center rounded-sm p-0 text-[10px] leading-none transition-colors hover:bg-accent",children:l.jsx(iw,{"aria-hidden":"true",className:cn("h-3.5 w-3.5 shrink-0 transition-transform text-current",we?"rotate-90":"")})}):null,l.jsx("span",{className:cn("branch-label min-w-0 flex-1 truncate font-normal whitespace-nowrap overflow-hidden","font-medium"),children:t})]})}),Z?l.jsx("ul",{className:"relative space-y-1 pl-4",children:le.map(ue=>{const je=ue.count>1&&!M(ue.key);return(je?[ue.lead]:ue.commits).map(Ge=>{var It;const $e=Le.findIndex(ut=>ut.fullSha===Ge.fullSha),Dt=C(Ge.fullSha,k!=null?k:t);return l.jsxs("li",{children:[l.jsxs("div",{className:"flex items-start gap-1",children:[l.jsxs("button",{type:"button",onClick:()=>O==null?void 0:O(Ge.fullSha),className:"min-w-0 flex-1 rounded-md px-2 h-6 text-left text-xs font-normal leading-4 text-muted-foreground/70 transition-colors hover:bg-accent hover:text-muted-foreground",title:Ge.message,children:[l.jsx("span",{className:"block truncate",children:Ge.message}),Dt.length>0?l.jsx("span",{className:"mt-0 block space-y-2",children:Dt.map(ut=>l.jsxs("span",{className:"block truncate",children:[l.jsx("span",{children:"Merged to "}),l.jsx("span",{className:"font-medium text-muted-foreground",children:ut})]},`${Ge.fullSha}:${ut}`))}):null]}),ue.count>1&&Ge.fullSha===ue.lead.fullSha?l.jsx("button",{type:"button","data-clump-toggle-id":`${t}:${ue.lead.fullSha}`,onClick:()=>A(ue.key,`${t}:${ue.lead.fullSha}`),className:cn("shrink-0 rounded-md px-2 h-6 text-left text-xs font-normal leading-4 text-muted-foreground/70 transition-colors hover:bg-accent hover:text-muted-foreground",je?"":"min-w-[2ch] text-center"),children:je?`+${Math.max(1,ue.count-1)}`:"−"}):null]}),(It=Ae.get($e))!=null&&It.length?l.jsx("ul",{className:"relative space-y-1",children:Ae.get($e).map((ut,tt,st)=>l.jsx(np,{branchName:ut,depth:n+1,isLast:tt===st.length-1&&P.length===0,branchByName:a,branchCommitPreviews:c,childNamesByParent:u,branchAnchorShaByName:d,expandedBranchNames:h,onToggleBranch:p,checkedOutBranchName:y,checkedOutHeadSha:g,ancestors:$,showCommits:v,getMergeTargetLabels:C,sourceBranchName:ut,clusterKeyByCommitId:j,isGridClusterOpen:M,onToggleGridCluster:A,onSelectCommit:O,onSelectBranch:B,isActiveProject:T},ut))}):null]},`${t}:${Ge.fullSha}`)})})}):null,W&&we&&P.length>0?l.jsx("ul",{className:"relative space-y-1",children:P.map((ue,je)=>l.jsx(np,{branchName:ue,depth:n+1,isLast:je===P.length-1,branchByName:a,branchCommitPreviews:c,childNamesByParent:u,branchAnchorShaByName:d,expandedBranchNames:h,onToggleBranch:p,checkedOutBranchName:y,checkedOutHeadSha:g,ancestors:$,showCommits:v,getMergeTargetLabels:C,sourceBranchName:ue,clusterKeyByCommitId:j,isGridClusterOpen:M,onToggleGridCluster:A,onSelectCommit:O,onSelectBranch:B,isActiveProject:T},ue))}):null]})}function kk({open:t}){return l.jsx("svg",{viewBox:"0 0 24 24","aria-hidden":"true",className:"h-4 w-4 shrink-0 transition-opacity",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t?l.jsxs(l.Fragment,{children:[l.jsx("path",{d:"M11.7031 19H5.97457C4.96341 19 4.11131 18.2453 3.9892 17.2415L2.77269 7.24152C2.62773 6.04996 3.5577 5 4.75805 5H7C7.64911 5 8.28071 5.21053 8.8 5.6L9.2 5.9C9.71929 6.28947 10.3509 6.5 11 6.5H16.2369C17.2445 6.5 18.0947 7.24955 18.2211 8.2492L18.4938 10.4062",stroke:"currentColor",strokeWidth:"1.5"}),l.jsx("path",{d:"M5.21532 12.0419C5.42789 11.1385 6.23405 10.5 7.16215 10.5H19.8105C20.7133 10.5 21.38 11.3419 21.1733 12.2207L19.9409 17.4581C19.7284 18.3615 18.9222 19 17.9941 19H6.10333C4.81363 19 3.8611 17.7973 4.1565 16.5419L5.21532 12.0419Z",stroke:"currentColor",strokeWidth:"1.5"})]}):l.jsxs(l.Fragment,{children:[l.jsx("path",{d:"M4 7C4 5.89543 4.89543 5 6 5H9C9.64911 5 10.2807 5.21053 10.8 5.6L11.2 5.9C11.7193 6.28947 12.3509 6.5 13 6.5H18C19.1046 6.5 20 7.39543 20 8.5V17C20 18.1046 19.1046 19 18 19H6C4.89543 19 4 18.1046 4 17V7Z",stroke:"currentColor",strokeWidth:"1.5"}),l.jsx("path",{d:"M4 10.5L12.4211 10.5L20 10.5",stroke:"currentColor",strokeWidth:"1.5"})]})})}function jk({projects:t,activeProjectPath:n,onSelectProject:i,onAddProject:a,onRemoveProject:c,onRevealProjectInFinder:u,onReorderProjects:d,projectLoading:h=!1,projectError:p=null,checkedOutRef:y,manuallyOpenedClumpsByProject:g={},manuallyClosedClumpsByProject:b={},manuallyOpenedClumps:v,manuallyClosedClumps:C,setManuallyOpenedClumps:k,setManuallyClosedClumps:j,gridLayoutModel:M,onSelectCommit:A,onSelectBranch:O,showCommits:B,className:T,style:F,collapsed:H=!1}){var Ke,Te;const W=_.useRef(null),Q=_.useRef(null),[me,se]=_.useState(()=>{if(typeof window>"u")return new Set;try{const he=window.localStorage.getItem(Q1);if(he){const Oe=JSON.parse(he);if(Array.isArray(Oe)){const Ye=new Set;for(const Qe of Oe)typeof Qe=="string"&&Ye.add(Qe);return Ye}}}catch{}return new Set(t.map(he=>he.path))}),[ae,we]=_.useState({}),[Le,Z]=_.useState(()=>new Set),[fe,$]=_.useState(()=>new Set),[ce,X]=_.useState(null),ge=v!=null?v:Le,Ae=C!=null?C:fe,P=k!=null?k:Z,le=j!=null?j:$,[ee,ve]=_.useState(null),[ue,je]=_.useState(null),[He,Ge]=_.useState(null),[$e,Dt]=_.useState(null),[It,ut]=_.useState(null),[tt,st]=_.useState(null),[Gt,an]=_.useState(null),Pe=_.useRef(new Map),ie=_.useRef(!1),We=_.useRef(null),nt=_.useRef(null),Se=he=>{try{window.localStorage.setItem(Q1,JSON.stringify(Array.from(he)))}catch{}},qe=he=>{try{const Oe=Object.fromEntries(Object.entries(he).map(([Ye,Qe])=>[Ye,Array.from(Qe)]));window.localStorage.setItem(Z1,JSON.stringify(Oe))}catch{}};_.useEffect(()=>{Se(me)},[me]),_.useEffect(()=>{try{const he=window.localStorage.getItem(Z1);if(!he)return;const Oe=JSON.parse(he);if(!Oe||typeof Oe!="object")return;const Ye={};for(const[Qe,Re]of Object.entries(Oe)){if(!Array.isArray(Re))continue;const it=new Set;for(const mt of Re)typeof mt=="string"&&it.add(mt);Ye[Qe]=it}we(Ye)}catch{}},[]),_.useEffect(()=>{qe(ae)},[ae]);const rt=t,lt=_.useMemo(()=>{if(!$e)return rt;const he=rt.find(Re=>Re.path===$e);if(!he)return rt;const Oe=rt.filter(Re=>Re.path!==$e);if(It==null)return Oe;const Ye=[...Oe],Qe=Math.max(0,Math.min(It,Ye.length));return Ye.splice(Qe,0,he),Ye},[It,$e,rt]),Ct=_.useCallback(he=>{d==null||d(he)},[d]),_t=_.useCallback(()=>{Ge(null),Dt(null),ut(null),st(null)},[]);_.useEffect(()=>{if(!He)return;const he=Ye=>{const Qe=We.current;!Qe||!Qe.active||Math.abs(Ye.clientX-Qe.startX)<=4&&Math.abs(Ye.clientY-Qe.startY)<=4||nt.current==null&&(nt.current=window.requestAnimationFrame(()=>{var Ze,Bt;nt.current=null;const Re=We.current;if(!Re||!Re.active)return;(Math.abs(Ye.clientX-Re.startX)>4||Math.abs(Ye.clientY-Re.startY)>4)&&(Re.moved=!0,Dt(Re.path)),st({x:Ye.clientX-Re.offsetX,y:Ye.clientY-Re.offsetY,width:Re.width});const mt=Array.from((Bt=(Ze=Q.current)==null?void 0:Ze.querySelectorAll("[data-project-path]"))!=null?Bt:[]).filter(gt=>gt.dataset.projectPath&&gt.dataset.projectPath!==Re.path);let wt=mt.length;if(mt.length>0)for(let gt=0;gt<mt.length;gt+=1){const Mt=mt[gt].getBoundingClientRect(),Yt=Mt.top+Mt.height/2;if(Ye.clientY<Yt){wt=gt;break}}ut(wt)}))},Oe=()=>{const Ye=We.current;if(We.current=null,nt.current!=null&&(window.cancelAnimationFrame(nt.current),nt.current=null),!Ye){_t();return}if(!Ye.moved){_t();return}ie.current=!0;const Qe=rt.map(Ze=>Ze.path);if(Qe.indexOf(Ye.path)<0){_t();return}const it=It;if(it==null){_t();return}const mt=Qe.filter(Ze=>Ze!==Ye.path),wt=Math.max(0,Math.min(it,mt.length));mt.splice(wt,0,Ye.path),Ct(mt),_t(),window.requestAnimationFrame(()=>{ie.current=!1,X(null)})};return window.addEventListener("pointermove",he),window.addEventListener("pointerup",Oe),window.addEventListener("pointercancel",Oe),()=>{window.removeEventListener("pointermove",he),window.removeEventListener("pointerup",Oe),window.removeEventListener("pointercancel",Oe)}},[_t,Ct,He,It,rt]);const Pt=_.useCallback((he,Oe)=>{if(he.button!==0)return;const Ye=he.currentTarget.getBoundingClientRect();We.current={active:!0,path:Oe,startX:he.clientX,startY:he.clientY,offsetX:he.clientX-Ye.left,offsetY:he.clientY-Ye.top,width:Ye.width,moved:!1},Ge(Oe),Dt(null),ut(null),st({x:he.clientX-Ye.left,y:he.clientY-Ye.top,width:Ye.width})},[]),ot=(Ke=M==null?void 0:M.defaultCollapsedClumps)!=null?Ke:new Set,V=he=>ge.has(he)||!ot.has(he)&&!Ae.has(he),J=(he,Oe)=>{const Ye=W.current,Qe=Q.current;if(Ye&&Qe){const Re=`[data-clump-toggle-id="${Oe}"]`,it=Ye.querySelector(Re);if(it){const mt=it.getBoundingClientRect().top-Qe.getBoundingClientRect().top;je({id:Oe,topWithinScrollBody:mt})}else je(null)}else je(null);ve(Oe),P(Re=>{const it=new Set(Re),mt=V(he);return le(wt=>{const Ze=new Set(wt);return mt?(it.delete(he),Ze.add(he)):(Ze.delete(he),it.add(he)),Ze}),it})};_.useLayoutEffect(()=>{if(!ee)return;const he=W.current,Oe=Q.current;if(!he||!Oe)return;const Ye=`[data-clump-toggle-id="${ee}"]`,Qe=he.querySelector(Ye);if(Qe){if((ue==null?void 0:ue.id)===ee){const it=Qe.getBoundingClientRect().top-Oe.getBoundingClientRect().top-ue.topWithinScrollBody;Number.isFinite(it)&&it!==0&&(Oe.scrollTop+=it)}Qe.focus({preventScroll:!0}),ve(null),je(null)}},[ge,Ae,ee,ue]);const xe=(he,Oe)=>{we(Ye=>{var mt;const Qe=(mt=Ye[he])!=null?mt:new Set,Re=new Set(Qe);Re.has(Oe)?Re.delete(Oe):Re.add(Oe);const it={...Ye,[he]:Re};return qe(it),it})};_.useEffect(()=>{if(ce==null)return;const he=()=>{const Ye=Pe.current.get(ce);if(!Ye)return;const Qe=Ye.getBoundingClientRect();an({top:Qe.bottom+8,right:Math.max(8,window.innerWidth-Qe.right)})};he();const Oe=()=>X(null);return window.addEventListener("pointerdown",Oe),window.addEventListener("resize",he),window.addEventListener("scroll",he,!0),()=>{window.removeEventListener("pointerdown",Oe),window.removeEventListener("resize",he),window.removeEventListener("scroll",he,!0)}},[ce]);const Me=_.useMemo(()=>{var Oe,Ye,Qe,Re,it,mt,wt,Ze,Bt,gt,Mt,Yt,pt,Nt,Lt,Rt;const he=new Map;for(const xt of t){const Vt=vk({branches:xt.branches,mergeNodes:xt.mergeNodes,directCommits:xt.directCommits,unpushedDirectCommits:xt.unpushedDirectCommits,defaultBranch:xt.defaultBranch,branchCommitPreviews:xt.branchCommitPreviews,branchUniqueAheadCounts:xt.branchUniqueAheadCounts,checkedOutRef:xt.checkedOutRef,stashes:xt.stashes,manuallyOpenedClumps:(Oe=g[xt.path])!=null?Oe:new Set,manuallyClosedClumps:(Ye=b[xt.path])!=null?Ye:new Set}),Xn=Vt.enrichedBranches.some(Ht=>Ht.name===xt.defaultBranch)?Vt.enrichedBranches:[{name:xt.defaultBranch,commitsAhead:0,commitsBehind:0,lastCommitDate:new Date(0).toISOString(),lastCommitAuthor:"Unknown",status:"unknown",remoteSyncStatus:"on-github",unpushedCommits:0,headSha:"",parentBranch:void 0,divergedFromSha:void 0,divergedFromDate:void 0},...Vt.enrichedBranches],Nn=new Map(Vt.sharedGridLayoutModel.nodes.map(Ht=>[Ht.commit.visualId,Ht.row])),Kt={};for(const Ht of Vt.sharedGridLayoutModel.allCommits){const Rn=(Qe=Kt[Ht.branchName])!=null?Qe:[];Rn.push({fullSha:Ht.id,sha:Ht.id.slice(0,7),parentSha:(Re=Ht.parentSha)!=null?Re:null,message:Ht.message,author:Ht.author,date:Ht.date,kind:(it=Ht.kind)!=null?it:"commit"}),Kt[Ht.branchName]=Rn}for(const Ht of Object.keys(Kt))Kt[Ht]=Kt[Ht].sort((Rn,Zn)=>{var bn,zn;const Bn=new Date(Rn.date).getTime(),En=new Date(Zn.date).getTime();if(Bn!==En)return Bn-En;const Es=(bn=Nn.get(`${Ht}:${Rn.fullSha}`))!=null?bn:Number.MAX_SAFE_INTEGER,Ts=(zn=Nn.get(`${Ht}:${Zn.fullSha}`))!=null?zn:Number.MAX_SAFE_INTEGER;return Es!==Ts?Es-Ts:Rn.fullSha.localeCompare(Zn.fullSha)});const Hn=(mt=Vt.sharedGridLayoutModel.mergeTargetBranchesBySourceBranchAndCommitSha)!=null?mt:new Map,qt=(Ht,Rn)=>{const Zn=Hn.get(Rn);if(!Zn)return[];for(const[Bn,En]of Zn.entries())if(bi(Ht,Bn))return Array.from(En).sort();return[]},hn=wk(Xn,xt.defaultBranch),at=Sk(Xn,xt.defaultBranch,hn),_n=new Map(Xn.map(Ht=>[Ht.name,Ht])),ps=new Map;for(const Ht of Xn){const Rn=(Ze=(wt=Vt.sharedGridLayoutModel.firstBranchCommitByName.get(Ht.name))==null?void 0:wt.parentSha)!=null?Ze:null,Zn=Rn!=null?Rn:null;ps.set(Ht.name,Zn)}const po=(Bt=Vt.sharedGridLayoutModel.defaultCollapsedClumps)!=null?Bt:new Set,Ls=(gt=g[xt.path])!=null?gt:new Set,wo=(Mt=b[xt.path])!=null?Mt:new Set,_o=Ht=>Ls.has(Ht)||!po.has(Ht)&&!wo.has(Ht);he.set(xt.path,{rootBranchNames:at,branchByName:_n,branchCommitPreviewsFromLayout:Kt,childNamesByParent:hn,branchAnchorShaByName:ps,checkedOutBranchName:(pt=(Yt=xt.checkedOutRef)==null?void 0:Yt.branchName)!=null?pt:null,checkedOutHeadSha:(Lt=(Nt=xt.checkedOutRef)==null?void 0:Nt.headSha)!=null?Lt:null,clusterKeyByCommitId:(Rt=Vt.sharedGridLayoutModel.clusterKeyByCommitId)!=null?Rt:new Map,getMergeTargetLabels:qt,isGridClusterOpen:_o})}return he},[n,b,g,t]),et=(he,Oe={})=>{var Mt,Yt,pt,Nt,Lt;const Ye=(Mt=Oe.ghostMode)!=null?Mt:!1,Qe=(Yt=Oe.hideLive)!=null?Yt:!1,Re=J1(he.path,n),it=me.has(he.path),mt=(pt=he.treeLoaded)!=null?pt:he.branches.length>0,wt=Me.get(he.path),Ze=(Nt=ae[he.path])!=null?Nt:wt?Ck(wt.rootBranchNames,wt.childNamesByParent,y,he.defaultBranch):new Set,Bt=$e===he.path,gt=J1(he.path,n);return l.jsxs(Go.div,{layout:"position",transition:{duration:.12,ease:"easeOut"},"data-project-path":he.path,"data-active-project":gt?"true":"false",className:cn("project-row relative z-10 flex flex-col gap-1 transition-colors",it&&wt?"mb-2.5":""),children:[It!==null&&$e!==he.path&&((Lt=lt[It])==null?void 0:Lt.path)===he.path?l.jsx("div",{className:"h-px","aria-hidden":"true",children:l.jsx("div",{className:"mx-1 h-px bg-foreground/60"})}):null,l.jsxs("div",{className:cn("relative z-0 px-1",Qe?"pointer-events-none opacity-0":""),children:[l.jsxs("div",{className:cn(Ye?"group flex w-full items-center gap-0 rounded-lg px-0 h-6":"group sticky top-0 z-20 flex w-full items-center gap-0 rounded-lg bg-background px-0 h-6 transition-all duration-100 ease-out hover:bg-accent cursor-grab active:cursor-grabbing",Bt&&!Ye?"opacity-0":""),onPointerDownCapture:Rt=>{if(Ye)return;const xt=Rt.target;xt!=null&&xt.closest('.window-no-drag, button, input, textarea, select, [contenteditable="true"]')||Pt(Rt,he.path)},onClick:Rt=>{if(Ye||gt||$e===he.path||ie.current)return;const xt=Rt.target;xt!=null&&xt.closest('button, input, textarea, select, [contenteditable="true"]')||i(he.path)},children:[l.jsx("button",{type:"button",onPointerDown:Rt=>Rt.stopPropagation(),onClick:Rt=>{Rt.preventDefault(),Rt.stopPropagation(),se(xt=>{const Vt=new Set(xt);return Vt.has(he.path)?Vt.delete(he.path):Vt.add(he.path),Se(Vt),Vt})},"aria-expanded":it,"aria-label":`${it?"Collapse":"Expand"} ${he.name}`,className:cn("project-icon flex h-6 w-6 shrink-0 items-center justify-center rounded-md transition-colors hover:bg-accent",Ye?"pointer-events-none":""),style:{color:gt?"var(--foreground)":"var(--muted-foreground)"},children:l.jsx(kk,{open:it})}),l.jsx("span",{className:cn("project-name min-w-0 flex-1 truncate pl-0 text-left text-sm transition-colors","font-normal"),style:{color:gt?"var(--foreground)":"var(--muted-foreground)"},children:he.name}),l.jsxs("div",{className:"relative z-[130] shrink-0",children:[l.jsx("button",{type:"button",onPointerDown:Rt=>Rt.stopPropagation(),"aria-label":`Project actions for ${he.name}`,"aria-expanded":ce===he.path,ref:Rt=>{Pe.current.set(he.path,Rt)},onClick:Rt=>{Rt.stopPropagation();const xt=Rt.currentTarget.getBoundingClientRect();an({top:xt.bottom+8,right:Math.max(8,window.innerWidth-xt.right)}),X(Vt=>Vt===he.path?null:he.path)},className:cn("pr-1.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-md opacity-0 hover:bg-accent group-hover:opacity-100 text-current",Ye?"pointer-events-none":""),children:l.jsx(cw,{className:"h-4 w-4 shrink-0"})}),ce===he.path&&!Ye&&Gt&&typeof document<"u"?wl.createPortal(l.jsxs("div",{role:"menu",className:"fixed z-[10000] inline-flex w-max flex-col overflow-hidden rounded-md border border-border bg-background p-1",style:{top:`${Gt.top}px`,right:`${Gt.right}px`},onPointerDownCapture:Rt=>Rt.stopPropagation(),onClick:Rt=>Rt.stopPropagation(),children:[l.jsx("button",{type:"button",role:"menuitem",onPointerDown:Rt=>Rt.stopPropagation(),onClick:()=>{X(null),u(he.path)},className:"flex w-full items-center rounded-[2px] px-2 py-1.5 text-left text-xs font-medium text-muted-foreground transition-colors hover:bg-accent hover:text-foreground",children:"Open in Finder"}),l.jsx("button",{type:"button",role:"menuitem",onPointerDown:Rt=>Rt.stopPropagation(),onClick:()=>{X(null),c(he.path)},className:"project-menu-remove flex w-full items-center rounded-[2px] px-2 py-1.5 text-left text-xs font-medium",children:"Remove"})]}),document.body):null]})]}),it?mt&&wt?l.jsx("ul",{className:cn("relative z-0 space-y-1 pt-0",Ye?"opacity-70":""),children:wt.rootBranchNames.map((Rt,xt)=>l.jsx(np,{branchName:Rt,depth:0,isLast:xt===wt.rootBranchNames.length-1,branchByName:wt.branchByName,branchCommitPreviews:wt.branchCommitPreviewsFromLayout,childNamesByParent:wt.childNamesByParent,branchAnchorShaByName:wt.branchAnchorShaByName,expandedBranchNames:Ze,onToggleBranch:Vt=>xe(he.path,Vt),checkedOutBranchName:wt.checkedOutBranchName,checkedOutHeadSha:wt.checkedOutHeadSha,ancestors:new Set,showCommits:B,getMergeTargetLabels:wt.getMergeTargetLabels,sourceBranchName:Rt,clusterKeyByCommitId:wt.clusterKeyByCommitId,isGridClusterOpen:wt.isGridClusterOpen,onToggleGridCluster:J,onSelectCommit:async Vt=>{Re||await i(he.path),A==null||A(Vt)},onSelectBranch:async Vt=>{Re||await i(he.path),O==null||O(Vt)},isActiveProject:gt},`${he.path}:${Rt}`))}):l.jsx("p",{className:cn("px-2 py-2 text-xs text-muted-foreground",Ye?"opacity-70":""),children:"Loading branch tree..."}):null]})]},he.path)};return l.jsxs("aside",{ref:W,"aria-label":"Dense branch sidebar",className:cn("pointer-events-auto relative z-[120] h-full select-none overflow-hidden",T),style:F,children:[l.jsx("header",{"data-tauri-drag-region":!0,className:"absolute inset-x-0 top-0 z-80 h-12"}),l.jsxs("div",{className:"flex h-full min-h-0 flex-col",children:[p&&l.jsx("div",{className:"px-2.5 pb-2",children:l.jsx("p",{className:"rounded-xl border border-red-50 bg-red-50 px-3 py-2 text-xs text-red-600 dark:border-red-900/20 dark:bg-red-900/20 dark:text-red-400",children:p})}),l.jsx("div",{className:cn("px-2 pb-2",H?"opacity-0 pointer-events-none":""),children:l.jsx("div",{className:"px-1",children:l.jsxs("button",{type:"button",onClick:a,disabled:h,"aria-label":"Add Repo",className:"window-no-drag group flex w-full items-center gap-0 rounded-lg px-0 h-6 text-foreground transition-colors hover:bg-accent disabled:cursor-not-allowed disabled:opacity-50",children:[l.jsx("span",{className:"flex h-6 w-6 shrink-0 items-center justify-center rounded-md transition-colors group-hover:bg-accent text-foreground",children:l.jsx("svg",{"aria-hidden":"true",viewBox:"0 0 24 24",fill:"none",className:"h-4 w-4 shrink-0",children:l.jsx("path",{d:"M12 5V19M5 12H19",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round"})})}),l.jsx("span",{className:"min-w-0 flex-1 truncate pl-0 text-left text-sm font-normal text-foreground",children:"New Project"})]})})}),l.jsx("div",{ref:Q,className:cn("sidebar-scrollbar min-h-0 flex-1 space-y-2 overflow-y-auto px-2",H?"opacity-0 pointer-events-none":""),style:{scrollbarGutter:"stable both-edges"},children:lt.map(he=>et(he,{hideLive:$e===he.path}))})]}),$e&&tt?l.jsx("div",{"aria-hidden":"true",className:"pointer-events-none fixed left-0 top-0 z-[90]",style:{transform:`translate3d(${tt.x}px, ${tt.y}px, 0)`,width:`${tt.width}px`},children:et((Te=t.find(he=>he.path===$e))!=null?Te:rt.find(he=>he.path===$e),{ghostMode:!0})}):null]})}const Mk="git-visualizer",ed="git-visualizer:projects",td=12,ex=1400,Ek=180,tx="git-visualizer:sidebar-width",nx="git-visualizer:sidebar-collapsed",sx="git-visualizer:grid-clumps",ox=360,ix=180,ax=360;function aa(t){return t==="/"?t:t.replace(/\/+$/,"")}function Tk(...t){return t.filter(Boolean).join(" ")}function kd(t){var a;if(!t)return"";const i=t.replace(/\\/g,"/").replace(/\/+$/,"").split("/");return(a=i[i.length-1])!=null?a:""}function Ak(t){return kd(t)===Mk}function rx(t){var n,i;return[t.path,t.name,t.defaultBranch,t.updatedAtMs,t.branches.map(a=>[a.name,a.headSha,a.commitsAhead,a.commitsBehind,a.unpushedCommits,a.remoteSyncStatus,a.status,a.lastCommitDate].join(":")).join("|"),t.mergeNodes.map(a=>[a.fullSha,a.targetBranch,a.targetCommitSha].join(":")).join("|"),t.directCommits.map(a=>a.fullSha).join("|"),t.unpushedDirectCommits.map(a=>a.fullSha).join("|"),t.checkedOutRef?[(n=t.checkedOutRef.branchName)!=null?n:"",t.checkedOutRef.headSha,(i=t.checkedOutRef.parentSha)!=null?i:"",t.checkedOutRef.hasUncommittedChanges?"1":"0"].join(":"):"__none__",Object.entries(t.unpushedCommitShasByBranch).map(([a,c])=>`${a}:${c.join(",")}`).join("|"),Object.entries(t.branchCommitPreviews).map(([a,c])=>`${a}:${c.map(u=>u.fullSha).join(",")}`).join("|"),Object.entries(t.branchParentByName).map(([a,c])=>`${a}:${c!=null?c:""}`).join("|"),Object.entries(t.laneByBranch).map(([a,c])=>`${a}:${c}`).join("|"),Object.entries(t.branchUniqueAheadCounts).map(([a,c])=>`${a}:${c}`).join("|")].join("@@")}function Dk(){var Si,Hi,fi,bo,Jo;const[t,n]=_.useState(null),[i,a]=_.useState(""),[c,u]=_.useState([]),[d,h]=_.useState({}),[p,y]=_.useState(!1),[g,b]=_.useState([]),[v,C]=_.useState([]),[k,j]=_.useState([]),[M,A]=_.useState([]),[O,B]=_.useState({}),[T,F]=_.useState("main"),[H,W]=_.useState(null),[Q,me]=_.useState([]),[se,ae]=_.useState(!1),[we,Le]=_.useState(""),[Z,fe]=_.useState(0),[$,ce]=_.useState(1),[X,ge]=_.useState({}),[Ae,P]=_.useState({}),[le,ee]=_.useState(null),[ve,ue]=_.useState(null),[je,He]=_.useState(null),[Ge,$e]=_.useState(!1),[Dt,It]=_.useState(!1),[ut,tt]=_.useState(null),[st,Gt]=_.useState(null),[an,Pe]=_.useState(!1),[ie,We]=_.useState(null),[nt,Se]=_.useState(null),[qe,rt]=_.useState(!1),[lt,Ct]=_.useState(!1),[_t,Pt]=_.useState(!1),[ot,V]=_.useState(!1),[J,xe]=_.useState({}),[Me,et]=_.useState({}),[Ke,Te]=_.useState({}),[he,Oe]=_.useState({}),[Ye,Qe]=_.useState({}),[Re,it]=_.useState([]),[mt,wt]=_.useState([]),[Ze,Bt]=_.useState(!1),[gt,Mt]=_.useState(!1),[Yt,pt]=_.useState(!1),[Nt,Lt]=_.useState(!1),[Rt,xt]=_.useState(!1),[Vt,Xn]=_.useState("horizontal"),[Nn,Kt]=_.useState(!1),[Hn,qt]=_.useState(ox),[hn,at]=_.useState(!1),_n=_.useRef(null),ps=_.useRef(0),po=_.useRef(0),Ls=_.useRef({}),wo=_.useRef(null),_o=_.useRef({}),Ht=_.useRef({}),Rn=_.useRef(!1),Zn=_.useRef(null),Bn=_.useRef(ox),En=_.useRef(null),Es=_.useRef(null),Ts=Ak(t)||!0,bn=_.useRef(!1),zn=_.useRef(!1),Fs=_.useRef(new Set),go=_.useRef([]),So=_.useRef([]),Ro=_.useRef(null),oo=_.useRef({}),Cn=t!=null?t:"__no-repo__",us=(U,x)=>{try{const S={opened:Object.fromEntries(Object.entries(U).map(([N,Y])=>[N,Array.from(Y)])),closed:Object.fromEntries(Object.entries(x).map(([N,Y])=>[N,Array.from(Y)]))};window.localStorage.setItem(sx,JSON.stringify(S))}catch{}};_.useEffect(()=>{var U,x;try{const S=window.localStorage.getItem(sx);if(!S)return;const N=JSON.parse(S);if(!N||typeof N!="object")return;const Y={},ne={},de=N;for(const[Xe,dt]of Object.entries((U=de.opened)!=null?U:{}))Array.isArray(dt)&&(Y[Xe]=new Set(dt.filter(Tt=>typeof Tt=="string")));for(const[Xe,dt]of Object.entries((x=de.closed)!=null?x:{}))Array.isArray(dt)&&(ne[Xe]=new Set(dt.filter(Tt=>typeof Tt=="string")));ge(Y),P(ne)}catch{}},[]),_.useEffect(()=>{us(X,Ae)},[Ae,X]);const mn=_.useMemo(()=>{var U;return(U=X[Cn])!=null?U:new Set},[Cn,X]),_s=_.useMemo(()=>{var U;return(U=Ae[Cn])!=null?U:new Set},[Cn,Ae]),vi=_.useCallback(U=>{ge(x=>{var ne;const S=(ne=x[Cn])!=null?ne:new Set,N=typeof U=="function"?U(S):U,Y={...x,[Cn]:new Set(N)};return us(Y,Ae),Y})},[Cn,Ae]),Cs=_.useCallback(U=>{P(x=>{var ne;const S=(ne=x[Cn])!=null?ne:new Set,N=typeof U=="function"?U(S):U,Y={...x,[Cn]:new Set(N)};return us(X,Y),Y})},[Cn,X]),io=_.useMemo(()=>c.map(U=>{var N,Y,ne,de,Xe,dt,Tt,bt,en,ht,$t,Jt,yt,un,pn;const x=(()=>{if(!t)return!1;const An=aa(U.path).toLowerCase(),as=aa(t).toLowerCase();return An===as})(),S=(N=d[U.path])!=null?N:{};return{...U,...S,branches:(Y=S.branches)!=null?Y:[],mergeNodes:(ne=S.mergeNodes)!=null?ne:[],directCommits:(de=S.directCommits)!=null?de:[],unpushedDirectCommits:(Xe=S.unpushedDirectCommits)!=null?Xe:[],unpushedCommitShasByBranch:(dt=S.unpushedCommitShasByBranch)!=null?dt:{},checkedOutRef:x?H:(Tt=S.checkedOutRef)!=null?Tt:null,worktrees:(bt=S.worktrees)!=null?bt:[],stashes:(en=S.stashes)!=null?en:[],branchCommitPreviews:(ht=S.branchCommitPreviews)!=null?ht:{},laneByBranch:($t=S.laneByBranch)!=null?$t:{},branchUniqueAheadCounts:(Jt=S.branchUniqueAheadCounts)!=null?Jt:{},defaultBranch:(un=(yt=S.defaultBranch)!=null?yt:U.branchName)!=null?un:"main",treeLoaded:(pn=S.loaded)!=null?pn:!1}}),[c,d,t,H]),yo=_.useMemo(()=>({githubAuthStatus:st,githubAuthLoading:an,onGitHubAuthSetup:zs,gridSearchQuery:we,setGridSearchQuery:Le,gridSearchResultCount:le,gridSearchResultIndex:ve,setGridSearchJumpDirection:ce,setGridSearchJumpToken:fe,mapGridOrientation:Vt,setMapGridOrientation:Xn,setIsGridDebugOpen:Kt,githubAuthMessage:ie,commitSwitchFeedback:nt,isCommitSwitchFeedbackVisible:qe}),[nt,an,ie,st,we,le,ve,zs,qe,Vt,Le,ce,fe,Kt,Xn]);function is(U,x){const S=rx(x);return Ls.current[U]===S?!1:(Ls.current={...Ls.current,[U]:S},h(Y=>Y[U]===x?Y:{...Y,[U]:x}),!0)}function ks(U){var x;return[U.repoPath,U.defaultBranch,U.headSha,(x=U.upstreamSha)!=null?x:"",U.hasUncommittedChanges?"1":"0",U.branchCount,U.worktreeCount,U.stashCount].join("|")}function ao(U){var x;return[U.repoPath,U.headSha,(x=U.upstreamSha)!=null?x:"",U.hasUncommittedChanges?"1":"0"].join("|")}function $n(U,x){var S,N,Y,ne,de,Xe;return{repoPath:U,headSha:(N=(S=x.checkedOutRef)==null?void 0:S.headSha)!=null?N:"",upstreamSha:(ne=(Y=x.checkedOutRef)==null?void 0:Y.parentSha)!=null?ne:null,hasUncommittedChanges:(Xe=(de=x.checkedOutRef)==null?void 0:de.hasUncommittedChanges)!=null?Xe:!1}}function ro(U,x,S){var N,Y,ne,de,Xe,dt;return{repoPath:U,defaultBranch:x,headSha:(Y=(N=S.checkedOutRef)==null?void 0:N.headSha)!=null?Y:"",upstreamSha:(de=(ne=S.checkedOutRef)==null?void 0:ne.parentSha)!=null?de:null,hasUncommittedChanges:(dt=(Xe=S.checkedOutRef)==null?void 0:Xe.hasUncommittedChanges)!=null?dt:!1,branchCount:S.branches.length,worktreeCount:S.worktrees.length,stashCount:S.stashes.length}}_.useEffect(()=>{try{const U=localStorage.getItem(ed);if(!U)return;const x=JSON.parse(U);if(!Array.isArray(x))return;const S=x.filter(N=>typeof N=="object"&&N!==null&&typeof N.path=="string"&&typeof N.name=="string"&&typeof N.lastOpenedAt=="number");u(S.slice(0,td))}catch{u([])}},[]),_.useEffect(()=>{zn.current||t||c.length!==0&&(zn.current=!0,Xs(c[0].path))},[c,t]);const ds=_.useMemo(()=>v.reduce((U,x)=>(U[x.targetCommitSha]=x.targetBranch,U),{}),[v]);_.useEffect(()=>{t&&(Rn.current||h(U=>{var x,S;return{...U,[t]:{path:t,name:i||kd(t),branches:g,mergeNodes:v,directCommits:k,unpushedDirectCommits:M,mergeTargetBranchByCommitSha:v.reduce((N,Y)=>(N[Y.targetCommitSha]=Y.targetBranch,N),{}),unpushedCommitShasByBranch:O,checkedOutRef:H,worktrees:Q,stashes:Re,branchCommitPreviews:Me,branchParentByName:Ke,laneByBranch:he,branchUniqueAheadCounts:Ye,defaultBranch:T,loaded:!0,cacheSchemaVersion:(S=(x=U[t])==null?void 0:x.cacheSchemaVersion)!=null?S:1,updatedAtMs:Date.now()}}}))},[t,i,g,v,k,M,ds,O,H,Q,Re,Me,Ke,he,Ye,T]);async function Gn(U,x=!1){var N;const S=aa(U);if(S&&!Fs.current.has(S)&&!(!x&&((N=d[S])!=null&&N.loaded))){Fs.current.add(S),S===t&&y(!0);try{const Y=await Ee("get_repo_visual_snapshot",{repoPath:S,forceRefresh:x});is(S,Y)}finally{Fs.current.delete(S),S===t&&Fs.current.size===0&&y(!1)}}}_.useEffect(()=>{c.length!==0&&c.forEach(U=>{Gn(U.path),Ee("watch_repo",{repoPath:U.path}).catch(console.error)})},[c]),_.useEffect(()=>{let U=!1,x=null;return xc("git-activity",S=>{if(U)return;const N=aa(S.payload.repoPath);!N||N===t||Gn(N,!0)}).then(S=>{U?S():x=S}).catch(console.error),()=>{U=!0,x&&x()}},[t]);function ri(U){u(x=>{const S=aa(U.path);if(!S)return x;const N={...U,path:S},ne=(x.some(de=>de.path===S)?x.map(de=>de.path===S?N:de):[...x,N]).slice(-td);try{localStorage.setItem(ed,JSON.stringify(ne))}catch{}return ne})}function zo(U){u(x=>{const S=new Map(x.map(Y=>[Y.path,Y])),N=[];for(const Y of U){const ne=S.get(Y);ne&&(N.push(ne),S.delete(Y))}for(const Y of x)S.has(Y.path)&&N.push(Y);try{localStorage.setItem(ed,JSON.stringify(N.slice(0,td)))}catch{}return N.slice(0,td)})}async function ea(U){const x=aa(U);if(x){tt(null);try{const[S,N]=await Promise.all([Ee("get_repo_info",{repoPath:x}),Ee("get_default_branch",{repoPath:x}).catch(()=>"main")]);ri({path:x,name:S.name,lastOpenedAt:Date.now(),branchName:N}),await Gn(x,!0)}catch(S){tt(S instanceof Error?S.message:String(S))}}}function Zt(U){var S,N;const x=aa(U);if(x&&(u(Y=>{const ne=Y.filter(de=>de.path!==x);try{localStorage.setItem(ed,JSON.stringify(ne))}catch{}return ne}),h(Y=>{if(!(x in Y))return Y;const ne={...Y};return delete ne[x],ne}),t===x)){const Y=(N=(S=c.find(ne=>ne.path!==x))==null?void 0:S.path)!=null?N:null;Y?Xs(Y):(n(null),a(""),b([]),C([]),j([]),A([]),B({}),W(null),me([]),it([]),et({}),Te({}),Oe({}),Qe({}))}}async function $i(U){const x=aa(U);if(x)try{await Ee("reveal_in_finder",{path:x})}catch(S){tt(S instanceof Error?S.message:String(S))}}const Os=()=>{(async()=>{var U,x;try{const S=await Qv({directory:!0,multiple:!1,defaultPath:(x=(U=c[0])==null?void 0:U.path)!=null?x:void 0});typeof S=="string"&&S&&await ea(S)}catch(S){tt(S instanceof Error?S.message:String(S))}})()};async function Ii(U,x){const N=[];let Y=0;for(;;){const ne=await Ee("get_merge_nodes",{repoPath:U,branch:x,page:Y,perPage:100});if(N.push(...ne.nodes),!ne.hasMore||ne.nodes.length===0)break;Y+=1}return N}async function Pi(U,x,S){const N=Array.from(new Set([S,...x.map(de=>de.name)].filter(de=>!!de)));if(N.length===0)return[];const Y=await Promise.all(N.map(de=>Ii(U,de).catch(()=>[]))),ne=new Map;for(const de of Y)for(const Xe of de){const dt=`${Xe.targetCommitSha}:${Xe.targetBranch}`;ne.has(dt)||ne.set(dt,Xe)}return Array.from(ne.values())}const $o=U=>U.map(x=>`${x.name}|${x.headSha}|${x.commitsAhead}|${x.commitsBehind}|${x.unpushedCommits}|${x.remoteSyncStatus}`).join("||"),fs=U=>U.map(x=>x.fullSha).join("|"),li=U=>{var x,S;return U?`${(x=U.branchName)!=null?x:""}|${U.headSha}|${(S=U.parentSha)!=null?S:""}|${U.hasUncommittedChanges?1:0}`:"__none__"};async function gn(U,x,S){var Jt,yt;const N=x!=null?x:T,Y=(Jt=S==null?void 0:S.includeMergeNodes)!=null?Jt:!0,ne=(yt=S==null?void 0:S.includeUnpushedShaMap)!=null?yt:!0,[de,Xe,dt,Tt,bt,en]=await Promise.all([Ee("get_branches",{repoPath:U}),Ee("get_all_repo_commits",{repoPath:U}),Ee("get_unpushed_direct_commits",{repoPath:U,branch:N}).catch(()=>[]),Ee("get_checked_out_ref",{repoPath:U}).catch(()=>null),Ee("list_worktrees",{repoPath:U}).catch(()=>[]),Ee("list_stashes",{repoPath:U}).catch(()=>[])]),ht=Y?await Pi(U,de,N):v,$t=ne?await Promise.all([N,...de.map(un=>un.name)].map(async un=>{const pn=await Ee("get_branch_unpushed_commit_shas",{repoPath:U,branch:un}).catch(()=>[]);return[un,pn]})):Object.entries(O);b(de),C(ht),j(Xe),A(dt),B(Object.fromEntries($t)),W(Tt),me(bt),it(en)}async function Tn(U){const[x,S,N]=await Promise.all([Ee("get_branches",{repoPath:U}).catch(()=>[]),Ee("get_all_repo_commits",{repoPath:U}).catch(()=>[]),Ee("get_checked_out_ref",{repoPath:U}).catch(()=>null)]);return $o(x)!==$o(go.current)||fs(S)!==fs(So.current)||li(N)!==li(Ro.current)}async function lo(U){Se(null),It(!0),Rn.current=!0;try{const[x,S]=await Promise.all([Ee("get_repo_info",{repoPath:U}),Ee("get_default_branch",{repoPath:U})]);a(x.name),F(S),n(U),await gn(U,S),rn(U),Se({kind:"success",message:`Now targeting worktree at ${U}`})}catch(x){const S=x instanceof Error?x.message:String(x);Se({kind:"error",message:S}),console.error("Failed to switch worktree:",S)}finally{It(!1),Rn.current=!1}}async function Ko(U,x){if(!(!t||se)){ae(!0),Se(null);try{await Ee("remove_worktree",{repoPath:t,worktreePath:U,force:x}),await gn(t),Se({kind:"success",message:`Removed worktree at ${U}`})}catch(S){const N=S instanceof Error?S.message:String(S);Se({kind:"error",message:N}),console.error("Failed to remove worktree:",N)}finally{ae(!1)}}}function vs(U,x){var N,Y;const S=rx(x);return wo.current===S?!1:(wo.current=S,a(x.name||kd(U)),F(x.defaultBranch||"main"),b(x.branches),C(x.mergeNodes),j(x.directCommits),A(x.unpushedDirectCommits),B(x.unpushedCommitShasByBranch),W(x.checkedOutRef),me(x.worktrees),it(x.stashes),et(x.branchCommitPreviews),Te((N=x.branchParentByName)!=null?N:{}),Oe((Y=x.laneByBranch)!=null?Y:{}),Qe(x.branchUniqueAheadCounts),n(U),!0)}async function Xs(U){var Y;const x=++ps.current,S=aa(U);if(!S)return;Rn.current=!0;const N=d[S];if(N!=null&&N.loaded)try{const ne=await Ee("get_repo_quick_state",{repoPath:S});if(x!==ps.current)return;const de=ao(ne);if(((Y=Ht.current[S])!=null?Y:N?ao($n(S,N)):null)===de){tt(null),Ht.current={...Ht.current,[S]:de},vs(S,N),ri({path:S,name:N.name||kd(S),lastOpenedAt:Date.now(),branchName:N.defaultBranch}),It(!1),$e(!1),rn(S),(async()=>{try{const dt=await Ee("get_repo_refresh_fingerprint",{repoPath:S}),Tt=ks(dt);if(x!==ps.current)return;if(_o.current[S]!==Tt){const bt=await Ee("get_repo_visual_snapshot",{repoPath:S,forceRefresh:!0});if(x!==ps.current)return;is(S,bt),_o.current={..._o.current,[S]:Tt},Ht.current={...Ht.current,[S]:ao($n(S,bt))},vs(S,bt)}}catch{}})(),Rn.current=!1;return}Ht.current={...Ht.current,[S]:de}}catch{}if($e(!0),It(!0),tt(null),await new Promise(ne=>setTimeout(ne,15)),x===ps.current)try{const[ne,de]=await Promise.all([Ee("get_repo_info",{repoPath:S}),Ee("get_default_branch",{repoPath:S})]);if(x!==ps.current)return;a(ne.name),F(de);const Xe=await Ee("get_repo_visual_snapshot",{repoPath:S,forceRefresh:!0});if(x!==ps.current)return;is(S,Xe),_o.current={..._o.current,[S]:ks(ro(S,de,Xe))},Ht.current={...Ht.current,[S]:ao($n(S,Xe))},vs(S,Xe),ri({path:S,name:ne.name,lastOpenedAt:Date.now(),branchName:de}),It(!1),$e(!1),rn(S)}catch(ne){if(x!==ps.current)return;console.error("Failed to load repo:",ne),tt(ne instanceof Error?ne.message:String(ne)),n(null),$e(!1),It(!1)}finally{Rn.current=!1}}async function rn(U){const x=++po.current;try{if(x!==po.current)return;We(null);const S=await Ee("get_github_info",{repoPath:U}),N=await Ee("get_github_auth_status");if(x!==po.current||(Gt(N),!N.ghAvailable||!N.authenticated))return;const Y=await Ee("get_open_prs",{owner:S.owner,repo:S.repo});if(x!==po.current)return;wt(Y)}catch(S){if(x!==po.current)return;console.log("GitHub data not available:",S),We(S instanceof Error?S.message:String(S))}}_.useEffect(()=>{let U=null,x=!1;const S=(()=>{try{return dp().label}catch{return null}})(),N=async ne=>{var Xe;const de=(Xe=ne==null?void 0:ne.path)==null?void 0:Xe.trim();!de||x||t!==de&&await Xs(de)};return(async()=>{S==="main"&&(U=await xc("gitviz://open-repo",async de=>{await N(de.payload)}));const ne=await Ee("take_pending_open_repo");await N(ne)})(),()=>{x=!0,U&&U()}},[t]),_.useEffect(()=>{go.current=g},[g]),_.useEffect(()=>{So.current=k},[k]),_.useEffect(()=>{Ro.current=H},[H]),_.useEffect(()=>{oo.current=Ke},[Ke]),_.useEffect(()=>{bn.current=Rt},[Rt]),_.useEffect(()=>{},[t,T,Ts]),_.useEffect(()=>{if(!t||!T||!Ts)return;Ee("watch_repo",{repoPath:t}).catch(console.error);let U=!1,x=!1,S=!1,N=!1,Y=null,ne=null,de=null;const Xe=async()=>{if(!U){if(bn.current){x=!0;return}if(S){x=!0;return}S=!0;try{if(!await Tn(t)||U)return;await gn(t,T)}catch(bt){console.warn("Frozen git-activity refresh failed:",bt)}finally{S=!1,x&&!U&&(x=!1,window.setTimeout(()=>{Xe()},0))}}},dt=()=>{x=!0,Xe()},Tt=async()=>{if(!(U||N||document.visibilityState!=="visible")){N=!0;try{const bt=await Ee("get_remote_branch_head_sha",{repoPath:t,branch:T});if(U||bt==null)return;if(Y==null){Y=bt;return}if(bt===Y)return;Y=bt,await gn(t,T)}catch(bt){console.warn("Remote tip refresh failed:",bt)}finally{N=!1}}};return ne=window.setInterval(()=>{Tt()},15e3),Tt(),xc("git-activity",bt=>{aa(bt.payload.repoPath)===t&&(Gn(t,!0),dt())}).then(bt=>{U?bt():de=bt}).catch(console.error),()=>{U=!0,ne!=null&&window.clearInterval(ne),de&&de()}},[t,T,Ts]);async function zs(){if(t){Pe(!0),We(null);try{await Ee("authenticate_github");const U=await Ee("get_github_auth_status");Gt(U),U.authenticated?await rn(t):U.message&&We(U.message)}catch(U){We(U instanceof Error?U.message:String(U))}finally{Pe(!1)}}}_.useEffect(()=>{xe({}),Es.current=null,Pe(!1),Gt(null),We(null),wt([]),Se(null)},[t]),_.useEffect(()=>{var dt,Tt,bt,en;if(!t||!T){xe({}),et({}),Te({}),Oe({}),Qe({}),Es.current=null;return}const U=g.map(ht=>{var $t;return`${ht.name}:${ht.headSha}:${($t=ht.parentBranch)!=null?$t:""}:${ht.commitsAhead}`}).join("|"),x=v.map(ht=>{var $t,Jt;return`${ht.fullSha}:${(Jt=($t=ht.parentShas)==null?void 0:$t[1])!=null?Jt:""}`}).join("|"),S=`${t}|${T}|${U}|${x}`;if(Es.current===S)return;Es.current=S;const N={},Y={};for(const ht of g){if(ht.name===T)continue;const $t=k.filter(Jt=>Jt.branch===ht.name).map(Jt=>{var yt;return{fullSha:Jt.fullSha,sha:Jt.sha,parentSha:(yt=Jt.parentSha)!=null?yt:null,message:Jt.message,author:Jt.author,date:Jt.date,kind:"commit"}});N[ht.name]=$t,Y[ht.name]=$t.length}const ne=new Map;for(const ht of k)ne.set(ht.fullSha,ht.branch);const de=ht=>{if(!ht)return null;const $t=ne.get(ht);if($t)return $t;for(const[Jt,yt]of ne.entries())if(Jt.startsWith(ht)||ht.startsWith(Jt))return yt;return null},Xe={[T]:null};for(const ht of g){if(ht.name===T){Xe[ht.name]=null;continue}const $t=k.filter(pn=>pn.branch===ht.name),Jt=new Set($t.map(pn=>pn.fullSha)),yt=(Tt=(dt=$t.filter(pn=>{var as;const An=(as=pn.parentSha)!=null?as:null;return!An||!Jt.has(An)}).sort((pn,An)=>{const as=new Date(pn.date).getTime()-new Date(An.date).getTime();return as!==0?as:pn.fullSha.localeCompare(An.fullSha)})[0])==null?void 0:dt.parentSha)!=null?Tt:null,un=de(yt);Xe[ht.name]=(en=(bt=un!=null?un:oo.current[ht.name])!=null?bt:ht.parentBranch)!=null?en:null}xe({}),et(N),Te(Xe),Oe(ht=>{const $t={};for(const Jt of g){const yt=ht[Jt.name];yt!=null&&Number.isFinite(yt)&&($t[Jt.name]=yt)}return $t}),Qe(Y)},[t,T,g,v,k]),_.useEffect(()=>{if(!nt){rt(!1);return}rt(!0);const U=window.setTimeout(()=>{rt(!1)},ex),x=window.setTimeout(()=>{Se(null)},ex+Ek);return()=>{window.clearTimeout(U),window.clearTimeout(x)}},[nt]),_.useEffect(()=>{if(!t||g.length===0)return;const U=N=>new Promise(Y=>setTimeout(Y,N));async function x(){const Y=`${await Ee("get_home_dir")}/Desktop/git-viz-screenshots/${i}`;console.log(`📸 Saving screenshots to ${Y}`),await U(800),await Ee("screenshot",{path:`${Y}/main-timeline.png`}),console.log(`📸 Done — screenshot saved to ${Y}`)}const S=N=>{if((N.metaKey||N.ctrlKey)&&!N.shiftKey&&!N.altKey&&N.key.toLowerCase()==="b"){N.preventDefault(),at(Y=>!Y);return}(N.metaKey||N.ctrlKey)&&N.shiftKey&&N.key==="S"&&(N.preventDefault(),x())};return window.addEventListener("keydown",S),()=>window.removeEventListener("keydown",S)},[t,i,g]);async function $s(U){if(!t)return;Se(null);const x=/^STASH:(\d+)$/.exec(U.commitSha);if(x){try{const S=parseInt(x[1],10),N=await Ee("apply_stash_restore",{repoPath:t,stashIndex:S});W(N),await gn(t);const Y=`Stash ${S+1}`,ne=N.branchName?` on branch ${N.branchName}`:" at the stash base (detached HEAD)";Se({kind:"success",message:`Restored ${Y}${ne}; stash applied and dropped (uncommitted changes).`})}catch(S){const N=S instanceof Error?S.message:String(S);Se({kind:"error",message:N}),console.error("Failed to apply stash:",N)}return}if(U.branchName){const S=(Y,ne)=>{const de=Y.replace(/\\/g,"/").replace(/\/+$/,""),Xe=ne.replace(/\\/g,"/").replace(/\/+$/,"");return de===Xe||de.toLowerCase()===Xe.toLowerCase()},N=Q.find(Y=>Y.pathExists===!1||Y.isCurrent||t&&S(Y.path,t)?!1:Y.branchName===U.branchName);if(N){await lo(N.path);return}}try{let S="";(await Ee("get_checked_out_ref",{repoPath:t})).hasUncommittedChanges&&(await Ee("stash_push",{repoPath:t,includeUntracked:!0}),S="Stashed local changes (including untracked), then ",await gn(t));const Y=U.branchName?await Ee("checkout_branch",{repoPath:t,branchName:U.branchName}):await Ee("checkout_ref",{repoPath:t,refName:U.commitSha}),ne=await Ee("get_checked_out_ref",{repoPath:t}).catch(()=>Y);W(ne),await gn(t);const de=ne.branchName?ne.branchName:`${ne.headSha.slice(0,7)} (detached)`;Se({kind:"success",message:`${S}Checked out ${de}`})}catch(S){const N=S instanceof Error?S.message:String(S);Se({kind:"error",message:N}),console.error("Failed to checkout commit:",N)}}async function Io(){if(!(!t||Ze)){Se(null),Bt(!0);try{if(!(await Ee("get_checked_out_ref",{repoPath:t})).hasUncommittedChanges){Se({kind:"error",message:"No local changes to stash."});return}await Ee("stash_push",{repoPath:t,includeUntracked:!0}),await gn(t),Se({kind:"success",message:"Stashed local changes (including untracked files)."})}catch(U){const x=U instanceof Error?U.message:String(U);Se({kind:"error",message:x}),console.error("Failed to stash:",x)}finally{Bt(!1)}}}async function js(U){if(!t||gt)return!1;const x=U.trim();if(!x)return Se({kind:"error",message:"Enter a commit message."}),!1;Se(null),Mt(!0);try{if(!(await Ee("get_checked_out_ref",{repoPath:t})).hasUncommittedChanges)return Se({kind:"error",message:"No local changes to commit."}),!1;const N=await Ee("commit_working_tree",{repoPath:t,message:x});return W(N),gn(t,void 0,{includeMergeNodes:!1,includeUnpushedShaMap:!1}),Se({kind:"success",message:"Committed local changes."}),!0}catch(S){const N=S instanceof Error?S.message:String(S);return Se({kind:"error",message:N}),console.error("Failed to commit:",N),!1}finally{Mt(!1)}}async function ci(){if(!t||Yt)return!1;Se(null),pt(!0);try{if(!(await Ee("get_checked_out_ref",{repoPath:t})).hasUncommittedChanges)return Se({kind:"error",message:"No local changes to stage."}),!1;const x=await Ee("stage_working_tree",{repoPath:t});return W(x),gn(t,void 0,{includeMergeNodes:!1,includeUnpushedShaMap:!1}),Se({kind:"success",message:"Staged all changes."}),!0}catch(U){const x=U instanceof Error?U.message:String(U);return Se({kind:"error",message:x}),console.error("Failed to stage:",x),!1}finally{pt(!1)}}async function Po(U,x){if(!(!t||Nt)){Lt(!0),Se(null);try{const S=/^STASH:(\d+)$/.exec(U);let N;if(S){const Y=parseInt(S[1],10);N=await Ee("move_stash_to_new_branch",{repoPath:t,stashIndex:Y,branchName:x})}else N=await Ee("create_branch_from_uncommitted",{repoPath:t,branchName:x});W(N),gn(t,void 0,{includeMergeNodes:!1,includeUnpushedShaMap:!1}),Se({kind:"success",message:`Moved to new branch "${x}"`})}catch(S){const N=S instanceof Error?S.message:String(S);Se({kind:"error",message:N}),console.error("Failed to create branch from node:",N)}finally{Lt(!1)}}}async function Ho(U){if(!(!t||Nt)){Lt(!0),Se(null);try{const x=await Ee("create_root_branch",{repoPath:t,branchName:U});W(x),gn(t,void 0,{includeMergeNodes:!1,includeUnpushedShaMap:!1}),Se({kind:"success",message:`Created new root branch "${U}"`})}catch(x){const S=x instanceof Error?x.message:String(x);Se({kind:"error",message:S}),console.error("Failed to create root branch:",S)}finally{Lt(!1)}}}async function Is(U,x){if(!t)return;const S=Array.from(new Set(U.filter(N=>!!N&&N!==x)));if(S.length!==0){Se(null),Ct(!0);try{let N=null;for(const Y of S)N=await Ee("merge_ref_into_branch",{repoPath:t,sourceRef:Y,targetBranch:x});gn(t,void 0,{includeMergeNodes:!1,includeUnpushedShaMap:!1}),N&&W(N),Se({kind:"success",message:S.length===1?`Merged ${S[0].slice(0,7)} into ${x}`:`Merged ${S.length} commits into ${x}`})}catch(N){const Y=N instanceof Error?N.message:String(N);Se({kind:"error",message:Y}),console.error("Failed to merge refs into branch:",Y)}finally{Ct(!1)}}}async function Uo(){if(!(!t||_t)){Se(null),Pt(!0);try{const U=await Ee("push_all_unpushed_branches",{repoPath:t});gn(t,void 0,{includeMergeNodes:!1,includeUnpushedShaMap:!1}),Se({kind:"success",message:U.length>0?U.length===1?`Pushed ${U[0].branchName}`:`Pushed ${U.length} branches`:"Everything local is already pushed."})}catch(U){const x=U instanceof Error?U.message:String(U);Se({kind:"error",message:x}),console.error("Failed to push all branches:",x)}finally{Pt(!1)}}}async function Co(){if(!(!t||_t)){Se(null),Pt(!0);try{const U=await Ee("push_current_branch",{repoPath:t});gn(t,void 0,{includeMergeNodes:!1,includeUnpushedShaMap:!1}),Se({kind:"success",message:`Pushed ${U.branchName}`})}catch(U){const x=U instanceof Error?U.message:String(U);Se({kind:"error",message:x}),console.error("Failed to push current branch:",x)}finally{Pt(!1)}}}async function Un(U){var S;if(!t||_t)return;const x=Array.from(new Map(U.filter(N=>N.branchName&&N.targetSha).map(N=>[N.branchName,N])).values());if(x.length!==0){Se(null),Pt(!0);try{for(const N of x)await Ee("push_branch",{repoPath:t,branchName:N.branchName,targetSha:N.targetSha});gn(t,void 0,{includeMergeNodes:!1,includeUnpushedShaMap:!1}),Se({kind:"success",message:x.length===1?`Pushed ${x[0].branchName} through ${(S=x[0].targetSha)==null?void 0:S.slice(0,7)}`:`Pushed ${x.length} selected commit ranges`})}catch(N){const Y=N instanceof Error?N.message:String(N);Se({kind:"error",message:Y}),console.error("Failed to push selected commits:",Y)}finally{Pt(!1)}}}async function Ms(U){var ne;if(!t||ot)return;const x=Array.from(new Set(U.branchNames.filter(de=>de&&de!==T))),S=!!U.discardUncommittedChanges,N=(ne=U.stashIndices)!=null?ne:[],Y=Array.from(new Set(N)).sort((de,Xe)=>Xe-de);if(!(x.length===0&&!S&&Y.length===0)){Se(null),V(!0);try{for(const dt of Y)await Ee("stash_drop",{repoPath:t,stashIndex:dt});const de=x.length>0||S?await Ee("delete_selected_elements",{repoPath:t,branchNames:x,discardUncommittedChanges:S}):{deletedBranches:[],discardedUncommittedChanges:!1};gn(t,void 0,{includeMergeNodes:!1,includeUnpushedShaMap:!1});const Xe=[];Y.length>0&&Xe.push(Y.length===1?`removed stash ${Y[0]+1}`:`removed ${Y.length} stashes`),de.discardedUncommittedChanges&&Xe.push("discarded local uncommitted changes"),de.deletedBranches.length>0&&Xe.push(de.deletedBranches.length===1?`deleted ${de.deletedBranches[0]}`:`deleted ${de.deletedBranches.length} branches`),Se({kind:"success",message:Xe.length>0?Xe.join(" and "):"Nothing to delete."})}catch(de){const Xe=de instanceof Error?de.message:String(de);Se({kind:"error",message:Xe}),console.error("Failed to delete selected elements:",Xe)}finally{V(!1)}}}function ui(U){U&&(He(U),fe(x=>x+1))}function Gs(U){U&&(Le(U),fe(x=>x+1))}_.useEffect(()=>{var S;const U=H!=null&&H.hasUncommittedChanges?"WORKING_TREE":(S=H==null?void 0:H.headSha)!=null?S:null;if(!U)return;const x=`${t!=null?t:"__no-repo__"}|${Vt}|${U}`;_n.current!==x&&(_n.current=x,He(U),fe(N=>N+1))},[H==null?void 0:H.hasUncommittedChanges,H==null?void 0:H.headSha,Vt,t]),_.useEffect(()=>{_n.current=null},[t]);const{enrichedBranches:tn,enrichedBranchCommitPreviews:Ps,enrichedBranchUniqueAheadCounts:Vn,enrichedDirectCommits:Yn}=_.useMemo(()=>{var as,Ks,Us,Qs,uo;const U=X5(Re,g,k,Me,Ye,T,(as=H==null?void 0:H.hasUncommittedChanges)!=null?as:!1);let x=U.branches,S=U.directCommits,N=U.branchCommitPreviews,Y=U.branchUniqueAheadCounts;if(!(H!=null&&H.hasUncommittedChanges))return{enrichedBranches:x,enrichedDirectCommits:S,enrichedBranchCommitPreviews:N,enrichedBranchUniqueAheadCounts:Y};const ne=H.headSha||H.parentSha||null,de=(Us=(Ks=S[0])==null?void 0:Ks.fullSha)!=null?Us:null,Xe=(Dn,gs)=>!Dn||!gs?!1:Dn===gs||Dn.startsWith(gs)||gs.startsWith(Dn),dt=[{name:T,headSha:de!=null?de:"",isDefault:!0},...x.map(Dn=>({name:Dn.name,headSha:Dn.headSha,isDefault:!1}))],Tt=H.branchName?dt.find(Dn=>Dn.name===H.branchName):void 0,bt=ne?dt.filter(Dn=>Xe(Dn.headSha,ne)):[],en=(Qs=Tt!=null?Tt:bt.find(Dn=>Dn.isDefault))!=null?Qs:bt[0],ht=en&&!en.isDefault?x.find(Dn=>Dn.name===en.name):void 0,$t=(()=>{var gs;if(!ne)return null;const Dn=S.find(As=>Xe(As.fullSha,ne)||Xe(As.sha,ne));if(Dn!=null&&Dn.date)return Dn.date;if(ht){const As=((gs=N[ht.name])!=null?gs:[]).find(ei=>Xe(ei.fullSha,ne)||Xe(ei.sha,ne));if(As!=null&&As.date)return As.date}return null})(),Jt=$t?new Date($t).getTime():Number.NaN,yt=Date.now(),un=Number.isFinite(Jt)?Math.max(yt,Jt+1):yt,pn=new Date(un).toISOString(),An={fullSha:"WORKING_TREE",sha:"Uncommited Changes",parentSha:ne,message:"Local uncommitted changes",author:"You",date:pn,kind:"uncommitted"};return ht?{enrichedBranches:x.map(gs=>gs.name===ht.name?{...gs,commitsAhead:gs.commitsAhead+1,unpushedCommits:gs.unpushedCommits+1,lastCommitDate:pn,headSha:"WORKING_TREE"}:gs),enrichedDirectCommits:S,enrichedBranchCommitPreviews:{...N,[ht.name]:[An,...N[ht.name]||[]]},enrichedBranchUniqueAheadCounts:{...Y,[ht.name]:Math.max(0,(uo=Object.prototype.hasOwnProperty.call(Y,ht.name)?Y[ht.name]:ht.commitsAhead)!=null?uo:0)+1}}:{enrichedBranches:x,enrichedBranchCommitPreviews:{...N,[T]:[An,...N[T]||[]]},enrichedBranchUniqueAheadCounts:{...Y},enrichedDirectCommits:S}},[g,Me,Ye,H,T,k,Re]),ws=_.useMemo(()=>{const U={...Ke};return U[T]=null,U},[Ke,T,tn]),qs=_.useMemo(()=>{var U;return(U=Tw(tn,T,ws,he))!=null?U:fp(tn,T,Ps,ws)},[tn,T,Ps,ws,he]),Vo=_.useMemo(()=>Ec({lanes:qs,branches:tn,mergeNodes:v,directCommits:Yn,unpushedDirectCommits:M,defaultBranch:T,branchCommitPreviews:Ps,branchParentByName:ws,branchUniqueAheadCounts:Vn,manuallyOpenedClumps:mn,manuallyClosedClumps:_s,isDebugOpen:!1,gridSearchQuery:we,gridFocusSha:je,checkedOutRef:H!=null?H:null,orientation:Vt}),[qs,tn,v,Yn,M,T,Ps,ws,Vn,mn,_s,we,je,(Si=H==null?void 0:H.headSha)!=null?Si:null,(Hi=H==null?void 0:H.branchName)!=null?Hi:null,Vt]),xo=_.useMemo(()=>{var U;return je&&(U=Vo.clusterKeyByCommitId.get(je))!=null?U:null},[Vo.clusterKeyByCommitId,je]),ko=_.useMemo(()=>{if(!xo||_s.has(xo))return mn;const U=new Set(mn);return U.add(xo),U},[_s,mn,xo]),Hs=_.useMemo(()=>{if(!xo)return _s;const U=new Set(_s);return U.delete(xo),U},[_s,xo]),di=_.useMemo(()=>Ec({lanes:qs,branches:tn,mergeNodes:v,directCommits:Yn,unpushedDirectCommits:M,defaultBranch:T,branchCommitPreviews:Ps,branchParentByName:ws,branchUniqueAheadCounts:Vn,manuallyOpenedClumps:ko,manuallyClosedClumps:Hs,isDebugOpen:!1,gridSearchQuery:we,gridFocusSha:je,checkedOutRef:H!=null?H:null,orientation:Vt}),[qs,tn,v,Yn,M,T,Ps,ws,Vn,ko,Hs,we,je,(fi=H==null?void 0:H.headSha)!=null?fi:null,(bo=H==null?void 0:H.branchName)!=null?bo:null,Vt]);_.useEffect(()=>{try{const U=window.localStorage.getItem(tx);if(U){const S=Number(U);Number.isFinite(S)&&qt(Math.min(ax,Math.max(ix,S)))}const x=window.localStorage.getItem(nx);x!=null&&at(x==="true")}catch{}},[]),_.useEffect(()=>{Bn.current=Hn},[Hn]),_.useEffect(()=>{const U=En.current;U&&(U.style.width=hn?"0px":`${Hn}px`)},[Hn,hn]),_.useEffect(()=>{try{window.localStorage.setItem(nx,String(hn))}catch{}},[hn]);const Qo=U=>{const x=Zn.current;if(!x)return;const S=x.startWidth+(U-x.startX);x.pendingWidth=Math.min(ax,Math.max(ix,S));const N=En.current;N&&(N.style.width=`${x.pendingWidth}px`)},co=(U,x)=>{const S=Zn.current;if(S&&!(x!=null&&S.pointerId!==x)){Zn.current=null,document.body.style.cursor="",document.body.style.userSelect="",qt(S.pendingWidth);try{window.localStorage.setItem(tx,String(S.pendingWidth))}catch{}}},Zo=U=>{U.button===0&&(U.preventDefault(),Zn.current={startX:U.clientX,startWidth:Bn.current,pendingWidth:Bn.current,pointerId:U.pointerId},document.body.style.cursor="col-resize",document.body.style.userSelect="none",U.currentTarget.setPointerCapture(U.pointerId))},jo=U=>{const x=Zn.current;!x||x.pointerId!==U.pointerId||Qo(U.clientX)},zt=U=>{if(Zn.current){try{U.currentTarget.releasePointerCapture(U.pointerId)}catch{}co("pointerup",U.pointerId)}},wi=U=>{if(Zn.current){try{U.currentTarget.releasePointerCapture(U.pointerId)}catch{}co("pointercancel",U.pointerId)}};return l.jsx("div",{className:"relative flex h-screen min-h-0 flex-col bg-background text-foreground",children:l.jsx("div",{className:"relative z-30 flex h-full min-h-0 flex-col",children:l.jsxs("div",{className:"relative flex h-full min-h-0 flex-1 overflow-hidden",children:[l.jsxs("div",{ref:En,className:"relative z-[60] flex h-full min-h-0 flex-none overflow-visible",style:{width:hn?64:Hn},children:[l.jsx("button",{type:"button",className:"window-no-drag absolute right-2.5 left-22 top-2.25 z-[9999] inline-flex h-7 w-7 items-center justify-center rounded-md text-foreground transition-colors hover:bg-accent","aria-label":hn?"Open sidebar":"Collapse sidebar",onClick:()=>at(U=>!U),children:hn?l.jsx(bw,{className:"h-4 w-4 shrink-0"}):l.jsx(yw,{className:"h-4 w-4 shrink-0"})}),l.jsx(jk,{className:Tk("min-h-0 shrink-0 overflow-hidden pt-14 transition-[width,opacity] duration-300 ease-in-out","opacity-100"),style:{width:"100%"},collapsed:hn,projects:io,activeProjectPath:t,onSelectProject:Xs,onAddProject:Os,onRemoveProject:Zt,onReorderProjects:zo,onRevealProjectInFinder:$i,projectLoading:Ge||(p&&t?!((Jo=d[t])!=null&&Jo.loaded):!1),projectError:ut,checkedOutRef:H,showCommits:!1,manuallyOpenedClumpsByProject:X,manuallyClosedClumpsByProject:Ae,manuallyOpenedClumps:ko,manuallyClosedClumps:Hs,setManuallyOpenedClumps:vi,setManuallyClosedClumps:Cs,gridLayoutModel:di,onSelectCommit:ui,onSelectBranch:Gs}),hn?null:l.jsx("div",{"aria-hidden":"true",onPointerDown:Zo,onPointerMove:jo,onPointerUp:zt,onPointerCancel:wi,className:"absolute bottom-0 right-[-6px] top-0 z-50 w-3 cursor-col-resize bg-transparent"})]}),l.jsxs("div",{className:"relative min-h-0 min-w-0 flex-1 overflow-hidden",children:[l.jsx("div",{className:"pointer-events-none absolute left-0 right-0 top-0 z-40 h-12"}),l.jsx(aS,{branches:tn,mergeNodes:v,directCommits:Yn,unpushedDirectCommits:M,unpushedCommitShasByBranch:O,openPRs:mt,defaultBranch:T,branchCommitPreviews:Ps,branchParentByName:ws,branchUniqueAheadCounts:Vn,gridSearchQuery:we,gridSearchJumpToken:Z,gridSearchJumpDirection:$,gridFocusSha:je,onGridSearchResultCountChange:ee,onGridSearchResultIndexChange:ue,onGridSearchFocusChange:He,checkedOutRef:H,onCommitClick:$s,onMergeRefsIntoBranch:Is,mergeInProgress:lt,onPushAllBranches:Uo,onPushCurrentBranch:Co,onPushCommitTargets:Un,pushInProgress:_t,onDeleteSelection:Ms,deleteInProgress:ot,worktrees:Q,currentRepoPath:t!=null?t:void 0,onRemoveWorktree:Ko,removeWorktreeInProgress:se,onSwitchToWorktree:lo,onStashLocalChanges:Io,stashInProgress:Ze,stashDisabled:!1,onCommitLocalChanges:js,commitInProgress:gt,commitDisabled:!1,onStageAllChanges:ci,stageInProgress:Yt,onCreateBranchFromNode:Po,onCreateRootBranch:Ho,createBranchFromNodeInProgress:Nt,isDebugOpen:Nn,onDebugClose:()=>Kt(!1),onInteractionChange:xt,manuallyOpenedClumps:ko,manuallyClosedClumps:Hs,setManuallyOpenedClumps:vi,setManuallyClosedClumps:Cs,layoutModel:di,orientation:Vt,gridHudProps:yo})]})]})})})}var Nk=`.styles-module__popup___IhzrD svg[fill=none] {
  fill: none !important;
}
...
`,c.forEach((T,F)=>{var W;const H=((W=Qi[T.type])==null?void 0:W.label)||T.type;u+=`${F+1}. **${H}** — \`${Math.round(T.width)}×${Math.round(T.height)}px\` at \`(${Math.round(T.x)}, ${Math.round(T.y)})\`
`}),u;const d=s2(n);u+=i2(d),u+=`### Components
`,c.forEach((T,F)=>{var we;const H=((we=Qi[T.type])==null?void 0:we.label)||T.type,W={x:T.x,y:T.y,width:T.width,height:T.height};u+=`${F+1}. **${H}** — \`${Math.round(T.width)}×${Math.round(T.height)}px\` at \`(${Math.round(T.x)}, ${Math.round(T.y)})\`
`;const Q=ap(W),se=n2(Q,{includeLeftRight:a==="detailed"||a==="forensic"});for(const Le of se)u+=`   - ${Le}
`;const ae=o2(W,d);ae&&(u+=`   - CSS: ${ae}
`)}),u+=`
### Layout Analysis
`;const h=[];for(const T of c){const F=h.find(H=>Math.abs(H.y-T.y)<30);F?F.items.push(T):h.push({y:T.y,items:[T]})}if(h.sort((T,F)=>T.y-F.y),h.forEach((T,F)=>{T.items.sort((W,Q)=>W.x-Q.x);const H=T.items.map(W=>{var Q;return((Q=Qi[W.type])==null?void 0:Q.label)||W.type});if(T.items.length===1){const Q=T.items[0].width>n.width*.8;u+=`- Row ${F+1} (y≈${Math.round(T.y)}): ${H[0]}${Q?" — full width":""}
`}else u+=`- Row ${F+1} (y≈${Math.round(T.y)}): ${H.join(" | ")} — ${T.items.length} items side by side
`}),a==="detailed"||a==="forensic"){u+=`
### Spacing & Gaps
`;for(let T=0;T<c.length-1;T++){const F=c[T],H=c[T+1],W=((M=Qi[F.type])==null?void 0:M.label)||F.type,Q=((A=Qi[H.type])==null?void 0:A.label)||H.type,me=Math.round(H.y-(F.y+F.height)),se=Math.round(H.x-(F.x+F.width));Math.abs(F.y-H.y)<30?u+=`- ${W} → ${Q}: \`${se}px\` horizontal gap
`:u+=`- ${W} → ${Q}: \`${me}px\` vertical gap
`}if(a==="forensic"&&c.length>2){u+=`
### All Pairwise Gaps
`;for(let T=0;T<c.length;T++)for(let F=T+1;F<c.length;F++){const H=c[T],W=c[F],Q=((O=Qi[H.type])==null?void 0:O.label)||H.type,me=((B=Qi[W.type])==null?void 0:B.label)||W.type,se=Math.round(W.y-(H.y+H.height)),ae=Math.round(W.x-(H.x+H.width));u+=`- ${Q} ↔ ${me}: h=\`${ae}px\` v=\`${se}px\`
`}}a==="forensic"&&(u+=`
### Z-Order (placement order)
`,t.forEach((T,F)=>{var W;const H=((W=Qi[T.type])==null?void 0:W.label)||T.type;u+=`${F}. ${H} at \`(${Math.round(T.x)}, ${Math.round(T.y)})\`
`}))}u+=`
...
`,b){const M=ap(C,y("original")),A=ap(k,y("current")),O=v?{width:C.width,height:C.height}:void 0;u+=`  - Currently ${Fj(M,{x:C.x,y:C.y},O)}
`;const B=v?{width:k.width,height:k.height}:void 0,T=`at (${Math.round(k.x)}, ${Math.round(k.y)})`,F=B?`, ${Math.round(B.width)}×${Math.round(B.height)}px`:"",W=n2(A,{includeLeftRight:n==="detailed"||n==="forensic"});if(W.length>0){u+=`  - Suggested position ${T}${F}: ${W[0]}
...
[data-agentation-theme=light] .styles-module__markerTooltip___-VUm- .styles-module__markerNote___Rh4eI {
  color: rgba(0, 0, 0, 0.85);
}`,LM={marker:"styles-module__marker___9CKF7",enter:"styles-module__enter___8kI3q",exit:"styles-module__exit___KBdR3",clearing:"styles-module__clearing___8rM7K",pending:"styles-module__pending___BiY-U",fixed:"styles-module__fixed___aKrQO",multiSelect:"styles-module__multiSelect___CPfTC",hovered:"styles-module__hovered___-mg2N",renumber:"styles-module__renumber___16lvD",markerTooltip:"styles-module__markerTooltip___-VUm-",markerQuote:"styles-module__markerQuote___tQake",markerNote:"styles-module__markerNote___Rh4eI"};if(typeof document<"u"){let t=document.getElementById("feedback-tool-styles-annotation-marker-styles");t||(t=document.createElement("style"),t.id="feedback-tool-styles-annotation-marker-styles",document.head.appendChild(t)),t.textContent=BM}var Ws=LM;function Ex({annotation:t,globalIndex:n,layerIndex:i,layerSize:a,isExiting:c,isClearing:u,isAnimated:d,isHovered:h,isDeleting:p,isEditingAny:y,renumberFrom:g,markerClickBehavior:b,tooltipStyle:v,onHoverEnter:C,onHoverLeave:k,onClick:j,onContextMenu:M}){const A=(h||p)&&!y,O=A&&b==="delete",B=t.isMultiSelect,T=B?"var(--agentation-color-green)":"var(--agentation-color-accent)",F=c?Ws.exit:u?Ws.clearing:d?"":Ws.enter,H=c?`${(a-1-i)*20}ms`:`${i*20}ms`;return l.jsxs("div",{className:`${Ws.marker} ${B?Ws.multiSelect:""} ${F} ${O?Ws.hovered:""}`,"data-annotation-marker":!0,style:{left:`${t.x}%`,top:t.y,backgroundColor:O?void 0:T,animationDelay:H},onMouseEnter:()=>C(t),onMouseLeave:k,onClick:W=>{W.stopPropagation(),c||j(t)},onContextMenu:M?W=>{b==="delete"&&(W.preventDefault(),W.stopPropagation(),c||M(t))}:void 0,children:[A?O?l.jsx(G5,{size:B?18:16}):l.jsx(Gk,{size:16}):l.jsx("span",{className:g!==null&&n>=g?Ws.renumber:void 0,children:n+1}),h&&!y&&l.jsxs("div",{className:`${Ws.markerTooltip} ${Ws.enter}`,style:v,children:[l.jsxs("span",{className:Ws.markerQuote,children:[t.element,t.selectedText&&` "${t.selectedText.slice(0,30)}${t.selectedText.length>30?"...":""}"`]}),l.jsx("span",{className:Ws.markerNote,children:t.comment})]})]})}function OM({x:t,y:n,isMultiSelect:i,isExiting:a}){return l.jsx("div",{className:`${Ws.marker} ${Ws.pending} ${i?Ws.multiSelect:""} ${a?Ws.exit:Ws.enter}`,style:{left:`${t}%`,top:n,backgroundColor:i?"var(--agentation-color-green)":"var(--agentation-color-accent)"},children:l.jsx(Ok,{size:12})})}function Tx({annotation:t,fixed:n}){const i=t.isMultiSelect;return l.jsx("div",{className:`${Ws.marker} ${n?Ws.fixed:""} ${Ws.hovered} ${i?Ws.multiSelect:""} ${Ws.exit}`,"data-annotation-marker":!0,style:{left:`${t.x}%`,top:t.y},children:l.jsx(G5,{size:i?12:10})})}var zM=`.styles-module__switchContainer___Ka-AB {
  display: flex;
  align-items: center;
  position: relative;
  padding: 2px;
...
`)}
    ...
    }`].join(""),document.head.appendChild(t)};XM();function Cr(t,n){let i=document.elementFromPoint(t,n);if(!i)return null;for(;i!=null&&i.shadowRoot;){const a=i.shadowRoot.elementFromPoint(t,n);if(!a||a===i)break;i=a}return i}function km(t){let n=t;for(;n&&n!==document.body;){const a=window.getComputedStyle(n).position;if(a==="fixed"||a==="sticky")return!0;n=n.parentElement}return!1}function kr(t){return t.status!=="resolved"&&t.status!=="dismissed"}function hd(t){const n=lp(t),i=n.found?n:DM(t);if(i.found&&i.source)return AM(i.source,"path")}function GM({demoAnnotations:t,demoDelay:n=1e3,enableDemoMode:i=!1,onAnnotationAdd:a,onAnnotationDelete:c,onAnnotationUpdate:u,onAnnotationsClear:d,onCopy:h,onSubmit:p,copyToClipboard:y=!0,endpoint:g,sessionId:b,onSessionCreated:v,webhookUrl:C,className:k}={}){var Qs,uo,Dn,gs,As,ei,lr;const[j,M]=_.useState(!1),[A,O]=_.useState([]),[B,T]=_.useState(!0),[F,H]=_.useState(()=>aM()),[W,Q]=_.useState(!1),me=_.useRef(null);_.useEffect(()=>{const R=K=>{const E=me.current;E&&E.contains(K.target)&&K.stopPropagation()},I=["mousedown","click","pointerdown"];return I.forEach(K=>document.body.addEventListener(K,R)),()=>{I.forEach(K=>document.body.removeEventListener(K,R))}},[]);const[se,ae]=_.useState(!1),[we,Le]=_.useState(!1),[Z,fe]=_.useState(null),[$,ce]=_.useState({x:0,y:0}),[X,ge]=_.useState(null),[Ae,P]=_.useState(!1),[le,ee]=_.useState("idle"),[ve,ue]=_.useState(!1),[je,He]=_.useState(!1),[Ge,$e]=_.useState(null),[Dt,It]=_.useState(null),[ut,tt]=_.useState([]),[st,Gt]=_.useState(null),[an,Pe]=_.useState(null),[ie,We]=_.useState(null),[nt,Se]=_.useState(null),[qe,rt]=_.useState([]),[lt,Ct]=_.useState(0),[_t,Pt]=_.useState(!1),[ot,V]=_.useState(!1),[J,xe]=_.useState(!1),[Me,et]=_.useState(!1),[Ke,Te]=_.useState(!1),[he,Oe]=_.useState("main"),[Ye,Qe]=_.useState(!1),[Re,it]=_.useState(!1),[mt,wt]=_.useState(!1),[Ze,Bt]=_.useState([]),[gt,Mt]=_.useState(null),Yt=_.useRef(!1),[pt,Nt]=_.useState(!1),[Lt,Rt]=_.useState(!1),[xt,Vt]=_.useState(1),[Xn,Nn]=_.useState("new-page"),[Kt,Hn]=_.useState(""),[qt,hn]=_.useState(!1),[at,_n]=_.useState(null),ps=_.useRef(!1),po=_.useRef({rearrange:null,placements:[]}),Ls=_.useRef({rearrange:null,placements:[]}),[wo,_o]=_.useState(0),[Ht,Rn]=_.useState(0),[Zn,Bn]=_.useState(0),[En,Es]=_.useState(0),Ts=_.useRef(new Set),bn=_.useRef(new Set),zn=_.useRef(null),Fs=_.useRef(),go=Re&&j&&!mt&&pt;_.useEffect(()=>{if(go){Rt(!1);const R=pl(()=>{Rt(!0)});return()=>cancelAnimationFrame(R)}else Rt(!1)},[go]);const So=_.useRef(new Map),Ro=_.useRef(new Map),oo=_.useRef(),[Cn,us]=_.useState(!1),[mn,_s]=_.useState([]),vi=_.useRef(mn);vi.current=mn;const[Cs,io]=_.useState(null),yo=_.useRef(null);_.useRef(!1),_.useRef([]),_.useRef(0),_.useRef(null),_.useRef(null),_.useRef(1);const[is,ks]=_.useState(!1),ao=_.useRef(null),[$n,ro]=_.useState([]),ds=_.useRef({cmd:!1,shift:!1}),Gn=()=>{Qe(!0)},ri=()=>{Qe(!1)},zo=()=>{is||(ao.current=Ft(()=>ks(!0),850))},ea=()=>{ao.current&&(clearTimeout(ao.current),ao.current=null),ks(!1),ri()};_.useEffect(()=>()=>{ao.current&&clearTimeout(ao.current)},[]);const[Zt,$i]=_.useState(()=>{var R;try{const I=JSON.parse((R=localStorage.getItem("feedback-toolbar-settings"))!=null?R:"");return{...Cm,...I,annotationColorId:Mc.find(K=>K.id===I.annotationColorId)?I.annotationColorId:Cm.annotationColorId}}catch{return Cm}}),[Os,Ii]=_.useState(!0),[Pi,$o]=_.useState(!1),fs=()=>{var R;(R=me.current)==null||R.classList.add(Fe.disableTransitions),Ii(I=>!I),pl(()=>{var I;(I=me.current)==null||I.classList.remove(Fe.disableTransitions)})},li=!1,gn="off",[Tn,lo]=_.useState(b!=null?b:null),Ko=_.useRef(!1),[vs,Xs]=_.useState(g?"connecting":"disconnected"),[rn,zs]=_.useState(null),[$s,Io]=_.useState(!1),[js,ci]=_.useState(null),Po=_.useRef(!1),[Ho,Is]=_.useState(new Set),[Uo,Co]=_.useState(new Set),[Un,Ms]=_.useState(!1),[ui,Gs]=_.useState(!1),[tn,Ps]=_.useState(!1),Vn=_.useRef(null),Yn=_.useRef(null),ws=_.useRef(null),qs=_.useRef(null),Vo=_.useRef(!1),xo=_.useRef(0),ko=_.useRef(null),Hs=_.useRef(null),di=8,Qo=50,co=_.useRef(null),Zo=_.useRef(null),jo=_.useRef(null),zt=typeof window<"u"?window.location.pathname:"/";_.useEffect(()=>{if(Me)Te(!0);else{Qe(!1),Oe("main");const R=Ft(()=>Te(!1),0);return()=>clearTimeout(R)}},[Me]);const wi=j&&B&&!Re;_.useEffect(()=>{if(wi){Le(!1),ae(!0),Is(new Set);const R=Ft(()=>{Is(I=>{const K=new Set(I);return A.forEach(E=>K.add(E.id)),K})},350);return()=>clearTimeout(R)}else if(se){Le(!0);const R=Ft(()=>{ae(!1),Le(!1)},250);return()=>clearTimeout(R)}},[wi]),_.useEffect(()=>{V(!0),Ct(window.scrollY);const R=gm(zt);O(R.filter(kr)),Nx||($o(!0),Nx=!0,Ft(()=>$o(!1),750));try{const I=localStorage.getItem("feedback-toolbar-theme");I!==null&&Ii(I==="dark")}catch{}try{const I=localStorage.getItem("feedback-toolbar-position");if(I){const K=JSON.parse(I);typeof K.x=="number"&&typeof K.y=="number"&&zs(K)}}catch{}},[zt]),_.useEffect(()=>{ot&&localStorage.setItem("feedback-toolbar-settings",JSON.stringify(Zt))},[Zt,ot]),_.useEffect(()=>{ot&&localStorage.setItem("feedback-toolbar-theme",Os?"dark":"light")},[Os,ot]);const Si=_.useRef(!1);_.useEffect(()=>{const R=Si.current;Si.current=$s,R&&!$s&&rn&&ot&&localStorage.setItem("feedback-toolbar-position",JSON.stringify(rn))},[$s,rn,ot]),_.useEffect(()=>{if(!g||!ot||Ko.current)return;Ko.current=!0,Xs("connecting"),(async()=>{try{const I=oM(zt),K=b||I;let E=!1;if(K)try{const L=await Sx(g,K);lo(L.id),Xs("connected"),ym(zt,L.id),E=!0;const q=gm(zt),oe=new Set(L.annotations.map(Ce=>Ce.id)),ye=q.filter(Ce=>!oe.has(Ce.id));if(ye.length>0){const Ve=`${typeof window<"u"?window.location.origin:""}${zt}`,vt=(await Promise.allSettled(ye.map(ft=>cl(g,L.id,{...ft,sessionId:L.id,url:Ve})))).map((ft,ct)=>ft.status==="fulfilled"?ft.value:(console.warn("[Agentation] Failed to sync annotation:",ft.reason),ye[ct])),At=[...L.annotations,...vt];O(At.filter(kr)),dc(zt,At.filter(kr),L.id)}else O(L.annotations.filter(kr)),dc(zt,L.annotations.filter(kr),L.id)}catch(L){console.warn("[Agentation] Could not join session, creating new:",L),iM(zt)}if(!E){const L=typeof window<"u"?window.location.href:"/",q=await xm(g,L);lo(q.id),Xs("connected"),ym(zt,q.id),v==null||v(q.id);const oe=Kj(),ye=typeof window<"u"?window.location.origin:"",Ce=[];for(const[Ve,Je]of oe){const vt=Je.filter(ct=>!ct._syncedTo);if(vt.length===0)continue;const At=`${ye}${Ve}`,ft=Ve===zt;Ce.push((async()=>{try{const ct=ft?q:await xm(g,At),yn=(await Promise.allSettled(vt.map(vn=>cl(g,ct.id,{...vn,sessionId:ct.id,url:At})))).map((vn,Ln)=>vn.status==="fulfilled"?vn.value:(console.warn("[Agentation] Failed to sync annotation:",vn.reason),vt[Ln])).filter(kr);if(dc(Ve,yn,ct.id),ft){const vn=new Set(vt.map(Ln=>Ln.id));O(Ln=>{const Wt=Ln.filter(Qt=>!vn.has(Qt.id));return[...yn,...Wt]})}}catch(ct){console.warn(`[Agentation] Failed to sync annotations for ${Ve}:`,ct)}})())}await Promise.allSettled(Ce)}}catch(I){Xs("disconnected"),console.warn("[Agentation] Failed to initialize session, using local storage:",I)}})()},[g,b,ot,v,zt]),_.useEffect(()=>{if(!g||!ot)return;const R=async()=>{try{(await fetch(`${g}/health`)).ok?Xs("connected"):Xs("disconnected")}catch{Xs("disconnected")}};R();const I=Jk(R,1e4);return()=>clearInterval(I)},[g,ot]),_.useEffect(()=>{if(!g||!ot||!Tn)return;const R=new EventSource(`${g}/sessions/${Tn}/events`),I=["resolved","dismissed"],K=E=>{var L;try{const q=JSON.parse(E.data);if(I.includes((L=q.payload)==null?void 0:L.status)){const oe=q.payload.id,ye=q.payload.kind;if(ye==="placement"){for(const[Ce,Ve]of So.current)if(Ve===oe){So.current.delete(Ce),Bt(Je=>Je.filter(vt=>vt.id!==Ce));break}}else if(ye==="rearrange"){for(const[Ce,Ve]of Ro.current)if(Ve===oe){Ro.current.delete(Ce),_n(Je=>{if(!Je)return null;const vt=Je.sections.filter(At=>At.id!==Ce);return vt.length===0?null:{...Je,sections:vt}});break}}else Co(Ce=>new Set(Ce).add(oe)),Ft(()=>{O(Ce=>Ce.filter(Ve=>Ve.id!==oe)),Co(Ce=>{const Ve=new Set(Ce);return Ve.delete(oe),Ve})},150)}}catch{}};return R.addEventListener("annotation.updated",K),()=>{R.removeEventListener("annotation.updated",K),R.close()}},[g,ot,Tn]),_.useEffect(()=>{if(!g||!ot)return;const R=Hs.current==="disconnected",I=vs==="connected";Hs.current=vs,R&&I&&(async()=>{try{const E=gm(zt);if(E.length===0)return;const q=`${typeof window<"u"?window.location.origin:""}${zt}`;let oe=Tn,ye=[];if(oe)try{ye=(await Sx(g,oe)).annotations}catch{oe=null}oe||(oe=(await xm(g,q)).id,lo(oe),ym(zt,oe));const Ce=new Set(ye.map(Je=>Je.id)),Ve=E.filter(Je=>!Ce.has(Je.id));if(Ve.length>0){const vt=(await Promise.allSettled(Ve.map(ct=>cl(g,oe,{...ct,sessionId:oe,url:q})))).map((ct,nn)=>ct.status==="fulfilled"?ct.value:(console.warn("[Agentation] Failed to sync annotation on reconnect:",ct.reason),Ve[nn])),ft=[...ye,...vt].filter(kr);O(ft),dc(zt,ft,oe)}}catch(E){console.warn("[Agentation] Failed to sync on reconnect:",E)}})()},[vs,g,ot,Tn,zt]);const Hi=_.useCallback(()=>{W||(Q(!0),et(!1),M(!1),Ft(()=>{rM(!0),H(!0),Q(!1)},400))},[W]);_.useEffect(()=>{if(!i||!ot||!t||t.length===0||A.length>0)return;const R=[];return R.push(Ft(()=>{M(!0)},n-200)),t.forEach((I,K)=>{const E=n+K*300;R.push(Ft(()=>{const L=document.querySelector(I.selector);if(!L)return;const q=L.getBoundingClientRect(),{name:oe,path:ye}=_l(L),Ce={id:`demo-${Date.now()}-${K}`,x:(q.left+q.width/2)/window.innerWidth*100,y:q.top+q.height/2+window.scrollY,comment:I.comment,element:oe,elementPath:ye,timestamp:Date.now(),selectedText:I.selectedText,boundingBox:{x:q.left,y:q.top+window.scrollY,width:q.width,height:q.height},nearbyText:cc(L),cssClasses:uc(L)};O(Ve=>[...Ve,Ce])},E))}),()=>{R.forEach(clearTimeout)}},[i,ot,t,n]),_.useEffect(()=>{const R=()=>{Ct(window.scrollY),Pt(!0),jo.current&&clearTimeout(jo.current),jo.current=Ft(()=>{Pt(!1)},150)};return window.addEventListener("scroll",R,{passive:!0}),()=>{window.removeEventListener("scroll",R),jo.current&&clearTimeout(jo.current)}},[]),_.useEffect(()=>{ot&&A.length>0?Tn?dc(zt,A,Tn):r2(zt,A):ot&&A.length===0&&localStorage.removeItem($d(zt))},[A,zt,ot,Tn]),_.useEffect(()=>{if(ot&&!Yt.current){Yt.current=!0;const R=Qj(zt);R.length>0&&Bt(R)}},[ot,zt]),_.useEffect(()=>{ot&&Yt.current&&!pt&&(Ze.length>0?Zj(zt,Ze):Jj(zt))},[Ze,zt,ot,pt]),_.useEffect(()=>{if(ot&&!ps.current){ps.current=!0;const R=eM(zt);if(R){const I={...R,sections:R.sections.map(K=>{var E;return{...K,currentRect:(E=K.currentRect)!=null?E:{...K.originalRect}}})};_n(I)}}},[ot,zt]),_.useEffect(()=>{ot&&ps.current&&!pt&&(at?tM(zt,at):nM(zt))},[at,zt,ot,pt]);const fi=_.useRef(!1);_.useEffect(()=>{if(ot&&!fi.current){fi.current=!0;const R=sM(zt);R&&(Ls.current={rearrange:R.rearrange,placements:R.placements||[]},R.purpose&&Hn(R.purpose))}},[ot,zt]),_.useEffect(()=>{var I,K,E,L,q;if(!ot||!fi.current)return;const R=Ls.current;pt?((K=(I=at==null?void 0:at.sections)==null?void 0:I.length)!=null?K:0)>0||Ze.length>0||Kt?wx(zt,{rearrange:at,placements:Ze,purpose:Kt}):ud(zt):((q=(L=(E=R.rearrange)==null?void 0:E.sections)==null?void 0:L.length)!=null?q:0)>0||R.placements.length>0||Kt?wx(zt,{rearrange:R.rearrange,placements:R.placements,purpose:Kt}):ud(zt)},[at,Ze,Kt,pt,zt,ot]),_.useEffect(()=>{Re&&!at&&_n({sections:[],originalOrder:[],detectedAt:Date.now()})},[Re,at]),_.useEffect(()=>{if(!g||!Tn)return;const R=So.current,I=new Set(Ze.map(K=>K.id));for(const K of Ze){if(R.has(K.id))continue;R.set(K.id,"");const E=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:zt;cl(g,Tn,{id:K.id,x:K.x/window.innerWidth*100,y:K.y,comment:`Place ${K.type} at (${Math.round(K.x)}, ${Math.round(K.y)}), ${K.width}×${K.height}px${K.text?` — "${K.text}"`:""}`,element:`[design:${K.type}]`,elementPath:"[placement]",timestamp:K.timestamp,url:E,intent:"change",severity:"important",kind:"placement",placement:{componentType:K.type,width:K.width,height:K.height,scrollY:K.scrollY,text:K.text}}).then(L=>{R.has(K.id)&&R.set(K.id,L.id)}).catch(L=>{console.warn("[Agentation] Failed to sync placement annotation:",L),R.delete(K.id)})}for(const[K,E]of R)I.has(K)||(R.delete(K),E&&er(g,E).catch(()=>{}))},[Ze,g,Tn,zt]),_.useEffect(()=>{if(!(!g||!Tn))return oo.current&&clearTimeout(oo.current),oo.current=Ft(()=>{const R=Ro.current;if(!at||at.sections.length===0){for(const[,E]of R)E&&er(g,E).catch(()=>{});R.clear();return}const I=new Set(at.sections.map(E=>E.id)),K=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:zt;for(const E of at.sections){const L=E.originalRect,q=E.currentRect;if(!(Math.abs(L.x-q.x)>1||Math.abs(L.y-q.y)>1||Math.abs(L.width-q.width)>1||Math.abs(L.height-q.height)>1)){const Ce=R.get(E.id);Ce&&(R.delete(E.id),er(g,Ce).catch(()=>{}));continue}const ye=R.get(E.id);ye?Cx(g,ye,{comment:`Move ${E.label} section (${E.tagName}) — from (${Math.round(L.x)},${Math.round(L.y)}) ${Math.round(L.width)}×${Math.round(L.height)} to (${Math.round(q.x)},${Math.round(q.y)}) ${Math.round(q.width)}×${Math.round(q.height)}`}).catch(Ce=>{console.warn("[Agentation] Failed to update rearrange annotation:",Ce)}):(R.set(E.id,""),cl(g,Tn,{id:E.id,x:q.x/window.innerWidth*100,y:q.y,comment:`Move ${E.label} section (${E.tagName}) — from (${Math.round(L.x)},${Math.round(L.y)}) ${Math.round(L.width)}×${Math.round(L.height)} to (${Math.round(q.x)},${Math.round(q.y)}) ${Math.round(q.width)}×${Math.round(q.height)}`,element:E.selector,elementPath:"[rearrange]",timestamp:Date.now(),url:K,intent:"change",severity:"important",kind:"rearrange",rearrange:{selector:E.selector,label:E.label,tagName:E.tagName,originalRect:L,currentRect:q}}).then(Ce=>{R.has(E.id)&&R.set(E.id,Ce.id)}).catch(Ce=>{console.warn("[Agentation] Failed to sync rearrange annotation:",Ce),R.delete(E.id)}))}for(const[E,L]of R)I.has(E)||(R.delete(E),L&&er(g,L).catch(()=>{}))},300),()=>{oo.current&&clearTimeout(oo.current)}},[at,g,Tn,zt]);const bo=_.useRef(new Map);_.useLayoutEffect(()=>{var K;const R=(K=at==null?void 0:at.sections)!=null?K:[],I=new Set;if((Re||mt)&&j)for(const E of R){I.add(E.id);try{const L=document.querySelector(E.selector);if(!L)continue;if(!bo.current.has(E.id)){const q={transform:L.style.transform,transformOrigin:L.style.transformOrigin,opacity:L.style.opacity,position:L.style.position,zIndex:L.style.zIndex,display:L.style.display},oe=[];let ye=L.parentElement;for(;ye&&ye!==document.body;){const Ve=getComputedStyle(ye);(Ve.overflow!=="visible"||Ve.overflowX!=="visible"||Ve.overflowY!=="visible")&&(oe.push({el:ye,overflow:ye.style.overflow}),ye.style.overflow="visible"),ye=ye.parentElement}getComputedStyle(L).display==="inline"&&(L.style.display="inline-block"),bo.current.set(E.id,{el:L,origStyles:q,ancestors:oe}),L.style.transformOrigin="top left",L.style.zIndex="9999"}}catch{}}for(const[E,L]of bo.current)if(!I.has(E)){const{el:q,origStyles:oe,ancestors:ye}=L;q.style.transition="transform 0.4s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.4s cubic-bezier(0.22, 1, 0.36, 1)",q.style.transform=oe.transform,q.style.transformOrigin=oe.transformOrigin,q.style.opacity=oe.opacity,q.style.position=oe.position,q.style.zIndex=oe.zIndex,bo.current.delete(E),Ft(()=>{q.style.transition="",q.style.display=oe.display;for(const Ce of ye)Ce.el.style.overflow=Ce.overflow},450)}},[at,Re,mt,j]),_.useEffect(()=>()=>{for(const[,R]of bo.current){const{el:I,origStyles:K,ancestors:E}=R;I.style.transition="transform 0.4s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.4s cubic-bezier(0.22, 1, 0.36, 1)",I.style.transform=K.transform,I.style.transformOrigin=K.transformOrigin,I.style.opacity=K.opacity,I.style.position=K.position,I.style.zIndex=K.zIndex,Ft(()=>{I.style.transition="",I.style.display=K.display;for(const L of E)L.el.style.overflow=L.overflow},450)}bo.current.clear()},[]);const Jo=_.useCallback(()=>{wt(!0),it(!1),Mt(null),clearTimeout(Fs.current),Fs.current=Ft(()=>{wt(!1)},300)},[]),U=_.useCallback(()=>{Re&&(wt(!0),it(!1),Mt(null),clearTimeout(Fs.current),Fs.current=Ft(()=>{wt(!1)},300)),M(!1)},[Re]),x=_.useCallback(()=>{J||(t8(),xe(!0))},[J]),S=_.useCallback(()=>{J&&(lx(),xe(!1))},[J]),N=_.useCallback(()=>{J?S():x()},[J,x,S]),Y=_.useCallback(()=>{if($n.length===0)return;const R=$n[0],I=R.element,K=$n.length>1,E=$n.map(L=>L.element.getBoundingClientRect());if(K){const L={left:Math.min(...E.map(ct=>ct.left)),top:Math.min(...E.map(ct=>ct.top)),right:Math.max(...E.map(ct=>ct.right)),bottom:Math.max(...E.map(ct=>ct.bottom))},q=$n.slice(0,5).map(ct=>ct.name).join(", "),oe=$n.length>5?` +${$n.length-5} more`:"",ye=E.map(ct=>({x:ct.left,y:ct.top+window.scrollY,width:ct.width,height:ct.height})),Ve=$n[$n.length-1].element,Je=E[E.length-1],vt=Je.left+Je.width/2,At=Je.top+Je.height/2,ft=km(Ve);ge({x:vt/window.innerWidth*100,y:ft?At:At+window.scrollY,clientY:At,element:`${$n.length} elements: ${q}${oe}`,elementPath:"multi-select",boundingBox:{x:L.left,y:L.top+window.scrollY,width:L.right-L.left,height:L.bottom-L.top},isMultiSelect:!0,isFixed:ft,elementBoundingBoxes:ye,multiSelectElements:$n.map(ct=>ct.element),targetElement:Ve,fullPath:rd(I),accessibility:ad(I),computedStyles:id(I),computedStylesObj:od(I),nearbyElements:sd(I),cssClasses:uc(I),nearbyText:cc(I),sourceFile:hd(I)})}else{const L=E[0],q=km(I);ge({x:L.left/window.innerWidth*100,y:q?L.top:L.top+window.scrollY,clientY:L.top,element:R.name,elementPath:R.path,boundingBox:{x:L.left,y:q?L.top:L.top+window.scrollY,width:L.width,height:L.height},isFixed:q,fullPath:rd(I),accessibility:ad(I),computedStyles:id(I),computedStylesObj:od(I),nearbyElements:sd(I),cssClasses:uc(I),nearbyText:cc(I),reactComponents:R.reactComponents,sourceFile:hd(I)})}ro([]),fe(null)},[$n]);_.useEffect(()=>{j||(ge(null),We(null),Se(null),rt([]),fe(null),et(!1),ro([]),ds.current={cmd:!1,shift:!1},J&&S())},[j,J,S]),_.useEffect(()=>()=>{lx()},[]),_.useEffect(()=>{if(!j)return;const R=["p","span","h1","h2","h3","h4","h5","h6","li","td","th","label","blockquote","figcaption","caption","legend","dt","dd","pre","code","em","strong","b","i","u","s","a","time","address","cite","q","abbr","dfn","mark","small","sub","sup","[contenteditable]"].join(", "),I=":not([data-agentation-root]):not([data-agentation-root] *)",K=document.createElement("style");return K.id="feedback-cursor-styles",K.textContent=`
      body ${I} {
        cursor: crosshair !important;
      }
