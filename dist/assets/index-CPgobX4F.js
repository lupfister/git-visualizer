 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ny;function Dv(){return ny||(ny=1,(function(t){function n(z,ce){var U=z.length;z.push(ce);e:for(;0<U;){var Q=U-1>>>1,ge=z[Q];if(0<c(ge,ce))z[Q]=ce,z[U]=ge,U=Q;else break e}}function i(z){return z.length===0?null:z[0]}function a(z){if(z.length===0)return null;var ce=z[0],U=z.pop();if(U!==ce){z[0]=U;e:for(var Q=0,ge=z.length,N=ge>>>1;Q<N;){var re=2*(Q+1)-1,oe=z[re],_e=re+1,De=z[_e];if(0>c(oe,U))_e<ge&&0>c(De,oe)?(z[Q]=De,z[_e]=U,Q=_e):(z[Q]=oe,z[re]=U,Q=re);else if(_e<ge&&0>c(De,U))z[Q]=De,z[_e]=U,Q=_e;else break e}}return ce}function c(z,ce){var U=z.sortIndex-ce.sortIndex;return U!==0?U:z.id-ce.id}if(t.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;t.unstable_now=function(){return u.now()}}else{var d=Date,h=d.now();t.unstable_now=function(){return d.now()-h}}var p=[],y=[],_=1,x=null,b=3,w=!1,S=!1,k=!1,j=!1,E=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,O=typeof setImmediate<"u"?setImmediate:null;function D(z){for(var ce=i(y);ce!==null;){if(ce.callback===null)a(y);else if(ce.startTime<=z)a(y),ce.sortIndex=ce.expirationTime,n(p,ce);else break;ce=i(y)}}function W(z){if(k=!1,D(z),!S)if(i(p)!==null)S=!0,H||(H=!0,je());else{var ce=i(y);ce!==null&&ue(W,ce.startTime-z)}}var H=!1,X=-1,P=5,K=-1;function ae(){return j?!0:!(t.unstable_now()-K<P)}function se(){if(j=!1,H){var z=t.unstable_now();K=z;var ce=!0;try{e:{S=!1,k&&(k=!1,I(X),X=-1),w=!0;var U=b;try{t:{for(D(z),x=i(p);x!==null&&!(x.expirationTime>z&&ae());){var Q=x.callback;if(typeof Q=="function"){x.callback=null,b=x.priorityLevel;var ge=Q(x.expirationTime<=z);if(z=t.unstable_now(),typeof ge=="function"){x.callback=ge,D(z),ce=!0;break t}x===i(p)&&a(p),D(z)}else a(p);x=i(p)}if(x!==null)ce=!0;else{var N=i(y);N!==null&&ue(W,N.startTime-z),ce=!1}}break e}finally{x=null,b=U,w=!1}ce=void 0}}finally{ce?je():H=!1}}}var je;if(typeof O=="function")je=function(){O(se)};else if(typeof MessageChannel<"u"){var Pe=new MessageChannel,J=Pe.port2;Pe.port1.onmessage=se,je=function(){J.postMessage(null)}}else je=function(){E(se,0)};function ue(z,ce){X=E(function(){z(t.unstable_now())},ce)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(z){z.callback=null},t.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<z?Math.floor(1e3/z):5},t.unstable_getCurrentPriorityLevel=function(){return b},t.unstable_next=function(z){switch(b){case 1:case 2:case 3:var ce=3;break;default:ce=b}var U=b;b=ce;try{return z()}finally{b=U}},t.unstable_requestPaint=function(){j=!0},t.unstable_runWithPriority=function(z,ce){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var U=b;b=z;try{return ce()}finally{b=U}},t.unstable_scheduleCallback=function(z,ce,U){var Q=t.unstable_now();switch(typeof U=="object"&&U!==null?(U=U.delay,U=typeof U=="number"&&0<U?Q+U:Q):U=Q,z){case 1:var ge=-1;break;case 2:ge=250;break;case 5:ge=1073741823;break;case 4:ge=1e4;break;default:ge=5e3}return ge=U+ge,z={id:_++,callback:ce,priorityLevel:z,startTime:U,expirationTime:ge,sortIndex:-1},U>Q?(z.sortIndex=U,n(y,z),i(p)===null&&z===i(y)&&(k?(I(X),X=-1):k=!0,ue(W,U-Q))):(z.sortIndex=ge,n(p,z),S||w||(S=!0,H||(H=!0,je()))),z},t.unstable_shouldYield=ae,t.unstable_wrapCallback=function(z){var ce=b;return function(){var U=b;b=ce;try{return z.apply(this,arguments)}finally{b=U}}}})(Ih)),Ih}var sy;function Nv(){return sy||(sy=1,$h.exports=Dv()),$h.exports}var Ph={exports:{}},Jt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var oy;function Rv(){if(oy)return Jt;oy=1;var t=Symbol.for("react.transitional.element"),n=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),c=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),d=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),x=Symbol.for("react.activity"),b=Symbol.iterator;function w(N){return N===null||typeof N!="object"?null:(N=b&&N[b]||N["@@iterator"],typeof N=="function"?N:null)}var S={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},k=Object.assign,j={};function E(N,re,oe){this.props=N,this.context=re,this.refs=j,this.updater=oe||S}E.prototype.isReactComponent={},E.prototype.setState=function(N,re){if(typeof N!="object"&&typeof N!="function"&&N!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,N,re,"setState")},E.prototype.forceUpdate=function(N){this.updater.enqueueForceUpdate(this,N,"forceUpdate")};function I(){}I.prototype=E.prototype;function O(N,re,oe){this.props=N,this.context=re,this.refs=j,this.updater=oe||S}var D=O.prototype=new I;D.constructor=O,k(D,E.prototype),D.isPureReactComponent=!0;var W=Array.isArray;function H(){}var X={H:null,A:null,T:null,S:null},P=Object.prototype.hasOwnProperty;function K(N,re,oe){var _e=oe.ref;return{$$typeof:t,type:N,key:re,ref:_e!==void 0?_e:null,props:oe}}function ae(N,re){return K(N.type,re,N.props)}function se(N){return typeof N=="object"&&N!==null&&N.$$typeof===t}function je(N){var re={"=":"=0",":":"=2"};return"$"+N.replace(/[=:]/g,function(oe){return re[oe]})}var Pe=/\/+/g;function J(N,re){return typeof N=="object"&&N!==null&&N.key!=null?je(""+N.key):re.toString(36)}function ue(N){switch(N.status){case"fulfilled":return N.value;case"rejected":throw N.reason;default:switch(typeof N.status=="string"?N.then(H,H):(N.status="pending",N.then(function(re){N.status==="pending"&&(N.status="fulfilled",N.value=re)},function(re){N.status==="pending"&&(N.status="rejected",N.reason=re)})),N.status){case"fulfilled":return N.value;case"rejected":throw N.reason}}throw N}function z(N,re,oe,_e,De){var ze=typeof N;(ze==="undefined"||ze==="boolean")&&(N=null);var ot=!1;if(N===null)ot=!0;else switch(ze){case"bigint":case"string":case"number":ot=!0;break;case"object":switch(N.$$typeof){case t:case n:ot=!0;break;case _:return ot=N._init,z(ot(N._payload),re,oe,_e,De)}}if(ot)return De=De(N),ot=_e===""?"."+J(N,0):_e,W(De)?(oe="",ot!=null&&(oe=ot.replace(Pe,"$&/")+"/"),z(De,re,oe,"",function(Yt){return Yt})):De!=null&&(se(De)&&(De=ae(De,oe+(De.key==null||N&&N.key===De.key?"":(""+De.key).replace(Pe,"$&/")+"/")+ot)),re.push(De)),1;ot=0;var ct=_e===""?".":_e+":";if(W(N))for(var Ct=0;Ct<N.length;Ct++)_e=N[Ct],ze=ct+J(_e,Ct),ot+=z(_e,re,oe,ze,De);else if(Ct=w(N),typeof Ct=="function")for(N=Ct.call(N),Ct=0;!(_e=N.next()).done;)_e=_e.value,ze=ct+J(_e,Ct++),ot+=z(_e,re,oe,ze,De);else if(ze==="object"){if(typeof N.then=="function")return z(ue(N),re,oe,_e,De);throw re=String(N),Error("Objects are not valid as a React child (found: "+(re==="[object Object]"?"object with keys {"+Object.keys(N).join(", ")+"}":re)+"). If you meant to render a collection of children, use an array instead.")}return ot}function ce(N,re,oe){if(N==null)return N;var _e=[],De=0;return z(N,_e,"","",function(ze){return re.call(oe,ze,De++)}),_e}function U(N){if(N._status===-1){var re=N._result;re=re(),re.then(function(oe){(N._status===0||N._status===-1)&&(N._status=1,N._result=oe)},function(oe){(N._status===0||N._status===-1)&&(N._status=2,N._result=oe)}),N._status===-1&&(N._status=0,N._result=re)}if(N._status===1)return N._result.default;throw N._result}var Q=typeof reportError=="function"?reportError:function(N){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var re=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof N=="object"&&N!==null&&typeof N.message=="string"?String(N.message):String(N),error:N});if(!window.dispatchEvent(re))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",N);return}console.error(N)},ge={map:ce,forEach:function(N,re,oe){ce(N,function(){re.apply(this,arguments)},oe)},count:function(N){var re=0;return ce(N,function(){re++}),re},toArray:function(N){return ce(N,function(re){return re})||[]},only:function(N){if(!se(N))throw Error("React.Children.only expected to receive a single React element child.");return N}};return Jt.Activity=x,Jt.Children=ge,Jt.Component=E,Jt.Fragment=i,Jt.Profiler=c,Jt.PureComponent=O,Jt.StrictMode=a,Jt.Suspense=p,Jt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=X,Jt.__COMPILER_RUNTIME={__proto__:null,c:function(N){return X.H.useMemoCache(N)}},Jt.cache=function(N){return function(){return N.apply(null,arguments)}},Jt.cacheSignal=function(){return null},Jt.cloneElement=function(N,re,oe){if(N==null)throw Error("The argument must be a React element, but you passed "+N+".");var _e=k({},N.props),De=N.key;if(re!=null)for(ze in re.key!==void 0&&(De=""+re.key),re)!P.call(re,ze)||ze==="key"||ze==="__self"||ze==="__source"||ze==="ref"&&re.ref===void 0||(_e[ze]=re[ze]);var ze=arguments.length-2;if(ze===1)_e.children=oe;else if(1<ze){for(var ot=Array(ze),ct=0;ct<ze;ct++)ot[ct]=arguments[ct+2];_e.children=ot}return K(N.type,De,_e)},Jt.createContext=function(N){return N={$$typeof:d,_currentValue:N,_currentValue2:N,_threadCount:0,Provider:null,Consumer:null},N.Provider=N,N.Consumer={$$typeof:u,_context:N},N},Jt.createElement=function(N,re,oe){var _e,De={},ze=null;if(re!=null)for(_e in re.key!==void 0&&(ze=""+re.key),re)P.call(re,_e)&&_e!=="key"&&_e!=="__self"&&_e!=="__source"&&(De[_e]=re[_e]);var ot=arguments.length-2;if(ot===1)De.children=oe;else if(1<ot){for(var ct=Array(ot),Ct=0;Ct<ot;Ct++)ct[Ct]=arguments[Ct+2];De.children=ct}if(N&&N.defaultProps)for(_e in ot=N.defaultProps,ot)De[_e]===void 0&&(De[_e]=ot[_e]);return K(N,ze,De)},Jt.createRef=function(){return{current:null}},Jt.forwardRef=function(N){return{$$typeof:h,render:N}},Jt.isValidElement=se,Jt.lazy=function(N){return{$$typeof:_,_payload:{_status:-1,_result:N},_init:U}},Jt.memo=function(N,re){return{$$typeof:y,type:N,compare:re===void 0?null:re}},Jt.startTransition=function(N){var re=X.T,oe={};X.T=oe;try{var _e=N(),De=X.S;De!==null&&De(oe,_e),typeof _e=="object"&&_e!==null&&typeof _e.then=="function"&&_e.then(H,Q)}catch(ze){Q(ze)}finally{re!==null&&oe.types!==null&&(re.types=oe.types),X.T=re}},Jt.unstable_useCacheRefresh=function(){return X.H.useCacheRefresh()},Jt.use=function(N){return X.H.use(N)},Jt.useActionState=function(N,re,oe){return X.H.useActionState(N,re,oe)},Jt.useCallback=function(N,re){return X.H.useCallback(N,re)},Jt.useContext=function(N){return X.H.useContext(N)},Jt.useDebugValue=function(){},Jt.useDeferredValue=function(N,re){return X.H.useDeferredValue(N,re)},Jt.useEffect=function(N,re){return X.H.useEffect(N,re)},Jt.useEffectEvent=function(N){return X.H.useEffectEvent(N)},Jt.useId=function(){return X.H.useId()},Jt.useImperativeHandle=function(N,re,oe){return X.H.useImperativeHandle(N,re,oe)},Jt.useInsertionEffect=function(N,re){return X.H.useInsertionEffect(N,re)},Jt.useLayoutEffect=function(N,re){return X.H.useLayoutEffect(N,re)},Jt.useMemo=function(N,re){return X.H.useMemo(N,re)},Jt.useOptimistic=function(N,re){return X.H.useOptimistic(N,re)},Jt.useReducer=function(N,re,oe){return X.H.useReducer(N,re,oe)},Jt.useRef=function(N){return X.H.useRef(N)},Jt.useState=function(N){return X.H.useState(N)},Jt.useSyncExternalStore=function(N,re,oe){return X.H.useSyncExternalStore(N,re,oe)},Jt.useTransition=function(){return X.H.useTransition()},Jt.version="19.2.4",Jt}var iy;function cp(){return iy||(iy=1,Ph.exports=Rv()),Ph.exports}var Hh={exports:{}},zo={};/**
 * @license React
...
`;const P=Bm(X),ae=sb(P,{includeLeftRight:a==="detailed"||a==="forensic"});for(const Pe of ae)u+=`   - ${Pe}
...
### Spacing & Gaps
`;for(let D=0;D<c.length-1;D++){const W=c[D],H=c[D+1],X=((j=Fi[W.type])==null?void 0:j.label)||W.type,P=((E=Fi[H.type])==null?void 0:E.label)||H.type,K=Math.round(H.y-(W.y+W.height)),ae=Math.round(H.x-(W.x+W.width));Math.abs(W.y-H.y)<30?u+=`- ${X} → ${P}: \`${ae}px\` horizontal gap
`:u+=`- ${X} → ${P}: \`${K}px\` vertical gap
`}if(a==="forensic"&&c.length>2){u+=`
### All Pairwise Gaps
`;for(let D=0;D<c.length;D++)for(let W=D+1;W<c.length;W++){const H=c[D],X=c[W],P=((I=Fi[H.type])==null?void 0:I.label)||H.type,K=((O=Fi[X.type])==null?void 0:O.label)||X.type,ae=Math.round(X.y-(H.y+H.height)),se=Math.round(X.x-(H.x+H.width));u+=`- ${P} ↔ ${K}: h=\`${se}px\` v=\`${ae}px\`
`}}a==="forensic"&&(u+=`
...
`+L)}if(y)try{await navigator.clipboard.writeText(B)}catch{}h==null||h(B),N(!0),Ut(()=>N(!1),2e3),Kt.autoClearAfterCopy&&Ut(()=>F(),500)},[E,dn,st,it,yt,tt,In,Mn,We,Kt.outputDetail,lo,Kt.autoClearAfterCopy,F,y,h]),de=g.useCallback(async()=>{const C=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:We;let M=o1(E,C,Kt.outputDetail);if(!M&&st.length===0&&!it)return;if(M||(M=`## Page Feedback: ${C}
`),st.length>0&&(M+=`
