...
export default function MapOrientationToggle({ orientation, onOrientationChange }: Props) {
  ...
  return (
    <button
      ...
      className={cn(
        'window-no-drag inline-flex h-7 items-center gap-1.5 rounded-md border border-[#E7E5DE] bg-background pl-1.5 pr-2 py-1 transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background',
      )}
