...
export const CONNECTOR_COLOR = 'rgba(71, 85, 105, 0.92)';
...
export function renderableBranchPreviews(branchName: string, branchUniqueAheadCounts: Record<string, number>, branchCommitPreviews: Record<string, BranchCommitPreview[]>): BranchCommitPreview[] { return sortedConcreteBranchPreviews(branchName, branchCommitPreviews); }
